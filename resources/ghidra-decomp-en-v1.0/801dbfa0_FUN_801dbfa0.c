// Function: FUN_801dbfa0
// Entry: 801dbfa0
// Size: 284 bytes

void FUN_801dbfa0(void)

{
  ...
  if (cVar5 != '\0') {
    ...
    *(undefined *)(iVar2 + 0x25) = 0xce;
    *(undefined2 *)(iVar2 + 0x26) = 0xffff;
    *(undefined4 *)(iVar2 + 0x18) = 0;
    uVar3 = FUN_8002df90(iVar2,5,0xffffffff,0xffffffff,*(undefined4 *)(iVar1 + 0x30));
    *(undefined4 *)((int)uVar7 + in_r6 * 4) = uVar3;
  }
  FUN_80286128();
  return;
}
