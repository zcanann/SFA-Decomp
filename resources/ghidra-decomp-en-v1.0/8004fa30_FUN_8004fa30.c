// Function: FUN_8004fa30
// Entry: 8004fa30
// Size: 880 bytes

void FUN_8004fa30(double param_1,undefined4 *param_2,float *param_3)

{
  ...
  if (((DAT_803dcd74 < 4) && (DAT_803dcd6a < 0x10)) && (DAT_803dcd69 < 7)) {
    if (param_1 < (double)FLOAT_803deae4) {
      param_1 = (double)FLOAT_803deae4;
    }
    ...
    FUN_8025ba40(DAT_803dcd90 + 1,0xf,2,8,0);
