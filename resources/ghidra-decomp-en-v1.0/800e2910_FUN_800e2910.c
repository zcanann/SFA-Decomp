// Function: FUN_800e2910
// Entry: 800e2910
// Size: 1612 bytes

/* WARNING: Removing unreachable block (ram,0x800e2f3c) */

void FUN_800e2910(undefined4 param_1,undefined4 param_2,int param_3,int *param_4)

{
  ...
  uVar29 = FUN_802860ac();
  iVar15 = (int)((ulonglong)uVar29 >> 0x20);
  if (iVar15 == 0) {
    local_6c0[0] = -1;
  }
  else {
    iVar5 = FUN_800e36f8(*(undefined4 *)(iVar15 + 0x14),&local_6d8);
    if (iVar5 == 0) {
      local_6c0[0] = -1;
    }
    else {
      ...
      do {
        if (-1 < *(int *)(iVar21 + 0x1c)) {
          ...
          iVar13 = FUN_800e36f8(*(undefined4 *)(iVar21 + 0x1c),&local_6d4,iVar13);
          if (iVar13 != 0) {
            ...
            do {
              if (iVar13 < 1) {
                ...
                iVar25 = (&DAT_803a17e8)[local_610[iVar13]];
                dVar28 = (double)local_6b0[iVar13];
                if (((int)*(char *)(iVar25 + 0x19) == (int)uVar29) &&
                   ((param_3 == -1 || (param_3 == *(char *)(iVar25 + 0x18))))) {
                  bVar4 = true;
                  *pfVar23 = local_6b0[iVar13];
                  pfVar20 = pfVar20 + 1;
                  pfVar23 = pfVar23 + 1;
                  local_6c0[iVar5] = *(int *)(iVar21 + 0x1c);
                  iVar5 = iVar5 + 1;
                }
                else {
                  iVar17 = 0;
                  ...
                  do {
                    if ((((-1 < *(int *)(iVar22 + 0x1c)) &&
                         (iVar6 = FUN_800e36f8(*(int *)(iVar22 + 0x1c),&local_6d4), iVar6 != 0)) &&
...
LAB_800e2eac:
        ...
        *param_4 = *(int *)(iVar15 + 0x14);
        ...
        local_6c0[0] = local_6c0[iVar15];
      }
    }
  }
  __psq_l0(auStack8,uVar27);
  __psq_l1(auStack8,uVar27);
  FUN_802860f8(local_6c0[0]);
  return;
}
