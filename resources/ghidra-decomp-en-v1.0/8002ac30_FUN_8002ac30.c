// Function: FUN_8002ac30
// Entry: 8002ac30
// Size: 256 bytes

void FUN_8002ac30(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  *(char *)(iVar1 + 0xee) = (char)param_5;
  ...
  for (iVar2 = 0; iVar2 < (int)(uint)*(byte *)(iVar1 + 0xeb); iVar2 = iVar2 + 1) {
    FUN_8002ac30(*(undefined4 *)(iVar3 + 200),(int)uVar4,param_3,param_4,param_5,param_6);
    iVar3 = iVar3 + 4;
  }
  FUN_8028611c();
  return;
