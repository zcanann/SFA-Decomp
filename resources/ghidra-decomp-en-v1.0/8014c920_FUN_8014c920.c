// Function: FUN_8014c920
// Entry: 8014c920
// Size: 564 bytes

/* WARNING: Removing unreachable block (ram,0x8014cb30) */
...
/* WARNING: Removing unreachable block (ram,0x8014cb28) */
/* WARNING: Removing unreachable block (ram,0x8014cb38) */

double FUN_8014c920(double param_1,double param_2,double param_3,double param_4,double param_5,
...

{
  ...
  dVar2 = (double)FUN_802931a0((double)(float)(dVar4 * dVar4 +
  ...
  if (dVar2 <= param_4) {
    if ((double)FLOAT_803e2574 < dVar2) {
      *(float *)(param_8 + 0x24) =
           ...
           *(float *)(param_8 + 0x24);
      *(float *)(param_8 + 0x28) =
           FLOAT_803db414 * (float)(param_5 * (double)(float)(dVar5 / param_4)) +
           *(float *)(param_8 + 0x28);
      *(float *)(param_8 + 0x2c) =
    ...
    *(float *)(param_8 + 0x24) =
         ...
         *(float *)(param_8 + 0x24);
    *(float *)(param_8 + 0x28) =
         FLOAT_803db414 * (float)(param_5 * (double)(float)(dVar5 / dVar2)) +
         *(float *)(param_8 + 0x28);
    *(float *)(param_8 + 0x2c) =
  ...
  if ((double)FLOAT_803e2574 != param_7) {
    ...
    *(float *)(param_8 + 0x24) = (float)((double)*(float *)(param_8 + 0x24) * dVar2);
    dVar2 = (double)FUN_80292b44(param_7,(double)FLOAT_803db414);
    *(float *)(param_8 + 0x28) = (float)((double)*(float *)(param_8 + 0x28) * dVar2);
    dVar2 = (double)FUN_80292b44(param_7,(double)FLOAT_803db414);
