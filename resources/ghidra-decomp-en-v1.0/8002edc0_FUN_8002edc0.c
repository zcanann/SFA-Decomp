// Function: FUN_8002edc0
// Entry: 8002edc0
// Size: 1100 bytes

undefined4 FUN_8002edc0(double param_1,double param_2,int param_3,int param_4)

{
  ...
  if (*(short *)(*piVar10 + 0xec) == 0) {
    ...
    if (*(short *)(iVar11 + 0x58) != 0) {
      ...
      *(float *)(iVar11 + 8) =
      ...
      if (*(char *)(iVar11 + 0x61) == '\0') {
        ...
        if ((FLOAT_803de8f0 <= fVar5) && (fVar6 = fVar5, fVar4 < fVar5)) {
          fVar6 = fVar4;
        }
        *(float *)(iVar11 + 8) = fVar6;
      }
      else {
        if (*(float *)(iVar11 + 8) < FLOAT_803de8f0) {
      ...
      if ((*(byte *)(iVar11 + 99) & 2) == 0) {
        ...
        if ((-1 < (int)uVar8) &&
           (uVar8 = uVar8 ^ 0x80000000, fVar4 = FLOAT_803de8f4,
           (float)((double)CONCAT44(0x43300000,uVar8) - DOUBLE_803de900) <= FLOAT_803de8f4)) {
          local_28 = (double)CONCAT44(0x43300000,uVar8);
          fVar4 = (float)(local_28 - DOUBLE_803de900);
        }
    ...
    *(float *)(param_3 + 0x9c) = fVar4 + (float)(param_1 * param_2);
    ...
    if (*(float *)(param_3 + 0x9c) < FLOAT_803de8e0) {
      if (*(float *)(param_3 + 0x9c) < FLOAT_803de8f0) {
        if (*(char *)(iVar11 + 0x60) == '\0') {
          *(float *)(param_3 + 0x9c) = FLOAT_803de8f0;
        }
        else {
      ...
      if (*(char *)(iVar11 + 0x60) == '\0') {
        *(float *)(param_3 + 0x9c) = FLOAT_803de8e0;
      }
      else {
    ...
    if ((param_4 != 0) && (*(undefined *)(param_4 + 0x12) = 0, *(int *)(param_3 + 0x60) != 0)) {
      *(undefined *)(param_4 + 0x1b) = 0;
      ...
      if (iVar11 != 0) {
        iVar1 = (int)(FLOAT_803de8f8 * fVar4);
        iVar2 = (int)(FLOAT_803de8f8 * *(float *)(param_3 + 0x9c));
        bVar13 = iVar2 < iVar1;
        if ((float)(param_1 * param_2) < FLOAT_803de8f0) {
          bVar13 = bVar13 | 2;
        }
        iVar12 = 0;
        iVar9 = 0;
