// Function: FUN_8001d168
// Entry: 8001d168
// Size: 1208 bytes

void FUN_8001d168(int param_1)

{
  ...
  if (iVar4 == 2) {
    *(float *)(param_1 + 0x2e0) =
         *(float *)(param_1 + 0x2dc) * FLOAT_803db414 + *(float *)(param_1 + 0x2e0);
  }
  else if (((iVar4 < 2) && (0 < iVar4)) &&
          (*(float *)(param_1 + 0x2e4) =
                *(float *)(param_1 + 0x2dc) * FLOAT_803db414 + *(float *)(param_1 + 0x2e4),
          FLOAT_803de760 <= *(float *)(param_1 + 0x2e4))) {
    uVar5 = FUN_800221a0(0,100);
    *(float *)(param_1 + 0x2e0) =
         (float)((double)CONCAT44(0x43300000,uVar5 ^ 0x80000000) - DOUBLE_803de780) / FLOAT_803de778
    ;
    *(float *)(param_1 + 0x2e4) = FLOAT_803de75c;
  }
  fVar1 = *(float *)(param_1 + 0x2e0);
  if (fVar1 <= FLOAT_803de760) {
    if (fVar1 < FLOAT_803de75c) {
      *(float *)(param_1 + 0x2e0) = -fVar1;
      *(float *)(param_1 + 0x2dc) = -*(float *)(param_1 + 0x2dc);
    }
  }
  else {
    *(float *)(param_1 + 0x2e0) = FLOAT_803de760 - (fVar1 - FLOAT_803de760);
    *(float *)(param_1 + 0x2dc) = -*(float *)(param_1 + 0x2dc);
  }
  dVar3 = DOUBLE_803de780;
