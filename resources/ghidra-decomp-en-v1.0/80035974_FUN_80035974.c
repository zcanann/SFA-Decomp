// Function: FUN_80035974
// Entry: 80035974
// Size: 476 bytes

void FUN_80035974(int param_1,undefined2 param_2)
  ...
  if (iVar3 != 0) {
    if ((*(byte *)(iVar3 + 0x62) & 1) != 0) {
      ...
      *(float *)(iVar3 + 0x2c) = *(float *)(param_1 + 0xa8) * *(float *)(param_1 + 8);
      uVar2 = (int)*(short *)(iVar3 + 0x5a) ^ 0x80000000;
      if (*(float *)(iVar3 + 0x2c) < (float)((double)CONCAT44(0x43300000,uVar2) - DOUBLE_803de940))
      {
        *(float *)(iVar3 + 0x2c) = (float)((double)CONCAT44(0x43300000,uVar2) - DOUBLE_803de940);
      }
    }
