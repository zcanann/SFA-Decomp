// Function: FUN_802895cc
// Entry: 802895cc
// Size: 1040 bytes

void FUN_802895cc(int param_1)
    ...
    if ((local_818 & 2) == 0) {
      if (local_816 < 0x801) {
        ...
        if (iVar3 == 0) {
          ...
          iVar3 = FUN_8028c6f4(auStack2060,local_810,&local_814,local_818 >> 3 & 1 ^ 1,1);
          local_816 = (ushort)local_814;
          if (iVar3 == 0) {
            iVar3 = FUN_80287544(param_1,local_814 & 0xffff);
          }
          if (iVar3 == 0) {
            iVar3 = FUN_80287624(param_1,auStack2060,local_814);
          }
        }
        if (iVar3 == 0) {
          iVar3 = 3;
