// Function: FUN_800e2f5c
// Entry: 800e2f5c
// Size: 568 bytes

int FUN_800e2f5c(int param_1,int param_2,int param_3,int *param_4)
    ...
    do {
      ...
      if (-1 < (int)uVar9) {
        if ((int)uVar9 < 0) {
          ...
          while (iVar3 <= iVar6) {
            iVar4 = iVar6 + iVar3 >> 1;
            iVar8 = (&DAT_803a17e8)[iVar4];
            if (*(uint *)(iVar8 + 0x14) < uVar9) {
              iVar3 = iVar4 + 1;
            }
            else {
              if (*(uint *)(iVar8 + 0x14) <= uVar9) goto LAB_800e300c;
              iVar6 = iVar4 + -1;
            }
          }
          iVar8 = 0;
...
LAB_800e3128:
      ...
      *param_4 = *(int *)(param_1 + 0x14);
      iVar2 = FUN_800221a0(0,iVar2 + -1);
      local_28[0] = local_28[iVar2];
    }
  }
  return local_28[0];
}
