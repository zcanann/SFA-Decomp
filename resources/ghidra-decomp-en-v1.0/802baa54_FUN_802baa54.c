// Function: FUN_802baa54
// Entry: 802baa54
// Size: 352 bytes

/* WARNING: Removing unreachable block (ram,0x802bab94) */

undefined4 FUN_802baa54(double param_1,int param_2,uint *param_3)
  ...
  if (sVar2 < 1) {
    ...
    if ((*(byte *)(param_2 + 0xaf) & 1) != 0) {
      if ((*(byte *)(iVar5 + 0xa8e) & 0x20) == 0) {
        (**(code **)(*DAT_803dca54 + 0x48))(5,param_2,0xffffffff);
      }
      else {
