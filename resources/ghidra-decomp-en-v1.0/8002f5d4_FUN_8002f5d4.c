...
undefined4 FUN_8002f5d4(double param_1,int param_2,float *param_3)
  ...
  if (*(short *)(iVar17 + 0xec) != 0) {
    ...
    if (*(ushort *)(iVar18 + 0x5a) != 0) {
      in_f7 = (double)((float)((double)CONCAT44(0x43300000,(uint)*(ushort *)(iVar18 + 0x5a)) -
                              DOUBLE_803de8e8) / FLOAT_803de8f4);
      in_f8 = (double)(float)((double)FLOAT_803de8e0 - in_f7);
    ...
    if (*(short *)(iVar17 + 4) != 0) {
      ...
      if (*(short *)pfVar14 != 0) {
        ...
        if (sVar6 != 0) {
          fVar4 = (float)((double)CONCAT44(0x43300000,uVar10 ^ 0x80000000) - DOUBLE_803de900);
          fVar8 = FLOAT_803de8e0 / fVar4;
          fVar4 = fVar4 * *(float *)(param_2 + 0x98);
          uVar11 = (uint)fVar4;
          fVar4 = fVar4 - (float)((double)CONCAT44(0x43300000,uVar11 ^ 0x80000000) - DOUBLE_803de900
                                 );
          if (pfVar15 == (float *)0x0) {
              ...
              if (pfVar15 == (float *)0x0) {
                ...
                fVar3 = (float)((double)(fVar7 * ((float)((double)CONCAT44(0x43300000,
                                                 ...
                                                 (float)((double)CONCAT44(0x43300000,
                                                  ...
                                                  DOUBLE_803de900))) * in_f8 +
                               (double)(float)((double)(float)(in_f6 * (double)((float)(local_20 -
                                                                                                                                                                              
                                                  DOUBLE_803de900) -
                                                  (float)((double)CONCAT44(0x43300000,
                                                                           (int)*(short *)((int)
                                                  pfVar15 + iVar17) ^ 0x80000000) - DOUBLE_803de900)
                                                  )) * in_f7));
              }
              fVar4 = fVar4 + fVar8;
              fVar1 = fVar2;
