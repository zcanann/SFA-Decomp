// Function: FUN_8026ac24
// Entry: 8026ac24
// Size: 1704 bytes

void FUN_8026ac24(int param_1,short *param_2)

{
  ...
  iVar8 = DAT_803de120 + 0x20;
  uVar9 = *(uint *)(param_1 + 0x6a0);
  uVar7 = iVar10 + 4U & 0x1f;
  uVar7 = (uVar9 << uVar7 | uVar9 >> 0x20 - uVar7) & 0x1f;
  if (iVar10 < 0x1d) {
    uVar3 = (uint)*(byte *)(DAT_803de120 + uVar7);
    if (uVar3 == 0xff) {
      uVar3 = iVar10 + 5;
      iVar8 = 5;
      piVar5 = (int *)(DAT_803de120 + 0x58);
LAB_8026ac84:
      if (uVar3 != 0x21) goto code_r0x8026ac90;
      uVar3 = 1;
...
LAB_8026acf4:
  ...
  if (iVar10 == 0x21) {
    ...
    *(int *)(param_1 + 0x6a4) = iVar12 + 2;
    ...
    if (iVar10 != 0x20) {
      uVar3 = (uint)*(byte *)(DAT_803de120 + (uVar7 & 0x1f));
    ...
    *(uint *)(param_1 + 0x6a4) = (uint)bVar2;
    if (uVar3 != 0xff) goto LAB_8026aeb8;
...
LAB_8026aeb8:
  ...
  sVar6 = *(short *)(param_1 + 0x68a) + sVar6;
  *(short *)(param_1 + 0x68a) = sVar6;
  iVar4 = 1;
  *param_2 = sVar6;
  do {
    iVar8 = DAT_803de180;
    ...
    iVar10 = DAT_803de180 + 0x20;
    uVar9 = *(uint *)(param_1 + 0x6a0);
    uVar7 = iVar12 + 4U & 0x1f;
    uVar7 = (uVar9 << uVar7 | uVar9 >> 0x20 - uVar7) & 0x1f;
    if (iVar12 < 0x1d) {
      uVar3 = (uint)*(byte *)(DAT_803de180 + uVar7);
      if (uVar3 == 0xff) {
        uVar3 = iVar12 + 5;
        iVar10 = 5;
        piVar5 = (int *)(DAT_803de180 + 0x58);
LAB_8026afcc:
        if (uVar3 != 0x21) goto code_r0x8026afd8;
        uVar3 = 1;
        puVar1 = (uint *)(*(int *)(param_1 + 0x69c) + 4);
        uVar9 = *puVar1;
        piVar5 = piVar5 + 1;
...
LAB_8026b0fc:
      ...
      if (iVar12 == 0x20) {
        ...
        *(uint *)(param_1 + 0x6a4) = (uint)bVar2;
        ...
        uVar3 = (uint)*(byte *)(DAT_803de180 + (uVar7 & 0x1f));
...
LAB_8026b200:
    ...
    if (uVar7 == 0) {
      ...
      param_2[(byte)(&DAT_802c2628)[iVar4]] = (short)uVar9;
    }
    iVar4 = iVar4 + 1;
  } while( true );
code_r0x8026ac90:
  ...
  uVar3 = uVar3 + 1;
  iVar8 = iVar8 + 1;
  if ((int)uVar7 <= *piVar5) goto LAB_8026acf4;
  goto LAB_8026ac84;
code_r0x8026afd8:
  piVar5 = piVar5 + 1;
  uVar7 = uVar7 << 1 | (uVar9 << (uVar3 & 0x1f) | uVar9 >> 0x20 - (uVar3 & 0x1f)) & 1;
  uVar3 = uVar3 + 1;
  iVar10 = iVar10 + 1;
  if ((int)uVar7 <= *piVar5) goto LAB_8026b03c;
  goto LAB_8026afcc;
}
