// Function: FUN_801cd678
// Entry: 801cd678
// Size: 348 bytes

/* WARNING: Removing unreachable block (ram,0x801cd730) */

void FUN_801cd678(undefined2 *param_1,int param_2)

{
  ...
  *param_1 = (short)(((int)*(char *)(param_2 + 0x18) & 0x3fU) << 10);
  if (*(short *)(param_2 + 0x1a) < 1) {
    *(float *)(param_1 + 4) = FLOAT_803e51e8;
  }
  else {
    uStack28 = (int)*(short *)(param_2 + 0x1a) ^ 0x80000000;
    local_20 = 0x43300000;
    *(float *)(param_1 + 4) =
         (float)((double)CONCAT44(0x43300000,uStack28) - DOUBLE_803e51f0) / FLOAT_803e51e4;
  }
