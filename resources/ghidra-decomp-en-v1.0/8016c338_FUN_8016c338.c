// Function: FUN_8016c338
// Entry: 8016c338
// Size: 372 bytes

void FUN_8016c338(int param_1,int param_2)

{
  ...
  *(float *)(iVar2 + 0x24) =
       FLOAT_803e3228 /
       (FLOAT_803e3228 +
       (float)((double)CONCAT44(0x43300000,(uint)*(byte *)(param_2 + 0x24)) - DOUBLE_803e3238));
