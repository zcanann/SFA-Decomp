// Function: FUN_800279cc
// Entry: 800279cc
// Size: 232 bytes

void FUN_800279cc(double param_1,int *param_2,int param_3,int param_4,int param_5,byte param_6)

{
  ...
  *(char *)((int)pfVar2 + 0xd) = (char)param_5;
  if ((param_6 & 0x10) == 0) {
    *pfVar2 = FLOAT_803de828;
  }
  pfVar2[1] = FLOAT_803de840;
