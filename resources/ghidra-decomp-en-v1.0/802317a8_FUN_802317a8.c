// Function: FUN_802317a8
// Entry: 802317a8
// Size: 444 bytes

void FUN_802317a8(int param_1,undefined4 param_2,int param_3)

{
  ...
  if (cVar3 != '\0') {
    ...
    *(undefined *)(iVar1 + 5) = 1;
    ...
    FUN_80231058(uVar2,&local_58);
    FUN_80231028(uVar2,*(undefined2 *)(param_3 + 0x1a));
  }
  return;
}
