// Function: FUN_800a0524
// Entry: 800a0524
// Size: 760 bytes

void FUN_800a0524(int param_1,int param_2,int param_3)

{
  ...
  if (param_3 == 1) {
    ...
    if (*(short *)(param_1 + 0xfe) == 0) {
      ...
      *(float *)(param_1 + 200) = FLOAT_803df430;
  ...
  *(float *)(param_1 + 0xc4) = *(float *)(param_1 + 0xc4) + *(float *)(param_1 + 0xd0);
  if (FLOAT_803df430 <= *(float *)(param_1 + 0xbc)) {
    if (FLOAT_803df43c < *(float *)(param_1 + 0xbc)) {
      *(float *)(param_1 + 0xbc) = FLOAT_803df43c;
    }
  }
  else {
    *(float *)(param_1 + 0xbc) = FLOAT_803df430;
  }
  if (FLOAT_803df430 <= *(float *)(param_1 + 0xc0)) {
    if (FLOAT_803df43c < *(float *)(param_1 + 0xc0)) {
      *(float *)(param_1 + 0xc0) = FLOAT_803df43c;
    }
  }
  else {
    *(float *)(param_1 + 0xc0) = FLOAT_803df430;
  }
  if (FLOAT_803df430 <= *(float *)(param_1 + 0xc4)) {
    if (FLOAT_803df43c < *(float *)(param_1 + 0xc4)) {
      *(float *)(param_1 + 0xc4) = FLOAT_803df43c;
    }
  }
  else {
    *(float *)(param_1 + 0xc4) = FLOAT_803df430;
  }
  iVar7 = 0;
