// Function: FUN_800a0478
// Entry: 800a0478
// Size: 172 bytes

void FUN_800a0478(int param_1)

{
  ...
  for (iVar3 = 0; fVar2 = FLOAT_803df434, iVar3 < *(short *)(param_1 + 0xea); iVar3 = iVar3 + 1) {
    *puVar4 = *puVar5;
    puVar4[1] = puVar5[1];
    puVar4[2] = puVar5[2];
  ...
  *(float *)(param_1 + 0x30) = FLOAT_803df434;
  *(float *)(param_1 + 0x34) = fVar2;
  *(float *)(param_1 + 0x38) = fVar2;
  fVar1 = FLOAT_803df430;
  *(float *)(param_1 + 0x3c) = FLOAT_803df430;
