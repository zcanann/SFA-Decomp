...

{
  ...
  if (iVar5 != 0) {
    ...
    *(undefined2 *)(iVar5 + 0x58) = 0x400;
    dVar1 = DOUBLE_803de940;
    uVar2 = (int)*(short *)(iVar5 + 0x5a) ^ 0x80000000;
    *(float *)(iVar5 + 0xc) =
         (float)((double)CONCAT44(0x43300000,uVar2) - DOUBLE_803de940) *
         (float)((double)CONCAT44(0x43300000,uVar2) - DOUBLE_803de940);
    ...
    *(float *)(iVar5 + 0x28) = *(float *)(param_1 + 0xa8) * *(float *)(param_1 + 8);
    if ((*(byte *)(iVar5 + 0x62) & 2) == 0) {
      ...
      if (*(float *)(iVar5 + 0x28) <
          (float)((double)CONCAT44(0x43300000,(int)sVar4 ^ 0x80000000U) - DOUBLE_803de940)) {
        *(float *)(iVar5 + 0x28) =
             (float)((double)CONCAT44(0x43300000,(int)sVar4 ^ 0x80000000U) - DOUBLE_803de940);
      }
    }
    *(float *)(iVar5 + 0x2c) = *(float *)(param_1 + 0xa8) * *(float *)(param_1 + 8);
    if (((*(byte *)(iVar5 + 0x62) & 2) != 0) || ((*(byte *)(iVar5 + 0x62) & 1) != 0)) {
      uVar2 = (int)*(short *)(iVar5 + 0x5a) ^ 0x80000000;
      if (*(float *)(iVar5 + 0x2c) < (float)((double)CONCAT44(0x43300000,uVar2) - DOUBLE_803de940))
      {
        *(float *)(iVar5 + 0x2c) = (float)((double)CONCAT44(0x43300000,uVar2) - DOUBLE_803de940);
      }
    }
    *(float *)(iVar5 + 0x30) = *(float *)(param_1 + 0xa8) * *(float *)(param_1 + 8);
    if ((*(byte *)(iVar5 + 0xb6) & 2) == 0) {
      if ((*(byte *)(iVar5 + 0xb6) & 1) != 0) {
        ...
        if (*(float *)(iVar5 + 0x30) < (float)((double)CONCAT44(0x43300000,uVar2) - DOUBLE_803de940)
           ) {
          *(float *)(iVar5 + 0x30) = (float)((double)CONCAT44(0x43300000,uVar2) - DOUBLE_803de940);
        }
      }
    }
    else {
    ...
    *(float *)(iVar5 + 0x34) = *(float *)(param_1 + 0xa8) * *(float *)(param_1 + 8);
    if (((*(byte *)(iVar5 + 0xb6) & 2) != 0) || ((*(byte *)(iVar5 + 0xb6) & 1) != 0)) {
      uVar2 = (int)*(short *)(iVar5 + 100) ^ 0x80000000;
      if (*(float *)(iVar5 + 0x34) < (float)((double)CONCAT44(0x43300000,uVar2) - DOUBLE_803de940))
      {
        *(float *)(iVar5 + 0x34) = (float)((double)CONCAT44(0x43300000,uVar2) - DOUBLE_803de940);
      }
    }
