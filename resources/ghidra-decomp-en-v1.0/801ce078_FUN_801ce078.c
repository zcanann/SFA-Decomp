...
undefined4 FUN_801ce078(int param_1,int param_2)

{
  ...
  cVar4 = (**(code **)(*DAT_803dca58 + 0x24))(auStack56);
  ...
  if (*(byte *)(param_2 + 0x408) < 0x14) {
    ...
    if (FLOAT_803e520c < *(float *)(param_2 + 0x54)) {
      return 0xffffffff;
    }
  ...
  if (bVar1 == 0x15) {
    if (uVar3 != 0) {
      FUN_8000bb18(param_1,0x14c);
    }
    *(float *)(param_2 + 4) = *(float *)(param_2 + 4) - FLOAT_803db414;
    if ((cVar4 == '\0') && (*(float *)(param_2 + 4) <= FLOAT_803e520c)) {
      *(undefined *)(param_2 + 0x408) = 0x16;
    }
    fVar2 = *(float *)(param_2 + 0x1c) - FLOAT_803db414;
    *(float *)(param_2 + 0x1c) = fVar2;
    if (fVar2 <= FLOAT_803e520c) {
      if ((*(ushort *)(param_1 + 0xb0) & 0x800) != 0) {
        ...
        (**(code **)(*DAT_803dca88 + 8))(param_1,0x7f0,auStack52,0x200001,0xffffffff,0);
      }
      *(float *)(param_2 + 0x1c) = FLOAT_803e5218;
    }
  }
  else if (bVar1 < 0x15) {
    if (0x13 < bVar1) {
      if (uVar3 != 0) {
        FUN_8000bb18(param_1,0x14b);
      }
      if ((*(byte *)(param_2 + 0x43c) & 2) != 0) {
        *(undefined *)(param_2 + 0x408) = 0x15;
        uVar3 = FUN_800221a0(0,300);
        *(float *)(param_2 + 4) =
             (float)((double)CONCAT44(0x43300000,uVar3 ^ 0x80000000) - DOUBLE_803e5220);
      }
    }
  }
  else if (bVar1 < 0x17) {
    if (uVar3 != 0) {
      FUN_8000bb18(param_1,0x14d);
    }
    if ((*(byte *)(param_2 + 0x43c) & 2) != 0) {
