// Function: FUN_80153790
// Entry: 80153790
// Size: 172 bytes

void FUN_80153790(int param_1,int param_2,undefined4 param_3,int param_4,undefined4 param_5,
                 int param_6)
    ...
    if (param_4 == 0x10) {
      ...
      *(uint *)(param_2 + 0x2e8) = *(uint *)(param_2 + 0x2e8) | 8;
      if ((int)(uint)*(ushort *)(param_2 + 0x2b0) < param_6) {
        FUN_8000bb18(param_1,0x246);
        *(undefined2 *)(param_2 + 0x2b0) = 0;
      }
      else {
        FUN_8000bb18(param_1,0x247);
