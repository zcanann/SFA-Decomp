// Function: FUN_80197c54
// Entry: 80197c54
// Size: 340 bytes

void FUN_80197c54(int param_1,int param_2)

{
  ...
  *(byte *)(iVar3 + 0x24) = *(byte *)(param_2 + 0x21) & 0xf | *(byte *)(iVar3 + 0x24) & 0xf0;
  fVar1 = FLOAT_803e40a0;
  *(float *)(iVar3 + 0x10) = FLOAT_803e40a0;
  *(float *)(iVar3 + 0x14) = fVar1;
  dVar2 = DOUBLE_803e40a8;
  *(float *)(iVar3 + 8) =
       (float)((double)CONCAT44(0x43300000,(uint)*(byte *)(param_2 + 0x1c)) - DOUBLE_803e40a8);
  *(float *)(iVar3 + 0xc) =
