// Function: FUN_8015af10
// Entry: 8015af10
// Size: 912 bytes

/* WARNING: Removing unreachable block (ram,0x8015b24c) */

undefined4 FUN_8015af10(int param_1,int param_2)

{
  ...
  if (*(char *)(param_2 + 0x27b) == '\0') {
    if (*(char *)(param_2 + 0x346) == '\0') {
      ...
      uVar2 = (**(code **)(*DAT_803dcab8 + 0x18))((double)FLOAT_803e2d00);
      if ((uVar2 & 1) == 0) {
        return 5;
      }
      local_18 = (double)CONCAT44(0x43300000,(uint)*(ushort *)(iVar3 + 0x3fe));
      iVar4 = (**(code **)(*DAT_803dcab8 + 0x44))
                        ((double)(float)(local_18 - DOUBLE_803e2d08),param_1,param_2,1);
      if (iVar4 != 0) {
        return 5;
      }
        ...
        if ((*(byte *)(iVar3 + 0x404) & 0x10) == 0) {
          ...
          *(short *)(iVar4 + 4) = sVar1 + 1;
          (**(code **)(*DAT_803dca8c + 0x14))
                    (param_1,param_2,(int)*(short *)(&DAT_8031fd80 + sVar1 * 2));
        }
        else {
          sVar1 = *(short *)(iVar4 + 4);
          *(short *)(iVar4 + 4) = sVar1 + 1;
          (**(code **)(*DAT_803dca8c + 0x14))
                    (param_1,param_2,(int)*(short *)(&DAT_8031fd90 + sVar1 * 2));
        }
        if (6 < *(short *)(iVar4 + 4)) {
