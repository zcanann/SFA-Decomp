// Function: FUN_80082bf0
// Entry: 80082bf0
// Size: 652 bytes

double FUN_80082bf0(undefined8 param_1,undefined8 param_2,double param_3,float *param_4,int param_5,
                   int param_6)
  ...
  if (param_5 < 1) {
    ...
    if (iVar3 == param_5) {
      ...
      if (bVar2 == 0) {
        ...
        if (param_3 < (double)FLOAT_803defb0) {
          param_3 = -param_3;
        }
        if (dVar6 < (double)FLOAT_803defb0) {
          dVar6 = -dVar6;
        }
        local_10 = (float)(param_3 + dVar6) * FLOAT_803df000 *
      ...
      if (iVar3 < param_5) {
        ...
        if (bVar2 == 0) {
          ...
          local_c = (float)(param_3 + dVar6) * FLOAT_803df000 *
                    (float)((double)CONCAT44(0x43300000,
                                             (int)*(char *)(param_4 + iVar3 * 2 + 1) >> 2 ^
                                             0x80000000) - DOUBLE_803defb8);
        }
      }
      if (fVar1 <= FLOAT_803defb0) {
        dVar6 = (double)local_14;
      }
      else {
        uStack4 = param_6 - *(short *)((int)param_4 + iVar3 * 8 + -2) ^ 0x80000000;
        local_8 = 0x43300000;
        if (bVar2 == 0) {
          dVar6 = (double)FUN_80010dc0(&local_18,0);
        }
        else if (bVar2 == 1) {
          dVar6 = (double)(((float)((double)CONCAT44(0x43300000,uStack4) - DOUBLE_803defb8) / fVar1)
