// Function: FUN_8025a310
// Entry: 8025a310
// Size: 628 bytes

void FUN_8025a310(uint *param_1,uint param_2,uint param_3,uint param_4,uint param_5,uint param_6,
  ...
  *param_1 = *param_1 & 0xffffffef | 0x10;
  if (param_8 == '\0') {
    ...
    *(byte *)((int)param_1 + 0x1f) = *(byte *)((int)param_1 + 0x1f) | 1;
    ...
    param_1[1] = ((int)(FLOAT_803e76d0 *
                       (float)((double)CONCAT44(0x43300000,0x1f - iVar1) - DOUBLE_803e76d8)) & 0xffU
