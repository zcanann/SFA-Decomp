...
void FUN_801899b4(undefined4 param_1,int param_2)

{
  ...
  if (((char)*(byte *)(param_2 + 0x1d) < '\0') && ((*(byte *)(param_2 + 0x1d) >> 6 & 1) == 0)) {
    if (*(char *)(param_2 + 0x1c) == '\0') {
      ...
      *(int *)(param_2 + 0x14) =
      ...
      if ((*(int *)(param_2 + 0x10) == 0x800) && (*(int *)(param_2 + 0x14) < 0x800)) {
        FUN_8000bb18(param_1,0x374);
      }
      if (*(int *)(param_2 + 0x14) < 0) {
        if (0 < *(int *)(param_2 + 0x10)) {
          FUN_8000bb18(param_1,0x6e);
          ...
          if (0 < (int)uVar3) {
            ...
            FUN_80014aa0((double)(float)(local_18 - DOUBLE_803e3bd0));
          }
        }
    ...
    FUN_80037b40(param_1,8,0xb4,0xf0,0xff,0x6f,param_2 + 0x20);
    *(undefined4 *)(param_2 + 0x10) = *(undefined4 *)(param_2 + 0x14);
    local_18 = (double)CONCAT44(0x43300000,*(uint *)(param_2 + 0x14) ^ 0x80000000);
    FUN_80030304((double)((float)(local_18 - DOUBLE_803e3bd0) / FLOAT_803e3bcc),param_1);
  }
  return;
}
