// Function: FUN_800e0a10
// Entry: 800e0a10
// Size: 480 bytes

/* WARNING: Removing unreachable block (ram,0x800e0bc4) */
/* WARNING: Removing unreachable block (ram,0x800e0bbc) */
/* WARNING: Removing unreachable block (ram,0x800e0bcc) */

int FUN_800e0a10(double param_1,double param_2,double param_3,int param_4,int param_5)

{
  ...
  local_70[1] = -1;
  local_70[0] = -1;
  local_78[1] = FLOAT_803e0644;
  local_78[0] = FLOAT_803e0644;
      ...
      if ((int)uVar6 < 0) {
        ...
        while (iVar3 <= iVar4) {
          ...
          if (*(uint *)(iVar5 + 0x14) < uVar6) {
            ...
            if (*(uint *)(iVar5 + 0x14) <= uVar6) goto LAB_800e0b00;
            iVar4 = iVar2 + -1;
          }
        }
        iVar5 = 0;
