// Function: FUN_8024386c
// Entry: 8024386c
// Size: 728 bytes

uint FUN_8024386c(uint param_1,uint param_2)

{
  ...
  if (iVar1 < 0xc) {
    if (iVar1 == 8) {
      ...
      write_volatile_4(DAT_cc006c00,uVar2);
      ...
      if (iVar1 < 5) {
        if (-1 < iVar1) {
          ...
          write_volatile_2(DAT_cc00401c,uVar3);
          param_1 = param_1 & 0x7ffffff;
        }
      }
      else {
        uVar3 = read_volatile_2(DAT_cc00500a);
        uVar3 = uVar3 & 0xfe07;
        ...
        write_volatile_2(DAT_cc00500a,uVar3);
        param_1 = param_1 & 0xf8ffffff;
      }
    }
    else {
      uVar2 = read_volatile_4(DAT_cc006800);
      ...
      write_volatile_4(DAT_cc006800,uVar2);
      param_1 = param_1 & 0xff8fffff;
    }
  }
  else if (iVar1 < 0x11) {
    if (iVar1 < 0xf) {
      uVar2 = read_volatile_4(DAT_cc006814);
      ...
      write_volatile_4(DAT_cc006814,uVar2);
      ...
      write_volatile_4(DAT_cc006828,uVar2);
    ...
    write_volatile_4(DAT_cc003004,uVar2);
