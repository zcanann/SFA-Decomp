// Function: FUN_80069b1c
// Entry: 80069b1c
// Size: 924 bytes

void FUN_80069b1c(undefined4 param_1,undefined4 param_2,int param_3)

{
  ...
  if ((((((iVar10 != 0) && (iVar11 != 0)) && (param_3 != 0)) &&
    ...
    uVar7 = (int)((double)FLOAT_803ded08 * extraout_f1) & 0xff;
    ...
    FUN_80241a1c(param_3 + 0x60,*(undefined4 *)(param_3 + 0x44));
  }
  FUN_8028611c();
  return;
}
