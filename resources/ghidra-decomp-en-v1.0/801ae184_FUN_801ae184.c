...
undefined4 FUN_801ae184(int param_1,undefined4 param_2,int param_3)

{
  ...
  piVar3 = (int *)FUN_800394ac(param_1,1,0);
  *piVar3 = (*(byte *)((int)psVar7 + 3) >> 1 & 1 ^ 1) << 8;
  ...
  if ((*(byte *)((int)psVar7 + 3) & 2) != 0) {
    DAT_803ac954 = FLOAT_803e4770;
    DAT_803ac958 = FLOAT_803e4774;
    DAT_803ac95c = FLOAT_803e4778;
    (**(code **)(*DAT_803dca88 + 8))(param_1,0x133,&DAT_803ac948,4,0xffffffff,0);
    DAT_803ac954 = FLOAT_803e477c;
    DAT_803ac958 = FLOAT_803e4774;
    DAT_803ac95c = FLOAT_803e4778;
    (**(code **)(*DAT_803dca88 + 8))(param_1,0x133,&DAT_803ac948,4,0xffffffff,0);
  }
