// Function: FUN_8015ed1c
// Entry: 8015ed1c
// Size: 380 bytes

void FUN_8015ed1c(int param_1,int param_2,int param_3)

{
  ...
  iVar5 = (**(code **)(*DAT_803dcab8 + 0x50))
                    (param_1,param_3,param_2 + 0x35c,(int)*(short *)(param_2 + 0x3f4),&DAT_8031fea8,
                     &DAT_8031ff20,1,&DAT_803ac580);
  if (iVar5 != 0) {
