// Function: FUN_801cd008
// Entry: 801cd008
// Size: 588 bytes

void FUN_801cd008(int param_1)

{
  ...
  if (in_r8 == '\0') {
    ...
    *(undefined *)(iVar4 + 10) = 1;
    ...
    if ((double)FLOAT_803e51c8 < dVar5) {
      fVar1 = (float)((double)FLOAT_803e51cc / dVar5);
      local_38 = local_38 * fVar1;
      local_34 = local_34 * fVar1;
      local_30 = local_30 * fVar1;
      local_44 = FLOAT_803e51d0 * local_38 + *(float *)(param_1 + 0xc);
      local_40 = FLOAT_803e51d0 * local_34 + *(float *)(param_1 + 0x10);
      local_3c = FLOAT_803e51d0 * local_30 + *(float *)(param_1 + 0x14);
      local_50 = FLOAT_803e51d4 * local_38 + *(float *)(iVar2 + 0xc);
      local_4c = FLOAT_803e51d4 * local_34 + *(float *)(iVar2 + 0x10);
      local_48 = FLOAT_803e51d4 * local_30 + *(float *)(iVar2 + 0x14);
    ...
    if (*(short *)(iVar4 + 4) < 1) {
      if (*(char *)(iVar4 + 10) != '\0') {
        local_20 = FLOAT_803e51d8;
        local_1c = FLOAT_803e51dc;
        local_18 = FLOAT_803e51d8;
