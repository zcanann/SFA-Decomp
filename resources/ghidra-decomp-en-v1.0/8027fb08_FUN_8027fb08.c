// Function: FUN_8027fb08
// Entry: 8027fb08
// Size: 988 bytes

void FUN_8027fb08(void)

{
  ...
  FUN_8027fa44();
  iVar10 = 0;
  for (puVar11 = DAT_803de358; puVar11 != (undefined4 *)0x0; puVar11 = (undefined4 *)*puVar11) {
    iVar10 = iVar10 + 1;
  }
  if (iVar10 != 0) {
    dVar13 = (double)FLOAT_803e7894;
    dVar14 = DOUBLE_803e7888;
    dVar15 = DOUBLE_803e7898;
    for (puVar11 = DAT_803de35c; puVar11 != (undefined4 *)0x0; puVar11 = (undefined4 *)*puVar11) {
      puVar8 = DAT_803de358;
      ...
      if (*(char *)(puVar11 + 7) == -1) {
        ...
        for (puVar8 = DAT_803de358; puVar8 != (undefined4 *)0x0; puVar8 = (undefined4 *)*puVar8) {
          if ((undefined4 *)puVar8[2] == puVar11) {
            bVar5 = true;
            break;
          }
        }
        uVar7 = (uint)DAT_803de369;
        if (~(-1 << uVar7) == (~(-1 << uVar7) & DAT_803de364)) {
          dVar12 = (double)FLOAT_803e7890;
          for (puVar8 = DAT_803de35c; puVar8 != (undefined4 *)0x0; puVar8 = (undefined4 *)*puVar8) {
          ...
          puVar8 = DAT_803de354;
          if ((!bVar5) && (dVar12 <= dVar16)) goto LAB_8027feb4;
          for (; puVar8 != (undefined4 *)0x0; puVar8 = (undefined4 *)*puVar8) {
            if ((undefined4 *)puVar8[2] == unaff_r30) {
              FUN_80271ac0(puVar8[0xf]);
          ...
          FUN_80272d74(*(undefined *)(unaff_r30 + 7));
          *(undefined *)(puVar11 + 7) = *(undefined *)(unaff_r30 + 7);
          *(undefined *)(unaff_r30 + 7) = 0xff;
          unaff_r30[2] = 0;
        }
        else {
          for (iVar9 = 0; (uVar7 != 0 && ((DAT_803de364 & 1 << iVar9) != 0)); iVar9 = iVar9 + 1) {
            uVar7 = uVar7 - 1;
          }
          DAT_803de364 = DAT_803de364 | 1 << iVar9;
          *(char *)(puVar11 + 7) = (char)iVar9 + DAT_803de368;
        }
        ...
        if ((double)(float)(dVar13 * (double)(float)((double)CONCAT44(0x43300000,puVar11[0xb]) -
                                                    dVar14)) < dVar15) {
          FUN_80272cc4(*(undefined *)(puVar11 + 7),0,0);
        }
        else {
          FUN_80272cc4(*(undefined *)(puVar11 + 7),1,0);
        }
