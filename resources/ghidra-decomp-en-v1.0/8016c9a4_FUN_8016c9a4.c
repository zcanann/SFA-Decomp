// Function: FUN_8016c9a4
// Entry: 8016c9a4
// Size: 572 bytes

void FUN_8016c9a4(int param_1)
    ...
    for (local_38 = 0; local_38 < (int)(uint)*(byte *)(iVar6 + 0x8b); local_38 = local_38 + 1) {
      ...
      if (bVar1 == 3) {
        *(uint *)(param_1 + 0xf8) = *(uint *)(param_1 + 0xf8) ^ 4;
        ...
        iVar4 = 3;
        do {
          (**(code **)(*DAT_803dca88 + 8))(param_1,0x7fe,auStack48,0x200001,0xffffffff,0);
          iVar4 = iVar4 + -1;
        } while (iVar4 != 0);
      }
    }
    local_38 = (**(code **)(*DAT_803dca54 + 0x14))((double)FLOAT_803db414,param_1);
    if ((local_38 != 0) && (*(short *)(param_1 + 0xb4) == -2)) {
      iVar5 = (int)*(char *)(iVar6 + 0x57);
      iVar6 = 0;
      piVar2 = (int *)FUN_8002e0fc(&local_38,&local_34);
      iVar4 = 0;
