// Function: FUN_801b0670
// Entry: 801b0670
// Size: 276 bytes

undefined4 FUN_801b0670(int param_1,undefined4 param_2,int param_3)

{
  ...
  if (*(char *)(iVar2 + 0x1b) == '\0') {
    FUN_8000b7bc(param_1,1);
  }
  else {
    (**(code **)(*DAT_803dca88 + 8))(param_1,0xd7,0,0,0xffffffff,0);
    FUN_8000b7bc(param_1,5);
  }
