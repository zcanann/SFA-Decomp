// Function: FUN_800e03ec
// Entry: 800e03ec
// Size: 1572 bytes

/* WARNING: Removing unreachable block (ram,0x800e09f0) */

void FUN_800e03ec(void)

{
  ...
  if (iVar5 == 0) {
    ...
    iVar6 = FUN_800e36f8(*(undefined4 *)(iVar5 + 0x14),&local_6d8);
    if (iVar6 == 0) {
      local_6c0[0] = -1;
    }
    else {
      ...
      do {
        if (-1 < *(int *)(iVar22 + 0x1c)) {
          ...
          iVar14 = FUN_800e36f8(*(undefined4 *)(iVar22 + 0x1c),&local_6d4,iVar14);
          if (iVar14 != 0) {
            ...
            do {
              if (iVar14 < 1) {
                ...
                iVar19 = (&DAT_803a17e8)[local_610[iVar14]];
                dVar28 = (double)local_6b0[iVar14];
                if (*(char *)(iVar19 + 0x34) == '\x01') {
                  bVar4 = true;
                  *pfVar24 = local_6b0[iVar14];
                  pfVar21 = pfVar21 + 1;
                  pfVar24 = pfVar24 + 1;
                  local_6c0[iVar6] = *(int *)(iVar22 + 0x1c);
                  iVar6 = iVar6 + 1;
                }
                else {
                  iVar17 = 0;
                  ...
                  do {
                    if ((((-1 < *(int *)(iVar23 + 0x1c)) &&
                         (iVar7 = FUN_800e36f8(*(int *)(iVar23 + 0x1c),&local_6d4), iVar7 != 0)) &&
                      ...
                      fVar1 = fVar1 * fVar1 +
                              (float)(dVar28 + (double)(fVar2 * fVar2)) + fVar3 * fVar3;
                      iVar7 = 0;
...
LAB_800e0960:
        ...
        *in_r6 = *(int *)(iVar5 + 0x14);
        ...
        local_6c0[0] = local_6c0[iVar5];
      }
    }
  }
  __psq_l0(auStack8,uVar27);
  __psq_l1(auStack8,uVar27);
  FUN_80286100(local_6c0[0]);
  return;
}
