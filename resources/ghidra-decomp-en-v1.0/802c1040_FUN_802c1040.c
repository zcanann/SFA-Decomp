// Function: FUN_802c1040
// Entry: 802c1040
// Size: 380 bytes

void FUN_802c1040(short *param_1)

{
  ...
  if ((((*(short *)(iVar3 + 0xbb0) != 0) && (param_1[0x50] != 0xf)) &&
      (iVar2 = FUN_8003687c(param_1,local_18,0,0), iVar2 != 0)) &&
    ...
    *(short *)(iVar3 + 0xbb0) = *(short *)(iVar3 + 0xbb0) + -1;
    if (*(short *)(iVar3 + 0xbb0) < 1) {
      ...
      *(undefined2 *)(iVar3 + 0xbb0) = 1;
      (**(code **)(*DAT_803dca8c + 0x14))(param_1,iVar3,7);
    }
    FUN_8000bb18(param_1,0x11f);
  }
  return;
}
