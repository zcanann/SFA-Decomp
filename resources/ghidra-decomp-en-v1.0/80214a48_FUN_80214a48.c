// Function: FUN_80214a48
// Entry: 80214a48
// Size: 340 bytes

undefined4 FUN_80214a48(int param_1,undefined4 param_2,int param_3)
  ...
  for (iVar2 = 0; iVar2 < (int)(uint)*(byte *)(param_3 + 0x8b); iVar2 = iVar2 + 1) {
    ...
    if (bVar1 == 4) {
      *(uint *)(DAT_803ddd54 + 0x104) = *(uint *)(DAT_803ddd54 + 0x104) | 0x1000;
      ...
      if (bVar1 == 2) {
        *(uint *)(DAT_803ddd54 + 0x104) = *(uint *)(DAT_803ddd54 + 0x104) | 8;
      }
      else if (bVar1 < 2) {
        if (bVar1 != 0) {
          *(uint *)(DAT_803ddd54 + 0x104) = *(uint *)(DAT_803ddd54 + 0x104) | 4;
        }
      }
      else {
      ...
      if (*(int *)(DAT_803ddd54 + 0x178) != 0) {
        FUN_8001f384();
        *(undefined4 *)(DAT_803ddd54 + 0x178) = 0;
      }
    }
    else if (bVar1 < 6) {
