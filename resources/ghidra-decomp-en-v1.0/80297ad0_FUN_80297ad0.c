// Function: FUN_80297ad0
// Entry: 80297ad0
// Size: 572 bytes

/* WARNING: Removing unreachable block (ram,0x80297ce8) */

int FUN_80297ad0(undefined8 param_1,undefined2 *param_2,int param_3)

{
  ...
  if (*(char *)(param_3 + 0x27a) != '\0') {
    FUN_80030334((double)FLOAT_803e7ea4,param_2,(int)*(short *)(&DAT_803336bc + DAT_80333b36 * 2),0)
    ;
