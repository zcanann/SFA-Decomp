// Function: FUN_800a02dc
// Entry: 800a02dc
// Size: 412 bytes

void FUN_800a02dc(int param_1,int param_2)

{
  ...
  fVar2 = FLOAT_803df438 * *(float *)(param_2 + 4) * FLOAT_803dd284;
  fVar3 = FLOAT_803df438 * *(float *)(param_2 + 8) * FLOAT_803dd284;
