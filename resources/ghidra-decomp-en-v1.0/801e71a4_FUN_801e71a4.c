// Function: FUN_801e71a4
// Entry: 801e71a4
// Size: 1096 bytes

uint FUN_801e71a4(int param_1,undefined4 param_2,int param_3)

{
  ...
  if (param_3 == 0x14) {
    ...
    piVar4 = (int *)FUN_800394ac(param_1,8,0);
    iVar3 = iVar8 >> 0x1f;
    iVar1 = iVar8 / 10 + iVar3;
    *piVar4 = (iVar8 + (iVar1 - (iVar1 >> 0x1f)) * -10) * 0x100;
    piVar4 = (int *)FUN_800394ac(param_1,7,0);
    iVar1 = iVar8 / 10 + iVar3;
    ...
    *piVar4 = (iVar1 + (iVar2 - (iVar2 >> 0x1f)) * -10) * 0x100;
    ...
    piVar4 = (int *)FUN_800394ac(param_1,6,0);
    *piVar4 = iVar3 << 8;
  }
