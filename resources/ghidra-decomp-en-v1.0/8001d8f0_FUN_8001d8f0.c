// Function: FUN_8001d8f0
// Entry: 8001d8f0
// Size: 148 bytes

void FUN_8001d8f0(double param_1,double param_2,double param_3,double param_4,double param_5,
...

{
  ...
  *(undefined4 *)(param_7 + 0x168) = 0;
  dVar2 = (double)(float)(param_6 * (double)FLOAT_803de790);
  dVar1 = (double)(float)(param_5 * (double)FLOAT_803de790);
  FUN_8024740c((double)*(float *)(param_7 + 0x150),(double)*(float *)(param_7 + 0x154),
               (double)*(float *)(param_7 + 0x158),(double)*(float *)(param_7 + 0x15c),dVar2,dVar1,
               dVar2,dVar1,param_7 + 0x1b0);
  dVar1 = (double)FLOAT_803de790;
  FUN_8024740c((double)*(float *)(param_7 + 0x150),(double)*(float *)(param_7 + 0x154),
               (double)*(float *)(param_7 + 0x158),(double)*(float *)(param_7 + 0x15c),dVar1,dVar1,
               dVar1,dVar1,param_7 + 0x1f0);
  return;
}
