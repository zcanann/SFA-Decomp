// Function: FUN_8004b658
// Entry: 8004b658
// Size: 2352 bytes

undefined4 FUN_8004b658(int param_1,undefined4 param_2,int param_3)

{
  ...
  do {
    ...
    if (uVar18 == 0) {
      ...
      if (uVar18 == 1) {
        puVar11 = &DAT_8030c880;
        iVar12 = -0x7fcf3660;
        iVar13 = 9;
        puVar14 = &DAT_8030cda0;
        puVar15 = &DAT_8030cdc0;
        iVar16 = 5;
      }
      else {
        puVar11 = &DAT_8035f740;
        iVar12 = -0x7fca07a0;
        puVar14 = &DAT_8036f860;
        puVar15 = &DAT_8036f880;
        iVar13 = 8;
        puVar19 = &DAT_803dcd20;
        do {
          *puVar19 = 0;
          puVar19 = puVar19 + 1;
          iVar13 = iVar13 + -1;
        ...
        while( true ) {
          ...
          (&DAT_80377880)[(byte)(&DAT_802c1c50)[iVar13]] = (char)uVar17;
          uVar10 = uVar10 + 3;
          (&DAT_803dcd20)[uVar17] = (&DAT_803dcd20)[uVar17] + '\x01';
          puVar6 = (ushort *)((int)puVar6 + ((int)uVar10 >> 3));
          iVar13 = iVar13 + 1;
        }
        for (iVar13 = 7; (&DAT_803dcd20)[iVar13] == '\0'; iVar13 = iVar13 + -1) {
        }
        iVar22 = 0;
        for (iVar25 = 1; iVar25 <= iVar13; iVar25 = iVar25 + 1) {
          if ((byte)(&DAT_803dcd20)[iVar25] != 0) {
            (&DAT_803dcd18)[iVar25] = (char)iVar22;
            iVar22 = iVar22 + ((uint)(byte)(&DAT_803dcd20)[iVar25] << iVar13 - iVar25);
          }
        }
        for (iVar22 = 0; iVar22 < 0x13; iVar22 = iVar22 + 1) {
          puVar28 = &DAT_803dcd18;
          uVar18 = (uint)(byte)(&DAT_80377880)[iVar22];
          if (uVar18 != 0) {
            for (iVar25 = 0; iVar25 < 1 << iVar13 - uVar18; iVar25 = iVar25 + 1) {
              bVar2 = (&DAT_803dcd18)[uVar18];
              (&DAT_803dcd18)[uVar18] = bVar2 + 1;
              (&DAT_803778d4)[bVar2] = (char)iVar22;
            }
          }
        }
        puVar20 = &DAT_80377894;
        ...
        do {
          ...
          puVar27 = (undefined1 *)
                    (uint)(byte)(&DAT_803778d4)
                                [(uint)(byte)(&DAT_8030cde0)
          ...
          puVar6 = (ushort *)
                   ((int)puVar6 + ((int)(uVar10 + (byte)(&DAT_80377880)[(int)puVar27]) >> 3));
          uVar10 = uVar10 + (byte)(&DAT_80377880)[(int)puVar27] & 7;
          bVar31 = uVar10 < 0x21;
          uVar17 = 0x20 - uVar10;
          ...
          do {
            ...
            if ((puVar19 == &DAT_8035f740) && (iVar22 == iVar16)) {
              puVar20 = &DAT_803778b4;
              iVar22 = 0;
              puVar19 = puVar14;
            }
          ...
          puVar28 = puVar27;
        } while ((puVar19 == &DAT_8035f740) || (iVar22 < iVar23));
        iVar13 = 0xf;
        for (psVar21 = &DAT_803778b2; *psVar21 == 0; psVar21 = psVar21 + -1) {
          iVar13 = iVar13 + -1;
        }
        iVar22 = 0;
        for (iVar25 = 1; iVar25 <= iVar13; iVar25 = iVar25 + 1) {
          uVar4 = (&DAT_80377894)[iVar25];
          if (uVar4 != 0) {
            *(short *)(iVar25 * 2 + -0x7fc886ac) = (short)iVar22;
            iVar22 = iVar22 + ((uint)uVar4 << iVar13 - iVar25);
          }
        }
        for (iVar22 = 0; iVar22 < iVar16; iVar22 = iVar22 + 1) {
          uVar18 = (uint)(byte)(&DAT_8035f740)[iVar22];
          if (uVar18 != 0) {
            for (iVar25 = 0; iVar25 < 1 << iVar13 - uVar18; iVar25 = iVar25 + 1) {
              puVar8 = (ushort *)(uVar18 * 2 + -0x7fc886ac);
              uVar4 = *puVar8;
              *puVar8 = uVar4 + 1;
              *(short *)((uint)uVar4 * 2 + -0x7fca07a0) = (short)iVar22;
            }
          }
        }
        for (iVar16 = 0xf; (&DAT_803778b4)[iVar16] == 0; iVar16 = iVar16 + -1) {
        }
        iVar22 = 0;
        for (iVar25 = 1; iVar25 <= iVar16; iVar25 = iVar25 + 1) {
          if ((ushort)(&DAT_803778b4)[iVar25] != 0) {
            (&DAT_80377974)[iVar25] = (short)iVar22;
            iVar22 = iVar22 + ((uint)(ushort)(&DAT_803778b4)[iVar25] << iVar16 - iVar25);
          }
        }
        for (iVar22 = 0; iVar22 < iVar23; iVar22 = iVar22 + 1) {
          uVar18 = (uint)(byte)(&DAT_8036f860)[iVar22];
          if (uVar18 != 0) {
            for (iVar25 = 0; iVar25 < 1 << iVar16 - uVar18; iVar25 = iVar25 + 1) {
              uVar4 = (&DAT_80377974)[uVar18];
              (&DAT_80377974)[uVar18] = uVar4 + 1;
              (&DAT_8036f880)[uVar4] = (char)iVar22;
            }
          }
        }
      }
      do {
        ...
        uVar4 = *(ushort *)
                 (iVar12 + ((uint)(byte)(&DAT_8030cde0)[uVar24 & 0xff] << uVar17 & 0xffff |
                            (uint)((byte)(&DAT_8030cde0)[uVar24 & 0xff] >> 0x20 - uVar17) |
                           (uint)(byte)(&DAT_8030cde0)[uVar24 >> 8] << uVar18 & 0xff |
                           (uint)((byte)(&DAT_8030cde0)[uVar24 >> 8] >> 0x20 - uVar18)) * 2);
        uVar18 = (uint)uVar4;
        ...
        if (uVar18 < 0x100) {
          ...
          *pbVar9 = (byte)uVar4;
          ...
          uVar29 = (uint)*(ushort *)(&DAT_802c1c64 + iVar23);
          uVar24 = (uint)*(ushort *)(&DAT_802c1c66 + iVar23);
          if (uVar24 != 0) {
          ...
          puVar6 = (ushort *)
                   ((int)puVar6 +
                   ((int)(uVar10 + (byte)puVar14[(byte)puVar15[(uint)(byte)(&DAT_8030cde0)
                                                                           [uVar26 & 0xff] << uVar24
                                                               & 0xffff |
                                                               (uint)((byte)(&DAT_8030cde0)
                                                                            [uVar26 & 0xff] >>
                                                               ...
                                                               (uint)(byte)(&DAT_8030cde0)
                                                                           [uVar26 >> 8] << uVar30 &
                                                               0xff | (uint)((byte)(&DAT_8030cde0)
                                                                                   [uVar26 >> 8] >>
                                                                            0x20 - uVar30)]]) >> 3))
          ;
          uVar10 = uVar10 + (byte)puVar14[(byte)puVar15[(uint)(byte)(&DAT_8030cde0)[uVar26 & 0xff]
                                                        << uVar24 & 0xffff |
                                                        (uint)((byte)(&DAT_8030cde0)[uVar26 & 0xff]
                                                              >> 0x20 - uVar24) |
                                                        (uint)(byte)(&DAT_8030cde0)[uVar26 >> 8] <<
                                                        uVar30 & 0xff |
                                                        (uint)((byte)(&DAT_8030cde0)[uVar26 >> 8] >>
                                                              0x20 - uVar30)]] & 7;
          uVar17 = 0x20 - uVar10;
          iVar23 = (uint)(byte)puVar15[(uint)(byte)(&DAT_8030cde0)[uVar26 & 0xff] << uVar24 & 0xffff
                                       | (uint)((byte)(&DAT_8030cde0)[uVar26 & 0xff] >>
                                               0x20 - uVar24) |
                                       (uint)(byte)(&DAT_8030cde0)[uVar26 >> 8] << uVar30 & 0xff |
                                       (uint)((byte)(&DAT_8030cde0)[uVar26 >> 8] >> 0x20 - uVar30)]
                   * 4;
          uVar30 = (uint)*(ushort *)(&DAT_802c1cd8 + iVar23);
          uVar24 = (uint)*(ushort *)(&DAT_802c1cda + iVar23);
          if (uVar24 != 0) {
