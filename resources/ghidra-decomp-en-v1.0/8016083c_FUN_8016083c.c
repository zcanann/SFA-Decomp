// Function: FUN_8016083c
// Entry: 8016083c
// Size: 384 bytes

void FUN_8016083c(int param_1,int param_2,int param_3)

{
  ...
  FUN_8003b310(param_1,param_2 + 0x3ac);
  ...
  iVar4 = (**(code **)(*DAT_803dcab8 + 0x50))
                    (param_1,param_3,param_2 + 0x35c,(int)*(short *)(param_2 + 0x3f4),&DAT_80320008,
                     &DAT_80320080,1,0);
  if (3 < iVar4) {
