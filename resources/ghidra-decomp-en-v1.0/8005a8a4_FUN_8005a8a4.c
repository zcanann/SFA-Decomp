...
void FUN_8005a8a4(float *param_1,int param_2)

{
  ...
  for (iVar5 = 0; iVar5 < param_2; iVar5 = iVar5 + 1) {
    iVar3 = 0;
    fVar1 = FLOAT_803debcc;
    while (iVar4 = iVar3, iVar4 < 0x18) {
      fVar2 = param_1[2] * (float)(&DAT_8030e5d4)[iVar4 + 2] +
              param_1[1] * (float)(&DAT_8030e5d4)[iVar4 + 1] +
              *param_1 * (float)(&DAT_8030e5d4)[iVar4];
      iVar3 = iVar4 + 3;
      if (fVar1 < fVar2) {
        in_r8 = iVar4;
        fVar1 = fVar2;
