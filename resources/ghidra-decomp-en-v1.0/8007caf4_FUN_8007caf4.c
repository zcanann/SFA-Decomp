// Function: FUN_8007caf4
// Entry: 8007caf4
// Size: 1160 bytes

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_8007caf4(void)

{
  ...
  local_5c = FLOAT_803deeec;
  local_58 = FLOAT_803deedc;
  local_54 = FLOAT_803deedc;
  local_50 = FLOAT_803deedc;
  local_4c = FLOAT_803deeec;
  local_48 = FLOAT_803deedc;
  cVar2 = FUN_8004c248();
  if (cVar2 == '\0') {
    (**(code **)(*DAT_803dca58 + 0x40))
              (&DAT_803db680,0x803db681,0x803db682,auStack112,auStack112,auStack112);
    bVar1 = (byte)((int)((_DAT_803db680 & 0xff0000) >> 0x10) >> 3);
    _DAT_803db680 =
         (ushort)((uint)(((int)(_DAT_803db680 >> 0x18) >> 3) << 0x18) >> 0x10) | (ushort)bVar1;
    _DAT_803db680 =
         CONCAT31(CONCAT21(_DAT_803db680,
                           (char)((int)((CONCAT12(bVar1,(short)_DAT_803db680) & 0xff00) >> 8) >> 3))
                  ,DAT_803db678);
  }
  else {
    _DAT_803db680 =
  ...
  local_68 = _DAT_803db680;
  FUN_8025bcc4(3,&local_68);
  local_6c = DAT_803db684;
  ...
  FUN_8025b1e8(1,0,0,7,2,0,0,0,0,3);
  FUN_8025b6f0(1);
  FUN_80259e58(1);
  FUN_802581e0(3);
  FUN_8025c2a0(2);
