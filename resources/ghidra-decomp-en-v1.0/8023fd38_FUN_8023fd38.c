// Function: FUN_8023fd38
// Entry: 8023fd38
// Size: 680 bytes

void FUN_8023fd38(undefined2 *param_1)

{
  ...
  if (*piVar5 == 0) {
    iVar3 = FUN_8002e0b4(0x47b77);
    *piVar5 = iVar3;
  }
  if (piVar5[1] == 0) {
    iVar3 = FUN_8002e0b4(0x4c611);
    piVar5[1] = iVar3;
  }
  ...
  if (cVar2 == '\x01') {
    if (bVar1) {
      *(undefined *)((int)piVar5 + 0x1f) = 0x3c;
      (**(code **)(*DAT_803dca68 + 0x58))(0x50,0x643);
    }
    (**(code **)(*DAT_803dca68 + 0x5c))(*(undefined *)((int)piVar5 + 0x1e));
    iVar4 = FUN_8003687c(param_1,auStack32,auStack36,auStack40);
    iVar3 = (uint)*(byte *)((int)piVar5 + 0x1f) - (uint)DAT_803db410;
    if (iVar3 < 0) {
      iVar3 = 0;
    }
    *(char *)((int)piVar5 + 0x1f) = (char)iVar3;
    if ((iVar4 != 0) && (*(char *)((int)piVar5 + 0x1f) == '\0')) {
      FUN_8002ac30(param_1,0x19,200,0,0,1);
      *(undefined *)((int)piVar5 + 0x1f) = 6;
      *(char *)((int)piVar5 + 0x1e) = *(char *)((int)piVar5 + 0x1e) + -1;
      if (*(char *)((int)piVar5 + 0x1e) == '\0') {
        *(undefined *)(piVar5 + 7) = 2;
        FUN_8023a688(*piVar5,1);
    ...
    if (bVar1) {
      FUN_80240218(piVar5[1],2,0);
      (**(code **)(*DAT_803dca68 + 100))();
    }
    param_1[3] = param_1[3] | 0x4000;
    FUN_8023a688(*piVar5,8);
  }
  return;
}
