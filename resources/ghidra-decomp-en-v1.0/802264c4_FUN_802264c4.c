// Function: FUN_802264c4
// Entry: 802264c4
// Size: 1156 bytes

void FUN_802264c4(undefined4 param_1,undefined4 param_2,short param_3,float *param_4,float *param_5,
  ...
  if (param_6 == 0) {
    if (param_7 == -1) {
      ...
      *param_4 = FLOAT_803e6db4 +
                 FLOAT_803e6dd0 + local_50 +
                 (float)((double)CONCAT44(0x43300000,uStack36) - DOUBLE_803e6dc8);
      *param_5 = fVar2 + FLOAT_803e6dd4 + local_4c + FLOAT_803e6dbc;
      param_3 = param_3 + 1;
      iVar6 = 8;
    }
    else {
      ...
      uStack36 = extraout_r4 * 0x30 ^ 0x80000000;
      *param_4 = FLOAT_803e6db4 +
                 FLOAT_803e6dd0 + local_58 +
                 (float)((double)CONCAT44(0x43300000,uStack36) - DOUBLE_803e6dc8);
      *param_5 = fVar2 + FLOAT_803e6dd4 + local_54 + FLOAT_803e6da8;
      param_3 = param_3 + -1;
      iVar6 = -1;
    }
    local_28 = 0x43300000;
    iVar7 = (int)param_3;
    pcVar4 = &DAT_803ad2d8 + iVar7 + extraout_r4 * 8;
    for (; iVar7 != iVar6; iVar7 = iVar7 - param_7) {
      if (*pcVar4 != '\0') {
        if ((byte)(&DAT_803ad2d8)[iVar7 + extraout_r4 * 8] < 5) {
          FUN_8005b0a8((double)*(float *)(iVar3 + 0xc),(double)*(float *)(iVar3 + 0x10),
                       (double)*(float *)(iVar3 + 0x14),auStack96,&local_5c);
          uStack36 = (short)((short)iVar7 + (short)param_7) * 0x30 ^ 0x80000000;
          *param_5 = FLOAT_803e6db4 +
                     FLOAT_803e6dd4 + local_5c +
                     (float)((double)CONCAT44(0x43300000,uStack36) - DOUBLE_803e6dc8);
          uVar5 = 1;
        }
        else {
    ...
    if (param_6 == -1) {
      ...
      fVar2 = FLOAT_803e6db4;
      *param_4 = FLOAT_803e6db4 + FLOAT_803e6dd0 + local_30 + FLOAT_803e6dbc;
      uStack36 = param_3 * 0x30 ^ 0x80000000;
      *param_5 = fVar2 + FLOAT_803e6dd4 + local_2c +
                         (float)((double)CONCAT44(0x43300000,uStack36) - DOUBLE_803e6dc8);
      sVar1 = 1;
      iVar6 = 8;
    }
      ...
      fVar2 = FLOAT_803e6db4;
      *param_4 = FLOAT_803e6db4 + FLOAT_803e6dd0 + local_38 + FLOAT_803e6da8;
      uStack36 = param_3 * 0x30 ^ 0x80000000;
      *param_5 = fVar2 + FLOAT_803e6dd4 + local_34 +
                         (float)((double)CONCAT44(0x43300000,uStack36) - DOUBLE_803e6dc8);
      sVar1 = -1;
      iVar6 = -1;
    }
