// Function: FUN_800567a8
// Entry: 800567a8
// Size: 708 bytes

int FUN_800567a8(int param_1,int param_2,uint param_3)

{
  ...
  if (iVar1 == -1) {
    ...
    if (iVar1 == -1) {
      FUN_8007d6dc(s_TRACK_ERROR__Global_texanim_over_8030e740);
      iVar1 = 0;
    }
    else {
      *(undefined2 *)(DAT_803dce6c + iVar1 * 4 + 3) = 1;
      DAT_803dce6c[iVar1 * 4 + 1] = 0;
      DAT_803dce6c[iVar1 * 4 + 2] = param_2;
      DAT_803dce6c[iVar1 * 4] = param_1;
      *(char *)((int)DAT_803dce6c + iVar1 * 0x10 + 0xe) = (char)param_3;
    }
  }
  else {
    *(short *)(DAT_803dce6c + iVar1 * 4 + 3) = *(short *)(DAT_803dce6c + iVar1 * 4 + 3) + 1;
  }
  return iVar1;
}
