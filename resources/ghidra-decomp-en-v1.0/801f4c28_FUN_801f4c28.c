...
void FUN_801f4c28(int param_1,int param_2)

{
  ...
  *(float *)(param_2 + 0x44) = FLOAT_803e5eac;
  *(float *)(param_2 + 0x48) = FLOAT_803e5eb0;
  *(float *)(param_2 + 0x40) = FLOAT_803e5eb4;
  *(undefined *)(param_2 + 0x68) = 0;
  *(undefined *)(param_2 + 0x67) = 0;
  uVar1 = FUN_800221a0(500,0x5dc);
  *(undefined2 *)(param_2 + 0x62) = uVar1;
  uVar1 = FUN_800221a0(0,65000);
  *(undefined2 *)(param_2 + 0x60) = uVar1;
  *(undefined2 *)(param_2 + 100) = 0x3c;
  *(undefined *)(param_2 + 0x66) = 4;
  *(float *)(param_2 + 0x4c) = FLOAT_803e5eb8;
  *(float *)(param_2 + 0x50) = FLOAT_803e5ebc;
  ...
  *(float *)(param_2 + 0x78) = FLOAT_803e5ec0;
  return;
}
