// Function: FUN_80273f74
// Entry: 80273f74
// Size: 460 bytes

undefined4 FUN_80273f74(short param_1)

{
  ...
  FUN_80284af4();
  uVar5 = (uint)DAT_803de28e;
  uVar4 = 0;
  for (puVar3 = &DAT_803c4a78; ((int)uVar4 < (int)uVar5 && (param_1 != *(short *)(puVar3 + 1)));
      puVar3 = puVar3 + 3) {
    uVar4 = uVar4 + 1;
  }
  if ((uVar4 == uVar5) ||
     (sVar1 = (&DAT_803c4a80)[uVar4 * 6], (&DAT_803c4a80)[uVar4 * 6] = sVar1 + -1,
     (short)(sVar1 + -1) != 0)) {
    FUN_80284abc();
    return 0;
  }
