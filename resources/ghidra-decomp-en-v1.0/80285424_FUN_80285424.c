// Function: FUN_80285424
// Entry: 80285424
// Size: 664 bytes

undefined4 FUN_80285424(byte *param_1,int param_2,int param_3)

{
  ...
  if (param_3 != 0) {
    ...
    write_volatile_4(DAT_cc006838,uVar3);
  }
  write_volatile_4(DAT_cc006834,param_3 << 2 | 1U | (param_2 + -1) * 0x10);
  do {
    uVar3 = read_volatile_4(DAT_cc006834);
  } while ((uVar3 & 1) != 0);
  if (param_3 == 0) {
    iVar2 = 0;
    uVar3 = read_volatile_4(DAT_cc006838);
    if (0 < param_2) {
