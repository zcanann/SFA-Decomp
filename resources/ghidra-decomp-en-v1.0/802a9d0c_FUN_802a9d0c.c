// Function: FUN_802a9d0c
// Entry: 802a9d0c
// Size: 776 bytes

void FUN_802a9d0c(undefined4 param_1,undefined4 param_2,undefined2 *param_3,undefined4 param_4,
...

{
  ...
  iVar5 = (int)uVar6;
  if (param_8 != 0) {
    iVar3 = FUN_800395d8(puVar2,0);
    if (iVar3 != 0) {
      sVar1 = *(short *)(iVar3 + 2);
      if (sVar1 < 1) {
        local_30 = (longlong)(int)(FLOAT_803e8050 * FLOAT_803db414);
        *(short *)(iVar3 + 2) = sVar1 + (short)(int)(FLOAT_803e8050 * FLOAT_803db414);
        if (0 < *(short *)(iVar3 + 2)) {
  ...
  *(undefined4 *)(puVar2 + 10) = local_3c;
  if ((*(short *)(*(int *)(puVar2 + 0x5c) + 0x274) == 0x18) || ((puVar2[0x58] & 0x1000) != 0)) {
    ...
    *(undefined2 *)(iVar5 + 0x478) = *param_3;
    ...
    sVar1 = *(short *)(iVar5 + 0x478) - sStack62;
    if (0x8000 < sVar1) {
      sVar1 = sVar1 + 1;
    }
    if (sVar1 < -0x8000) {
    ...
    sVar4 = -sStack66;
    if ((sVar4 <= sVar1) && (sVar4 = sVar1, sStack66 < sVar1)) {
      sVar4 = sStack66;
    }
    *(short *)(iVar5 + 0x478) = sStack62 + sVar4;
