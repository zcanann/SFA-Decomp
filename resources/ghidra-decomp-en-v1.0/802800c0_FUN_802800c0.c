...
void FUN_802800c0(int param_1,float *param_2,float *param_3,float *param_4,float *param_5,
                 float *param_6)

{
  ...
  iVar4 = 0;
  dVar12 = (double)FLOAT_803e7880;
  *param_2 = FLOAT_803e7880;
  dVar14 = (double)FLOAT_803e78a4;
  *param_3 = FLOAT_803e78a4;
  dVar15 = (double)FLOAT_803e78b0;
  dVar10 = dVar12;
  dVar11 = dVar12;
  dVar13 = dVar12;
  dVar16 = DOUBLE_803e7898;
  dVar17 = DOUBLE_803e78a8;
  for (puVar5 = DAT_803de358; dVar6 = DOUBLE_803e7888, puVar5 != (undefined4 *)0x0;
      ...
      if ((*(uint *)(param_1 + 0x10) & 0x80000) == 0) {
        if (((*(uint *)(param_1 + 0x10) & 8) != 0) || ((puVar5[3] & 1) != 0)) {
          ...
          if (dVar13 < dVar7) {
            ...
            dVar9 = (double)(fVar2 * fVar2 + fVar1 * fVar1 + fVar3 * fVar3);
            if (dVar13 < dVar9) {
  ...
  if (iVar4 != 0) {
    dVar13 = (double)CONCAT44(0x43300000,iVar4) - DOUBLE_803e7888;
    *param_4 = (float)(dVar12 / (double)(float)((double)CONCAT44(0x43300000,iVar4) - DOUBLE_803e7888
                                               ));
