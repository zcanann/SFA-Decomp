// Function: FUN_802a03bc
// Entry: 802a03bc
// Size: 708 bytes

undefined4 FUN_802a03bc(int param_1,uint *param_2)

{
  ...
  if (*(char *)((int)param_2 + 0x27a) != '\0') {
    ...
    FUN_80030334((double)FLOAT_803e7ea4,param_1,(int)DAT_80332f6a,1);
    FUN_8002ed6c(param_1,(int)DAT_80332f6c,0);
    param_2[0xa8] = (uint)FLOAT_803e7f84;
    ...
    *(undefined4 *)(param_1 + 0x10) = *(undefined4 *)(iVar4 + 0x54c);
    *(undefined2 *)(param_2 + 0x9e) = 0x14;
