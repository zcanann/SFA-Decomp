// Function: FUN_80057d24
// Entry: 80057d24
// Size: 776 bytes

void FUN_80057d24(int param_1,int param_2,int *param_3,int *param_4,int *param_5,int *param_6,
...

{
  ...
  if (param_9 != -1) {
    psVar5 = (short *)(DAT_8038223c + (short)(&DAT_80382250)[param_9 * 4] * 10);
    psVar6 = (short *)(&DAT_8038224c)[param_9 * 2];
    if (param_9 != -1) {
      if (param_8 == 0) {
        iVar2 = *(int *)(psVar6 + 10);
