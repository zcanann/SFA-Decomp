// Function: FUN_800a0ab4
// Entry: 800a0ab4
// Size: 452 bytes

void FUN_800a0ab4(int param_1,int param_2,int param_3,uint param_4)

{
  ...
  iVar3 = param_1 + iVar7;
  *(float *)(iVar3 + 0xb0) = *(float *)(iVar3 + 0xac) * FLOAT_803dd284 + *(float *)(iVar3 + 0xb0);
  if (FLOAT_803df430 <= *(float *)(iVar3 + 0xb0)) {
    if (FLOAT_803df43c < *(float *)(iVar3 + 0xb0)) {
      *(float *)(iVar3 + 0xb0) = FLOAT_803df43c;
    }
  }
  else {
    *(float *)(iVar3 + 0xb0) = FLOAT_803df430;
  }
  iVar3 = 0;
