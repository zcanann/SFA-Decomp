// Function: FUN_8017cd28
// Entry: 8017cd28
// Size: 376 bytes

void FUN_8017cd28(int param_1)

{
  ...
  if ((pbVar6[1] & 1) != 0) {
    ...
    FUN_800200e8((int)*(short *)(iVar5 + (uint)*pbVar6 * 2 + 0x18),uVar1 >> 5);
    pbVar6[1] = pbVar6[1] & 0xfe;
    *pbVar6 = *pbVar6 + 1;
  }
  if (*pbVar6 != 4) {
    if (*(short *)(iVar5 + (uint)*pbVar6 * 2 + 0x20) == -1) {
      *pbVar6 = 4;
    }
    else {
      uVar2 = FUN_8001ffb4();
  ...
  iVar3 = *pbVar6 - 1;
  for (iVar4 = iVar5 + iVar3 * 2; (-1 < iVar3 && (*(short *)(iVar4 + 0x18) != -1));
      iVar4 = iVar4 + -2) {
    uVar1 = FUN_8001ffb4();
    if (((int)(uint)*(byte *)(iVar5 + 0x30) >> (iVar3 + 4U & 0x3f) & 1U) != uVar1) {
      return;
    }
    *pbVar6 = *pbVar6 - 1;
    iVar3 = iVar3 + -1;
