// Function: FUN_8025ab1c
// Entry: 8025ab1c
// Size: 580 bytes

void FUN_8025ab1c(int param_1,uint *param_2)

{
  ...
  write_volatile_4(0xcc008000,uVar12);
  write_volatile_1(DAT_cc008000,0x61);
  write_volatile_4(0xcc008000,uVar11);
  write_volatile_1(DAT_cc008000,0x61);
  write_volatile_4(0xcc008000,uVar10);
  write_volatile_1(DAT_cc008000,0x61);
  write_volatile_4(0xcc008000,uVar14);
  if (uVar13 != 0) {
    for (uVar1 = 0; uVar1 < uVar13; uVar1 = uVar1 + 1) {
      ...
      FUN_8025a088(*(undefined4 *)(param_1 + 0x14),&local_58,local_54);
      if (uVar6 == 0) {
        uVar6 = 1;
      }
      if (uVar5 == 0) {
