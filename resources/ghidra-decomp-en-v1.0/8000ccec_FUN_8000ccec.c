// Function: FUN_8000ccec
// Entry: 8000ccec
// Size: 360 bytes

int * FUN_8000ccec(int param_1,ushort param_2,short param_3,int param_4)
...
LAB_8000cdf4:
      ...
      else if (param_4 < 4) goto LAB_8000cdf4;
      if ((param_4 != 3) && (DAT_803dc83c == 3)) {
        return piVar2;
      }
    }
    piVar1 = piVar1 + 0xe;
