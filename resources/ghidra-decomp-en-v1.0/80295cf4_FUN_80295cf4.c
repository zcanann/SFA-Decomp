// Function: FUN_80295cf4
// Entry: 80295cf4
// Size: 412 bytes

void FUN_80295cf4(int param_1,uint param_2)

{
  ...
  if ((DAT_803de44c != 0) && (bVar1 = *(byte *)(iVar2 + 0x3f4) >> 6, (bVar1 & 1) != param_2)) {
    if (param_2 == 0) {
      if (DAT_803de44c != 0) {
        *(ushort *)(DAT_803de44c + 6) = *(ushort *)(DAT_803de44c + 6) | 0x4000;
    ...
    else if (DAT_803de44c != 0) {
      if ((DAT_803de44c != 0) && ((bVar1 & 1) != 0)) {
        *(undefined *)(iVar2 + 0x8b4) = 4;
        *(byte *)(iVar2 + 0x3f4) = *(byte *)(iVar2 + 0x3f4) & 0xf7 | 8;
      }
      *(ushort *)(DAT_803de44c + 6) = *(ushort *)(DAT_803de44c + 6) & 0xbfff;
