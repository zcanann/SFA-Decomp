// Function: FUN_802539e0
// Entry: 802539e0
// Size: 604 bytes

undefined4 FUN_802539e0(int param_1,byte *param_2,int param_3,int param_4,undefined4 param_5)

{
  ...
  if (((*(uint *)(&DAT_803af06c + iVar1) & 3) == 0) && ((*(uint *)(&DAT_803af06c + iVar1) & 4) != 0)
    ...
    *(uint *)(&DAT_803af06c + iVar1) = *(uint *)(&DAT_803af06c + iVar1) | 2;
    if (param_4 != 0) {
      iVar5 = 0;
      uVar6 = 0;
      if (0 < param_3) {
    ...
    *(byte **)(&DAT_803af074 + iVar1) = param_2;
    iVar5 = param_3;
    if (param_4 == 1) {
      iVar5 = 0;
    }
    *(int *)(&DAT_803af070 + iVar1) = iVar5;
