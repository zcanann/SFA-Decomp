// Function: FUN_8025c828
// Entry: 8025c828
// Size: 476 bytes

void FUN_8025c828(uint param_1,int param_2,uint param_3,int param_4)

{
  ...
  *(uint *)(DAT_803dd210 + param_1 * 4 + 0x49c) = param_3;
  ...
  if (param_2 < 8) {
    *(uint *)(DAT_803dd210 + 0x4e0) = *(uint *)(DAT_803dd210 + 0x4e0) | 1 << param_1;
  }
  else {
    param_2 = 0;
    *(uint *)(DAT_803dd210 + 0x4e0) = *(uint *)(DAT_803dd210 + 0x4e0) & ~(1 << param_1);
  ...
  if ((param_1 & 1) == 0) {
    ...
    *puVar2 = *puVar2 & 0xffffffc7 | param_2 << 3;
    if (param_4 == 0xff) {
      ...
      iVar1 = *(int *)(&DAT_8032f6e0 + param_4 * 4);
    }
