  ...
  if (param_6 == 0) {
    if (param_7 == -1) {
      ...
      *param_4 = FLOAT_803e7a4c +
                 FLOAT_803e7a50 + local_50 +
                 (float)((double)CONCAT44(0x43300000,uStack_24) - DOUBLE_803e7a60);
      *param_5 = fVar2 + FLOAT_803e7a58 + local_4c + FLOAT_803e7a54;
      sVar1 = 1;
      iVar4 = 8;
    }
    else {
      ...
      uStack_24 = extraout_r4 * 0x30 ^ 0x80000000;
      *param_4 = FLOAT_803e7a4c +
                 FLOAT_803e7a50 + local_58 +
                 (float)((double)CONCAT44(0x43300000,uStack_24) - DOUBLE_803e7a60);
      *param_5 = fVar2 + FLOAT_803e7a58 + local_54 + FLOAT_803e7a40;
      sVar1 = -1;
      iVar4 = -1;
    }
    local_2c[1] = 176.0;
    iVar5 = (int)(short)(param_3 + sVar1);
    pcVar3 = &DAT_803adef8 + iVar5 + extraout_r4 * 8;
    for (; iVar5 != iVar4; iVar5 = iVar5 - param_7) {
      if (*pcVar3 != '\0') {
        if ((byte)(&DAT_803adef8)[iVar5 + extraout_r4 * 8] < 5) {
          FUN_8005b224(&fStack_60,&local_5c);
          uStack_24 = (short)((short)iVar5 + (short)param_7) * 0x30 ^ 0x80000000;
          *param_5 = FLOAT_803e7a4c +
                     FLOAT_803e7a58 + local_5c +
                     (float)((double)CONCAT44(0x43300000,uStack_24) - DOUBLE_803e7a60);
        }
        else {
    ...
    if (param_6 == -1) {
      ...
      fVar2 = FLOAT_803e7a4c;
      *param_4 = FLOAT_803e7a4c + FLOAT_803e7a50 + local_30 + FLOAT_803e7a54;
      uStack_24 = param_3 * 0x30 ^ 0x80000000;
      *param_5 = fVar2 + FLOAT_803e7a58 + local_2c[0] +
                         (float)((double)CONCAT44(0x43300000,uStack_24) - DOUBLE_803e7a60);
      sVar1 = 1;
      iVar4 = 8;
    }
      ...
      fVar2 = FLOAT_803e7a4c;
      *param_4 = FLOAT_803e7a4c + FLOAT_803e7a50 + local_38 + FLOAT_803e7a40;
      uStack_24 = param_3 * 0x30 ^ 0x80000000;
      *param_5 = fVar2 + FLOAT_803e7a58 + local_34 +
                         (float)((double)CONCAT44(0x43300000,uStack_24) - DOUBLE_803e7a60);
      sVar1 = -1;
      iVar4 = -1;
    }
