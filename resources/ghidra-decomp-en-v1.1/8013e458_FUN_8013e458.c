...
/* WARNING: Removing unreachable block (ram,0x8013f1ec) */
/* WARNING: Removing unreachable block (ram,0x8013f1e4) */
/* WARNING: Removing unreachable block (ram,0x8013f1dc) */
/* WARNING: Removing unreachable block (ram,0x8013f1d4) */
/* WARNING: Removing unreachable block (ram,0x8013e480) */
/* WARNING: Removing unreachable block (ram,0x8013e478) */
/* WARNING: Removing unreachable block (ram,0x8013e470) */
/* WARNING: Removing unreachable block (ram,0x8013e468) */
/* WARNING: Removing unreachable block (ram,0x8013e4c8) */
  ...
  if (bVar12 == 3) {
    if ((*(short *)(uVar2 + 0xa0) == 0x34) &&
      ...
      if ((uVar3 & 0xff) != 0) {
        ...
        puVar14 = puVar10;
        do {
          puVar4 = FUN_8002becc(0x24,0x4f0);
          *(undefined *)(puVar4 + 2) = 2;
          *(undefined *)((int)puVar4 + 5) = 1;
          puVar4[0xd] = (short)iVar15;
          uVar5 = FUN_8002e088(dVar19,param_2,param_3,param_4,param_5,param_6,param_7,param_8,puVar4
        ...
        FUN_8000bb38(uVar2,0x3db);
        FUN_8000dcdc(uVar2,0x3dc);
      }
    ...
    if (bVar12 == 1) {
      ...
      FUN_80148ff0();
      cVar8 = FUN_8013b6f0((double)FLOAT_803e3164,param_2,param_3,param_4,param_5,param_6,param_7,
      ...
      if (bVar9) {
        dVar19 = extraout_f1;
        if (puVar10[0x1ca] == 0) {
          iVar15 = FUN_8013f20c(uVar2,(int)puVar10);
        ...
        if (cVar8 == '\x02') {
          ...
          *(undefined *)((int)puVar10 + 0xd) = 0xff;
          ...
          if (cVar8 == '\0') {
            ...
            FUN_8013a778(dVar19,uVar2,0x33,0);
          }
          if (puVar10[0x1ca] != 0) {
            if (1 < *(byte *)*puVar10) {
              ...
              *(undefined *)((int)puVar10 + 0xd) = 0xff;
              if (puVar10[0x1ee] == 0) {
                ...
                *(byte *)(puVar10 + 0x1ef) =
                ...
                uVar5 = FUN_8002e088(dVar19,param_2,param_3,param_4,param_5,param_6,param_7,param_8,
                                     puVar4,4,0xff,0xffffffff,*(uint **)(uVar2 + 0x30),param_14,
                                     param_15,param_16);
                puVar10[0x1ee] = uVar5;
                FUN_80037e24(uVar2,puVar10[0x1ee],*(byte *)(puVar10 + 0x1ef) >> 2 & 3);
                fVar1 = FLOAT_803e306c;
          ...
          if (dVar19 <= (double)FLOAT_803e3170) {
            ...
            if ((float)puVar10[0x1c7] < FLOAT_803e306c) {
              ...
              if ((((*(byte *)(iVar15 + 0x58) >> 6 & 1) == 0) &&
                 ...
                 (bVar9 = FUN_8000b598(uVar2,0x10), !bVar9)) {
                FUN_800394f0(uVar2,iVar15 + 0x3a8,0x29b,0x1000,0xffffffff,0);
              }
            }
          }
          else {
          ...
          *(undefined *)((int)puVar10 + 0xd) = 0xff;
          ...
          if (dVar19 < (double)FLOAT_803e316c) {
            ...
            *(undefined *)((int)puVar10 + 10) = 1;
            ...
            if (bVar9) {
              FUN_8013a778((double)FLOAT_803e30cc,uVar2,8,0);
              puVar10[0x1e7] = FLOAT_803e30d0;
              puVar10[0x20e] = FLOAT_803e306c;
              FUN_80148ff0();
            }
            else {
              FUN_8013a778((double)FLOAT_803e30d4,uVar2,0,0);
              FUN_80148ff0();
            }
          }
        }
      ...
      FUN_80148ff0();
      cVar8 = FUN_8013b6f0((double)FLOAT_803e3174,param_2,param_3,param_4,param_5,param_6,param_7,
                           param_8,uVar2,puVar10,param_11,param_12,bVar11,param_14,param_15,param_16
                          );
      iVar15 = FUN_80139330();
      puVar10[9] = iVar15;
      ...
      if ((bVar9) && (cVar8 != '\x01')) {
        FUN_8013a778((double)FLOAT_803e30d4,uVar2,0x34,0x4000000);
    ...
    if ((iVar6 == 0) || (*(short *)(iVar6 + 0x46) != 0x6a3)) {
      iVar6 = FUN_80296878(puVar10[1]);
    }
    bVar12 = (byte)param_13;
    if ((iVar6 == puVar10[0x1c8]) && (puVar10[0x1ca] == 0)) {
      piVar7 = FUN_80037048(0x4b,local_74);
      dVar20 = (double)FLOAT_803e3088;
      for (iVar13 = 0; bVar12 = (byte)param_13, iVar13 < local_74[0]; iVar13 = iVar13 + 1) {
        dVar16 = (double)FUN_80021754((float *)(*piVar7 + 0x18),(float *)(iVar6 + 0x18));
        dVar17 = (double)FUN_80021754((float *)(*piVar7 + 0x18),(float *)(puVar10[1] + 0x18));
        dVar18 = (double)FUN_80021754((float *)(iVar6 + 0x18),(float *)(puVar10[1] + 0x18));
        param_2 = (double)(float)(dVar16 + dVar17);
        if ((double)(float)(dVar20 * dVar18) < param_2) {
          dVar16 = (double)FUN_80021754((float *)(*piVar7 + 0x18),(float *)(uVar2 + 0x18));
      ...
      if (iVar15 != 0) {
        if ((((puVar10[0x1c9] == 0) &&
          ...
          bVar12 = 0xff;
          param_14 = 0;
          FUN_800394f0(uVar2,iVar6 + 0x3a8,0x35b,0x500,0xffffffff,0);
        }
    ...
    if (puVar10[0x1c9] == 0) {
      cVar8 = FUN_8013b6f0((double)FLOAT_803e30a8,param_2,param_3,param_4,param_5,param_6,param_7,
                           param_8,uVar2,puVar10,param_11,param_12,bVar12,param_14,param_15,param_16
                          );
    }
    else {
      cVar8 = FUN_8013b6f0((double)FLOAT_803e3118,param_2,param_3,param_4,param_5,param_6,param_7,
                           param_8,uVar2,puVar10,param_11,param_12,bVar12,param_14,param_15,param_16
                          );
    }
    if (cVar8 != '\x01') {
    ...
    if ((puVar10[0x15] & 0x8000000) != 0) {
      ...
      if (((*(byte *)(iVar15 + 0x58) >> 6 & 1) == 0) &&
         (((0x2f < *(short *)(uVar2 + 0xa0) || (*(short *)(uVar2 + 0xa0) < 0x29)) &&
          (bVar9 = FUN_8000b598(uVar2,0x10), !bVar9)))) {
        FUN_800394f0(uVar2,iVar15 + 0x3a8,0x29d,0,0xffffffff,0);
      }
      puVar10[0x15] = puVar10[0x15] & 0xffffffef;
      *(undefined *)((int)puVar10 + 10) = 0;
    }
