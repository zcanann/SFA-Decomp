// Function: FUN_8026ad0c
// Entry: 8026ad0c
// Size: 1660 bytes

void FUN_8026ad0c(int param_1,short *param_2)

{
  ...
  iVar7 = DAT_803ded80 + 0x20;
  uVar10 = *(uint *)(param_1 + 0x6a0);
  uVar6 = iVar11 + 4U & 0x1f;
  uVar6 = (uVar10 << uVar6 | uVar10 >> 0x20 - uVar6) & 0x1f;
  if (iVar11 < 0x1d) {
    uVar3 = (uint)*(byte *)(DAT_803ded80 + uVar6);
    if (uVar3 == 0xff) {
      uVar3 = iVar11 + 5;
      iVar7 = 5;
      piVar8 = (int *)(DAT_803ded80 + 0x58);
LAB_8026ad70:
      if (uVar3 != 0x21) goto code_r0x8026ad7c;
      uVar3 = 1;
...
LAB_8026ade0:
  ...
  if (iVar11 == 0x21) {
    ...
    *(int *)(param_1 + 0x6a4) = iVar9 + 2;
    ...
    if (iVar11 != 0x20) {
      uVar3 = (uint)*(byte *)(DAT_803ded80 + (uVar6 & 0x1f));
    ...
    *(uint *)(param_1 + 0x6a4) = (uint)bVar2;
    if (uVar3 != 0xff) goto LAB_8026afa4;
  ...
  for (iVar7 = 1; uVar3 = uVar6, iVar7 < 0x40; iVar7 = iVar7 + 1) {
    ...
    if ((int)uVar6 < 0x1d) {
      ...
      if (uVar14 == 0xff) {
        ...
        piVar8 = (int *)(iVar4 + 0x58);
LAB_8026b0b4:
        if (uVar3 != 0x21) goto code_r0x8026b0c0;
        uVar3 = 1;
        puVar1 = (uint *)(*(int *)(param_1 + 0x69c) + 4);
        uVar10 = *puVar1;
        piVar8 = piVar8 + 1;
...
LAB_8026b2c4:
    ...
    if (uVar6 == 0) {
      ...
      param_2[(byte)(&DAT_802c2da8)[iVar7]] = (short)uVar12;
    }
    uVar6 = uVar3;
  }
  *(uint *)(param_1 + 0x6a4) = uVar3;
...
code_r0x8026ad7c:
  ...
  uVar3 = uVar3 + 1;
  iVar7 = iVar7 + 1;
  if ((int)uVar6 <= *piVar8) goto LAB_8026ade0;
  goto LAB_8026ad70;
code_r0x8026b0c0:
  piVar8 = piVar8 + 1;
  uVar12 = uVar12 << 1 | (uVar10 << (uVar3 & 0x1f) | uVar10 >> 0x20 - (uVar3 & 0x1f)) & 1;
  uVar3 = uVar3 + 1;
  iVar9 = iVar9 + 1;
  if ((int)uVar12 <= *piVar8) goto LAB_8026b120;
  goto LAB_8026b0b4;
}
