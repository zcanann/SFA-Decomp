...

{
  ...
  FUN_80135b9c(iVar5,0);
  FUN_801350c8(0xff,1,1);
  uVar6 = FUN_80019940(0xc0,0xc0,0xc0,0xff);
  FUN_800168a8(uVar6,dVar7,param_3,param_4,param_5,param_6,param_7,param_8,0x3ae);
  FUN_80019940(0xff,0xff,0xff,0xff);
  uVar6 = FUN_8001b4f8(FUN_80135e18);
  FUN_800168a8(uVar6,dVar7,param_3,param_4,param_5,param_6,param_7,param_8,0xed);
  puVar4 = &DAT_803de370;
  for (iVar5 = 0; iVar5 < (int)(uint)DAT_803de374; iVar5 = iVar5 + 1) {
    local_68 = *puVar4;
    FUN_80015e00(&local_68,iVar5 + 0x2a,0,0);
    puVar4 = puVar4 + 1;
  }
  ...
  uVar3 = 0xff;
  uVar6 = FUN_80019940((byte)iVar2,(byte)iVar1,(byte)iVar5,0xff);
  iVar1 = DAT_803de364;
  uVar3 = FUN_8001947c(uVar6,dVar8,param_3,param_4,param_5,param_6,param_7,param_8,
  ...
  FUN_80015e00(uVar3,0x56,iVar5,0);
  dVar7 = (double)FUN_8001b4f8(0);
  FUN_80134fb0(dVar7,dVar8,param_3,param_4,param_5,param_6,param_7,param_8,'\0');
  return;
}
