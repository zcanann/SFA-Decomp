...

{
  ...
  uVar1 = (uint)param_1;
  piVar3 = (int *)(DAT_803dee98 + (uint)param_1 * 8 + 0x124);
  puVar7 = (uint *)(DAT_803dee98 + uVar1 * 0x2c + 0x364);
  if (piVar3[1] == 0) {
    return 0;
  }
  iVar4 = DAT_803dee98 + uVar1 * 0x18 + 0xee4;
...
LAB_8026e608:
    ...
    if (*(int *)(DAT_803dee98 + 0x14e4) == 0) {
      if (*(char *)(DAT_803dee98 + 0x151e) != '\0') {
        piVar3[1] = 0;
        return 0;
      }
    }
    else if (*(char *)(DAT_803dee98 +
                       (uint)*(byte *)(*(int *)(DAT_803dee98 + 0x14e4) + uVar1) * 0x38 + 0x151e) !=
             '\0') {
      piVar3[1] = 0;
      return 0;
    }
...
LAB_8026e7b0:
    ...
    if (uVar9 <= uVar2) goto LAB_8026e7b0;
...
LAB_8026e778:
    ...
    if (*(byte *)(uVar6 + 2) != 0 || *(char *)(uVar6 + 3) != '\0') {
      puVar7[2] = uVar6 + 6;
      goto LAB_8026e778;
    }
    puVar7[2] = uVar6 + 4;
