...

{
  ...
  if ((FLOAT_803e79e8 + local_14[0] < *(float *)(param_3 + 0xc)) ||
     (*(float *)(param_3 + 0xc) < local_14[0] - FLOAT_803e79e8)) {
    uVar1 = 1;
  }
  else if ((FLOAT_803e79e8 + local_18 < *(float *)(param_3 + 0x14)) ||
          (*(float *)(param_3 + 0x14) < local_18 - FLOAT_803e79e8)) {
    uVar1 = 1;
  }
  else {
    uVar1 = 0;
