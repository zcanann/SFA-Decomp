// Function: FUN_80246a0c
// Entry: 80246a0c
// Size: 288 bytes

undefined4
FUN_80246a0c(int param_1,undefined4 param_2,undefined4 param_3,uint param_4,int param_5,int param_6,
            ushort param_7)

{
  ...
  if ((param_6 < 0) || (0x1f < param_6)) {
    ...
    *(undefined4 *)(uVar1 - 4) = 0;
    FUN_80242b90(param_1,param_2,uVar1 - 8);
    *(undefined **)(param_1 + 0x84) = &LAB_80246b2c;
