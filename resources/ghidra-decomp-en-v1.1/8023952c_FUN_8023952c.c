...

{
  ...
  *(char *)(param_2 + 0x18) =
  ...
  puVar2[1] = (&PTR_DAT_8032cb50)[*(char *)(param_2 + 0x18)];
  *(undefined *)(puVar2 + 2) = (&DAT_803dd094)[*(char *)(param_2 + 0x18)];
  if ((undefined *)puVar2[1] == &DAT_803dd090) {
    FUN_80035f28((int)param_1,8);
  }
  ...
  *(code **)(param_1 + 0x5e) = FUN_802391a8;
  return;
}
