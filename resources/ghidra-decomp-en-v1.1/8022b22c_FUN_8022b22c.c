...

{
  ...
  dVar2 = DOUBLE_803e7b78;
  *(int *)(param_2 + 0x398) =
       (int)(FLOAT_803dc074 * *(float *)(param_2 + 0x3a0) * *(float *)(param_2 + 0x3a8) +
            (float)((double)CONCAT44(0x43300000,*(uint *)(param_2 + 0x398) ^ 0x80000000) -
                   DOUBLE_803e7b78));
  *(short *)(param_1 + 4) =
       (short)(int)(FLOAT_803dc074 * *(float *)(param_2 + 0x3a0) * *(float *)(param_2 + 0x3a8) +
                   (float)((double)CONCAT44(0x43300000,(int)*(short *)(param_1 + 4) ^ 0x80000000) -
                          dVar2));
  fVar1 = FLOAT_803e7b64;
  if (*(float *)(param_2 + 0x3a0) <= FLOAT_803e7b64) {
    ...
    if (iVar4 < (int)(uVar3 - 0xffff)) {
      ...
      *(float *)(param_2 + 0x60) = *(float *)(param_2 + 0x60) / *(float *)(param_2 + 0x3b0);
      FUN_8022f80c(*(int *)(param_2 + 0x10),'\0','\0');
    }
      ...
      *(float *)(param_2 + 0x3a8) =
           (float)(local_10 - DOUBLE_803e7b78) / *(float *)(param_2 + 0x3a4);
      if (FLOAT_803e7b90 <= *(float *)(param_2 + 0x3a8)) {
        if (FLOAT_803e7b68 < *(float *)(param_2 + 0x3a8)) {
          *(float *)(param_2 + 0x3a8) = FLOAT_803e7b68;
        }
      }
      else {
        *(float *)(param_2 + 0x3a8) = FLOAT_803e7b90;
      }
    }
  }
  else {
