// Function: FUN_8028eb50
// Entry: 8028eb50
// Size: 652 bytes

void FUN_8028eb50(undefined *param_1,int param_2,int param_3)
  ...
  *(short *)(param_1 + 2) = *(short *)(param_2 + 2) + *(short *)(param_3 + 2);
  ...
  if ((pbVar20 < pbVar21) && (4 < *pbVar20)) {
    if (*pbVar20 == 5) {
      ...
      if (pbVar19 < pbVar21) {
        do {
          if (*pbVar19 != 0) goto LAB_8028ed70;
          pbVar19 = pbVar19 + 1;
          iVar27 = iVar27 + -1;
        } while (iVar27 != 0);
      }
