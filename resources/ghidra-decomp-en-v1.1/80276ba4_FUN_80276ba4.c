...

{
  ...
  if ((param_2[1] >> 8 & 1) == 0) {
    FUN_802836f4(local_1c,param_1);
  }
  else {
    FUN_802836e4((int *)local_1c);
  }
  uVar1 = FUN_8028373c(local_1c[0]);
  if (uVar1 == 0) {
    uVar1 = 1;
  }
  uVar3 = *param_2;
  ...
  uVar3 = uVar3 >> 0x18 | (param_2[1] & 0xff) << 8;
  if ((uVar3 != 0xffff) && (iVar2 = FUN_802757bc((short)uVar3), iVar2 != 0)) {
    uVar3 = uVar4 >> 0x10;
    if (uVar3 < 0x7f) {
      uVar4 = (uVar4 & 0xffff) *
  ...
  *(int *)(param_1 + 0x194) = (int)(uVar4 - param_3) / (int)uVar1;
