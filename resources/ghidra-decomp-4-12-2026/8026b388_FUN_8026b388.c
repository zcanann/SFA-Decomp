// Function: FUN_8026b388
// Entry: 8026b388
// Size: 1704 bytes

void FUN_8026b388(int param_1,short *param_2)

{
  ...
  iVar8 = DAT_803deda0 + 0x20;
  uVar9 = *(uint *)(param_1 + 0x6a0);
  uVar7 = iVar10 + 4U & 0x1f;
  uVar7 = (uVar9 << uVar7 | uVar9 >> 0x20 - uVar7) & 0x1f;
  if (iVar10 < 0x1d) {
    uVar3 = (uint)*(byte *)(DAT_803deda0 + uVar7);
    if (uVar3 == 0xff) {
      uVar3 = iVar10 + 5;
      iVar8 = 5;
      piVar5 = (int *)(DAT_803deda0 + 0x58);
LAB_8026b3e8:
      if (uVar3 != 0x21) goto code_r0x8026b3f4;
      uVar3 = 1;
...
LAB_8026b458:
  ...
  if (iVar10 == 0x21) {
    ...
    *(int *)(param_1 + 0x6a4) = iVar12 + 2;
    ...
    if (iVar10 != 0x20) {
      uVar3 = (uint)*(byte *)(DAT_803deda0 + (uVar7 & 0x1f));
    ...
    *(uint *)(param_1 + 0x6a4) = (uint)bVar2;
    if (uVar3 != 0xff) goto LAB_8026b61c;
...
LAB_8026b61c:
  ...
  *param_2 = sVar6;
  do {
    ...
    iVar10 = DAT_803dee00 + 0x20;
    uVar9 = *(uint *)(param_1 + 0x6a0);
    uVar7 = iVar12 + 4U & 0x1f;
    uVar7 = (uVar9 << uVar7 | uVar9 >> 0x20 - uVar7) & 0x1f;
    if (iVar12 < 0x1d) {
      uVar3 = (uint)*(byte *)(DAT_803dee00 + uVar7);
      if (uVar3 == 0xff) {
        uVar3 = iVar12 + 5;
        iVar10 = 5;
        piVar5 = (int *)(DAT_803dee00 + 0x58);
LAB_8026b730:
        if (uVar3 != 0x21) goto code_r0x8026b73c;
        uVar3 = 1;
        puVar1 = (uint *)(*(int *)(param_1 + 0x69c) + 4);
        uVar9 = *puVar1;
        piVar5 = piVar5 + 1;
...
LAB_8026b860:
      ...
      if (iVar12 == 0x20) {
        ...
        *(uint *)(param_1 + 0x6a4) = (uint)bVar2;
        ...
        uVar3 = (uint)*(byte *)(DAT_803dee00 + (uVar7 & 0x1f));
...
code_r0x8026b3f4:
  ...
  uVar3 = uVar3 + 1;
  iVar8 = iVar8 + 1;
  if ((int)uVar7 <= *piVar5) goto LAB_8026b458;
  goto LAB_8026b3e8;
code_r0x8026b73c:
  piVar5 = piVar5 + 1;
  uVar7 = uVar7 << 1 | (uVar9 << (uVar3 & 0x1f) | uVar9 >> 0x20 - (uVar3 & 0x1f)) & 1;
  uVar3 = uVar3 + 1;
  iVar10 = iVar10 + 1;
  if ((int)uVar7 <= *piVar5) goto LAB_8026b7a0;
  goto LAB_8026b730;
}
