// Function: FUN_80252160
// Entry: 80252160
// Size: 764 bytes

uint FUN_80252160(void)

{
  ...
  if (DAT_8032ee98 != -1) {
    lVar10 = FUN_802473d4();
    uVar3 = 0;
    *(longlong *)(&DAT_803aefa0 + DAT_8032ee98 * 8) = lVar10;
    uVar5 = DAT_8032eea0 >> 2;
    puVar4 = DAT_8032eea4;
    if (uVar5 != 0) {
    ...
    if ((uVar5 & 0x20000000) == 0) {
      lVar10 = FUN_802473d4();
      uVar6 = 0;
      *(longlong *)(&DAT_803aef80 + DAT_8032ee98 * 8) = lVar10;
    }
    else {
      uVar5 = uVar6 >> (3 - DAT_8032ee98) * 8;
      uVar6 = uVar5 & 0xf;
      if (((uVar5 & 8) != 0) && ((*(uint *)(&DAT_8032eeac + DAT_8032ee98 * 4) & 0x80) == 0)) {
        *(uint *)(&DAT_8032eeac + DAT_8032ee98 * 4) = 8;
      }
      if (uVar6 == 0) {
        uVar6 = 4;
      }
