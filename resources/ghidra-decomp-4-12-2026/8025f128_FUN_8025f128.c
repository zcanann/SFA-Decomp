// Function: FUN_8025f128
// Entry: 8025f128
// Size: 308 bytes

int FUN_8025f128(int param_1,int param_2)

{
  ...
  *(undefined4 *)(&DAT_803afee4 + iVar2) = 0;
  *(undefined4 *)(&DAT_803afee8 + iVar2) = 0;
  iVar1 = FUN_8025ef74(param_1,param_2,0);
  if (iVar1 == -1) {
    iVar1 = 0;
  }
  else if (-1 < iVar1) {
    ...
    if (((iVar1 == 0) ||
        (iVar1 = FUN_80253c3c(param_1,(byte *)((&DAT_803afec0)[param_1 * 0x44] + 0x200),
                              *(int *)(&DAT_803afe54 + iVar2),1), iVar1 == 0)) ||
       (iVar1 = FUN_80253cdc(param_1,*(uint *)(&DAT_803afef4 + iVar2),0x200,
                             *(int *)(&DAT_803afee4 + iVar2),&LAB_8025e80c), iVar1 == 0)) {
      *(undefined4 *)(&DAT_803aff08 + iVar2) = 0;
