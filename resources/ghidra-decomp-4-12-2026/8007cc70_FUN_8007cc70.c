...

{
  ...
  local_5c = FLOAT_803dfb6c;
  local_58 = FLOAT_803dfb5c;
  local_54 = FLOAT_803dfb5c;
  local_50 = FLOAT_803dfb5c;
  local_4c = FLOAT_803dfb6c;
  local_48 = FLOAT_803dfb5c;
  cVar1 = FUN_8004c3c4();
  if (cVar1 == '\0') {
    (**(code **)(*DAT_803dd6d8 + 0x40))
              (&DAT_803dc2e0,0x803dc2e1,0x803dc2e2,auStack_70,auStack_70,auStack_70);
    _DAT_803dc2e0 =
         CONCAT31(CONCAT21(CONCAT11((char)((int)(_DAT_803dc2e0 >> 0x18) >> 3),
                                    (char)((int)(_DAT_803dc2e0 >> 0x10 & 0xff) >> 3)),
                           (char)((int)(_DAT_803dc2e0 >> 8 & 0xff) >> 3)),DAT_803dc2d8);
  }
  else {
    _DAT_803dc2e0 =
  ...
  local_68 = _DAT_803dc2e0;
  FUN_8025c428(3,(byte *)&local_68);
  local_6c = DAT_803dc2e4;
  ...
  FUN_8025b94c(1,0,0,7,2,0,0,0,0,3);
  FUN_8025be54(1);
  FUN_8025a5bc(1);
  FUN_80258944(3);
  FUN_8025ca04(2);
