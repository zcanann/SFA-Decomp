...

{
  ...
  if (puVar1 != *(undefined4 **)(DAT_803dda44 + 4)) {
    if (puVar1 == (undefined4 *)0x0) {
      ...
      *(short *)((int)puVar1 + 0xe) = *(short *)((int)puVar1 + 0xe) + -1;
      if ((*(short *)((int)puVar1 + 0xe) == 0) &&
         (iVar3 = 0, iVar2 = DAT_803dda44, iVar6 = DAT_803dda3c, 0 < DAT_803dda3c)) {
        do {
              ...
              if ((puVar5 < &DAT_80000000) || ((undefined4 *)0x9fffffff < puVar5)) {
                ...
                if (puVar5 != (undefined4 *)0x0) {
                  ...
                  if (*(char *)(puVar5 + 0x12) != '\0') {
                    FUN_8006cc4c((undefined *)puVar5[0x10]);
                  }
                  if (*(char *)((int)puVar5 + 0x49) == '\0') {
                    FUN_800238c4((uint)puVar5);
                  }
                }
              }
            }
            if (*(char *)(puVar1 + 0x12) != '\0') {
              FUN_8006cc4c((undefined *)puVar1[0x10]);
            }
            if (*(char *)((int)puVar1 + 0x49) == '\0') {
              FUN_800238c4((uint)puVar1);
            }
            *(undefined4 *)(DAT_803dda44 + iVar3 * 0x10) = 0xffffffff;
            *(undefined4 *)(DAT_803dda44 + iVar3 * 0x10 + 4) = 0;
            break;
          }
          iVar2 = iVar2 + 0x10;
          iVar3 = iVar3 + 1;
