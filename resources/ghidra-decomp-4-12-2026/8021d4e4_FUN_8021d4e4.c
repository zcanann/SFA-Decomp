...

{
  ...
  *(float *)(iVar3 + 0x118) =
       (float)((double)CONCAT44(0x43300000,(int)param_2[0xd] ^ 0x80000000) - DOUBLE_803e76f8);
  fVar2 = FLOAT_803e76d4;
  *(float *)(iVar3 + 0x110) = FLOAT_803e76d4;
