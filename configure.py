...
config.libs = [
    ...
    MSLLib(
        ...
        [
            ...
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/math_float_helpers.c", mw_version="GC/1.2.5n", extra_cflags=["-inline", "off", *msl_math_extra], progress_category="game"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/math_802927a4.c", mw_version="GC/1.2.5n", cflags=msl_math_o0_cflags, extra_cflags=["-O0", "-opt", "peephole", "-inline", "auto", "-use_lmw_stmw", "on", *msl_math_extra], progress_category="game"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/math_80293da4.c", mw_version="GC/1.2.5n", cflags=msl_math_o0_cflags, extra_cflags=["-O0", "-opt", "peephole", "-inline", "auto", *msl_math_extra], progress_category="game"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/math_8029454c.c", mw_version="GC/1.2.5n", cflags=msl_math_o0_cflags, extra_cflags=["-O0", "-opt", "peephole", "-inline", "auto", "-sym", "on", *msl_math_extra], progress_category="game"),
        ],
    ),
    {
        "lib": "musyx",
    ...
    },
    {
        ...
        "progress_category": "game",
            ...
            Object(MatchingFor("GSAE01"), "main/math_80292d3c.c", mw_version="GC/1.2.5n", cflags=msl_math_o0_cflags, extra_cflags=["-O0", "-inline", "auto", *msl_math_extra], progress_category="game"),
            Object(MatchingFor("GSAE01"), "main/reciprocal.c", mw_version="GC/1.2.5n", cflags=msl_math_o0_cflags, extra_cflags=["-O0", "-opt", "peephole", "-inline", "auto", *msl_math_extra], progress_category="game"),
            Object(MatchingFor("GSAE01"), "main/trig_float_helpers.c", mw_version="GC/1.2.5n", cflags=msl_math_o0_cflags, extra_cflags=["-O0", "-opt", "peephole,functions", "-inline", "auto", *msl_math_extra], progress_category="game"),
            Object(MatchingFor("GSAE01"), "main/math_8029312c.c", mw_version="GC/1.2.5n", cflags=msl_math_o0_cflags, extra_cflags=["-O0", "-inline", "auto", *msl_math_extra], progress_category="game"),
            Object(MatchingFor("GSAE01"), "main/acosf.c", mw_version="GC/1.2.5n", cflags=msl_math_o0_cflags, extra_cflags=["-O0", "-opt", "peephole", "-inline", "auto", "-sym", "on", *msl_math_extra], progress_category="game"),
            Object(MatchingFor("GSAE01"), "main/trig.c", mw_version="GC/1.2.5n", cflags=msl_math_o0_cflags, extra_cflags=["-O0", "-opt", "peephole", "-inline", "auto", "-sym", "on", *msl_math_extra], progress_category="game"),
            Object(MatchingFor("GSAE01"), "main/sincosf.c", mw_version="GC/1.2.5n", cflags=msl_math_o0_cflags, extra_cflags=["-O0", "-opt", "peephole,functions", "-inline", "auto", "-sym", "on", *msl_math_extra], progress_category="game"),
        ],
    },
]
