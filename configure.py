...
config.libs = [
    ...
    MSLLib(
        ...
        [
            ...
            Object(MatchingFor("GSAE01"), "dolphin/MSL_C/PPCEABI/bare/H/hyperbolicsf.c", extra_cflags=["-lang=c++"]),
            ...
            Object(MatchingFor("GSAE01"), "dolphin/MSL_C/PPCEABI/bare/H/float.c"),
            Object(Matching, "dolphin/MSL_C/PPCEABI/bare/H/exponentialsf.c", extra_cflags=["-O3,p", "-opt", "nopeephole"]),
            ...
            Object(MatchingFor("GSAE01"), "dolphin/MSL_C/PPCEABI/bare/H/math_float_helpers.c", mw_version="GC/1.2.5", extra_cflags=["-inline", "off", *msl_math_extra], progress_category="game"),
            ...
            Object(NonMatching, "dolphin/MSL_C/PPCEABI/bare/H/math_8029454c.c", mw_version=config.compiler_version, cflags=msl_math_o0_cflags, extra_cflags=["-O0", "-opt", "peephole", "-inline", "auto", "-sym", "on", *msl_math_extra], progress_category="game"),
        ],
    ),
    {
        "lib": "musyx",
