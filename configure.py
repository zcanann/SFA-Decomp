...
config.libs = [
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "main/audio/synth_callback.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            Object(MatchingFor("GSAE01"), "main/audio/synth_channel.c", mw_version="GC/1.2.5n"),
            Object(NonMatching, "main/audio/synth_handle.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            ...
            Object(NonMatching, "main/audio/synth_control.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            Object(NonMatching, "main/audio/snd_synth_api.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            Object(NonMatching, "main/audio/mcmd_volume.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            Object(NonMatching, "main/audio/voice_prio.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            Object(MatchingFor("GSAE01"), "main/audio/vid_init.c", mw_version="GC/1.2.5n"),
            Object(NonMatching, "main/audio/synth_vsamples.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            ...
            Object(NonMatching, "main/gametext.c", cflags=cflags_dll_noopt_noinline),
            ...
            Object(NonMatching, "main/audio/snd_service.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            Object(NonMatching, "main/audio/hw_init.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            Object(NonMatching, "main/audio/hw_adsr.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            Object(MatchingFor("GSAE01"), "main/audio/hw_voice_params.c", mw_version="GC/1.2.5n"),
            Object(NonMatching, "main/audio/hw_voice_start.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            Object(NonMatching, "main/audio/hw_input.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            Object(NonMatching, "main/audio/hw_aram.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            Object(NonMatching, "main/audio/hw_samplemem.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            ...
            Object(NonMatching, "main/lightmap.c", cflags=cflags_dll_noopt_noprop),
            ...
            Object(NonMatching, "main/light.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/main.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/dll_023F_dbegg.c", cflags=cflags_dll_noopt_noloopinv),
            ...
            Object(NonMatching, "main/track_dolphin.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/expgfx.c", cflags=cflags_dll_noopt_noloopinv),
            ...
            Object(NonMatching, "main/dll/dll_000D_playershadow.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/dll_001D_effect4.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/dll_000F_unk.c", cflags=cflags_dll_noopt_nocse),
            ...
            Object(NonMatching, "main/dll/dll_009A_dll9afunc0.c", cflags=cflags_dll_noopt_noprop),
            Object(MatchingFor("GSAE01"), "main/dll/dll_009B_dll9bfunc0.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/dll_009C_dll9cfunc0.c", cflags=cflags_dll_noopt, extra_cflags=["-opt", "level=2"]),
            ...
            Object(NonMatching, "main/dll/dll_0045_camTalk.c", cflags=cflags_dll_noopt_noprop),
            ...
            Object(NonMatching, "main/dll/camshipbattle5c.c", cflags=cflags_dll_noopt_nocse),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_0019_dll19func0.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/skeetla.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/trickyfollow.c", cflags=cflags_dll_noopt_nocse_noloopinv),
            Object(NonMatching, "main/dll/mmp_cratercritter.c", cflags=cflags_dll_nosched),
            ...
            Object(NonMatching, "main/dll/animobjd2.c", cflags=[*cflags_base, "-opt", "nopeephole,noschedule,nocse,nopropagation,noloopinvariants"]),
            ...
            Object(NonMatching, "main/dll/dll_00CA_icebaddie.c", cflags=cflags_dll_noopt_noautoinline),
            ...
            Object(NonMatching, "main/dll/dll_00CB_dllcb.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/grimblegroup.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/DIM/dll_00C7_dim2roofrub.c", cflags=cflags_dll_noopt_noprop),
            ...
            Object(NonMatching, "main/dll/dll_00EF_pushable.c", cflags=cflags_dll_noopt_noinline),
            ...
            Object(NonMatching, "main/dll/dll_0158_gunpowderbarrel.c", cflags=cflags_dll_noopt_noinline),
            ...
            Object(NonMatching, "main/dll/dll_017F_moonseedbush.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/DIM/dll_01E2_dimbosstonsil.c", cflags=cflags_dll_noopt_noprop),
            ...
            Object(NonMatching, "main/dll/dll_801c0bf8.c", cflags=cflags_dll_nosched),
            ...
            Object(NonMatching, "main/dll/NW/dll_01A2_nwtricky.c", cflags=cflags_dll_noopt_noloopinv),
            ...
            Object(NonMatching, "main/snowclaw.c", cflags=cflags_dll_noopt_noinline),
            ...
            Object(NonMatching, "main/dll/WC/dll_0290_wcpushblock.c", cflags=[*cflags_base, "-opt", "nopeephole,noschedule,nocse,nodeadstore"]),
            ...
            Object(NonMatching, "main/audio/mcmd_wait.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            Object(NonMatching, "main/audio/mcmd_loop.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            Object(NonMatching, "main/audio/mcmd_setup.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            ...
            Object(NonMatching, "main/audio/voice_id.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on", "-O2"]),
            Object(MatchingFor("GSAE01"), "main/audio/voice_unregister.c", mw_version="GC/1.2.5n"),
            Object(NonMatching, "main/audio/snd_groups.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            Object(NonMatching, "main/audio/sal_studio.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            Object(NonMatching, "main/audio/hw_dspctrl.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            Object(NonMatching, "main/audio/sal_volume.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on", "-fp_contract", "off"]),
            Object(NonMatching, "main/audio/snd3dgroup.c", mw_version="GC/1.2.5n", extra_cflags=["-fp_contract", "off", "-Cpp_exceptions", "on"]),
            ...
            Object(NonMatching, "main/audio/hw_volume.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            Object(NonMatching, "main/audio/hw_stream.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            Object(NonMatching, "main/audio/aram_queue.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            Object(NonMatching, "main/audio/aram_init.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            Object(NonMatching, "main/audio/aram_data.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            Object(NonMatching, "main/audio/sal_ai.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            Object(NonMatching, "main/audio/sal_dsp.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            Object(NonMatching, "main/audio/snd_reverb.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
