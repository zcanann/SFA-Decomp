...
config.libs = [
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "main/fileio.c", cflags=cflags_dll_noopt_noloopinv),
            ...
            Object(NonMatching, "main/objseq.c", cflags=cflags_dll_noopt_noloopinv),
            ...
            Object(NonMatching, "main/dll/dll_00FE_magicplant.c", cflags=cflags_dll_noopt_nocse),
