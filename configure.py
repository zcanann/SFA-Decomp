...
config.libs = [
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "main/modelEngine.c", cflags=cflags_dll_noopt_noautoinline),
            Object(NonMatching, "main/pad.c", cflags=cflags_dll_noopt_nocse),
            Object(NonMatching, "main/fileio.c", cflags=cflags_dll_noopt_noloopinv_noautoinline),
            ...
            Object(NonMatching, "main/dll/duster_wb.c", cflags=cflags_dll_noopt_noautoinline),
            ...
            Object(NonMatching, "main/dll/dll_00CD_iceball.c", cflags=cflags_dll_noopt_noautoinline),
            ...
            Object(NonMatching, "main/dll/cfdoorlightgroup.c", cflags=cflags_dll_noopt_noautoinline),
            ...
            Object(NonMatching, "main/dll/dll_0139_hitanimator.c", cflags=cflags_dll_noopt_noautoinline),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/DIM/dll_01DD_dim2icicle.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/dll_01AA_bombplantspore.c", cflags=cflags_dll_noopt_noautoinline),
            ...
            Object(NonMatching, "main/dll/SH/dll_01B1_shstaff.c", cflags=cflags_dll_noopt_noautoinline),
            ...
            Object(NonMatching, "main/dll/dll_0273_firepipe.c", cflags=cflags_dll_noopt_noautoinline),
            ...
            Object(NonMatching, "main/dll/WC/dll_028D_wclevelcont.c", cflags=cflags_dll_noopt_noautoinline),
            ...
            Object(NonMatching, "main/audio/snd_groups.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on", "-inline", "noauto"]),
            ...
            Object(NonMatching, "main/audio/snd3dgroup.c", mw_version="GC/1.2.5n", extra_cflags=["-fp_contract", "off", "-Cpp_exceptions", "on", "-inline", "noauto"]),
