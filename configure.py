...
config.libs = [
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "main/dll/WM/dll_0212_wmnewcrystal.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/df_partfx.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/CAM/dll_59.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/dll_36.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/projswitch.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/texframeanimator.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/lightning.c"),
            Object(NonMatching, "main/dll/dll_138.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/transporter.c"),
            Object(NonMatching, "main/dll/autoTransporter.c"),
            Object(NonMatching, "main/dll/sidekickball.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/cloudprisoncontrol.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/MMP/mmp_barrel.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/DR/cannontargetControl.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/vfp_lavastar.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/riverFlowRelated018D.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/dll_19C.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/dll_19E.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/dimbarrier.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/creator1C6.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/scene1C7.c"),
            Object(NonMatching, "main/dll/flybaddie.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/torch1CD.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/shrine1CE.c"),
            Object(NonMatching, "main/dll/creator1CF.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/worldobj.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/WM/deaddino.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/fruit.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/proximitymine.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/proximitymine_update.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/proximitymine_init.c", cflags=cflags_dll_noopt),
