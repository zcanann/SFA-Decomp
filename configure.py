...
config.libs = [
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "main/gameloop.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/vecmath.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/dll_0242_dbstealerworm.c", cflags=cflags_dll_noopt_noinline),
            ...
            Object(NonMatching, "main/objlib.c", cflags=cflags_dll_nosched),
            ...
            Object(NonMatching, "main/dll/dll_025B_msplantings.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/DR/dll_0250_ktrex.c", cflags=cflags_dll_noopt_noinline),
