...
config.libs = [
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "main/dll/dll_0157_spiritdoorspirit.c", cflags=cflags_dll_noopt_nocse),
            ...
            Object(NonMatching, "main/dll/dll_018C_mmshshrine.c", cflags=cflags_dll_noopt_nolifetimes_noautoinline),
