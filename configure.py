...
config.libs = [
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "main/dll/DF/dll_196.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/DF/DFmole.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/DF/DFwhirlpool.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/DF/dll_198.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/DF/dll_199.c"),
            Object(NonMatching, "main/dll/DF/DFlantern.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/DR/DRpulley.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/DR/DRhalolight.c", cflags=cflags_dll_noopt),
