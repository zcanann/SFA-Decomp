...
def dll_opt_cflags(opt=None, inline_off=False, exceptions_on=False, fp_contract_off=False):
    flags = list(cflags_base)
    if inline_off:
        flags = [f for f in flags if f != "-inline auto"]
        flags += ["-inline", "off"]
    if exceptions_on:
        flags = [f for f in flags if f != "-Cpp_exceptions off"]
        flags += ["-Cpp_exceptions", "on"]
    if opt:
        flags += ["-opt", opt]
    return flags
...
config.libs = [
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_000C_projgfx.c", cflags=dll_opt_cflags(opt="noschedule")),
            Object(MatchingFor("GSAE01"), "main/dll/dll_000D_playershadow.c", cflags=dll_opt_cflags(opt="nopeephole,noschedule")),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_0010_uicontroller.c", cflags=dll_opt_cflags(opt="nopeephole,noschedule")),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_004F_dll4f.c", cflags=dll_opt_cflags(opt="nopeephole,noschedule")),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_0057_cameramodetitle.c", cflags=dll_opt_cflags(opt="nopeephole,noschedule")),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_0038_weirdunusedmenu.c", cflags=dll_opt_cflags(opt="nopeephole,noschedule")),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0039_dummy39.c", cflags=dll_opt_cflags(opt="nopeephole,noschedule")),
            Object(NonMatching, "main/dll/dll_003A_dummy3a.c"),
            Object(MatchingFor("GSAE01"), "main/dll/dll_8011d918.c", cflags=dll_opt_cflags(opt="noschedule")),
            Object(NonMatching, "main/dll/dll_0000_gameui.c", cflags=cflags_dll_noopt, extra_cflags=["-inline", "noauto"]),
            Object(MatchingFor("GSAE01"), "main/dll/dll_003B_menu.c", cflags=dll_opt_cflags(opt="nopeephole,noschedule")),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_003F_dll3f.c", cflags=dll_opt_cflags(opt="nopeephole,noschedule")),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0040_credits.c", cflags=dll_opt_cflags(opt="nostrength,nopeephole,noschedule")),
            ...
            Object(NonMatching, "main/dll/kooshy.c", cflags=cflags_dll_noopt),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_00CC_chukchuk.c", cflags=dll_opt_cflags(opt="nopropagation,nopeephole,noschedule", inline_off=True)),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_00CF_cannonclaw.c", cflags=dll_opt_cflags(opt="nopeephole,noschedule")),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_0109_unk.c", cflags=dll_opt_cflags(opt="nopeephole,noschedule")),
            Object(MatchingFor("GSAE01"), "main/dll/dll_010A_fallladders.c", cflags=dll_opt_cflags(opt="nopeephole,noschedule")),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0119_coldwatercontrol.c", cflags=dll_opt_cflags(opt="nopeephole,noschedule")),
            Object(MatchingFor("GSAE01"), "main/dll/dll_00EC_infopoint.c", cflags=dll_opt_cflags(opt="nopeephole,noschedule")),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_0137_alphaanimator.c", cflags=dll_opt_cflags(opt="nopeephole,noschedule")),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_013A_visanimator.c", cflags=dll_opt_cflags(opt="nopeephole,noschedule")),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_0157_spiritdoorspirit.c", cflags=dll_opt_cflags(opt="nopeephole,noschedule")),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/MMP/dll_0180_mmpasteroidre.c", cflags=dll_opt_cflags(opt="nopeephole,noschedule")),
            Object(NonMatching, "main/dll/MMP/dll_0182_mmpmoonrock.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/MMP/dll_0181_mmptrenchfx.c", cflags=dll_opt_cflags(opt="nopeephole,noschedule")),
            Object(MatchingFor("GSAE01"), "main/dll/MMP/dll_0183_mmpgyservent.c", cflags=dll_opt_cflags(opt="nopeephole,noschedule")),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0184_animsharpclaw.c", cflags=dll_opt_cflags(opt="nopeephole,noschedule", inline_off=True)),
            Object(NonMatching, "main/dll/dll_025B_msplantings.c"),
            Object(MatchingFor("GSAE01"), "main/dll/CC/dll_0185_ccgasvent.c", cflags=dll_opt_cflags(opt="nopeephole,noschedule")),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/CC/dll_0189_ccsharpclawpad.c", cflags=dll_opt_cflags(opt="nopeephole,noschedule")),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_801ac01c.c", cflags=dll_opt_cflags(opt="noschedule")),
            Object(MatchingFor("GSAE01"), "main/dll/IM/dll_0169_imicemountain.c", cflags=dll_opt_cflags(opt="nopeephole,noschedule")),
            Object(NonMatching, "main/dll/dll_016A_crrockfall.c"),
            Object(MatchingFor("GSAE01"), "main/dll/dll_016B_magiclight.c", cflags=dll_opt_cflags(opt="nopeephole,noschedule")),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/DIM/dll_01CB_dimwooddoor2.c", cflags=dll_opt_cflags(opt="nopeephole,noschedule")),
            Object(MatchingFor("GSAE01"), "main/dll/dll_01CE_dll1ce.c", cflags=dll_opt_cflags(opt="nostrength,nopeephole,noschedule")),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_801b9ecc.c", cflags=dll_opt_cflags(opt="nopeephole,noschedule")),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/DR/dll_0281_drearthcal.c", cflags=dll_opt_cflags(opt="nopeephole,noschedule")),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/ARW/dll_029D_arwarwinggu.c", cflags=dll_opt_cflags(opt="nopeephole,noschedule")),
