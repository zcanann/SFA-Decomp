...
config.libs = [
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(MatchingFor("GSAE01"), "main/dll/WM/dll_0212_wmnewcrystal.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/CAM/camslide.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/CAM/firstperson.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/dll_4A.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/DR/gasvent.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/DF/dll_194.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/WM/WMcrystal.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/DR/DRcradle.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/ARW/ARWarwingattachment.c", cflags=cflags_dll_noopt),
