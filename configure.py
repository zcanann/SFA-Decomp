...
config.libs = [
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "main/dll/dll_000F_unk.c", cflags=cflags_dll_noopt_nocse_noautoinline),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_80198a00.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/dll_0266_kytesmum.c", cflags=cflags_dll_noopt_noautoinline),
