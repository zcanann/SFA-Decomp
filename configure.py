...
config.libs = [
    {
        ...
        "progress_category": "sdk",
        "objects": [
            Object(NonMatching, "Runtime.PPCEABI.H/__start.c", cflags=cflags_runtime_125),
    ...
    DolphinLib(
        ...
        [
            ...
            Object(NonMatching, "dolphin/axfx/reverb_std_create.c"),
        ],
    ),
    {
        "lib": "vi",
    ...
    MSLLib(
        ...
        [
            ...
            Object(NonMatching, "dolphin/MSL_C/PPCEABI/bare/H/math_float_helpers.c", extra_cflags=["-inline", "off", *msl_math_extra], progress_category="game"),
            Object(NonMatching, "dolphin/MSL_C/PPCEABI/bare/H/math_802927a4.c", cflags=msl_math_o0_cflags, extra_cflags=["-O0", "-opt", "peephole", "-inline", "auto", "-use_lmw_stmw", "on", *msl_math_extra], progress_category="game"),
            Object(NonMatching, "dolphin/MSL_C/PPCEABI/bare/H/math_80293da4.c", cflags=msl_math_o0_cflags, extra_cflags=["-O0", "-opt", "peephole", "-inline", "auto", *msl_math_extra], progress_category="game"),
            Object(NonMatching, "dolphin/MSL_C/PPCEABI/bare/H/math_8029454c.c", cflags=msl_math_o0_cflags, extra_cflags=["-O0", "-opt", "peephole", "-inline", "auto", "-sym", "on", *msl_math_extra], progress_category="game"),
        ],
    ),
    {
        "lib": "musyx",
        ...
        "progress_category": "third_party",
        "objects": [
            Object(NonMatching, "musyx/runtime/synth_callback.c"),
            Object(NonMatching, "musyx/runtime/synth_queue.c"),
            Object(MatchingFor("GSAE01"), "musyx/runtime/synth_channel.c"),
            Object(NonMatching, "musyx/runtime/synth_handle.c"),
            Object(NonMatching, "musyx/runtime/synth_seq_events.c"),
            ...
            Object(NonMatching, "musyx/runtime/synth_control.c"),
            Object(NonMatching, "musyx/runtime/snd_synth_api.c"),
            Object(NonMatching, "musyx/runtime/synth_job_init.c"),
            Object(NonMatching, "musyx/runtime/synth_jobs.c"),
            Object(NonMatching, "musyx/runtime/data_tables.c"),
            Object(NonMatching, "musyx/runtime/mcmd_wait.c"),
            Object(NonMatching, "musyx/runtime/mcmd_loop.c"),
            Object(NonMatching, "musyx/runtime/mcmd_setup.c"),
            Object(NonMatching, "musyx/runtime/mcmd_volume.c"),
            ...
            Object(NonMatching, "musyx/runtime/snd_groups.c", extra_cflags=["-inline", "noauto"]),
            Object(NonMatching, "musyx/runtime/sal_studio.c"),
            Object(NonMatching, "musyx/runtime/hw_dspctrl.c"),
            Object(NonMatching, "musyx/runtime/sal_volume.c", extra_cflags=["-fp_contract", "off", "-inline", "all"]),
            Object(NonMatching, "musyx/runtime/snd3dgroup.c", extra_cflags=["-fp_contract", "off", "-inline", "noauto"]),
            Object(NonMatching, "musyx/runtime/snd_core.c", extra_cflags=["-fp_contract", "off"]),
            Object(NonMatching, "musyx/runtime/snd_midictrl.c"),
            Object(NonMatching, "musyx/runtime/snd_service.c"),
            Object(NonMatching, "musyx/runtime/hw_init.c"),
            Object(MatchingFor("GSAE01"), "musyx/runtime/hw_break.c"),
            Object(NonMatching, "musyx/runtime/hw_adsr.c"),
            Object(MatchingFor("GSAE01"), "musyx/runtime/hw_sample.c"),
            Object(NonMatching, "musyx/runtime/hw_voice_start.c"),
            Object(MatchingFor("GSAE01"), "musyx/runtime/hw_keyoff.c"),
            Object(NonMatching, "musyx/runtime/hw_voice_params.c"),
            Object(NonMatching, "musyx/runtime/hw_volume.c"),
            Object(NonMatching, "musyx/runtime/hw_input.c"),
            Object(NonMatching, "musyx/runtime/hw_stream.c"),
            Object(NonMatching, "musyx/runtime/hw_aram.c"),
            Object(NonMatching, "musyx/runtime/hw_samplemem.c"),
            Object(NonMatching, "musyx/runtime/aram_queue.c"),
            Object(NonMatching, "musyx/runtime/aram_init.c", section_alignments={".bss": 4}),
            Object(NonMatching, "musyx/runtime/aram_data.c"),
            Object(NonMatching, "musyx/runtime/sal_ai.c"),
            Object(NonMatching, "musyx/runtime/sal_dsp.c"),
            Object(NonMatching, "musyx/runtime/sal_dsp_irqinit.c", extra_cflags=["-opt", "noschedule"]),
            Object(NonMatching, "musyx/runtime/sal_dsp_irq.c"),
            Object(NonMatching, "musyx/runtime/snd_reverb.c"),
        ],
    },
    {
        "lib": "main",
