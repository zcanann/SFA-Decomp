...
config.libs = [
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "main/dll/DIM/dimsnowball_init.c"),
            ...
            Object(NonMatching, "main/modelEngine.c"),
            Object(NonMatching, "main/pad.c"),
            ...
            Object(NonMatching, "main/newclouds.c"),
            ...
            Object(NonMatching, "main/dll/WM/dll_020F_wmspiritset.c"),
            Object(NonMatching, "main/dll/WM/dll_0210_wmplanets.c"),
            Object(NonMatching, "main/dll/WM/dll_0211_wmwallcrawler.c"),
            Object(NonMatching, "main/dll/WM/dll_0212_wmnewcrystal.c"),
            Object(NonMatching, "main/dll/VF/dll_0216_vfplevelcontrol.c"),
            Object(NonMatching, "main/dll/VF/dll_0217_vfpobjcreator.c"),
            Object(NonMatching, "main/dll/VF/dll_0218_vfpminifire.c"),
            Object(NonMatching, "main/dll/VF/dll_0219.c"),
            Object(NonMatching, "main/dll/VF/dll_021A_vfpstatueball.c"),
            Object(NonMatching, "main/dll/VF/dll_021B.c"),
            Object(NonMatching, "main/dll/VF/dll_021C_vfpladders.c"),
            ...
            Object(NonMatching, "main/dll/player.c"),
            Object(NonMatching, "main/dll/dll_01B5_lightfoot.c"),
            Object(NonMatching, "main/dll/DIM/dll_0256_dimsnowhorn1.c"),
            Object(NonMatching, "main/dll/DIM/dll_01D9_dim2prisonmammoth.c"),
            Object(NonMatching, "main/dll/DR/dll_0077_DR_EarthWarrior.c"),
            ...
            Object(NonMatching, "main/dll/CAM/attention.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/CAM/camstatic.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/CAM/pathcam.c"),
            Object(NonMatching, "main/dll/CAM/camshipbattle.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/CAM/camclimb.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/tumbleweedbush.c"),
            ...
            Object(NonMatching, "main/dll/cf_doorlight.c"),
            Object(NonMatching, "main/dll/texscroll2.c"),
            Object(NonMatching, "main/dll/campfire.c"),
            Object(NonMatching, "main/dll/wallanimator.c"),
            Object(NonMatching, "main/dll/xyzanimator.c"),
            Object(NonMatching, "main/dll/genprops.c"),
            Object(NonMatching, "main/dll/gfxEmit.c"),
            Object(NonMatching, "main/dll/texframeanimator.c"),
            Object(NonMatching, "main/dll/lightning.c"),
            ...
            Object(NonMatching, "main/dll/babycloudrunner.c"),
            Object(NonMatching, "main/dll/dll_14D.c"),
            Object(NonMatching, "main/dll/cfprisonuncle.c"),
            Object(NonMatching, "main/dll/gcrobotlightbea.c"),
            Object(NonMatching, "main/dll/cfperch.c"),
            Object(NonMatching, "main/dll/blasted.c"),
            Object(NonMatching, "main/dll/explodable.c"),
            Object(NonMatching, "main/dll/cfforcefield.c"),
            Object(NonMatching, "main/dll/CF/CFguardian.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/CF/windlift.c"),
            Object(NonMatching, "main/dll/CF/CFcrystal.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/CF/CFBaby.c"),
            Object(NonMatching, "main/dll/CF/CFPrisonGuard.c"),
            Object(NonMatching, "main/dll/CF/dll_163.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/CF/dll_165.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/CF/dll_166.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/CF/dll_179.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/mmp_asteroid_re.c"),
            Object(NonMatching, "main/dll/holoPoint.c"),
            Object(NonMatching, "main/dll/mmp_moonrock.c"),
            ...
            Object(NonMatching, "main/dll/vfp_lavapool.c"),
            Object(NonMatching, "main/dll/vfp_lavastar.c"),
            Object(NonMatching, "main/dll/riverFlowRelated018D.c"),
            Object(NonMatching, "main/dll/mmsh_waterspike.c"),
            ...
            Object(NonMatching, "main/dll/dim_bossgut.c"),
            ...
            Object(NonMatching, "main/dll/infopoint.c"),
            ...
            Object(NonMatching, "main/worldplanet_lighting.c"),
            Object(NonMatching, "main/worldplanet.c"),
            Object(NonMatching, "main/worldobj.c"),
            Object(NonMatching, "main/snowclaw.c"),
            ...
            Object(NonMatching, "main/proximitymine_reset.c"),
            Object(NonMatching, "main/proximitymine.c"),
            Object(NonMatching, "main/proximitymine_update.c"),
            Object(NonMatching, "main/proximitymine_init.c"),
            Object(NonMatching, "main/dll/DR/dll_024F_kt_rexlevel.c"),
            Object(NonMatching, "main/dll/DR/obj_008A_kt_rex.c"),
            Object(NonMatching, "main/dll/DR/dll_0251_kt_rexfloorswitch.c"),
            Object(NonMatching, "main/dll/DR/dll_0252_kt_lazerwall.c"),
            Object(NonMatching, "main/dll/DR/dll_0253_kt_lazerlight.c"),
            Object(NonMatching, "main/dll/DR/dll_0254_kt_fallingrocks.c"),
            Object(NonMatching, "main/dll/DR/dll_0261_dr_lasercannon.c"),
            Object(NonMatching, "main/dll/DR/dll_0262_drakormissile.c"),
            Object(NonMatching, "main/dll/DR/dll_0263_gm_mazewell.c"),
            Object(NonMatching, "main/dll/DR/dll_0266_kytesmum.c"),
            Object(NonMatching, "main/dll/DR/dll_0265_dr_creator.c"),
            Object(NonMatching, "main/dll/DR/dll_0268_dr_cagecontrol.c"),
            Object(NonMatching, "main/dll/DR/dll_0269_explodeplan.c"),
            Object(NonMatching, "main/dll/DR/dll_026B_dr_chimmey.c"),
            Object(NonMatching, "main/dll/DR/dll_026C_dr_cagewith.c"),
            Object(NonMatching, "main/dll/DR/dll_026E_dr_shackle.c"),
            Object(NonMatching, "main/dll/DR/dll_0271_drakorhoverpad.c"),
            Object(NonMatching, "main/dll/DR/dll_0272_hightop.c"),
            Object(NonMatching, "main/dll/DR/dll_026F_dr_generator.c"),
            Object(NonMatching, "main/dll/firepipe.c"),
            Object(NonMatching, "main/dll/DR/dll_0279_dr_energydisc.c"),
            Object(NonMatching, "main/dll/DR/dll_027C_dr_lightbea.c"),
            ...
            Object(NonMatching, "main/dll/WC/dll_028D_wclevelcont.c"),
            Object(NonMatching, "main/dll/WC/dll_028E_wcbeacon.c"),
            ...
            Object(NonMatching, "main/dll/WC/dll_0296_wctempledia.c"),
            Object(NonMatching, "main/dll/WC/dll_0297_wctemplebri.c"),
            Object(NonMatching, "main/dll/WC/dll_0298_wcfloortile.c"),
            Object(NonMatching, "main/dll/ARW/dll_029A_arwarwing.c"),
            Object(NonMatching, "main/dll/ARW/dll_029B_arwingandrossstuff.c"),
            ...
            Object(NonMatching, "main/dll/LGT/dll_02AB_projectedlight.c"),
            Object(NonMatching, "main/dll/LGT/dll_02AC_controllight.c"),
            Object(NonMatching, "main/dll/softbody.c"),
            Object(NonMatching, "main/dll/waterflowwe.c"),
            Object(NonMatching, "main/dll/tree.c"),
            Object(NonMatching, "main/dll/brokenpipe.c"),
            Object(NonMatching, "main/dll/cmbsrc.c"),
            Object(NonMatching, "main/dll/dustmotesou.c"),
            Object(NonMatching, "main/dll/vortex.c"),
            Object(NonMatching, "main/dll/cntcounter.c"),
            Object(NonMatching, "main/dll/timer.c"),
            Object(NonMatching, "main/dll/cnthitobjec.c"),
            Object(NonMatching, "main/dll/mcupgrade.c"),
            Object(NonMatching, "main/dll/mcupgradema.c"),
            Object(NonMatching, "main/dll/mcstaffeffe.c"),
            Object(NonMatching, "main/dll/mclightning.c"),
            Object(NonMatching, "main/dll/gf_levelcon.c"),
            Object(NonMatching, "main/dll/andross.c"),
            Object(NonMatching, "main/dll/androsshand.c"),
            Object(NonMatching, "main/dll/androssbrain.c"),
            Object(NonMatching, "main/dll/androssligh.c"),
