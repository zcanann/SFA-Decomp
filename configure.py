...
config.libs = [
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_0107_unused.c", cflags=cflags_dll_noopt),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_0123_fuelcell.c", cflags=cflags_dll_noopt),
