...
config.libs = [
    ...
    MSLLib(
        ...
        [
            ...
            Object(NonMatching, "MSL_C/PPCEABI/bare/H/math_float_helpers.c", mw_version=config.compiler_version, extra_cflags=["-inline", "off", *msl_math_extra], progress_category="game"),
            Object(NonMatching, "MSL_C/PPCEABI/bare/H/math_802927a4.c", mw_version=config.compiler_version, cflags=msl_math_o0_cflags, extra_cflags=["-O0", "-opt", "peephole", "-inline", "auto", "-use_lmw_stmw", "on", *msl_math_extra], progress_category="game"),
            Object(NonMatching, "MSL_C/PPCEABI/bare/H/math_80293da4.c", mw_version=config.compiler_version, cflags=msl_math_o0_cflags, extra_cflags=["-O0", "-opt", "peephole", "-inline", "auto", *msl_math_extra], progress_category="game"),
            Object(NonMatching, "MSL_C/PPCEABI/bare/H/math_8029454c.c", mw_version=config.compiler_version, cflags=msl_math_o0_cflags, extra_cflags=["-O0", "-opt", "peephole", "-inline", "auto", "-sym", "on", *msl_math_extra], progress_category="game"),
        ],
    ),
    {
        "lib": "musyx",
    ...
    },
    {
        ...
        "progress_category": "game",
            ...
            Object(NonMatching, "main/trig.c", cflags=msl_math_o0_cflags, extra_cflags=["-O0", "-opt", "peephole", "-inline", "auto", "-sym", "on", *msl_math_extra], progress_category="game"),
            Object(NonMatching, "main/sincosf.c", cflags=msl_math_o0_cflags, extra_cflags=["-O0", "-opt", "peephole", "-inline", "auto", "-sym", "on", *msl_math_extra], progress_category="game"),
        ],
    },
]
