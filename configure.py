...
config.libs = [
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "main/dll/CF/windlift.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/DIM/DIM2flameburst.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/LGT/LGTprojectedlight.c", cflags=cflags_dll_noopt),
