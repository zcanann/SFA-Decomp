...
config.libs = [
    ...
    DolphinLib(
        ...
        [
            ...
            Object(MatchingFor("GSAE01"), "thp/THPAudio.c"),
        ],
    ),
    DolphinLib(
        "OdemuExi2",
    ...
    ),
    {
        ...
        "progress_category": "sdk",
        "objects": [
            Object(MatchingFor("GSAE01"), "amcstubs/AmcExi2Stubs.c"),
        ],
    },
    {
        ...
        "objects": [
            ...
            Object(MatchingFor("GSAE01"), "TRK_MINNOW_DOLPHIN/targcont.c"),
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "audio/synth_control.c"),
        ],
    },
]
