...
config.libs = [
    ...
    DolphinLib(
        "mtx",
        [
            Object(MatchingFor("GSAE01"), "dolphin/mtx/mtx.c", source="dolphin/mtx/mtx.c", mw_version="GC/1.2.5", extra_cflags=["-DGEKKO", "-fp_contract", "off"]),
    ...
    MSLLib(
        "MSL_C",
        [
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/abort_exit.c", mw_version="GC/1.3"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/alloc.c", mw_version="GC/1.3", cflags=cflags_msl, extra_cflags=["-common", "off", "-inline", "auto,deferred"]),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/ansi_files.c", mw_version="GC/1.3"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/ansi_fp.c", mw_version="GC/1.3", extra_cflags=["-inline", "all", "-inline", "auto,deferred", "-use_lmw_stmw", "on", "-char", "signed", "-str", "pool,readonly"]),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/buffer_io.c", mw_version="GC/1.3"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/direct_io.c", mw_version="GC/1.3", extra_cflags=["-use_lmw_stmw", "on"]),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/file_io.c", mw_version="GC/1.3"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/FILE_POS.c", mw_version="GC/1.3"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/mbstring.c", mw_version="GC/1.3.2r", cflags=cflags_msl),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/mem.c", mw_version="GC/1.3"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/mem_funcs.c", mw_version="GC/1.3"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/misc_io.c"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/printf.c", mw_version="GC/1.3", extra_cflags=["-use_lmw_stmw", "on", "-char", "signed"]),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/string.c", mw_version="GC/1.3"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/wchar_io.c"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/ctype.c"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/s_copysign.c", mw_version="GC/1.3"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/s_frexp.c", mw_version="GC/1.3"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/s_ldexp.c", mw_version="GC/1.3"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/s_modf.c", mw_version="GC/1.3"),
            # Older math block: provisional MSL ownership; preserve exact TU profiles.
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/math_float_helpers.c", mw_version="GC/1.2.5n", extra_cflags=["-inline", "off", *msl_math_extra]),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/inverse_trig.c", mw_version="GC/1.2.5n", cflags=msl_math_o0_cflags, extra_cflags=["-O0", "-opt", "peephole", "-inline", "auto", "-sym", "on", *msl_math_extra]),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/power_helpers.c", mw_version="GC/1.2.5n", cflags=msl_math_o0_cflags, extra_cflags=["-O0", "-opt", "peephole", "-inline", "auto", "-use_lmw_stmw", "on", *msl_math_extra]),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/trig_reduce.c", mw_version="GC/1.2.5n", cflags=msl_math_o0_cflags, extra_cflags=["-O0", "-inline", "auto", *msl_math_extra]),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/rand.c", mw_version="GC/1.3", cflags=[*cflags_base, "-char signed"], extra_cflags=["-O0"]),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/reciprocal.c", mw_version="GC/1.2.5n", cflags=msl_math_o0_cflags, extra_cflags=["-O0", "-opt", "peephole", "-inline", "auto", *msl_math_extra]),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/angle_vectors.c", mw_version="GC/1.2.5n", cflags=msl_math_o0_cflags, extra_cflags=["-O0", "-opt", "peephole,functions", "-inline", "auto", *msl_math_extra]),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/sqrtf.c", mw_version="GC/1.2.5n", cflags=msl_math_o0_cflags, extra_cflags=["-O0", "-inline", "auto", *msl_math_extra]),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/trig16.c", mw_version="GC/1.2.5n", cflags=msl_math_o0_cflags, extra_cflags=["-O0", "-opt", "peephole", "-inline", "auto", "-sym", "on", *msl_math_extra]),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/sincosf.c", mw_version="GC/1.2.5n", cflags=msl_math_o0_cflags, extra_cflags=["-O0", "-opt", "peephole,functions", "-inline", "auto", "-sym", "on", *msl_math_extra]),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/sincos_approximations.c", mw_version="GC/1.2.5n", cflags=msl_math_o0_cflags, extra_cflags=["-O0", "-opt", "peephole", "-inline", "auto", *msl_math_extra]),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/tanf_log2.c", mw_version="GC/1.2.5n", cflags=msl_math_o0_cflags, extra_cflags=["-O0", "-opt", "peephole", "-inline", "auto", "-sym", "on", *msl_math_extra]),
            Object(MatchingFor("GSAE01"), "dolphin/base/PPCArch_weak.c", progress_category="sdk"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/ctype_funcs.c"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/uart_console_io_gcn.c", mw_version="GC/1.2.5"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/hyperbolicsf.c", extra_cflags=["-lang=c++"]),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/floorf.c"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/math_ppc.c"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/s_cos.c"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/s_atan.c"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/e_acos.c"),
            Object(NonMatching, "MSL_C/PPCEABI/bare/H/e_fmod.c"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/float.c"),
            Object(Matching, "MSL_C/PPCEABI/bare/H/exponentialsf.c", extra_cflags=["-O3,p", "-opt", "nopeephole"]),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/extras.c"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/k_rem_pio2.c"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/w_acos.c"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/w_atan2.c"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/w_fmod.c"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/w_pow.c"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/w_sqrt.c"),
            Object(MatchingFor("GSAE01"), "MSL_C/PPCEABI/bare/H/common_float_tables.c"),
            Object(MatchingFor("GSAE01", "GSAE01_rev1", "GSAJ01", "GSAP01", "GSAP01_rev1"), "MSL_C/PPCEABI/bare/H/trigf.c", mw_version="GC/1.2.5", extra_cflags=["-lang=c++"]),
        ],
    ),
    {
        "lib": "musyx",
        ...
        "progress_category": "third_party",
        "objects": [
            Object(MatchingFor("GSAE01"), "musyx/runtime/seq.c", extra_cflags=["-fp_contract", "off", "-inline", "noauto"]),
    ...
    },
    {
        ...
        "progress_category": "game",
            ...
            Object(MatchingFor("GSAE01"), "dlls/engine/6/6.c"),
            Object(MatchingFor("GSAE01"), "dlls/engine/7/7.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "dlls/engine/8/8.c"),
            Object(MatchingFor("GSAE01"), "dlls/engine/9/9.c"),
            Object(MatchingFor("GSAE01"), "dlls/engine/10_expgfx/expgfx.c", cflags=cflags_dll_noopt_noautoinline_deferred),
            Object(MatchingFor("GSAE01"), "dlls/engine/11/11.c", cflags=cflags_dll_noopt_noautoinline),
            ...
            Object(MatchingFor("GSAE01"), "dlls/engine/19/19.c", cflags=cflags_dll_noopt_noautoinline),
            Object(MatchingFor("GSAE01"), "dlls/engine/20_Hcurves/Hcurves.c"),
            Object(MatchingFor("GSAE01"), "dlls/engine/20_Hcurves/Hcurves_romcurve.c", cflags=cflags_dll_noopt_noautoinline),
            Object(MatchingFor("GSAE01"), "dlls/engine/21/21.c", cflags=cflags_dll_noopt_noautoinline),
            Object(MatchingFor("GSAE01"), "dlls/engine/22/22.c", cflags=cflags_dll_noopt_noautoinline_level3),
            Object(MatchingFor("GSAE01"), "dlls/engine/23/23.c", cflags=cflags_dll_noopt_noautoinline_deferred),
            Object(MatchingFor("GSAE01"), "dlls/engine/24/24.c"),
            ...
            Object(MatchingFor("GSAE01"), "dlls/engine/60/60.c", cflags=cflags_dll_noopt_noinline),
            ...
            Object(MatchingFor("GSAE01"), "dlls/engine/66/66.c", cflags=cflags_dll_noopt_noautoinline),
            Object(MatchingFor("GSAE01"), "dlls/engine/67/67.c"),
            Object(MatchingFor("GSAE01"), "dlls/engine/68/68.c", cflags=cflags_dll_noopt_noautoinline),
            Object(MatchingFor("GSAE01"), "dlls/engine/69/69.c", cflags=cflags_dll_noopt_noprop),
            Object(MatchingFor("GSAE01"), "dlls/engine/70/70.c", cflags=cflags_dll_noopt_nocse_noprop),
            Object(MatchingFor("GSAE01"), "dlls/engine/71/71.c", cflags=cflags_dll_noopt_noautoinline),
            ...
            Object(MatchingFor("GSAE01"), "dlls/engine/78/78.c", cflags=cflags_dll_noopt_nocse_noprop),
            ...
            Object(MatchingFor("GSAE01"), "dlls/objects/195_Player/player.c", cflags=cflags_dll_noopt_noautoinline),
            ...
            Object(MatchingFor("GSAE01"), "dlls/objects/241_InvHit/InvHit.c"),
            ...
            Object(MatchingFor("GSAE01"), "dlls/objects/332/332.c", cflags=cflags_dll_noopt),
            ...
            Object(MatchingFor("GSAE01"), "dlls/objects/455_DIMLavaSmas/DIMLavaSmas.c", cflags=cflags_dll_noopt_noprop_noinline),
            ...
            Object(MatchingFor("GSAE01"), "dlls/objects/466_WORLDplanet/WORLDplanet.c"),
            ...
            Object(MatchingFor("GSAE01"), "dlls/objects/589_BossDrakor/BossDrakor.c", cflags=cflags_dll_noopt_nocse_noprop),
            ...
            Object(MatchingFor("GSAE01"), "main/shader.c", cflags=cflags_dll_noopt_noautoinline_deferred),
            Object(MatchingFor("GSAE01"), "main/shadow_dolphin.c", cflags=cflags_dll_noopt_noautoinline),
            Object(Matching, "main/track_dolphin.c", cflags=cflags_dll_noopt_noautoinline),
