...
config.libs = [
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(MatchingFor("GSAE01"), "main/audio/synth_jobs.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            ...
            Object(MatchingFor("GSAE01"), "main/audio/snd3dgroup.c", mw_version="GC/1.2.5n", extra_cflags=["-fp_contract", "off", "-Cpp_exceptions", "on"]),
