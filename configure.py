...
config.libs = [
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "main/audio/synth_seq_dispatch.c", mw_version="GC/1.2.5n", extra_cflags=["-fp_contract", "off"]),
            Object(NonMatching, "main/audio/synth_channel_scale.c", mw_version="GC/1.2.5n", extra_cflags=["-fp_contract", "off"]),
            Object(NonMatching, "main/audio/synth.c", mw_version="GC/1.2.5n", extra_cflags=["-fp_contract", "off"]),
            ...
            Object(NonMatching, "main/audio/voice_id.c", mw_version="GC/1.2.5n", extra_cflags=["-O2"]),
            ...
            Object(NonMatching, "main/audio/sal_volume.c", mw_version="GC/1.2.5n", extra_cflags=["-fp_contract", "off"]),
            Object(NonMatching, "main/audio/snd3dgroup.c", mw_version="GC/1.2.5n", extra_cflags=["-fp_contract", "off", "-Cpp_exceptions", "on"]),
            Object(NonMatching, "main/audio/snd_core.c", mw_version="GC/1.2.5n", extra_cflags=["-fp_contract", "off"]),
