...
config.libs = [
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_0046_cameramodedebug.c", cflags=cflags_dll_noopt),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/NW/dll_01A0_nwgeyser.c", cflags=cflags_dll_noopt),
