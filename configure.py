...
config.libs = [
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "main/dll/CF/cfperch.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/WM/dll_01F9_wmobjcreator.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/wcdial.c"),
            Object(NonMatching, "main/dll/WM/dll_01F8_wmgalleon.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/WM/dll_01FA_wmseqobject.c", cflags=cflags_dll_noopt),
