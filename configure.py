...
config.libs = [
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "main/audio.c", cflags=[*cflags_dll_noopt, "-inline", "noauto"]),
            Object(NonMatching, "main/camera.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/curves.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/voxmaps.c", cflags=cflags_dll_noopt_nostrength),
            ...
            Object(NonMatching, "main/gametext.c", cflags=[*cflags_dll_noopt, "-inline", "noauto"]),
            ...
            Object(NonMatching, "main/dll/DR/dll_0257_drearthwarrior.c", cflags=cflags_dll_noopt_noprop),
            ...
            Object(NonMatching, "main/dll/dll_0242_dbstealerworm.c", cflags=[*cflags_base, "-opt", "nopeephole,noschedule,noloopinvariants,nopropagation", "-inline", "noauto"]),
            ...
            Object(NonMatching, "main/pi_dolphin.c", cflags=[*cflags_base, "-opt", "nopeephole,noschedule,noloopinvariants,nopropagation"]),
            ...
            Object(NonMatching, "main/track_dolphin.c", cflags=[*cflags_dll_noopt, "-inline", "noauto"]),
            Object(NonMatching, "main/newshadows.c", cflags=cflags_dll_noopt_noprop),
            Object(NonMatching, "track/intersect.c", cflags=[*cflags_dll_noopt, "-inline", "noauto"]),
            ...
            Object(NonMatching, "main/dll/dll_0018_boneparticleeffect.c", cflags=cflags_dll_noopt_noprop),
            ...
            Object(NonMatching, "main/dll/Hcurves.c", cflags=cflags_dll_noopt_noloopinv),
            ...
            Object(NonMatching, "main/dll/dll_0052_cameramodeforcebehind.c", cflags=cflags_dll_noopt_nocse_noprop),
            ...
            Object(NonMatching, "main/dll/dll_02C0_front.c", cflags=cflags_dll_noopt_noprop),
            ...
            Object(NonMatching, "main/dll/trickyfollow.c", cflags=cflags_dll_noopt_nocse),
            ...
            Object(NonMatching, "main/dll/dll_00C4_tricky.c", cflags=cflags_dll_noopt_noprop),
            ...
            Object(NonMatching, "main/dll/newseqobjgroup.c", cflags=cflags_dll_noopt_noloopinv),
            ...
            Object(NonMatching, "main/dll/dll_00E2_staff.c", cflags=cflags_dll_noopt_nocse),
            Object(
                MatchingFor("GSAE01"),
            ...
            Object(NonMatching, "main/dll/dll_013C_xyzanimator.c", cflags=cflags_dll_noopt_noloopinv),
            ...
            Object(
                NonMatching,
                "main/dll/CF/dll_0148_cfguardian.c", cflags=cflags_dll_noopt_nocse,
                section_alignments={".data": 4},
            ),
            ...
            Object(NonMatching, "main/dll/dll_0158_gunpowderbarrel.c", cflags=[*cflags_dll_noopt_noprop, "-inline", "off"]),
            ...
            Object(NonMatching, "main/dll/DIM/dll_01CA_dimexplosion.c", cflags=[*cflags_dll_noopt_noprop, "-inline", "noauto"]),
            ...
            Object(NonMatching, "main/dll/DF/dll_0175_dfropenode.c", cflags=cflags_dll_noopt_noloopinv),
            ...
            Object(NonMatching, "main/dll/dll_018C_mmshshrine.c", cflags=cflags_dll_noopt_nocse),
            ...
            Object(NonMatching, "main/dll/scshgroup.c", cflags=[*cflags_dll_noopt, "-inline", "noauto"]),
            ...
            Object(NonMatching, "main/dll/DR/dll_0250_ktrex.c", cflags=[*cflags_dll_noopt, "-inline", "noauto"]),
            ...
            Object(NonMatching, "main/dll/ARW/dll_029A_arwarwing.c", cflags=cflags_dll_noopt_noprop),
            ...
            Object(NonMatching, "main/dll/dll_02B1_cmbsrc.c", cflags=cflags_dll_noopt_noprop),
