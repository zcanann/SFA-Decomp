...
config.libs = [
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_018C_mmshshrine.c", cflags=cflags_dll_noopt),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/laserturretgroup.c", cflags=cflags_dll_noopt),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/WC/dll_0290_wcpushblock.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/WC/dll_028D_wclevelcont.c", cflags=cflags_dll_noopt),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_02A0_ring.c", cflags=cflags_dll_noopt),
