...
config.libs = [
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(MatchingFor("GSAE01"), "main/audio/synth_control.c", mw_version="GC/1.2.5n"),
            ...
            Object(MatchingFor("GSAE01"), "main/audio/voice_prio.c", mw_version="GC/1.2.5n"),
            ...
            Object(MatchingFor("GSAE01"), "main/audio/hw_aram.c", mw_version="GC/1.2.5n"),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_012C_transporter.c", cflags=cflags_dll_noopt),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/CC/dll_0188_cclightfoot.c", cflags=cflags_dll_noopt),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/NW/dll_01A2_nwtricky.c", cflags=cflags_dll_noopt),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_02BB_gflevelcon.c", cflags=cflags_dll_noopt),
            ...
            Object(MatchingFor("GSAE01"), "main/audio/inp_ctrl.c", mw_version="GC/1.2.5n"),
            ...
            Object(MatchingFor("GSAE01"), "main/audio/hw_volume.c", mw_version="GC/1.2.5n"),
            ...
            Object(MatchingFor("GSAE01"), "main/audio/aram_init.c", mw_version="GC/1.2.5n"),
