...
config.libs = [
    ...
    },
    {
        ...
        "objects": [
            ...
            Object(MatchingFor("GSAE01"), "main/unknown/autos/placeholder_803D8888.c"),
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(MatchingFor("GSAE01"), "main/audio/synth_handle.c", mw_version="GC/1.2.5n"),
            ...
            Object(MatchingFor("GSAE01"), "main/audio/synth_init.c", mw_version="GC/1.2.5n"),
            Object(MatchingFor("GSAE01"), "main/audio/synth_delay.c", mw_version="GC/1.2.5n"),
            Object(NonMatching, "main/audio/synth_control.c", mw_version="GC/1.2.5n"),
            Object(MatchingFor("GSAE01"), "main/audio/snd_synth_api.c", mw_version="GC/1.2.5n"),
            Object(MatchingFor("GSAE01"), "main/audio/mcmd_volume.c", mw_version="GC/1.2.5n"),
            ...
            Object(MatchingFor("GSAE01"), "main/audio/vsample_update.c", mw_version="GC/1.2.5n"),
            ...
            Object(MatchingFor("GSAE01"), "main/audio/hw_adsr.c", mw_version="GC/1.2.5n"),
            Object(NonMatching, "main/audio/hw_voice_params.c", mw_version="GC/1.2.5n"),
            Object(MatchingFor("GSAE01"), "main/audio/hw_voice_start.c", mw_version="GC/1.2.5n"),
            Object(MatchingFor("GSAE01"), "main/audio/hw_input.c", mw_version="GC/1.2.5n"),
            Object(NonMatching, "main/audio/hw_aram.c", mw_version="GC/1.2.5n"),
            Object(MatchingFor("GSAE01"), "main/audio/hw_samplemem.c", mw_version="GC/1.2.5n"),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_0052_cameramodeforcebehind.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/maybetemplate.c", cflags=cflags_dll_noopt, extra_cflags=["-inline", "noauto"]),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_010B_fireflylantern.c", cflags=cflags_dll_noopt),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/CC/dll_0186_ccgasventcontrol.c", cflags=cflags_dll_noopt),
            ...
            Object(MatchingFor("GSAE01"), "main/audio/adsr_setup.c", mw_version="GC/1.2.5n"),
            Object(MatchingFor("GSAE01"), "main/audio/adsr_lowprec.c", mw_version="GC/1.2.5n"),
            Object(MatchingFor("GSAE01"), "main/audio/vsample_events.c", mw_version="GC/1.2.5n"),
            Object(MatchingFor("GSAE01"), "main/audio/snd_groups.c", mw_version="GC/1.2.5n"),
            Object(MatchingFor("GSAE01"), "main/audio/sal_studio.c", mw_version="GC/1.2.5n"),
            ...
            Object(MatchingFor("GSAE01"), "main/audio/snd_core.c", mw_version="GC/1.2.5n"),
            Object(NonMatching, "main/audio/inp_midi.c", mw_version="GC/1.2.5n"),
            Object(MatchingFor("GSAE01"), "main/audio/inp_voice.c", mw_version="GC/1.2.5n"),
            ...
            Object(MatchingFor("GSAE01"), "main/audio/hw_stream.c", mw_version="GC/1.2.5n"),
            Object(MatchingFor("GSAE01"), "main/audio/aram_queue.c", mw_version="GC/1.2.5n"),
            ...
            Object(MatchingFor("GSAE01"), "main/audio/sal_ai.c", mw_version="GC/1.2.5n"),
            Object(MatchingFor("GSAE01"), "main/audio/sal_dsp.c", mw_version="GC/1.2.5n"),
