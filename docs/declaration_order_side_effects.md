...
/*12*/ f32 v;
/*13*/ int bumpRowOff;
/*14*/ u8 saved = mmSetForceHeap3Only(1);   // CALL: mmSetForceHeap3Only
```

`mmSetForceHeap3Only` writes `gMmForceHeap3Only` and `gMmOpCount` (src/main/mm.c). The partners cast/read `gNewShadowEntries`. Disjoint. Hoisting it across an ALLOCATION would matter; there is none in this block.
