...
| 0x1D2 | WORLDplanet | COMPLETE | dlls/objects/466_WORLDplanet/WORLDplanet.c | = (canonical) | Complete 11-function TU at 99.81221% fuzzy with ten exact functions, an allocation-backed 0x18-byte state, a separate allocation-backed 0x20-byte Fox-spawn setup, canonical unit header, terminal descriptor, and exact 344-byte data image; independent private orbit/path arrays correct the former table struct. Still NonMatching; see [matching progress](WORLDplanet_matching.md). The generated source path remains unchanged |
...
| 0x271 | dlls/objects/625/625.c | include/dlls/objects/625_DrakorHoverpad.h |
