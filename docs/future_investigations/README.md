...
| `objanim_component_vs_gameobject.md` | type and caller census | is `ObjAnimComponent` a genuine reusable component, or the recovered `0xB0`-byte head of the original `GameObject` / `ObjInstance` type? |
