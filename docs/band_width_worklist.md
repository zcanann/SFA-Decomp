...
| lightmapQueueShadowRow | main/lightmap_draw | 312 | 98.910 | 11 | 0 | 3G/0F | 1 | resolved by [source recovery](lightmap_draw_recovery.md): six scalar bounds and `/ 8.0f` produce exact code; shared retail constant pool still blocks source linking |
