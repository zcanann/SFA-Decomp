...
| pauseMenuDrawStatus | dlls/engine/0/0 | 2064 | 99.922 | 8 | 0 | 6G/2F | 14 | Updated 2026-09-08: indexed status/opacity accesses and inline snapshot initialization recover the animated loop and remainder copy. One r0/r3 swap remains in the first unrolled snapshot copy; see [analysis](engine_0_matching.md). |
