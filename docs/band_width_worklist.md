...
| cMenuSetItems | dlls/engine/0/0 | 1208 | 53.566 | — | — | — | — | **Source reset 2026-09-08:** indexed arrays, shared append logic, and early filtering replace the offset workaround. Current source emits 964 bytes; this is no longer a register-only residual. 10,000 differential cases pass. See [analysis](engine_0_matching.md). |
