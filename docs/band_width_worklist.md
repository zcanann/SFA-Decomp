...
| mathTanf | MSL_C/PPCEABI/bare/H/math_8029454c | 148 | 97.297 | 1 | 1 | 0G/4F | 1 | un-elided parameter-home fmr copy; profile already maximal |
...
| mapLoadDataFile | main/pi_dolphin | 8444 | 100 | 0 | 0 | 10G/0F | 0 | **Resolved 2026-09-26:** sized `extern u8 gResourceFileTable[0x160]` stops IR full-address sharing; plain typed accessors replace the biased locals. [Matching record](map_load_data_file_matching.md). |
...
| powf | MSL_C/PPCEABI/bare/H/exponentialsf | 1916 | 99.781 | 12 | 0 | 0G/0F | 1 | true scratch rotation: commutative fadds operand canon + one temp home; all 1.2.5n cells flat 12/0, GC/1.3+ wrong era (277+); MSL source-spelling lane only |
