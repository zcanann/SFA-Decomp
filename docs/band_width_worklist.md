...
| worldplanet_update | dlls/objects/466_WORLDplanet/WORLDplanet | 3136 | 99.694 | — | — | 13G/9F | 1 | Updated 2026-09-06: independent orbit/path array definitions resolve the missing instruction and index-vs-base shape; an inlined spawn helper fixes its pointer register. The selected-object spill and final orbit register choices remain (42 code bytes in a diagnostic source link). The earlier “all individually walled” assessment was too strong; see [matching progress](WORLDplanet_matching.md). |
