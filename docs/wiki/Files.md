...
| BITTABLE.BIN | 0x33 | `src/main/gameloop.c` (`loadAssetFileById(&gGameBitTable, 0x33)`) | 4-byte `GameBitDef` records, one per GameBit id (`include/main/gamebits.h` holds the symbolic id enum) |
