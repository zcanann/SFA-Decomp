...
asm void __PSMTXMultVecAB(const register Mtx m, const register Vec *in, register Vec *out)
{
    nofralloc
entry fn_80247494
    psq_l f0, 0(in), 0, 0
...
asm void __PSMTXMultVecArrayAB(const register Mtx m, const register Vec *srcBase, register Vec *dstBase, register u32 count)
{
    nofralloc
entry fn_802474E8
    psq_l f13, 0(m), 0, 0
