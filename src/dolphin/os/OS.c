...
/* DSP init microcode; local to the original OS TU but referenced from the split-out
   OSAudioSystem.c, so exported under dtk's cross-unit alias name */
u8 DSPInitCode_8032C520[0x80] ATTRIBUTE_ALIGN(32) = {
