...
float mathSinf(float angle) {
    ...
    case 2:
        return reducedSquared * (reducedSquared * (-0.000318879f * reducedSquared + 0.015849913f) + -0.30842426f) +
               1.0f;
    case 4:
        return -(reducedAngle * (reducedSquared * (0.0024270867f * reducedSquared + -0.08071397f) + 0.78539425f));
    default:
...
float mathSinfPrecise(float angle) {
    ...
    case 0:
        return reducedAngle *
               (reducedSquared * (reducedSquared * (-3.58772e-05f * reducedSquared + 0.002489872f) + -0.0807454f) +
                0.7853982f);
    case 2:
        return reducedSquared * (reducedSquared * (reducedSquared * (3.5298042e-06f * reducedSquared + -0.0003259386f) +
                                                   0.015854325f) +
                                 -0.30842513f) +
               1.0f;
    case 4:
    ...
    default:
        return -(
            reducedSquared *
                (reducedSquared * (reducedSquared * (3.5298042e-06f * reducedSquared + -0.0003259386f) + 0.015854325f) +
                 -0.30842513f) +
            1.0f);
    }
}
...
float mathSinfHighPrecision(float angle) {
    ...
    case 0:
        return (
            float)(reducedAngle *
                   (reducedSquared *
                        (reducedSquared * (reducedSquared * (reducedSquared * (-2.473889883359452e-08 * reducedSquared +
                                                                               2.7554973093759717e-06) +
    ...
    case 2:
        return (float)(reducedSquared *
                           (reducedSquared *
                                (reducedSquared *
                                     (reducedSquared * (reducedSquared * (2.048770813211803e-09 * reducedSquared +
                                                                          -2.755268200651971e-07) +
                                                        2.4801561642773723e-05) +
