    ...
    case 2:
        ...
        if (seq->curveId < 0) {
            ...
            if (seq->curveId > -1) {
                ...
                if (seq->curveInterp != NULL) {
                    RomCurveInterp_InitFromNode(seq->curveInterp, seq->curveId);
                } else {
                    seq->curveId = -1;
                }
            }
...
int ObjSeq_ExecuteActionCommand(GameObject* obj, u8* action, u8** cmdPtr, s8 flags, void* out) {
    ...
    seq = obj->extra;
    model = (ObjSeqPlacement*)obj->anim.placementData;
    activeObj = ((ObjSeqState*)seq)->targetObj;
    if (activeObj == NULL) {
        activeObj = obj;
    }
    ...
    case SEQACT_OVERRIDE:
        ...
        activeObj = ObjSeq_ToggleCommand3Target(obj, (ObjSeqState*)seq, model);
...
void ObjSeq_onMapSetup(void) {
...

    {
        ...
        for (; i < 0x50; group++, i += 8) {
            ...
            states[group * 8 + 0] = 0;
            pending[group * 8 + 0] = 0;
            frames[group * 8 + 0] = zero;
            dists[group * 8 + 0] = neg1;
            counts[group * 8 + 0] = 0;
            handles[group * 8 + 0] = 0;
            marks[group * 8 + 0] = 0;
            flagsB[group * 8 + 1] = 0;
            ...
            states[group * 8 + 1] = 0;
            pending[group * 8 + 1] = 0;
            frames[group * 8 + 1] = zero;
            dists[group * 8 + 1] = neg1;
            counts[group * 8 + 1] = 0;
            handles[group * 8 + 1] = 0;
            marks[group * 8 + 1] = 0;
            flagsB[group * 8 + 2] = 0;
            ...
            states[group * 8 + 2] = 0;
            pending[group * 8 + 2] = 0;
            frames[group * 8 + 2] = zero;
            dists[group * 8 + 2] = neg1;
            counts[group * 8 + 2] = 0;
            handles[group * 8 + 2] = 0;
            marks[group * 8 + 2] = 0;
            flagsB[group * 8 + 3] = 0;
            ...
            states[group * 8 + 3] = 0;
            pending[group * 8 + 3] = 0;
            frames[group * 8 + 3] = zero;
            dists[group * 8 + 3] = neg1;
            counts[group * 8 + 3] = 0;
            handles[group * 8 + 3] = 0;
            marks[group * 8 + 3] = 0;
            flagsB[group * 8 + 4] = 0;
            ...
            states[group * 8 + 4] = 0;
            pending[group * 8 + 4] = 0;
            frames[group * 8 + 4] = zero;
            dists[group * 8 + 4] = neg1;
            counts[group * 8 + 4] = 0;
            handles[group * 8 + 4] = 0;
            marks[group * 8 + 4] = 0;
            flagsB[group * 8 + 5] = 0;
            ...
            states[group * 8 + 5] = 0;
            pending[group * 8 + 5] = 0;
            frames[group * 8 + 5] = zero;
            dists[group * 8 + 5] = neg1;
            counts[group * 8 + 5] = 0;
            handles[group * 8 + 5] = 0;
            marks[group * 8 + 5] = 0;
            flagsB[group * 8 + 6] = 0;
            ...
            states[group * 8 + 6] = 0;
            pending[group * 8 + 6] = 0;
            frames[group * 8 + 6] = zero;
            dists[group * 8 + 6] = neg1;
            counts[group * 8 + 6] = 0;
            handles[group * 8 + 6] = 0;
            marks[group * 8 + 6] = 0;
            flagsB[group * 8 + 7] = 0;
            ...
            states[group * 8 + 7] = 0;
            pending[group * 8 + 7] = 0;
            frames[group * 8 + 7] = zero;
            dists[group * 8 + 7] = neg1;
            counts[group * 8 + 7] = 0;
            handles[group * 8 + 7] = 0;
            marks[group * 8 + 7] = 0;
        }
