...
#if defined(VERSION_GSAP01) || defined(VERSION_GSAP01_rev1)
u8 gOptionsLanguageIds[5] = {0, 1, 3, 5, 2};
#endif
...
#if defined(VERSION_GSAP01) || defined(VERSION_GSAP01_rev1)
u16 gOptionsMiscPanelEntries[240] = {
    0x035f, 0x0017, 0x0140, 0x0170, 0x0000, 0x0140, 0x00bb, 0x0000, 0xffff, 0xffff, 0x00b4, 0x0000, 0x0000, 0xff01, 0xffff, 0xff00,
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0352, 0x0018,
    0x0140, 0x0170, 0x0000, 0x0140, 0x00bb, 0x0000, 0xffff, 0xffff, 0x00b4, 0x0000, 0x0000, 0x0002, 0xffff, 0xff00, 0x0000, 0x0000,
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0353, 0x0019, 0x0140, 0x0170,
    0x0000, 0x0140, 0x00bb, 0x0000, 0xffff, 0xffff, 0x00b4, 0x0000, 0x0000, 0x0103, 0xffff, 0xff00, 0x0000, 0x0000, 0x0000, 0x0000,
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0355, 0x001a, 0x0140, 0x0170, 0x0000, 0x0140,
    0x00bb, 0x0000, 0xffff, 0xffff, 0x00b4, 0x0000, 0x0000, 0x0204, 0xffff, 0xff00, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0356, 0x001b, 0x0140, 0x0170, 0x0000, 0x0140, 0x00bb, 0x0000,
    0xffff, 0xffff, 0x00b4, 0x0000, 0x0000, 0x0305, 0xffff, 0xff00, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0354, 0x001c, 0x0140, 0x0170, 0x0000, 0x0140, 0x00bb, 0x0000, 0xffff, 0xffff,
    0x00b4, 0x0000, 0x0000, 0x0406, 0xffff, 0xff00, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    0x0000, 0x0000, 0x0000, 0x0000, 0x0506, 0x001d, 0x0140, 0x0170, 0x0000, 0x0140, 0x00bb, 0x0000, 0xffff, 0xffff, 0x00b4, 0x0000,
    0x0000, 0x05ff, 0xffff, 0xff00, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    0x0000, 0x0000, 0x0369, 0x0002, 0x0109, 0x0188, 0x0000, 0x0109, 0x017c, 0x0000, 0xffff, 0xffff, 0x0000, 0x0000, 0x0000, 0xffff,
    0xffff, 0xff00, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000};
#else
...
#if defined(VERSION_GSAP01) || defined(VERSION_GSAP01_rev1)
    {gOptionsMiscPanelEntries, 0, 0x0703, 0x035b, 0x0368, 0},
#else
...
#if defined(VERSION_GSAP01) || defined(VERSION_GSAP01_rev1)
ObjectDescriptor6WithPadding OptionsScreen_funcs = {
    {
        0,
        0,
        0,
