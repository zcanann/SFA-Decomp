...
int Effect20_spawnObject(void* sourceObj, int effectId, PartFxSpawnParams* spawnParams, u32 spawnFlags, u8 modelId,
    ...
    case 0x7aa:
        if (spawnParams != NULL) {
            ...
            cfg.startPosX = spawnParams->scale * (0.1f * (f32)(s32)randomGetRange(0xffffff9c, 100)) + spawnParams->posX;
            cfg.startPosY = spawnParams->posY * spawnParams->scale;
            cfg.startPosZ = spawnParams->scale * (0.1f * (f32)(s32)randomGetRange(0xffffff9c, 100)) + spawnParams->posZ;
    ...
    case 0x7ad:
        if (spawnParams != NULL) {
            ...
            cfg.startPosY = spawnParams->scale * (0.5f * (f32)(s32)randomGetRange(0xf, 0x14) + spawnParams->posY);
    ...
    case 0x7bf:
        if (spawnParams != NULL) {
            ...
            cfg.scale =
                (0.5f + spawnParams->posX) * (spawnParams->scale * (0.001583f * (f32)(s32)randomGetRange(10, 0xd)));
    ...
    case 0x7c0:
        if (spawnParams != NULL) {
            ...
            cfg.velocityZ = spawnParams->posX * (spawnParams->scale * (0.01165f * (f32)(s32)randomGetRange(100, 0x6c)));
            cfg.velocityY = 0.0f;
            cfg.velocityX = 0.0f;
            if (extraArgs != NULL) {
    ...
    case 0x7c1:
        if (spawnParams != NULL) {
            ...
            cfg.scale =
                (0.5f + spawnParams->posX) * (spawnParams->scale * (0.000306f * (f32)(s32)randomGetRange(2, 0xd)));
    ...
    case 0x7c2:
        if (spawnParams != NULL) {
            ...
            cfg.velocityX =
                spawnParams->scale * ((0.25f + cfg.velocityY) * (0.004f * (f32)(s32)randomGetRange(0xffffff9c, 100)));
            cfg.velocityZ =
                spawnParams->scale * ((0.25f + cfg.velocityY) * (0.004f * (f32)(s32)randomGetRange(0xffffff9c, 100)));
    ...
    case 0x7d0:
        if (spawnParams != NULL) {
            if (extraArgs == NULL) {
                cfg.velocityY = spawnParams->scale * (0.00253f * (f32)(s32)randomGetRange(100, 200));
                cfg.velocityZ = 12.0f * (spawnParams->scale * (-0.00253f * (f32)(s32)randomGetRange(100, 200)));
            } else {
                cfg.velocityY = 0.00025f * (f32)(s32)randomGetRange(100, 200);
                cfg.velocityZ = 8.0f * (spawnParams->scale * (0.0015f * (f32)(s32)randomGetRange(0x32, 100)));
            }
    ...
    case 0x7d1:
        if (spawnParams != NULL) {
            if (extraArgs == NULL) {
                ...
                cfg.velocityZ = 1.5f * (spawnParams->scale * (-0.00253f * (f32)(s32)randomGetRange(100, 200)));
            } else {
                cfg.velocityY = 0.00025f * (f32)(s32)randomGetRange(100, 200);
                cfg.velocityZ = 1.5f * (spawnParams->scale * (0.00253f * (f32)(s32)randomGetRange(100, 200)));
            }
    ...
    case 0x7e6:
        if (spawnParams != NULL) {
            ...
            cfg.velocityX = spawnParams->scale * (0.003f * (f32)(s32)randomGetRange(0xffffff9c, 100)) + cfg.velocityX;
            cfg.velocityY = spawnParams->scale * (0.002f * (f32)(s32)randomGetRange(0x32, 100)) + cfg.velocityY;
            cfg.velocityZ = spawnParams->scale * (0.003f * (f32)(s32)randomGetRange(0xffffff9c, 100)) + cfg.velocityZ;
