  ...
  if (cVar1 == '\x02') {
    ...
    *(short *)(iVar3 + 6) = *(short *)(iVar3 + 6) - (short)(int)lbl_803DC074;
    ...
    ((GameObject *)param_9)->anim.localPosZ =
         (float)((double)((GameObject *)param_9)->anim.velocityZ * dVar5 + (double)((GameObject *)param_9)->anim.localPosZ);
    if (*(short *)(iVar3 + 6) < 1) {
      FUN_80017ac8(dVar5,(double)((GameObject *)param_9)->anim.velocityZ,param_3,param_4,param_5,param_6,param_7,
                   param_8,param_9);
    }
  }
  else if (cVar1 == '\0') {
  ...
  if (iVar1 != 0) {
    ...
    if ((((short)uVar2 == 0) && (*(char *)(psVar5 + 2) == '\0')) && (sVar4 != 0)) {
      *(byte *)&((GameObject *)param_1)->anim.resetHitboxMode = *(byte *)&((GameObject *)param_1)->anim.resetHitboxMode & 0xf7;
      ...
      if ((iVar3 != 0) &&
         (dVar6 = (double)FUN_8001771c((float *)&((GameObject *)param_1)->anim.worldPosX,(float *)(iVar1 + 0x18)),
...
void FUN_801fdae0(int param_1)
{
  ...
  psVar4 = ((GameObject *)param_1)->extra;
  *(byte *)&((GameObject *)param_1)->anim.resetHitboxMode = *(byte *)&((GameObject *)param_1)->anim.resetHitboxMode | 8;
  if ((*(char *)((int)psVar4 + 5) < '\0') ||
    ...
    *(byte *)((int)psVar4 + 5) = (byte)((uVar1 & 1) << 7) | *(byte *)((int)psVar4 + 5) & 0x7f;
    if ((uVar1 & 1) == 0) {
      *(char *)(psVar4 + 2) = (char)*(undefined2 *)(*(int *)&((GameObject *)param_1)->anim.placementData + 0x1a);
    }
  }
  ...
  *(float *)(iVar4 + 0xc) =
  ...
  if (lbl_803E6DFC < *(float *)(iVar4 + 0xc)) {
    ...
    *(float *)(iVar4 + 0x10) = (float)(local_40 - DOUBLE_803e6e40);
    uVar2 = randomGetRange(0x15e,800);
  ...
  if (((lbl_803E6E1C < *(float *)(iVar4 + 0xc)) && (*(float *)(iVar4 + 0xc) < lbl_803E6E20)) &&
     (local_50 = *(undefined4 *)(iVar4 + 8), (((GameObject *)param_1)->objectFlags & 0x800) != 0)) {
...
void FUN_801fe1c4(LaserObject *obj)
{
  ...
  state = obj->state;
  if ((state->completionLatched == '\0') &&
     (uVar1 = GameBit_Get((int)state->completionGameBit), uVar1 != 0)) {
...
void FUN_801fe324(LaserObject *obj,LaserObjectMapData *mapData)
{
  ...
  uVar1 = GameBit_Get((int)state->completionGameBit);
  if (uVar1 != 0) {
    state->completionLatched = 1;
    obj->statusFlags = obj->statusFlags | LASER_OBJECT_STATUS_DISABLED;
  }
...
code_r0x801fe7fc:
  if (0xf < (int)local_34) {
    ((GameObject *)param_1)->anim.velocityX = runtimeState->reboundVelocityX;
    ((GameObject *)param_1)->anim.velocityY = runtimeState->reboundVelocityY;
    ((GameObject *)param_1)->anim.velocityZ = -runtimeState->reboundVelocityZ;
            ...
            if (tricky != NULL) {
                ...
                if (d->noCheck || ObjGroup_FindNearestObject(5, obj, &dist) == 0) {
                    if (*(u8 *)&((GameObject *)obj)->anim.resetHitboxMode & 4) {
                        (*(void (*)(void *, int, int, int))*(int *)(*(int *)*(int *)((u8 *)tricky + 0x68) + 0x28))(tricky, obj, 1, 4);
                    }
                    *(u8 *)&((GameObject *)obj)->anim.resetHitboxMode &= ~8;
...
void fn_801FD6B4(int obj) {
    ...
    *(f32 *)(extra + 0xc) += timeDelta * ((lbl_803E6160 * *(f32 *)(extra + 0x10)) / lbl_803E6160);
    if (*(f32 *)(extra + 0xc) > lbl_803E6164) {
        ...
        *(f32 *)(extra + 8) = lbl_803E6168 / ((f32)(int)*(s16 *)(def + 0x1a) / (f32)(int)randomGetRange(0x15e, 800));
...
void VFP_lavapool_init(int obj, int def) {
    ...
    *(s16 *)(extra + 6) = 2000;
    ...
    ((GameObject *)obj)->anim.rootMotionScale = lbl_803E6168 / ((f32)(int)*(s16 *)(def + 0x1a) / (f32)(int)randomGetRange(600, 1000));
...
int fn_801FE560(int obj, f32 *out, f32 a, f32 b, int flag) {
    ...
    *out = lbl_803E61C8;
    n = hitDetectFn_80065e50(((GameObject *)obj)->anim.localPosX + a, ((GameObject *)obj)->anim.localPosY, ((GameObject *)obj)->anim.localPosZ + b, obj, &list, 0, 0);
    if (n != 0) {
        ground = lbl_803E61E0;
        water = ground;
        cursor = list;
