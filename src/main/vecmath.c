...
void mtxRotateByVec3s(f32* mtx, const void* transform)
{
    ...
    f32 cosY;
    f32 product;
    f32 term0, term1, component2, sum;
    f32 component0;
    f32 translation;
    f32 component1;
    const MatrixTransform* xf = (const MatrixTransform*)transform;

    product = (f32)(int)(65536.0f * fsin16((u16)xf->rotX));
    sinX = product * gVecMathAngleScaleInv[0];
    product = (f32)(int)(65536.0f * fcos16((u16)xf->rotX));
    cosX = product * gVecMathAngleScaleInv[0];
    product = (f32)(int)(65536.0f * fsin16((u16)xf->rotY));
    sinY = product * gVecMathAngleScaleInv[0];
    product = (f32)(int)(65536.0f * fcos16((u16)xf->rotY));
    cosY = product * gVecMathAngleScaleInv[0];
    component0 = (f32)(int)(65536.0f * fsin16((u16)xf->rotZ));
    component0 *= gVecMathAngleScaleInv[0];
    component1 = (f32)(int)(65536.0f * fcos16((u16)xf->rotZ));
    component1 *= gVecMathAngleScaleInv[0];

    term0 = sinY * component0;
    product = term0 * sinX;
    term1 = cosX * component1;
    product = term1 - product;
    mtx[0] = product;
    term1 = sinY * component1;
    sum = term1 * sinX;
    {
        f32 p = cosX * component0;
        sum += p;
    }
    mtx[1] = sum;
    mtx[2] = -(sinX * cosY);
    mtx[3] = (component2 = gVecMathZero[0]);
    mtx[4] = -(cosY * component0);
    mtx[5] = cosY * component1;
    mtx[6] = sinY;
    mtx[7] = component2;
    product = term0 * cosX;
    term0 = sinX * component1;
    product += term0;
    mtx[8] = product;
    term1 *= cosX;
    term0 = sinX * component0;
    term0 -= term1;
    mtx[9] = term0;
    term0 = cosX * cosY;
    mtx[10] = term0;
    mtx[11] = component2;
    /* Reuse the completed rotation temporaries for the translation vector. */
    component0 = xf->x;
    component1 = xf->y;
    component2 = xf->z;
    product = mtx[0];
