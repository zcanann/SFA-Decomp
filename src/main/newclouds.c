...
void snowReposSnowCloud(int cloudId)
{
    ...
    if (((NewCloud*)q)->cloudType == 4 && (((NewCloud*)q)->unk144B & 0x38) != 0 &&
        ((NewCloud*)q)->lightningTimer <= 0 && ((NewCloud*)q)->unk144D == 0 && lbl_803DD19C == 0)
    {
        if (((NewCloud*)q)->unk1452 != 0 && cam != NULL)
        {
            dir[0] = lbl_803DF1A0;
            dir[1] = lbl_803DF1A0;
            dir[2] = lbl_803DF228;
...
void newClouds(u8* params, void* owner, f32 x, f32 y, f32 z)
{
    ...
    *(void**)(NC_CLOUD + 4) = mmAlloc(((NewCloud*)NC_CLOUD)->flakeCount * 0x18, 0x17, 0);
    ...
    for (i = 0; i < ((NewCloud*)NC_CLOUD)->flakeCount; i++)
    {
        ...
        NC_PARTS[i].unk12 = randomGetRange(0, 0x13);
        if (((NewCloud*)NC_CLOUD)->cloudType == 0)
        {
            ...
            if (params[0x5c] == 0 || params[0x5c] == 4)
            {
                ...
                case 0:
                    ...
                    *(int*)(env + 0x1c) = posA[2];
                    ...
                    ((NewCloud*)NC_CLOUD)->unk144D = 1 - env[*(u16*)(params + 0x26) + 0x41];
...
void dll_07_func06(void)
{
    ...
    for (i = 0; i < 8; i++)
    {
        ...
        else if (p != NULL && ((NewCloud*)p)->unk144F == 0)
        {
            ...
            if (((NewCloud*)D7_CLOUD)->unk144D == 0)
            {
                inpos[0] = pos[0];
                inpos[1] = pos[1];
                inpos[2] = pos[2];
            ...
            if (((NewCloud*)D7_CLOUD)->unk1453 != 0)
            {
