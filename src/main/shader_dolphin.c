...
void addWarpedNoiseTevStages(void* p1, void* mtx)
{
    ...
    gRcpNextTevStage = gRcpNextTevStage + 2;
    gRcpNextTexMap = gRcpNextTexMap + 2;
    gRcpNumTevStages += 2;
    gRcpNumTexGens += 1;
    gRcpNumIndStages += 1;
}
...
void addWarpedRingTevStages(void)
{
    ...
    gRcpNextTexCoord = gRcpNextTexCoord + 4;
    gRcpNextTevStage = gRcpNextTevStage + 2;
    gRcpNextTexMap = gRcpNextTexMap + 2;
    gRcpNextPostTexMtx = gRcpNextPostTexMtx + 0xc;
    gRcpNextIndTexStage = gRcpNextIndTexStage + 2;
    gRcpNumTevStages += 2;
    gRcpNumTexGens += 4;
    gRcpNumIndStages += 2;
}
...
void renderHeavyFog(void* fogColor)
{
    ...
    if (gHeavyFogMode != 0)
    {
        ...
        gRcpNextTexCoord = gRcpNextTexCoord + 3;
        gRcpNextTevStage = gRcpNextTevStage + 2;
        gRcpNextTexMap = gRcpNextTexMap + 2;
        gRcpNextPostTexMtx = gRcpNextPostTexMtx + 9;
        gRcpNextIndTexStage = gRcpNextIndTexStage + 2;
        gRcpNumTevStages += 2;
        gRcpNumTexGens += 3;
        gRcpNumIndStages += 2;
...
void addPointLightAccumStages(f32 scale, int* colorIn, f32* pos)
{
    ...
    }
    {
        ...
        gRcpNextKColorSel = gRcpNextKColorSel + 1;
        gRcpNextKAlphaSel = gRcpNextKAlphaSel + 1;
        gRcpNextPostTexMtx = gRcpNextPostTexMtx + 6;
        gRcpNumTexGens += 2;
        gRcpNumTevStages += 2;
    }
}
...
void addCastShadowTevStages(u8* objInst)
{
    ...
    gRcpNumTexGens += 2;
    gRcpNumTevStages += 4;
    gRcpNextTevStage = gRcpNextTevStage + 4;
}
