  ...
  if ((piVar3 != (int *)0x0) && (iVar7 = *piVar3, *(short *)(iVar7 + 0xec) != 0)) {
    ...
    *(undefined2 *)(iVar6 + 100) = 0xffff;
    ...
    if ((iVar4 != 0) && (*(int *)(iVar4 + 8) != 0)) {
      param_14 = 0;
      dVar9 = (double)FUN_8003586c(param_1,param_2,param_3,param_4,param_5,param_6,param_7,
