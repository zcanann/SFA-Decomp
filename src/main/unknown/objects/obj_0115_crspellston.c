 ...
 *
 * Object def: 0x0115 CRSpellston
 * Output path: src/main/unknown/objects/obj_0115_crspellston.c
 * Retail placements: 1
 * Root romlists: 1
...
enum obj_0115_CRSpellston_packet_info {
    ...
    CRSPELLSTON_OBJECT_DEF_BYTES = 0xE0,
    CRSPELLSTON_PLACEMENT_BYTES_MIN = 0x24,
    CRSPELLSTON_PLACEMENT_BYTES_MAX = 0x24,
};
#endif
