 ...
 *
 * Object def: 0x007E DrakorSpell
 * Output path: src/main/unknown/objects/obj_007E_drakorspell.c
 * Retail placements: 1
 * Root romlists: 1
 ...
 * - 0x007E DrakorSpell: placements=1, class=0x0030, widths=9w x1
 * - 0x0115 CRSpellston: placements=1, class=0x0030, widths=9w x1
 *
 * EN descriptor slot map:
 * - descriptor=0x8032A428 gSpellStoneObjDescriptor (slots=12, mask=110111111111)
...
enum obj_007E_DrakorSpell_packet_info {
    ...
    DRAKORSPELL_OBJECT_DEF_BYTES = 0xA0,
    DRAKORSPELL_PLACEMENT_BYTES_MIN = 0x24,
    DRAKORSPELL_PLACEMENT_BYTES_MAX = 0x24,
};
#endif
