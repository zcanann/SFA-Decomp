 ...
 *
 * Object def: 0x051B TrigCyl
 * Output path: src/main/unknown/objects/obj_051B_trigcyl.c
 * Retail placements: 56
 * Root romlists: 14
 * Object-def size: 0xA0
 * Root placement widths: 20w x56
 * DLL ID: 0x0126
 * Class ID: 0x0016
 * Suggested outer boundary: single-def class inside shared DLL
 * Reference class name: TrigCyl
 * Reference DLL name: Trigger
 * Remap aliases: 0x0230
 *
 * Related packet paths:
 * - class: src/main/unknown/classes/class_0016_trigcyl.c
 * - family: src/main/unknown/dll_0126_trigger.c
 *
 * Width samples:
 * - 20w (0x50 bytes): clouddungeon.romlist.zlb, dbshrine.romlist.zlb, dfptop.romlist.zlb, ecshrine.romlist.zlb
 *
 * Inline object-def evidence:
 * - inline fields: pModelList
 * - model IDs: 0x00000473
...
enum obj_051B_TrigCyl_packet_info {
    ...
    TRIGCYL_OBJECT_DEF_BYTES = 0xA0,
    TRIGCYL_PLACEMENT_BYTES_MIN = 0x50,
    TRIGCYL_PLACEMENT_BYTES_MAX = 0x50,
};
#endif
