 ...
 *
 * Object def: 0x01D1 LINK_BlueMu
 * Output path: src/main/unknown/objects/obj_01D1_link_bluemu.c
 * Retail placements: 3
 * Root romlists: 1
...
enum obj_01D1_LINK_BlueMu_packet_info {
    ...
    LINK_BLUEMU_OBJECT_DEF_BYTES = 0x100,
    LINK_BLUEMU_PLACEMENT_BYTES_MIN = 0x20,
    LINK_BLUEMU_PLACEMENT_BYTES_MAX = 0x20,
};
#endif
