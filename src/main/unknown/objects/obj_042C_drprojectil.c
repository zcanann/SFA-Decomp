 ...
 *
 * Object def: 0x042C DRProjectil
 * Output path: src/main/unknown/objects/obj_042C_drprojectil.c
 * Retail placements: 7
 * Root romlists: 1
...
enum obj_042C_DRProjectil_packet_info {
    ...
    DRPROJECTIL_OBJECT_DEF_BYTES = 0xC0,
    DRPROJECTIL_PLACEMENT_BYTES_MIN = 0x24,
    DRPROJECTIL_PLACEMENT_BYTES_MAX = 0x24,
};
#endif
