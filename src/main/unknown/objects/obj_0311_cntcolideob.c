 ...
 *
 * Object def: 0x0311 CNTColideOb
 * Output path: src/main/unknown/objects/obj_0311_cntcolideob.c
 * Retail placements: 1
 * Root romlists: 1
...
enum obj_0311_CNTColideOb_packet_info {
    ...
    CNTCOLIDEOB_OBJECT_DEF_BYTES = 0xA0,
    CNTCOLIDEOB_PLACEMENT_BYTES_MIN = 0x24,
    CNTCOLIDEOB_PLACEMENT_BYTES_MAX = 0x24,
};
#endif
