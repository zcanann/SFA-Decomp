 ...
 *
 * Width samples:
 * - 10w (0x28 bytes): dfshrine.romlist.zlb, ecshrine.romlist.zlb, finalboss.romlist.zlb, fortress.romlist.zlb
 *
...
enum obj_05A8_AreaFXEmit_packet_info {
    ...
    AREAFXEMIT_OBJECT_DEF_BYTES = 0xA0,
    AREAFXEMIT_PLACEMENT_BYTES_MIN = 0x28,
    AREAFXEMIT_PLACEMENT_BYTES_MAX = 0x28,
};
#endif
