 ...
 *
 * Object def: 0x0520 TriggSetp
 * Output path: src/main/unknown/objects/obj_0520_triggsetp.c
 * Retail placements: 2
 * Root romlists: 2
 * Object-def size: 0xC0
 * Root placement widths: 20w x2
 * DLL ID: 0x0126
 * Class ID: 0x001A
 * Suggested outer boundary: single-def class inside shared DLL
 * Reference class name: TriggSetp
 * Reference DLL name: Trigger
 * Remap aliases: 0x0050
 *
 * Related packet paths:
 * - class: src/main/unknown/classes/class_001A_triggsetp.c
 * - family: src/main/unknown/dll_0126_trigger.c
 *
 * Width samples:
 * - 20w (0x50 bytes): moonpass.romlist.zlb, wgshrine.romlist.zlb
 *
 ...
 * - 0x0520 TriggSetp: placements=2, dll=0x0126, widths=20w x2
 *
 ...
 */
enum obj_0520_TriggSetp_packet_info {
    TRIGGSETP_DEF_ID = 0x0520,
    TRIGGSETP_DLL_ID = 0x0126,
    TRIGGSETP_CLASS_ID = 0x001A,
    TRIGGSETP_OBJECT_DEF_BYTES = 0xC0,
    TRIGGSETP_PLACEMENT_BYTES_MIN = 0x50,
    TRIGGSETP_PLACEMENT_BYTES_MAX = 0x50,
};
#endif
