 ...
 *
 * Object def: 0x0068 baddieInter
 * Output path: src/main/unknown/objects/obj_0068_baddieinter.c
 * Retail placements: 175
 * Root romlists: 10
 * Object-def size: 0xA0
 * Root placement widths: 9w x175
 * DLL ID: 0x00DE
 * Class ID: 0x0030
 * Suggested outer boundary: tight DLL family
 * Reference class name: various0030
 * Reference DLL name: baddieInterestP
 * Remap aliases: 0x0787
 *
 * Related packet paths:
 * - class: src/main/unknown/classes/class_0030_various0030.c
 * - family: src/main/unknown/dll_00DE_baddieinterestp.c
 *
 * Width samples:
 ...
 *
 * Same-DLL objects (1 defs / 175 placements):
...
enum obj_0068_baddieInter_packet_info {
    ...
    BADDIEINTER_OBJECT_DEF_BYTES = 0xA0,
    BADDIEINTER_PLACEMENT_BYTES_MIN = 0x24,
    BADDIEINTER_PLACEMENT_BYTES_MAX = 0x24,
};
#endif
