 ...
 *
 * Object def: 0x0077 DIMbossfire
 * Output path: src/main/unknown/objects/obj_0077_dimbossfire.c
 * Retail placements: 6
 * Root romlists: 1
...
enum obj_0077_DIMbossfire_packet_info {
    ...
    DIMBOSSFIRE_OBJECT_DEF_BYTES = 0xA0,
    DIMBOSSFIRE_PLACEMENT_BYTES_MIN = 0x24,
    DIMBOSSFIRE_PLACEMENT_BYTES_MAX = 0x24,
};
#endif
