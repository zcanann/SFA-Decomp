 ...
 *
 * Object def: 0x051D TrigArea
 * Output path: src/main/unknown/objects/obj_051D_trigarea.c
 * Retail placements: 40
 * Root romlists: 13
 * Object-def size: 0xC0
 * Root placement widths: 20w x40
 * DLL ID: 0x0126
 * Class ID: 0x0017
 * Suggested outer boundary: single-def class inside shared DLL
 * Reference class name: TrigArea
 * Reference DLL name: Trigger
 * Remap aliases: 0x004D
 *
 * Related packet paths:
 * - class: src/main/unknown/classes/class_0017_trigarea.c
 * - family: src/main/unknown/dll_0126_trigger.c
 *
 * Width samples:
 * - 20w (0x50 bytes): capeclaw.romlist.zlb, clouddungeon.romlist.zlb, dbshrine.romlist.zlb, dragrock.romlist.zlb
 *
 ...
 *
 * Same-class objects (1 defs / 40 placements):
 * - 0x051D TrigArea: placements=40, dll=0x0126, widths=20w x40
 *
...
enum obj_051D_TrigArea_packet_info {
    ...
    TRIGAREA_OBJECT_DEF_BYTES = 0xC0,
    TRIGAREA_PLACEMENT_BYTES_MIN = 0x50,
    TRIGAREA_PLACEMENT_BYTES_MAX = 0x50,
};
#endif
