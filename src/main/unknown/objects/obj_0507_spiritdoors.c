 ...
 *
 * Object def: 0x0507 SpiritDoorS
 * Output path: src/main/unknown/objects/obj_0507_spiritdoors.c
 * Retail placements: 38
 * Root romlists: 10
 * Object-def size: 0xA0
 * Root placement widths: 9w x38
 * DLL ID: 0x0157
 * Class ID: 0x0030
 * Suggested outer boundary: tight DLL family
 * Reference class name: various0030
 * Reference DLL name: SpiritDoorSpirit
 * Remap aliases: 0x0795
 *
 * Related packet paths:
 * - class: src/main/unknown/classes/class_0030_various0030.c
 * - family: src/main/unknown/dll_0157_spiritdoorspirit.c
 *
 * Width samples:
 * - 9w (0x24 bytes): dragrock.romlist.zlb, ecshrine.romlist.zlb, fortress.romlist.zlb, moonpass.romlist.zlb
 *
 * Inline object-def evidence:
 * - inline fields: pModelList
 * - model IDs: 0x00000340
...
enum obj_0507_SpiritDoorS_packet_info {
    ...
    SPIRITDOORS_OBJECT_DEF_BYTES = 0xA0,
    SPIRITDOORS_PLACEMENT_BYTES_MIN = 0x24,
    SPIRITDOORS_PLACEMENT_BYTES_MAX = 0x24,
};
#endif
