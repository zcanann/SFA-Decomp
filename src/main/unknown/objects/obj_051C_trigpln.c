 ...
 *
 * Object def: 0x051C TrigPln
 * Output path: src/main/unknown/objects/obj_051C_trigpln.c
 * Retail placements: 1218
 * Root romlists: 46
 * Object-def size: 0xC0
 * Root placement widths: 20w x1218
 * DLL ID: 0x0126
 * Class ID: 0x0015
 * Suggested outer boundary: single-def class inside shared DLL
 * Reference class name: TrigPln
 * Reference DLL name: Trigger
 * Remap aliases: 0x004C
 *
 * Related packet paths:
 * - class: src/main/unknown/classes/class_0015_trigpln.c
 * - family: src/main/unknown/dll_0126_trigger.c
 *
 * Width samples:
 * - 20w (0x50 bytes): capeclaw.romlist.zlb, clouddungeon.romlist.zlb, cloudjoin.romlist.zlb, cloudrace.romlist.zlb
 *
 * Inline object-def evidence:
 * - inline fields: pModelList
 * - model IDs: 0x00000472 0x0000045A
 * - help texts: 0xFFFF 0xFFFF 0xFFFF 0xFFFF
 *
 * Same-class objects (1 defs / 1218 placements):
 * - 0x051C TrigPln: placements=1218, dll=0x0126, widths=20w x1218
 *
...
enum obj_051C_TrigPln_packet_info {
    ...
    TRIGPLN_OBJECT_DEF_BYTES = 0xC0,
    TRIGPLN_PLACEMENT_BYTES_MIN = 0x50,
    TRIGPLN_PLACEMENT_BYTES_MAX = 0x50,
};
#endif
