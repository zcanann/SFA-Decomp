 ...
 *
 * Object def: 0x051F TrigButt
 * Output path: src/main/unknown/objects/obj_051F_trigbutt.c
 * Retail placements: 1
 * Root romlists: 1
 * Object-def size: 0xC0
 * Root placement widths: 20w x1
 * DLL ID: 0x0126
 * Class ID: 0x0019
 * Suggested outer boundary: single-def class inside shared DLL
 * Reference class name: TrigButt
 * Reference DLL name: Trigger
 * Remap aliases: 0x004F
 *
 * Related packet paths:
 * - class: src/main/unknown/classes/class_0019_trigbutt.c
 * - family: src/main/unknown/dll_0126_trigger.c
 *
 * Width samples:
 * - 20w (0x50 bytes): hollow2.romlist.zlb
 *
 ...
 * - 0x051F TrigButt: placements=1, dll=0x0126, widths=20w x1
 *
 ...
 */
enum obj_051F_TrigButt_packet_info {
    TRIGBUTT_DEF_ID = 0x051F,
    TRIGBUTT_DLL_ID = 0x0126,
    TRIGBUTT_CLASS_ID = 0x0019,
    TRIGBUTT_OBJECT_DEF_BYTES = 0xC0,
    TRIGBUTT_PLACEMENT_BYTES_MIN = 0x50,
    TRIGBUTT_PLACEMENT_BYTES_MAX = 0x50,
};
#endif
