 ...
 *
 * Object def: 0x02B0 SH_whitemus
 * Output path: src/main/unknown/objects/obj_02B0_sh_whitemus.c
 * Retail placements: 6
 * Root romlists: 1
 ...
 *
 * Width samples:
 * - 8w (0x20 bytes): hollow2.romlist.zlb
 *
 * Inline object-def evidence:
 * - inline fields: pModelList, pSeq, hitboxes, aButtonInteraction
 * - model IDs: 0x000000D7
 * - sequence IDs: 0x0000
 * - help texts: 0x0056 0xFFFF 0xFFFF 0xFFFF
 *
...
enum obj_02B0_SH_whitemus_packet_info {
    ...
    SH_WHITEMUS_OBJECT_DEF_BYTES = 0x100,
    SH_WHITEMUS_PLACEMENT_BYTES_MIN = 0x20,
    SH_WHITEMUS_PLACEMENT_BYTES_MAX = 0x20,
};
#endif
