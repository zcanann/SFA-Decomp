/*
 * Exploratory class packet for the retail-backed TrigPnt class family.
 *
 ...
 * Suggested packet name: TrigPnt
 * Output path: src/main/unknown/classes/class_0014_trigpnt.c
 ...
 *
 * Retail object defs:
 * - 0x051A TrigPnt: dll=0x0126, placements=47, romlists=14, objsize=0xC0, widths=20w x47, aliases=0x004B
 *
 ...
 */
enum class_0014_TrigPnt_defs {
    TRIGPNT_TRIGPNT = 0x051A,
};
#endif
