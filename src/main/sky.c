...
void fn_8008C9F4(u8* cfg, u8 flags)
{
    ...
    b1 = (((Sky2Config*)cfg)->flags & 0x80) ? 1 : 0;
    *(int*)((&gSky2State)[b1]) = 0;
    ...
    for (i = 0; i < SKY_CONFIG_FIELD_COUNT; i++)
    {
        ...
        *(f32*)((&gSky2State)[b1] + i * 4 + 0x14c) = (f32)(u32)
        cfg[gSkyConfigFieldIndices[i] + 0x1c];
        *(f32*)((&gSky2State)[b1] + i * 4 + 0x254) = (f32)(u32) * (u16*)(cfg + gSkyConfigFieldIndices[i] * 2 + 0x3e);
        *(f32*)((&gSky2State)[b1] + i * 4 + 0x280) = (f32)(u32) * (u16*)(cfg + gSkyConfigFieldIndices[i] * 2 + 0x2e);
    }
    *(u16*)((&gSky2State)[b1] + 4) = ((Sky2Config*)cfg)->flags;
    *(u16*)((&gSky2State)[b1] + 6) = ((Sky2Config*)cfg)->flags2;
    ...
    *(f32*)((&gSky2State)[b1] + 0x6c) = lbl_803DF108;
    ...
    if (((Sky2Config*)cfg)->unk2A != 0)
    {
        ...
        *(int*)((&gSky2State)[b1] + 8) = ((Sky2Config*)cfg)->skyTexId0;
