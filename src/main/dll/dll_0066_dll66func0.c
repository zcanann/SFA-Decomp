...
void dll_66_func03(int sourceObj, int variant, int posSource, uint flags)
{
    ...
    buf.entries[15].tex = &tab[432];
    buf.entries[15].mode = 0x4000;
    buf.entries[15].x = lbl_803E0990;
    buf.entries[15].y = lbl_803E0998;
