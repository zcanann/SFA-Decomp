...
void dll_6A_func03(u8* sourceObj, int variant, u8* posSource, uint flags)
{
    ...
    if ((buf.flags & 1) != 0)
    {
        ...
        {
            buf.pos[0] = lbl_803E0A28 + ((PartFxSpawnParams*)posSource)->posX;
            buf.pos[1] = lbl_803E0A28 + ((PartFxSpawnParams*)posSource)->posY;
            buf.pos[2] = lbl_803E0A28 + ((PartFxSpawnParams*)posSource)->posZ;
        }
    }
