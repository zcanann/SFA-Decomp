    ...
    *(int*)buf = lbl_803E1E08;
    ...
    if (arwing != NULL)
    {
        ...
        for (; (int)(pip = i & 0xff) < maxPips; i++)
        {
            ...
            drawTexture(hudTextures[texIdx], (f32)(int)(pip * 0x21 + 0x1e), lbl_803E1FAC, arwingHudAlpha, 0x100);
        }
        ...
        if (((GameObject*)arwing)->anim.mapEventSlot != 0x26)
        {
            ...
            {
                drawTexture(hudTextures[60], (f32)(int)(0x244 - (i & 0xff) * 0x14), lbl_803E1F9C, arwingHudAlpha,
                            0x100);
            }
            for (; (int)(pip = i & 0xff) < req; i++)
            {
                drawTexture(hudTextures[59], (f32)(int)(0x244 - pip * 0x14), lbl_803E1F9C, arwingHudAlpha, 0x100);
            }
