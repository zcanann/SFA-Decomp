...
void FUN_801c8ebc(int param_1,int param_2)
{
  ...
  *(float *)(param_1 + 0x10) = *(float *)(param_1 + 0x10) - lbl_803E5D1C;
  fVar1 = lbl_803E5D00;
  ...
  *(undefined *)(param_1 + 0x37) = 0;
  puVar3[7] = lbl_803E5D00;
  if (DAT_803de848 == 0) {
    DAT_803de848 = ObjGroup_FindNearestObject(0xb,param_1,local_18);
  }
