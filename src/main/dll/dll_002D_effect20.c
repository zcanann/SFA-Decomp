...
/* descriptor/ptr table auto 0x803112e4-0x80311518 */
u32 lbl_803112E8[22] = { 0x00000000, 0x00000000, 0x00000000, 0x00110000, (u32)Checkpoint_initialise, (u32)Checkpoint_release, 0x00000000, (u32)Checkpoint_reset, (u32)Checkpoint_Add, (u32)Checkpoint_remove, (u32)Checkpoint_func06, (u32)Checkpoint_func07, (u32)Checkpoint_func08, (u32)Checkpoint_func09_ret_1, (u32)Checkpoint_func0A, (u32)Checkpoint_find, (u32)Checkpoint_func0C, (u32)Checkpoint_func0D, (u32)Checkpoint_func0E, (u32)Checkpoint_func0F, (u32)Checkpoint_func10, (u32)Checkpoint_onGameLoop };
u32 lbl_80311340[14] = { 0x00000000, 0x00000000, 0x00000000, 0x00080000, 0x00000000, 0x00000000, 0x00000000, (u32)screenTransition_do2, (u32)screenTransition_Do, (u32)screenTransition_screenFade, (u32)screenTransition_fadeFrom, (u32)screenTransition_func07, (u32)screenTransition_getAlpha, 0x00000000 };
u32 lbl_80311378[48] = { 0x00000000, 0x00000000, 0x00000000, 0x002b0000, (u32)Dummy04_initialise, (u32)Dummy04_release, 0x00000000, (u32)Dummy04_func03_ret_m1, (u32)Dummy04_func04_nop, (u32)Dummy04_func05_ret_0, (u32)Dummy04_onSetupPlayer, (u32)Dummy04_func07_nop, (u32)Dummy04_func08_nop, (u32)Dummy04_onSelectSave, (u32)Dummy04_func0A_ret_0, (u32)Dummy04_func0B_ret_0, (u32)Dummy04_func0C_nop, (u32)Dummy04_func0D_ret_0, (u32)Dummy04_func0E_nop, (u32)Dummy04_func0F_ret_0, (u32)Dummy04_func10_nop, (u32)Dummy04_func11_ret_0, (u32)Dummy04_func12_nop, (u32)Dummy04_func13_nop, (u32)Dummy04_func14_nop, (u32)Dummy04_func15_nop, (u32)Dummy04_func16_nop, (u32)Dummy04_func17_nop, (u32)Dummy04_func18_nop, (u32)Dummy04_func19_nop, (u32)Dummy04_func1A_nop, (u32)Dummy04_func1B_nop, (u32)Dummy04_func1C_nop, (u32)Dummy04_func1D_ret_0, (u32)Dummy04_func1E_nop, (u32)Dummy04_func1F_nop, (u32)Dummy04_func20_nop, (u32)Dummy04_func21_ret_0, (u32)Dummy04_func22_ret_127, (u32)Dummy04_func23_nop, (u32)Dummy04_func24_ret_0, (u32)Dummy04_func25_nop, (u32)Dummy04_func26_nop, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000 };
u32 lbl_80311438[30] = { 0x00000000, 0x00000000, 0x00000000, 0x00190000, (u32)player_initialise, (u32)player_release, 0x00000000, (u32)player_init, (u32)player_update, (u32)player_updateVel, (u32)player_setOverride, (u32)player_setState, (u32)player_followCurve, (u32)player_getExtraSize, (u32)player_setScale, (u32)dll_0F_func0B, (u32)player_modelMtxFn, (u32)player_render2, (u32)player_rotateTowardEnemy, (u32)player_playSoundFn0F, (u32)player_playSoundFn10, (u32)player_findCurve, (u32)player_updateCurve, (u32)dll_0F_func13, (u32)player_clearXZvel, (u32)player_setAnimIds, (u32)player_animFn16, (u32)player_doProjGfx, (u32)player_updateParticles, (u32)dll_0F_func19_nop };
u32 lbl_803114B0[10] = { 0x00000000, 0x00000000, 0x00000000, 0x00050000, (u32)UIController_initialise, (u32)UIController_release, 0x00000000, (u32)UIController_frameStart, (u32)UIController_frameEnd, (u32)UIController_render };
u32 lbl_803114D8[16] = { 0x00000000, 0x00000000, 0x00000000, 0x000a0000, (u32)Dummy12_initialise, (u32)Dummy12_release, 0x00000000, (u32)dll_12_func03_nop, (u32)dll_12_func04_nop, (u32)dll_12_func05_nop, (u32)dll_12_func06_ret_0, (u32)dll_12_func07_nop, (u32)dll_12_func08_nop, (u32)dll_12_func09, (u32)dll_12_func0A_nop, 0x00000000 };
