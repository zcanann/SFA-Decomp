            ...
            case 3:
                {
                    ...
                    if (found != 0)
                    {
                        ...
                        *(f32*)((char*)inner + 0x6a8) = ((PlayerState *)inner)->savedPosY;
                        *(f32*)((char*)inner + 0x6ac) = ((PlayerState *)inner)->savedPosZ;
...
int fn_802A8680(int p1, int p2, int src, int vec, int out, int flag)
{
    ...
    *(f32*)((char*)out + 0x3c) = *(f32*)((char*)src + 0x1c);
    c38 = *(f32*)((char*)out + 0x38);
    *(f32*)((char*)out + 0x40) = -(*(f32*)((char*)out + 0x48) * c38 +
