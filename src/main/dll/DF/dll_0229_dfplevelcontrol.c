             ...
             undefined4 param_15, undefined4 param_16)
{
    ...
    *(byte*)(control + 0x15) = *(byte*)(control + 0x15) | 4;
    ((BaddieState*)state)->moveSpeed = lbl_803E6F80;
             ...
             undefined4 param_15, undefined4 param_16)
{
    ...
    *(byte*)(control + 0x15) = *(byte*)(control + 0x15) & 0xfb;
    ...
    ((BaddieState*)state)->animSpeedA = ((BaddieState*)state)->animSpeedA / lbl_803E6F88;
    ((BaddieState*)state)->animSpeedB = ((BaddieState*)state)->animSpeedB / divisor;
    ((BaddieState*)state)->moveSpeed = lbl_803E6F8C;
    if (*(s8*)&((BaddieState*)state)->moveJustStartedA != '\0')
    {
        ...
        (((GameObject*)obj)->anim.localPosY < *(float*)(*(int*)(state + 0x2d0) + 0x10) - lbl_803E6F90))
    {
        ...
        {
            msgNear_2 = *(undefined4*)(state + 0x2d0);
    ...
    else
    {
        ...
        *(undefined*)(control + 0x34) = 1;
        msgGiveup_2 = *(undefined4*)(state + 0x2d0);
        port = *(short**)(control + 0x24);
        msgGiveup_0 = 7;
        msgGiveup_1 = 1;
        portBusy = FUN_80006ab8(port);
             ...
             undefined4 param_15, undefined4 param_16)
{
    ...
    if (*(s8*)&((BaddieState*)state)->moveJustStartedA != '\0')
    {
        *(undefined4*)(state + 0x2d0) = 0;
        ...
        if (subState == 0)
        {
            ...
            FUN_80006824(obj, (ushort) * (undefined4*)(&DAT_8032a290 + sfxIndex * 4));
        }
        else
        {
    ...
    ((BaddieState*)state)->unk34D = 0x10;
    ((BaddieState*)state)->moveSpeed = lbl_803E6FD8;
    ((BaddieState*)state)->animSpeedA = lbl_803E6F40;
             ...
             undefined4 param_15, undefined4 param_16)
{
    ...
    {
        FUN_800305f8((double)lbl_803E6F40, param_2, param_3, param_4, param_5, param_6, param_7, param_8,
                     obj, 10, 0, noTarget, param_13, param_14, param_15, param_16);
        ((BaddieState*)state)->moveDone = 0;
    }
    ((BaddieState*)state)->unk34D = 1;
    control = *(int*)(control + 0x40c);
    *(byte*)(control + 0x14) = *(byte*)(control + 0x14) | 2;
    if ((((BaddieState*)state)->eventFlags & 1) != 0)
    {
        ((BaddieState*)state)->eventFlags = ((BaddieState*)state)->eventFlags & ~1;
             ...
             undefined4 param_15, undefined4 param_16)
{
    ...
    {
        FUN_800305f8((double)lbl_803E6F40, param_2, param_3, param_4, param_5, param_6, param_7, param_8,
                     obj, 5, 0, noTarget, param_13, param_14, param_15, param_16);
        ((BaddieState*)state)->moveDone = 0;
    }
    ((BaddieState*)state)->unk34D = 1;
    return 0;
             ...
             undefined4 param_15, undefined4 param_16)
{
    ...
    if (*(s8*)&((BaddieState*)state)->moveJustStartedA != '\0')
    {
        ...
        if (pick == 0)
        {
            ...
            {
                FUN_800305f8((double)lbl_803E6F40, param_2, param_3, param_4, param_5, param_6, param_7, param_8,
                             obj, 7, 0, noTarget, param_13, param_14, param_15, param_16);
                ((BaddieState*)state)->moveDone = 0;
            }
        }
        else if (*(s8*)&((BaddieState*)state)->moveJustStartedA != '\0')
        {
            FUN_800305f8((double)lbl_803E6F40, param_2, param_3, param_4, param_5, param_6, param_7, param_8,
                         obj, 6, 0, noTarget, param_13, param_14, param_15, param_16);
            ((BaddieState*)state)->moveDone = 0;
        }
        ((BaddieState*)state)->unk34D = 1;
...
undefined4
FUN_80202004(double param_1, double param_2, undefined8 param_3, double param_4, ushort* selfObj,
             int targetObj)
{
    int yawDelta;
    undefined4 result;
    ...
    sub = *(int*)(selfObj + 0x5c);
    yawDelta = Obj_GetYawDeltaToObject(selfObj, targetObj, out);
...
undefined4
FUN_80202130(double param_1, double param_2, undefined8 param_3, double param_4, ushort* selfObj,
             int targetObj)
{
    int yawDelta;
    int sub;
    ...
    sub = *(int*)(selfObj + 0x5c);
    if ((selfObj != (ushort*)0x0) && (targetObj != 0))
    {
        yawDelta = Obj_GetYawDeltaToObject(selfObj, targetObj, out);
        if ((double)lbl_803E6F40 != param_4)
        {
            ...
            {
                heightDiff = (double)(*(float*)(selfObj + 8) - *(float*)(targetObj + 0x10));
...
void dfplevelcontrol_init(int obj, int init)
{
