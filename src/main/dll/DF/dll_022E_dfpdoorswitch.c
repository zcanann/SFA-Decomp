             ...
             undefined4 param_15, undefined4 param_16)
{
    ...
    *(byte*)(control + 0x15) = *(byte*)(control + 0x15) & 0xfb;
    ...
    ((BaddieState*)state)->animSpeedB = ((BaddieState*)state)->animSpeedB / scaleDiv;
        ...
        (((GameObject*)obj)->anim.localPosY < *(float*)(*(int*)(state + 0x2d0) + 0x10) - lbl_803E6F90))
    {
        ...
        {
            msgA_target = *(undefined4*)(state + 0x2d0);
    ...
    else
    {
        ...
        *(undefined*)(control + 0x34) = 1;
        msgB_target = *(undefined4*)(state + 0x2d0);
        msgPort = *(short**)(control + 0x24);
        msgD_id = 7;
        msgD_arg = 1;
        isQueued = FUN_80006ab8(msgPort);
