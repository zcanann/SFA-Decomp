             ...
             undefined4 param_15, undefined4 param_16)
{
    ...
    *(byte*)(control + 0x15) = *(byte*)(control + 0x15) & 0xfb;
    ...
    ((BaddieState*)baddie)->animSpeedB = ((BaddieState*)baddie)->animSpeedB / scale;
        ...
        (((GameObject*)obj)->anim.localPosY < *(float*)(*(int*)(baddie + 0x2d0) + 0x10) - lbl_803E6F90))
    {
        ...
        {
            msgA_arg2 = *(undefined4*)(baddie + 0x2d0);
    ...
    else
    {
        ...
        *(undefined*)(control + 0x34) = 1;
        msgC_arg2 = *(undefined4*)(baddie + 0x2d0);
        msgQueue = *(short**)(control + 0x24);
        msgC_arg0 = 7;
        msgC_arg1 = 1;
        queueFull = FUN_80006ab8(msgQueue);
             ...
             undefined4 param_15, undefined4 param_16)
{
    ...
    {
        FUN_800305f8((double)lbl_803E6F40, param_2, param_3, param_4, param_5, param_6, param_7, param_8,
                     obj, 10, 0, animArg, param_13, param_14, param_15, param_16);
        ((BaddieState*)baddie)->moveDone = 0;
    }
             ...
             undefined4 param_15, undefined4 param_16)
{
    ...
    {
        FUN_800305f8((double)lbl_803E6F40, param_2, param_3, param_4, param_5, param_6, param_7, param_8,
                     obj, 5, 0, animArg, param_13, param_14, param_15, param_16);
        ((BaddieState*)baddie)->moveDone = 0;
    }
    ((BaddieState*)baddie)->unk34D = 1;
    return 0;
             ...
             undefined4 param_15, undefined4 param_16)
{
    ...
    if (*(s8*)&((BaddieState*)baddie)->moveJustStartedA != '\0')
    {
        ...
        if (randomChoice == 0)
        {
            ...
            {
                FUN_800305f8((double)lbl_803E6F40, param_2, param_3, param_4, param_5, param_6, param_7, param_8,
                             obj, 7, 0, animArg, param_13, param_14, param_15, param_16);
                ((BaddieState*)baddie)->moveDone = 0;
            }
        }
        ...
        {
            FUN_800305f8((double)lbl_803E6F40, param_2, param_3, param_4, param_5, param_6, param_7, param_8,
                         obj, 6, 0, animArg, param_13, param_14, param_15, param_16);
            ((BaddieState*)baddie)->moveDone = 0;
        }
        ((BaddieState*)baddie)->unk34D = 1;
             ...
             int target)
{
    ...
    stateBase = *(int*)(obj + 0x5c);
    yaw = Obj_GetYawDeltaToObject(obj, target, outVec);
             ...
             int target)
{
    ...
    if ((obj != (ushort*)0x0) && (target != 0))
    {
        ...
        if ((double)lbl_803E6F40 != param_4)
        {
            ...
            {
                deltaY = (double)(*(float*)(obj + 8) - *(float*)(target + 0x10));
