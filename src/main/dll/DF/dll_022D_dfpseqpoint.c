             ...
             undefined4 param_15, undefined4 param_16)
{
    ...
    *(byte*)(control + 0x15) = *(byte*)(control + 0x15) & 0xfb;
        ...
        (((GameObject*)obj)->anim.localPosY < *(float*)(*(int*)(state + 0x2d0) + 0x10) - lbl_803E6F90))
    {
        ...
        {
            msgA_arg2 = *(undefined4*)(state + 0x2d0);
    ...
    else
    {
        ...
        *(undefined*)(control + 0x34) = 1;
        msgC_arg2 = *(undefined4*)(state + 0x2d0);
        msgQueue = *(short**)(control + 0x24);
        msgC_id = 7;
        msgC_arg1 = 1;
        queueFull = FUN_80006ab8(msgQueue);
    ...
    if (*(s8*)&((BaddieState*)state)->moveJustStartedA != '\0')
    {
        *(undefined4*)(state + 0x2d0) = 0;
        ...
        if (useAltSfx == 0)
        {
            ...
            FUN_80006824(obj, (ushort) * (undefined4*)(&DAT_8032a290 + queueFull * 4));
        }
        else
        {
             ...
             undefined4 param_15, undefined4 param_16)
{
    ...
    {
        FUN_800305f8((double)lbl_803E6F40, param_2, param_3, param_4, param_5, param_6, param_7, param_8,
                     obj, 10, 0, msgArg, param_13, param_14, param_15, param_16);
        ((BaddieState*)state)->moveDone = 0;
    }
             ...
             undefined4 param_15, undefined4 param_16)
{
    ...
    {
        FUN_800305f8((double)lbl_803E6F40, param_2, param_3, param_4, param_5, param_6, param_7, param_8,
                     obj, 5, 0, msgArg, param_13, param_14, param_15, param_16);
        ((BaddieState*)state)->moveDone = 0;
    }
    ((BaddieState*)state)->unk34D = 1;
    return 0;
             ...
             undefined4 param_15, undefined4 param_16)
{
    ...
    if (*(s8*)&((BaddieState*)state)->moveJustStartedA != '\0')
    {
        ...
        if (animSel == 0)
        {
            ...
            {
                FUN_800305f8((double)lbl_803E6F40, param_2, param_3, param_4, param_5, param_6, param_7, param_8,
                             obj, 7, 0, msgArg, param_13, param_14, param_15, param_16);
                ((BaddieState*)state)->moveDone = 0;
            }
        }
        ...
        {
            FUN_800305f8((double)lbl_803E6F40, param_2, param_3, param_4, param_5, param_6, param_7, param_8,
                         obj, 6, 0, msgArg, param_13, param_14, param_15, param_16);
            ((BaddieState*)state)->moveDone = 0;
        }
        ((BaddieState*)state)->unk34D = 1;
             ...
             int targetObj)
{
    ...
    state = *(int*)(selfObj + 0x5c);
    yawDelta = Obj_GetYawDeltaToObject(selfObj, targetObj, yawOut);
