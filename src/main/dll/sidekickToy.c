...
void objAnimFn_8014a9f0(short *obj, int state)
{
  ...
  if ((*(uint *)(state + 0x2e4) & 0x400) != 0) {
    characterDoEyeAnims(obj, (void *)(state + 0x26c));
  }
  if ((*(void **)(state + 0x29c) != 0) && ((*(uint *)(state + 0x2e4) & 0x800) != 0)) {
    fn_8003B0D0(obj, *(int *)(state + 0x29c), (void *)(state + 0x26c), 0x19);
  }
  *(u8 *)(state + 0x2f0) = *(u8 *)(state + 0x2ef);
  flags = *(uint *)(state + 0x2dc);
  if ((flags & 0x800) != 0) {
    ...
    *(u8 *)(state + 0x2ef) = 2;
    if (((*(uint *)(state + 0x2dc) & 0x100) != 0) && ((*(uint *)(state + 0x2e0) & 0x100) == 0)) {
  ...
  if (*(u8 *)(state + 0x2ef) != *(u8 *)(state + 0x2f0)) {
    *(uint *)(state + 0x2dc) = *(uint *)(state + 0x2dc) | 0x80000000;
  }
  else {
  ...
  *(u16 *)(state + 0x2f8) = 0;
  for (i = 0; i < res.eventCount; i++) {
    *(u16 *)(state + 0x2f8) |= 1 << res.events[i];
  }
  vy = lbl_803E2574;
  if ((((*(uint *)(state + 0x2e4) & 0x20) != 0) && ((*(uint *)(state + 0x2e4) & 0x400000) == 0))
      && (((*(uint *)(state + 0x2dc) & 0x1800) == 0) && ((*(u8 *)(state + 0x323) & 4) == 0))) {
  ...
  *(f32 *)(obj + 0x16) = c;
  ...
  else if ((*(uint *)(state + 0x2e4) & 0x100) != 0) {
    mode = 2;
  }
  else if ((*(uint *)(state + 0x2e4) & 0x10) != 0) {
    mode = 3;
  }
  if (((*(uint *)(state + 0x2e4) & 0x200) != 0) && ((*(uint *)(state + 0x2dc) & 0x4010) != 0)) {
    mode = 3;
  }
  if (mode == 1) {
    f32 zero;
    ...
    if ((*(u8 *)(state + 0x323) & 4) != 0) {
      dy = res.dy * oneOverTimeDelta;
    }
    if ((*(u8 *)(state + 0x323) & 1) != 0) {
    ...
    if ((*(u8 *)(state + 0x2f1) & 0x80) == 0) {
      *(f32 *)(obj + 0x12) = *(f32 *)(obj + 0x12) * powfBitEstimate(*(f32 *)(state + 0x304), timeDelta);
      *(f32 *)(obj + 0x14) = *(f32 *)(obj + 0x14) * powfBitEstimate(*(f32 *)(state + 0x304), timeDelta);
      *(f32 *)(obj + 0x16) = *(f32 *)(obj + 0x16) * powfBitEstimate(*(f32 *)(state + 0x304), timeDelta);
    }
  }
  Tricky_applyFloorResponse(obj, state);
  if (((*(uint *)(state + 0x2e4) & 0x400000) != 0) || ((*(uint *)(state + 0x2dc) & 0x8100000) != 0)) {
    if ((*(u8 *)(state + 0x2f1) & 0x80) == 0) {
      ...
      *(undefined *)((int)param_10 + 0x2ef) = 2;
      if (((param_10[0xb7] & 0x100U) != 0) && ((param_10[0xb8] & 0x100U) == 0)) {
        ...
        if ((double)lbl_803E31FC == param_2) {
          param_10[0xc2] = (int)lbl_803E3208;
        }
        else {
          param_10[0xc2] = (int)(lbl_803E3200 / (float)((double)lbl_803E3204 * param_2));
        }
      ...
      if ((param_10[0xb7] & 0x40000000U) == 0) {
        local_58 = (longlong)(int)(lbl_803E3210 * *(float *)(param_9 + 0x4c));
        *(char *)(param_9 + 0x1b) = (char)(int)(lbl_803E3210 * *(float *)(param_9 + 0x4c));
        param_9[3] = param_9[3] & 0xbfff;
      }
      else {
        param_10[0xc2] = (int)lbl_803E320C;
...
LAB_8014b804:
  ...
  local_9d = '\0';
  iVar6 = FUN_8002fc3c((double)(float)param_10[0xc2],(double)lbl_803DC074);
  if (iVar6 == 0) {
  ...
  *(float *)(param_9 + 0x16) = fVar4;
  ...
  if (iVar6 == 1) {
    dVar12 = (double)lbl_803E31FC;
    bVar1 = *(byte *)((int)param_10 + 0x323);
    dVar11 = dVar12;
    if ((bVar1 & 2) != 0) {
      dVar11 = (double)(local_b8 * lbl_803DC078);
    }
    dVar10 = dVar12;
    if ((bVar1 & 4) != 0) {
      dVar10 = (double)(local_b4 * lbl_803DC078);
    }
    if ((bVar1 & 1) != 0) {
      dVar12 = (double)(-local_b0 * lbl_803DC078);
    }
    if ((bVar1 & 8) != 0) {
    ...
    local_ce = param_9[1];
    local_cc = param_9[2];
    local_c8 = lbl_803E3200;
    local_c4 = lbl_803E31FC;
    local_c0 = lbl_803E31FC;
    local_bc = lbl_803E31FC;
    FUN_80017754(afStack_9c,&local_d0);
    if ((*(byte *)((int)param_10 + 0x323) & 4) == 0) {
      FUN_80017778(dVar11,(double)lbl_803E31FC,-dVar12,afStack_9c,(float *)(param_9 + 0x12),
    ...
    dVar11 = (double)FUN_80293130((double)(float)param_10[0xc1],(double)lbl_803DC074);
  ...
  if (((param_10[0xb9] & 0x400000U) == 0) && ((param_10[0xb7] & 0x8100000U) == 0)) {
    if ((param_10[0xb9] & 0x20U) == 0) {
      ...
      FUN_80017a88((double)(*(float *)(param_9 + 0x12) * lbl_803DC074),
                   (double)(-(lbl_803E3268 *
                              (float)param_10[0xc0] * lbl_803DC074 * lbl_803DC074 -
...
uint FUN_8014ca90(int param_1)
{
  ...
  if (param_1 == 0) {
    ...
    if (fVar1 == lbl_803E31FC) {
      ...
      uVar2 = (int)(fVar1 / lbl_803E322C) + 1U & 0xff;
    }
  }
  return uVar2;
}
                   ...
                   double param_6,double param_7,int param_8)
{
  ...
  if (dVar1 <= param_4) {
    if ((double)lbl_803E31FC < dVar1) {
      *(float *)(param_8 + 0x24) =
           lbl_803DC074 * (float)(param_5 * (double)(float)(dVar2 / param_4)) +
           *(float *)(param_8 + 0x24);
      *(float *)(param_8 + 0x28) =
           lbl_803DC074 * (float)(param_5 * (double)(float)(dVar4 / param_4)) +
           *(float *)(param_8 + 0x28);
      *(float *)(param_8 + 0x2c) =
           lbl_803DC074 * (float)(param_5 * (double)(float)(dVar3 / param_4)) +
           *(float *)(param_8 + 0x2c);
    }
  }
  else {
    *(float *)(param_8 + 0x24) =
         lbl_803DC074 * (float)(param_5 * (double)(float)(dVar2 / dVar1)) +
         *(float *)(param_8 + 0x24);
    *(float *)(param_8 + 0x28) =
         lbl_803DC074 * (float)(param_5 * (double)(float)(dVar4 / dVar1)) +
         *(float *)(param_8 + 0x28);
    *(float *)(param_8 + 0x2c) =
         lbl_803DC074 * (float)(param_5 * (double)(float)(dVar3 / dVar1)) +
         *(float *)(param_8 + 0x2c);
  }
  dVar1 = -param_6;
  ...
  if ((double)lbl_803E31FC != param_7) {
    dVar1 = (double)FUN_80293130(param_7,(double)lbl_803DC074);
  ...
  if ((flags & 1) != 0) {
    ...
    if (tgt != 0) {
      ...
      if ((flags & 2) != 0) {
        ...
        *(uint *)(state + 0x2dc) = *(uint *)(state + 0x2dc) & ~lbl_8031DBF0[ang];
        if ((flags & 4) != 0) {
    ...
    radius = (f32)(f64)radius * (f32)(f64)radius;
