...
void FUN_8014accc(int param_1,int param_2,float *param_3,float *param_4)
{
  ...
  *param_4 = fVar2;
  uVar7 = FUN_80065fcc((double)*(float *)(param_1 + 0xc),(double)*(float *)(param_1 + 0x10),
