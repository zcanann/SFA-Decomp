...
void objAnimFn_8014a9f0(short *obj, int state)
{
  ...
  if ((((TrickyState *)state)->flags2E4 & 0x400) != 0) {
    characterDoEyeAnims(obj, (void *)(state + 0x26c));
  }
  if ((*(void **)&((TrickyState *)state)->unk29C != 0) && ((((TrickyState *)state)->flags2E4 & 0x800) != 0)) {
  ...
  ((TrickyState *)state)->flags2F8 = 0;
  for (i = 0; i < res.eventCount; i++) {
    ((TrickyState *)state)->flags2F8 |= 1 << res.events[i];
  }
  vy = lbl_803E2574;
  if ((((((TrickyState *)state)->flags2E4 & 0x20) != 0) && ((((TrickyState *)state)->flags2E4 & 0x400000) == 0))
      && (((((TrickyState *)state)->flags2DC & 0x1800) == 0) && ((((TrickyState *)state)->bool323 & 4) == 0))) {
    vy = -(((TrickyState *)state)->speed300 * timeDelta - *(f32 *)(obj + 0x14));
  }
  v = *(f32 *)(obj + 0x12);
  ...
  *(f32 *)(obj + 0x16) = (v < lbl_803E25CC) ? lbl_803E25CC : ((v > lbl_803E25D0) ? lbl_803E25D0 : v);
  mode = 0;
  if (((((TrickyState *)state)->flags2E4 & 0x80) != 0) && (((TrickyState *)state)->bool323 != 0)) {
    mode = 1;
  }
  else if ((((TrickyState *)state)->flags2E4 & 0x100) != 0) {
    mode = 2;
  }
  else if ((((TrickyState *)state)->flags2E4 & 0x10) != 0) {
    mode = 3;
  }
  if (((((TrickyState *)state)->flags2E4 & 0x200) != 0) && ((((TrickyState *)state)->flags2DC & 0x4010) != 0)) {
    mode = 3;
  }
  if (mode == 1) {
    f32 zero;
    dx = (dz = lbl_803E2574);
    dy = dz;
    if ((((TrickyState *)state)->bool323 & 2) != 0) {
      dx = res.dx * oneOverTimeDelta;
    }
    if ((((TrickyState *)state)->bool323 & 4) != 0) {
      dy = res.dy * oneOverTimeDelta;
    }
    if ((((TrickyState *)state)->bool323 & 1) != 0) {
      dz = -res.dz * oneOverTimeDelta;
    }
    if ((((TrickyState *)state)->bool323 & 8) != 0) {
  ...
  if (((((TrickyState *)state)->flags2E4 & 0x400000) != 0) || ((((TrickyState *)state)->flags2DC & 0x8100000) != 0)) {
    if ((((TrickyState *)state)->flags2F1 & 0x80) == 0) {
      objMove(obj, *(f32 *)(obj + 0x12) * timeDelta, *(f32 *)(obj + 0x14) * timeDelta,
              *(f32 *)(obj + 0x16) * timeDelta);
    }
  }
  else if ((((TrickyState *)state)->flags2E4 & 0x20) != 0) {
    f32 newY = (*(f32 *)(obj + 0x14) * timeDelta + *(f32 *)(obj + 8))
                 - lbl_803E25D4 * (((TrickyState *)state)->speed300 * (timeDelta * timeDelta));
    if ((((TrickyState *)state)->flags2F1 & 0x80) == 0) {
...
int fn_8014C11C(short *obj, f32 radius, u8 flags, int max, TrickyTargetRec *out)
{
  ...
  if ((flags & 1) != 0) {
    ...
    if (tgt != 0) {
      ...
      n = 1;
      if ((flags & 2) != 0) {
        if ((((TrickyState *)state)->flags2E4 & 0x8000) != 0) {
...
int enemy_animEventCallback(int *node, int unused, ObjAnimUpdateState *animUpdate)
{
    ...
    if (((GameObject *)node)->classIdB4 == -1) {
        ((TrickyState *)sub)->flags2E8 &= ~3;
    ...
    if (n29[0x2e] != -1) {
        if ((((TrickyState *)sub)->flags2DC & 0x600) != 0) {
            if (animUpdate->sequenceSlot == ((GameObject *)node)->classIdB4)
                return 4;
        }
    }
    return 0;
...
void fn_8014B878(int *arg1, int *sub) {
    ...
    if (target != NULL && (((TrickyState *)sub)->flags2E4 & 0x10000) == 0 &&
        ...
        if ((((TrickyState *)sub)->flags2E4 & 0x10000) != 0 ||
    ...
    if (*(int**)&((TrickyState *)sub)->unk29C == player) {
        if (playerIsDisguised(player) != 0) {
            ...
            if ((((TrickyState *)sub)->flags2E4 & 0x2000) != 0) {
                ((TrickyState *)sub)->flags2DC &= 0xff7ff9ff;
            }
        }
    }
    if ((((TrickyState *)sub)->flags2DC & 0x20000600) != 0) {
        if ((((TrickyState *)sub)->flags2E4 & 0x1000) != 0) {
        ...
        if ((((TrickyState *)sub)->flags2E4 & 0x4000) == 0) {
        ...
        if ((((TrickyState *)sub)->flags2DC & 0x20000000) != 0) {
            if ((((TrickyState *)sub)->flags2E4 & 0x40) != 0) {
...
void fn_8014BC98(int *node, int *sub) {
    ...
    if (target != NULL) {
        ...
        if ((((TrickyState *)sub)->flags2E4 & 0x8000) != 0) {
