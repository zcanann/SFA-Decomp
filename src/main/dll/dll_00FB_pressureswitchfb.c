...
{
    s16 objType;
    PressureswitchfbPlacement* config;
    u32 handle;
    u32 offset;
    int runtime;
    ...
    config = (PressureswitchfbPlacement*)obj->anim.placementData;
