...
{
    vfplift_getState((struct GameObject*)(obj))->forceRaised = 1;
    return 0;
}
...
void vfplift23_updateState(int obj)
{
    ...
    {
        vfplift_setObjectHitEnabled((struct GameObject*)(obj));
...
{
    VfpLiftState* state = vfplift_getState((struct GameObject*)(obj));
