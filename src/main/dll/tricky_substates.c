...
static inline void trickyPlayWhineSfx(u32 id, u8* obj)
{
    ...
    {
        objAudioFn_800393f8Legacy(obj, ptr + 0x3a8, id, 0x500, -1, 0);
    }
}
...
void trickyDigTunnel(u8* obj, u8* state)
{
    ...
    case 0:
        ...
        if (((TrickyCurveNode*)((TrickyState*)state)->unk704)->walkGroup != 0)
        {
            *(u32*)&((TrickyState*)state)->unk704 =
                *(u32*)&((TrickyState*)state)->unk704 ^ *(u32*)&((TrickyState*)state)->unk708;
            *(u32*)&((TrickyState*)state)->unk708 =
                *(u32*)&((TrickyState*)state)->unk708 ^ *(u32*)&((TrickyState*)state)->unk704;
            *(u32*)&((TrickyState*)state)->unk704 =
                *(u32*)&((TrickyState*)state)->unk704 ^ *(u32*)&((TrickyState*)state)->unk708;
        }
    ...
    case 3:
        ...
        ((TrickyState*)state)->dirX =
            ((TrickyCurveNode*)((TrickyState*)state)->unk704)->x - ((TrickyCurveNode*)((TrickyState*)state)->unk700)->x;
        ((TrickyState*)state)->dirZ =
            ((TrickyCurveNode*)((TrickyState*)state)->unk704)->z - ((TrickyCurveNode*)((TrickyState*)state)->unk700)->z;
        ...
        if (*(f32*)&((TrickyState*)state)->unk70C <= lbl_803E23DC)
        {
            ...
            *(f32*)&((TrickyState*)state)->unk70C *= lbl_803E2424;
            ...
            if (((u32)((TrickyState*)ptr)->statusFlags >> 6 & 1) == 0 &&
                ...
                Sfx_IsPlayingFromObjectChannel((int)obj, 0x10) == 0)
            {
                objAudioFn_800393f8Legacy(obj, ptr + 0x3a8, 0x360, 0x500, -1, 0);
            }
        }
        spd = ((f32(**)(u8*, u8*))(**(u8***)(((TrickyState*)state)->followObj + 0x68)))[8](
            ((TrickyState*)state)->followObj, obj);
        ((GameObject*)obj)->anim.localPosX =
            ((TrickyState*)state)->dirX * spd + ((TrickyCurveNode*)((TrickyState*)state)->unk700)->x;
        ((GameObject*)obj)->anim.localPosZ =
            ((TrickyState*)state)->dirZ * spd + ((TrickyCurveNode*)((TrickyState*)state)->unk700)->z;
        ...
        *(f32*)&((TrickyState*)state)->unk700 += timeDelta;
        ...
        if (*(f32*)&((TrickyState*)state)->unk700 >= lbl_803E24F8)
        {
            ...
            *(f32*)&((TrickyState*)state)->unk708 = ((GameObject*)obj)->anim.worldPosZ;
            ...
            {
                pc = ((TrickyState*)state)->followObj;
                ((TrickyState*)state)->dirX = ((TrickyCurveNode*)ptr)->x - *(f32*)(pc + 0x18);
                ((TrickyState*)state)->dirZ = ((TrickyCurveNode*)ptr)->z - *(f32*)(pc + 0x20);
    ...
    else if ((u8)trickyFn_8013b368((int)obj, lbl_803E24C8, state) != 1)
    {
        ...
        if ((((u32) * (u8*)(tex + 0x58) >> 6) & 1) == 0)
        {
            ...
            if (move >= 48 || move < 41)
            {
                if (Sfx_IsPlayingFromObjectChannel(obj, 16) == 0)
                {
                    objAudioFn_800393f8Legacy(obj, (void*)(tex + 0x3a8), sfxId, 1280, -1, 0);
                }
            }
        }
        return 0;
        ...
        else
        {
            if (((TrickyState*)state)->stateFlags & TRICKY_STATE_FLAG_MOVE_ADVANCING)
            {
                ...
                if (((u32)((TrickyState*)ptr)->statusFlags >> 6 & 1) == 0 &&
                    ...
                    Sfx_IsPlayingFromObjectChannel((int)obj, 0x10) == 0)
                {
                    objAudioFn_800393f8Legacy(obj, ptr + 0x3a8, 0x29d, 0, -1, 0);
                }
                state[0xa] = 10;
            }
        }
    ...
    dobody:;
        ...
        if (((*(u8*)(tex + 0x58) >> 6) & 1) == 0u)
        {
            ...
            if (move >= 48 || move < 41)
            {
                ...
                {
                    objAudioFn_800393f8Legacy(obj, (void*)(tex + 0x3a8), 861, 1280, -1, 0);
                }
            }
        }
    }
    ...
    if ((u8)trickyFn_8013b368((int)obj, lbl_803E2418, state) != 1)
    {
        if (((TrickyState*)state)->childB != NULL)
        {
            ...
            if (((u32)((TrickyState*)ptr)->statusFlags >> 6 & 1) == 0 &&
                ...
                Sfx_IsPlayingFromObjectChannel((int)obj, 0x10) == 0)
            {
                objAudioFn_800393f8Legacy(obj, ptr + 0x3a8, 0x357, 0, -1, 0);
            }
    ...
    case 0x2a:
        *(float*)(trickyState + 0x1cf) = *(float*)(trickyState + 0x1cf) - timeDelta;
        ...
        for (val = 0; val < *(char*)((int)trickyState + 0x827); val++)
        {
            ...
            if (bval == '\0')
            {
                objAudioFn_800393f8Legacy(obj, (void*)(trickyState + 0xea), 0x390, 0x500, -1, 0);
            }
            else if (bval == '\a')
            {
                objAudioFn_800393f8Legacy(obj, (void*)(trickyState + 0xea), 0x391, 0x100, -1, 0);
            }
        }
...
int trickyFoodFn_801437d4(GameObject* obj, int* state)
{
    ...
    if (((TrickyState*)state)->sfxRepeatTimer < lbl_803E23DC)
    {
        ...
        if (((u32)((TrickyState*)ptr)->statusFlags >> 6 & 1) == 0 &&
            ...
            Sfx_IsPlayingFromObjectChannel((int)obj, 0x10) == 0)
        {
            objAudioFn_800393f8Legacy(obj, ptr + 0x3a8, 0x29a, 0x100, -1, 0);
        }
    ...
    if (((TrickyState*)state)->child == NULL && Obj_IsLoadingLocked() != 0)
    {
        ...
        ((TrickyState*)state)->child = Obj_SetupObject(e, 4, -1, -1, (obj)->anim.parent);
        ...
        mainGetBit(GAMEBIT_ITEM_TrickyCall_Got) != 0)
    {
        ...
        if (((u32)((TrickyState*)ptr)->statusFlags >> 6 & 1) == 0 &&
            ...
            Sfx_IsPlayingFromObjectChannel((int)obj, 0x10) == 0)
        {
            objAudioFn_800393f8Legacy(obj, ptr + 0x3a8, 0x354, 0x1000, -1, 0);
        }
        ((TrickyState*)state)->stateFlags |= 0x10;
        ((u8*)state)[0xa] = 4;
...
u32 fn_80143DD4(int obj, int* trickyState)
{
    ...
    if ((done != 0) && ((((TrickyState*)trickyState)->stateFlags & 0x20000000U) == 0))
    {
        ...
        {
            objAudioFn_800393f8Legacy(obj, (void*)(done + 0x3a8), 0x353, 0x500, 0xffffffff, 0);
        }
        return 0;
    }
    if (*(u8*)*trickyState <= 3)
        ...
        else
        {
            if ((u32)((TrickyState*)trickyState)->childB != 0)
            {
                ...
                if ((((*(u8*)(extra + 0x58) >> 6 & 1) == 0U) &&
                     ...
                     !Sfx_IsPlayingFromObjectChannel(obj, 0x10)))
                {
                    objAudioFn_800393f8Legacy(obj, (void*)(extra + 0x3a8), 0x357, 0, 0xffffffff, 0);
                }
    ...
    case 1:
        ...
        if (((u32)(*(u8*)(state + 0x58) >> 6 & 1)) == 0U)
        {
            if ((obj)->anim.currentMove >= 0x30 || (obj)->anim.currentMove < 0x29)
            {
                if (Sfx_IsPlayingFromObjectChannel((int)obj, 0x10) == 0)
                {
                    objAudioFn_800393f8Legacy(obj, (void*)(state + 0x3a8), 0x357, 0, 0xffffffff, 0);
                }
            }
        }
        objAnimFn_8013a3f0((int)obj, 0x26, lbl_803E251C, 0);
        ...
        *(s16*)(*(u8**)(hit[0] + 0xc4) + 0x44) == 1)
    {
        ...
        if (fv <= lbl_803E23DC)
        {
            ...
            if (((u32)((TrickyState*)ptr)->statusFlags >> 6 & 1) == 0 &&
                ...
                Sfx_IsPlayingFromObjectChannel((int)obj, 0x10) == 0)
            {
                objAudioFn_800393f8Legacy(obj, ptr + 0x3a8, 0x34f, 0x500, -1, 0);
            }
        }
        else
        {
                ...
                if (((TrickyState*)state)->stateFlags & 0x10)
                {
                    if (((TrickyState*)state)->cooldownB > lbl_803E2534)
                    {
                        ...
                        if (((u32)((TrickyState*)ptr)->statusFlags >> 6 & 1) == 0 &&
                            ...
                            Sfx_IsPlayingFromObjectChannel((int)obj, 0x10) == 0)
                        {
                            objAudioFn_800393f8Legacy(obj, ptr + 0x3a8, 0x350, 0x500, -1, 0);
                        }
                    }
                    else
                    {
