...
void FUN_800d9fc8(undefined4 param_1,int param_2,undefined2 param_3,undefined2 param_4)
{
  ...
  *(float *)(param_2 + 0x2b8) = FLOAT_803e123c;
...
{
  if (FLOAT_803e1270 < *param_2) {
    if (FLOAT_803e1248 <= *param_2) {
      *param_2 = FLOAT_803e124c;
    }
  }
  else {
    *param_2 = FLOAT_803e1274;
  }
  FUN_80010340(param_1,param_2);
  return;
}
...
void FUN_800e0670(void)
{
  ...
  fStack_4 = (float)in_ps31_1;
  iVar5 = FUN_80286818();
  if ((iVar5 != 0) && (iVar6 = RomCurve_getById(*(uint *)(iVar5 + 0x14),&local_6d8), iVar6 != 0)) {
    iVar6 = 0;
    iVar18 = 0;
    pfVar20 = local_6d0;
    pfVar21 = pfVar20;
    ...
    do {
      if (-1 < *(int *)(iVar22 + 0x1c)) {
        ...
        iVar14 = RomCurve_getById(*(uint *)(iVar22 + 0x1c),&local_6d4);
        if (iVar14 != 0) {
                ...
                *pfVar24 = local_6b0[iVar14];
                ...
                do {
                  if ((((-1 < (int)*(uint *)(iVar23 + 0x1c)) &&
                       (iVar7 = RomCurve_getById(*(uint *)(iVar23 + 0x1c),&local_6d4), iVar7 != 0)) &&
