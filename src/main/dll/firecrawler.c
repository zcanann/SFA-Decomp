...
void snowworm_update(int* obj, u8* state)
{
    ...
    if ((((BaddieState*)state)->controlFlags & 0x40000000) != 0)
    {
        *(char*)&((BaddieState*)state)->seqEntryIndex += 1;
        if (((BaddieState*)state)->seqEntryIndex > lbl_803DBD2C[*(u16*)(state + 0x338)])
        {
            ((BaddieState*)state)->seqEntryIndex = lbl_803DBD28[*(u16*)(state + 0x338)];
        }
        ...
        else if (((GameObject*)obj)->anim.currentMove == 1)
        {
            ...
            ((GameObject*)obj)->anim.localPosX = (f32)r * mathSinf(angle) + *(f32*)(*(int*)&((GameObject*)obj)->anim.
                placementData + 8);
            ((GameObject*)obj)->anim.localPosZ = (f32)r * mathCosf(angle) + *(f32*)(*(int*)&((GameObject*)obj)->anim.
                placementData + 0x10);
...
void hoodedZyck_update(s16* obj, u8* state)
{
    ...
    *(f32*)(state + 0x324) = *(f32*)(state + 0x324) - timeDelta;
    ...
    if (lbl_803E2B18 != *(f32*)(state + 0x328))
    {
        ...
        {
            Baddie_SetMove((int*)obj, (int*)state, 5, lbl_803DBCEC, 0, 0);
        }
    ...
    if (moved == 0)
    {
        ...
        *(s16*)obj = (f32) * (u16*)(state + 0x338) * timeDelta + (f32)(int) * (s16*)obj;
        ...
        {
            Baddie_SetMove((int*)obj, (int*)state, 4, lbl_803DBCE0, 0, 1);
        }
        else
        {
            if (grabbed != 0
                    ...
                    && ((GameObject*)obj)->anim.currentMove != 6))
            {
                if (mag < 1000)
                {
                    ...
                    {
                        Baddie_SetMove((int*)obj, (int*)state, 2, lbl_803E2B44, 0, 0);
                    }
                    else
                    {
                        Baddie_SetMove((int*)obj, (int*)state, 6, lbl_803DBCE4, 0, 0);
                    }
                    *(u16*)(state + 0x338) = 0;
                }
                else
                {
                    Baddie_SetMove((int*)obj, (int*)state, 1, lbl_803E2B44, 0, 0);
                    if ((s16)turnRaw < 0)
                    {
    ...
    if ((((BaddieState*)state)->controlFlags & 0x40000000) != 0)
    {
        *(u8*)(state + 0x33d) = *(u8*)(state + 0x33d) & ~0x30;
        ...
        if (*(u8*)(state + 0x33f) != 0)
        {
            ...
            Baddie_SetMove(obj, (int*)state, *(u8*)((char*)t6 + i + 8), *(f32*)((int)t6 + i), 0,
        ...
        else
        {
            ...
            {
                Baddie_SetMove(obj, (int*)state, *(u8*)(t7 + i + 8), *(f32*)((int)t7 + i), 0,
                            *(u8*)(t7 + i + 0xa));
            }
        }
    }
    ...
    if (moved == 0)
    {
        ...
        *(s16*)obj = *(s16*)obj + *(u16*)(state + 0x338);
                ...
                if (t < 0x4000)
                {
                    *(s16*)obj = -*(s16*)obj;
                                               ...
                                               0) == 0)
                    {
                        if ((((BaddieState*)state)->controlFlags & 0x40000000) != 0)
                        {
                            Baddie_SetMove((int*)obj, (int*)state, 7, lbl_803E2B40 / (lbl_803E2B4C * scale), 0, 1);
                        }
                        ((GameObject*)obj)->anim.rotY = ((BaddieState*)state)->spawnRotY;
                        ((GameObject*)obj)->anim.rotZ = ((BaddieState*)state)->spawnRotZ;
                    }
            ...
            || (mag < 3000 && noHit != 0 && ((GameObject*)obj)->anim.currentMove != 0))
        {
            ...
            {
                *(u16*)(state + 0x338) = 0;
                Baddie_SetMove((int*)obj, (int*)state, 0, lbl_803E2B40 / scale, 0, 1);
            }
            else
            {
                Baddie_SetMove((int*)obj, (int*)state, 1, lbl_803E2B44 / scale, 0, 0);
                {
                    f32 z = lbl_803E2B18;
                    ((GameObject*)obj)->anim.velocityX = z;
                    ((GameObject*)obj)->anim.velocityY = z;
...
void crawler_onHit(int obj, u8* state, u8* attacker, int cmd, int p5, int damage)
{
    ...
    *(u8*)(state + 0x33d) = *(u8*)(state + 0x33d) & ~0x40;
    ...
    {
        u8 v;
        Baddie_SetMove((int*)obj, (int*)state, tbl[1].moveId, tbl[1].spd, 0, tbl[1].mask & 0xff);
...
void crawler_updateC(s16* obj, u8* state)
{
...

    {
        ...
        if ((flags & 0x2000) != 0)
        {
            int count = fn_8014C11C((int)obj, lbl_803E2BB8, 1, 0x28, lbl_803AC4A8);
            if (count >= 1 && (f32) * (u16*)((char*)lbl_803AC4A8 + 4) <= lbl_803E2BB8)
            {
                f32* dp = dv;
                int rel;
                u16 oct;
                ...
                if (oct == 3 || oct == 4)
                {
                    scale = (f32) * (u16*)((char*)lbl_803AC4A8 + 4) / lbl_803E2BB8;
                }
                else if (oct == 0 || oct == 7)
                {
                    scale = lbl_803E2BB4 * (lbl_803E2BA4 - (f32) * (u16*)((char*)lbl_803AC4A8 + 4) / lbl_803E2BB8) +
                        lbl_803E2BA4;
                }
            }
            {
            ...
            if ((((BaddieState*)state)->controlFlags & 0xc0000000) != 0)
            {
                *(u8*)(state + 0x33d) = *(u8*)(state + 0x33d) & ~0x20;
                ...
                {
                    i = *(u8*)(state + 0x33f) * 0x10;
                    Baddie_SetMove((int*)obj, (int*)state, *(u8*)((char*)seq + i + 8), *(f32*)((int)seq + i), 0,
                ...
                else
                {
                    ...
                    {
                        Baddie_SetMove((int*)obj, (int*)state, mv, *(f32*)((int)tC + i), 0,
                                    *(u8*)((char*)tC + i + 0xa));
                        *(u8*)(state + 0x33d) = *(u8*)(state + 0x33d) | 8;
                    }
                }
        ...
        else if ((flags & 0xc0000000) != 0)
        {
            ...
            Baddie_SetMove((int*)obj, (int*)state, *(u8*)((char*)t8 + i + 8), *(f32*)((int)t8 + i), 0,
                        *(u8*)((char*)t8 + i + 0xa));
        }
    }
    fn_80157CDC((int)obj, (int)state);
...
void crawler_updateB(s16* obj, u8* state)
{
    ...
    count = fn_8014C11C((int)obj, lbl_803E2BE0, 1, 0x28, lbl_803AC4A8);
    if (count >= 1)
    {
        if ((*(u8*)(state + 0x33d) & 0x20) == 0 || (((BaddieState*)state)->controlFlags & 0x40000000) != 0)
        {
            ...
            else
            {
                ...
                if (oct != 0 && oct < 7)
                {
                    if (oct < 3 || oct > 4)
                    {
                        ...
                        if (mv == 0)
                        {
                            ...
                            Baddie_SetMove((int*)obj, (int*)state, *(u8*)((char*)t4 + i2 + 8), *(f32*)((int)t4 + i2), 0,
                                        *(u8*)((char*)t4 + i2 + 0xa));
                ...
                {
                    Baddie_SetMove((int*)obj, (int*)state, *(u8*)(t10 + 8), *(f32*)t10, 0, *(u8*)(t10 + 0xa));
                }
                *(u8*)(state + 0x33d) = *(u8*)(state + 0x33d) | 0x20;
                *(u8*)(state + 0x33d) = *(u8*)(state + 0x33d) & ~0x10;
            }
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (mv == 0)
                    {
                        ...
                        Baddie_SetMove((int*)obj, (int*)state, *(u8*)((char*)t8 + i4 + 8), *(f32*)((int)t8 + i4), 0,
                                    *(u8*)((char*)t8 + i4 + 0xa));
                    }
                    else
                    {
