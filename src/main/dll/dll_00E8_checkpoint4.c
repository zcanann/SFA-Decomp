 ...
 *
 * The bulk of the file is the DLL's ObjectDescriptor table block: this DLL owns
 * a large family of placement objects (kaldachompspit, pinponspike, pollen +
 * pollenfragment, mikabomb/mikabombshadow, staticcamera, gcbaddieshield,
 * baddieinterestp, animatedobj, dim2roofrub, depthoffieldpoint, staff, fireball,
 * flamethrowerspe, shield, curve, restartmarker, dll_F7, checkpoint4) whose
