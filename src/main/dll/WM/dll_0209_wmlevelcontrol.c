...
__declspec(section ".sdata2") f32 gWmLevelControlBlendDecayPerTick = 0.02f;   /* blend decay per tick */
__declspec(section ".sdata2") f32 gWmLevelControlLightIntensityBase = 32.0f;  /* light-intensity base */
__declspec(section ".sdata2") f32 gWmLevelControlLightIntensityRange = 128.0f; /* light-intensity blend range */
__declspec(section ".sdata2") f32 gWmLevelControlOverrideLightIntensity = 100.0f; /* override light intensity */
