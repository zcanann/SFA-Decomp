...
void mmsh_scales_free(void)
{
  ...
  if (in_r8 == '\0') {
    if (*piVar2 != 0) {
      FUN_800175cc((double)FLOAT_803e5be8,*piVar2,'\0');
    }
  }
  else {
    if (*piVar2 != 0) {
      FUN_800175cc((double)FLOAT_803e5be8,*piVar2,'\x01');
    }
    FUN_8003b818(iVar1);
    FUN_8008111c((double)FLOAT_803e5be8,(double)FLOAT_803e5be8,iVar1,7,(int *)*piVar2);
  }
  FUN_80286888();
  return;
}
