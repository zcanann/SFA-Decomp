...
void dll_88_func03(int param_1,int param_2,int param_3,uint param_4)
{
  ...
  e[0].layer = 0; e[0].flags = 25; e[0].tex = &lbl_80316240[0x1bc]; e[0].mode = 2;
  e[0].x = lbl_803E1010; e[0].y = lbl_803E1010; e[0].z = lbl_803E1010;
  e[1].layer = 0; e[1].flags = 25; e[1].tex = &lbl_80316240[0x1bc]; e[1].mode = 0x80;
  ...
  e[3].layer = 0; e[3].flags = 25; e[3].tex = &lbl_80316240[0x1bc]; e[3].mode = 4;
  e[3].x = lbl_803E1014; e[3].y = lbl_803E1014; e[3].z = lbl_803E1014;
  e[4].layer = 1; e[4].flags = 25; e[4].tex = &lbl_80316240[0x1bc]; e[4].mode = 4;
  e[4].x = lbl_803E1018; e[4].y = lbl_803E1014; e[4].z = lbl_803E1014;
  e[5].layer = 1; e[5].flags = 25; e[5].tex = &lbl_80316240[0x1bc]; e[5].mode = 2;
  e[5].x = lbl_803E101C; e[5].y = lbl_803E101C; e[5].z = lbl_803E1020;
  e[6].layer = 2; e[6].flags = 25; e[6].tex = &lbl_80316240[0x1bc]; e[6].mode = 2;
  e[6].x = lbl_803E1024; e[6].y = lbl_803E1024; e[6].z = lbl_803E1020;
  e[7].layer = 3; e[7].flags = 25; e[7].tex = &lbl_80316240[0x1bc]; e[7].mode = 2;
  e[7].x = lbl_803E1024; e[7].y = lbl_803E1024; e[7].z = lbl_803E1020;
  e[8].layer = 3; e[8].flags = 25; e[8].tex = &lbl_80316240[0x1bc]; e[8].mode = 4;
  ...
  buf.v5b = 16;
  buf.count = 9;
  buf.hw[0] = *(s16 *)&lbl_80316240[0x1f0]; buf.hw[1] = *(s16 *)&lbl_80316240[0x1f2];
  buf.hw[2] = *(s16 *)&lbl_80316240[0x1f4]; buf.hw[3] = *(s16 *)&lbl_80316240[0x1f6];
  buf.hw[4] = *(s16 *)&lbl_80316240[0x1f8]; buf.hw[5] = *(s16 *)&lbl_80316240[0x1fa];
  buf.hw[6] = *(s16 *)&lbl_80316240[0x1fc];
  buf.cmds = buf.entries;
  buf.flags = param_4 | 0x4000480;
  if ((param_4 & 1) != 0) {
    if (param_1 == 0) {
  ...
  (**(code **)(*gModgfxInterface + 8))(&buf,0,0x19,lbl_80316240,0x20,&lbl_80316240[0xfc],0x205,0);
}
