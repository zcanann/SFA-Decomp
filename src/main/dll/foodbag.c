...
void dll_87_func03(int param_1,int param_2,int param_3,uint param_4)
{
  typedef struct {
    ...
    u8 v58, v59, v5a, v5b, v5c, count; u8 pad1[2];
    FbCmd entries[33];
  } FbBuf87;
  FbBuf87 buf;
  FbCmd *e = buf.entries;

  e[0].layer = 0; e[0].flags = 10; e[0].tex = &lbl_80316050[0x1ac]; e[0].mode = 2;
  e[0].x = lbl_803E0FE8; e[0].y = lbl_803E0FEC; e[0].z = lbl_803E0FE8;
  e[1].layer = 0; e[1].flags = 10; e[1].tex = &lbl_80316050[0x1ac]; e[1].mode = 4;
  ...
  e[3].layer = 1; e[3].flags = 10; e[3].tex = &lbl_80316050[0x1ac]; e[3].mode = 0x4000;
  e[3].x = lbl_803E1000; e[3].y = lbl_803E1000; e[3].z = lbl_803E0FF0;
  e[4].layer = 0; e[4].flags = 9; e[4].tex = &lbl_80316050[0x198]; e[4].mode = 2;
  ...
  e[6].layer = 2; e[6].flags = 10; e[6].tex = &lbl_80316050[0x1ac]; e[6].mode = 0x4000;
  e[6].x = lbl_803E1000; e[6].y = lbl_803E1000; e[6].z = lbl_803E0FF0;
  e[7].layer = 3; e[7].flags = 10; e[7].tex = &lbl_80316050[0x1ac]; e[7].mode = 0x4000;
  e[7].x = lbl_803E1000; e[7].y = lbl_803E1000; e[7].z = lbl_803E0FF0;
  e[8].layer = 4; e[8].flags = 10; e[8].tex = &lbl_80316050[0x1ac]; e[8].mode = 0x4000;
  e[8].x = lbl_803E1000; e[8].y = lbl_803E1000; e[8].z = lbl_803E0FF0;
  e[9].layer = 4; e[9].flags = 10; e[9].tex = &lbl_80316050[0x1ac]; e[9].mode = 4;
  ...
  buf.v5b = 16;
  buf.count = 10;
  buf.hw[0] = *(s16 *)&lbl_80316050[0x1c0]; buf.hw[1] = *(s16 *)&lbl_80316050[0x1c2];
  buf.hw[2] = *(s16 *)&lbl_80316050[0x1c4]; buf.hw[3] = *(s16 *)&lbl_80316050[0x1c6];
  buf.hw[4] = *(s16 *)&lbl_80316050[0x1c8]; buf.hw[5] = *(s16 *)&lbl_80316050[0x1ca];
  buf.hw[6] = *(s16 *)&lbl_80316050[0x1cc];
  buf.cmds = buf.entries;
  ...
  (**(code **)(*gModgfxInterface + 8))(&buf,0,10,lbl_80316050,8,&lbl_80316050[0x168],0x1fd,0);
}
