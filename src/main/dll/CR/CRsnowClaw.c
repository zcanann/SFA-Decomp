...
void FUN_801e34c0(int param_1)
{
  ...
  *(undefined *)(iVar1 + 4) = 4;
  *(float *)(iVar1 + 0xc) = *(float *)(iVar1 + 0xc) + lbl_803E64C8;
  *(float *)(iVar1 + 8) = *(float *)(iVar1 + 8) + lbl_803E64D0;
  return;
}
 ...
 * --INFO--
 *
 * Function: FUN_801e3530
 * EN v1.0 Address: 0x801E3530
 * EN v1.0 Size: 40b
 * EN v1.1 Address: 0x801E38C0
 * EN v1.1 Size: 52b
 * JP Address: TODO
 * JP Size: TODO
 * PAL Address: TODO
 ...
 * --INFO--
 *
 * Function: FUN_801e3558
 * EN v1.0 Address: 0x801E3558
 * EN v1.0 Size: 540b
 * EN v1.1 Address: 0x801E38F4
 * EN v1.1 Size: 288b
 * JP Address: TODO
 * JP Size: TODO
 * PAL Address: TODO
                 ...
                 undefined4 param_13,undefined4 param_14,undefined4 param_15,undefined4 param_16)
{
  ...
  if (*(int *)(param_9 + 0x30) != 0) {
    ...
    dVar3 = (double)lbl_803E6504;
    *(float *)(param_9 + 0xc) = lbl_803E6504;
    ...
    *(float *)(param_9 + 0x14) = fVar1;
    if (*(short *)(*(int *)(param_9 + 0x30) + 0x46) == 0x139) {
      if ((iVar2 < 10) || (0xc < iVar2)) {
        if (*(short *)(param_9 + 0xa0) != 1) {
          FUN_800305f8((double)lbl_803E6504,param_2,param_3,param_4,param_5,param_6,param_7,
                       param_8,param_9,1,0,param_12,param_13,param_14,param_15,param_16);
        }
        dVar3 = (double)lbl_803E6510;
      }
      else {
        if (*(short *)(param_9 + 0xa0) != 0) {
          FUN_800305f8(dVar3,param_2,param_3,param_4,param_5,param_6,param_7,param_8,param_9,0,0,
                       param_12,param_13,param_14,param_15,param_16);
        }
        if (iVar2 < 0xc) {
          dVar3 = (double)lbl_803E650C;
        }
        else {
          dVar3 = (double)lbl_803E6508;
        }
      }
    }
    else {
    ...
    FUN_8002fc3c(dVar3,(double)(float)((double)CONCAT44(0x43300000,(uint)DAT_803dc070) -
                                      DOUBLE_803e6518));
  }
  return;
}
 ...
 * --INFO--
 *
 * Function: FUN_801e3774
 * EN v1.0 Address: 0x801E3774
 * EN v1.0 Size: 52b
 * EN v1.1 Address: 0x801E3A14
 * EN v1.1 Size: 48b
 * JP Address: TODO
 * JP Size: TODO
 * PAL Address: TODO
