...
void FUN_801c95e8(void)
{
  ...
  if (in_r8 == '\0') {
    ...
    if (*piVar2 != 0) {
      FUN_800175cc((double)lbl_803E5D70,*piVar2,'\x01');
    }
    FUN_8003b818(iVar1);
    FUN_8008111c((double)lbl_803E5D70,(double)lbl_803E5D70,iVar1,7,(int *)*piVar2);
  }
  FUN_80286888();
  return;
}
                 ...
                 ushort *param_9)
{
  ...
  if (iVar3 != 0) {
    ...
    SH_LevelControl_runBloopEvent(iVar6 + 4,2,-1,-1,0xdd3,(int *)0xe);
    FUN_801d8480(iVar6 + 4,1,-1,-1,0xcbb,(int *)0x8);
    SH_LevelControl_runBloopEvent(iVar6 + 4,4,-1,-1,0xcbb,(int *)0xc4);
    ...
    if (bVar1 != 3) {
      if (bVar1 < 3) {
        if (bVar1 == 1) {
          ...
          fVar2 = *(float *)(iVar6 + 8) - lbl_803DC074;
          *(float *)(iVar6 + 8) = fVar2;
          if (fVar2 <= lbl_803E5D74) {
            FUN_80006824((uint)param_9,0x343);
            uVar4 = randomGetRange(500,1000);
            *(float *)(iVar6 + 8) =
