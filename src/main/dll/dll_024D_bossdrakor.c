...
void bossdrakor_update(int obj)
{
    ...
    {
        Obj_SmoothTurnAnglesTowardVelocity((struct GameObject*)(obj), &((GameObject*)obj)->anim.velocityX, 0x2d,
    ...
    adv = ((int (*)(f32, int, f32, void*))ObjAnim_AdvanceCurrentMove)(
        lbl_803E6570 + PSVECMag(&((GameObject*)obj)->anim.velocityX) / ((BossDrakorState*)state)->moveSpeed, obj,
        timeDelta, buf);
    if (adv != 0)
    {
