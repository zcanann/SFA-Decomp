...
void FUN_801f456c(int param_1)
{
  ...
  if (cVar10 != '\a') {
    ...
    if (bVar11 == 0) {
      ...
      skyFn_800894a8((double)fVar1,(double)fVar2,(double)fVar3,1);
    }
    else {
      FUN_80080f60(0);
      FUN_80080f68(0);
