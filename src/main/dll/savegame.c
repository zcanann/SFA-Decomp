...
void FUN_800fb9bc(undefined4 param_1,undefined4 param_2,int param_3,uint param_4)
{
  ...
  if (uVar2 == 0) {
    ...
    local_310 = 2;
    uVar2 = FUN_80020078(0x4e9);
    if (uVar2 == 0) {
      uStack_24 = FUN_80022264(5,10);
      uStack_24 = uStack_24 ^ 0x80000000;
      local_28 = 0x43300000;
