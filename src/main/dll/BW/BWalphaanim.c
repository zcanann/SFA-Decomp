...
void SB_CloudRunner_onSeqFree(int *obj) {
    ...
    p->posX04C = ((GameObject *)obj)->anim.localPosX;
    p->posY04C = ((GameObject *)obj)->anim.localPosY;
    p->posZ04C = ((GameObject *)obj)->anim.localPosZ;
    {
        s32 v = *(s16*)obj - 0x4000;
        p->unk02C = (s16)v;
    }
    p->angle02E = ((GameObject *)obj)->anim.rotZ;
}
...
void SnowBike_init(int obj, u8 *params, int flag)
{
    ...
    ((SnowBikeState *)state)->flags40E = rot;
    *(s16 *)obj = rot;
    ...
    if (flag == 0) {
        if (((SnowBikeFlags *)(state + 0x428))->b20) {
            ...
            ((SnowBikeState *)state)->speed4BC = lbl_803E5B94;
    ...
    ((SnowBikeState *)state)->posX00C = ((GameObject *)obj)->anim.localPosX;
    ((SnowBikeState *)state)->posY00C = ((GameObject *)obj)->anim.localPosY;
    ((SnowBikeState *)state)->posZ00C = ((GameObject *)obj)->anim.localPosZ;
    ...
    ((SnowBikeState *)state)->posX51C = ((GameObject *)obj)->anim.worldPosX;
    ((SnowBikeState *)state)->posY51C = ((GameObject *)obj)->anim.worldPosY;
    ((SnowBikeState *)state)->posZ51C = ((GameObject *)obj)->anim.worldPosZ;
    ...
    ((SnowBikeState *)state)->unk060 = base + ((SnowBikeState *)state)->bool434 * 6 + 0xa4;
    if (((SnowBikeState *)state)->bool434 == 0) {
        if (!((SnowBikeFlags *)(state + 0x428))->b02) {
            ((SnowBikeFlags *)(state + 0x428))->b20 = 1;
            ((SnowBikeState *)state)->speed4C4 = lbl_803E5AE8;
        }
...
void SnowBike_update(int obj)
{
    ...
    *(u8 *)&((GameObject *)obj)->anim.resetHitboxMode |= 8;
    ((GameObject *)obj)->anim.rotY = ((SnowBikeState *)state)->angle41C;
    ((GameObject *)obj)->anim.rotZ = ((SnowBikeState *)state)->angle41E;
    ...
    case 2:
        {
            ...
            if (((SnowBikeFlags *)(state + 0x428))->b02) {
                if (drshackle_updateAttachedPosition(obj, state) != 0) {
                    ...
                    if (((SnowBikeState *)state)->timer3E4 != lbl_803E5AE8) {
                        ...
                        ((SnowBikeState *)state)->timer3E4 -= timeDelta;
                        if (((SnowBikeState *)state)->timer3E4 <= lbl_803E5AE8) {
                            if (Rcp_GetMotionBlurEnabled() != 0) {
                                setMotionBlur(0, lbl_803E5AE8);
                            }
                            ((SnowBikeState *)state)->timer3E4 = lbl_803E5AE8;
                        }
                    } else {
                    ...
                    rq1.rot[0] = -((SnowBikeState *)state)->flags40E;
                    rq1.rot[1] = -((GameObject *)obj)->anim.rotY;
                    rq1.rot[2] = -((GameObject *)obj)->anim.rotZ;
                    mtxRotateByVec3s(mtx1, rq1.rot);
                    Matrix_TransformPoint(mtx1, lbl_803E5AE8, ((SnowBikeState *)state)->speed4B0 * ((SnowBikeState *)state)->unk544, lbl_803E5AE8, &vec1[0], &dummy1, &vec1[2]);
                    vec1[0] = vec1[0] * ((SnowBikeState *)state)->unk540;
                    vec1[1] = lbl_803E5AE8;
                    PSVECScale(vec1, vec1, timeDelta);
                    PSVECAdd((f32 *)(state + 0x494), vec1, (f32 *)(state + 0x494));
                    ((SnowBikeState *)state)->velY494 = ((SnowBikeState *)state)->speed4B0 * timeDelta + ((SnowBikeState *)state)->velY494;
                    p = powfBitEstimate(((SnowBikeState *)state)->unk548, timeDelta);
                    ((SnowBikeState *)state)->velX494 *= p;
                    p = powfBitEstimate(((SnowBikeState *)state)->unk54C, timeDelta);
                    ((SnowBikeState *)state)->velZ494 *= p;
                    fn_801EC1AC(obj, (int)state);
                    Matrix_TransformPoint((f32 *)(state + 0xec), ((SnowBikeState *)state)->velX494, ((SnowBikeState *)state)->velY494, ((SnowBikeState *)state)->velZ494, &((GameObject *)obj)->anim.velocityX, &((GameObject *)obj)->anim.velocityY, &((GameObject *)obj)->anim.velocityZ);
                ...
                rq2.rot[0] = -((SnowBikeState *)state)->flags40E;
                rq2.rot[1] = -((GameObject *)obj)->anim.rotY;
                rq2.rot[2] = -((GameObject *)obj)->anim.rotZ;
                mtxRotateByVec3s(mtx2, rq2.rot);
                Matrix_TransformPoint(mtx2, lbl_803E5AE8, ((SnowBikeState *)state)->speed4B0 * ((SnowBikeState *)state)->unk544, lbl_803E5AE8, &vec2[0], &dummy2, &vec2[2]);
            ...
            fn_801EA240(obj, state, ((SnowBikeState *)state)->velZ494, (int)(lbl_803E5BA0 * -((SnowBikeState *)state)->unk430), state + 0x461, 7);
            fn_801EB634(obj, state);
            *(s16 *)obj = ((SnowBikeState *)state)->flags40E;
        }
        break;
    }
}
