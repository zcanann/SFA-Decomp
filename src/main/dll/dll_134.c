            ...
            int param_10)
{
  ...
  if (*(char *)(param_10 + 0x27b) == '\0') {
    ...
    *(float *)(iVar1 + 1000) = lbl_803E3D10;
    *(float *)(iVar1 + 0x3ec) = lbl_803E3D14;
  }
  return 0;
}
...
undefined4 FUN_80167ec8(undefined4 param_1,int param_2)
{
  ...
  if (*(int *)(param_2 + 0x2d0) != 0) {
    if (*(char *)(param_2 + 0x27b) == '\0') {
      ...
      *(float *)(param_2 + 0x284) = lbl_803E3CF8;
            ...
            undefined4 param_15,undefined4 param_16)
{
  ...
  *(float *)(param_10 + 0x2a0) = lbl_803E3D1C;
  fVar1 = lbl_803E3CF8;
  dVar4 = (double)lbl_803E3CF8;
    ...
    *(byte *)(iVar3 + 0x4b) = *(byte *)(iVar3 + 0x4b) | 1;
    ...
    if (iVar2 != 0) {
      (**(code **)(**(int **)(iVar2 + 0x68) + 0x2c))
                ((double)lbl_803E3CF8,(double)lbl_803E3D10,(double)lbl_803E3CF8);
    }
  }
  ...
  *(char *)(param_9 + 0x36) =
       (char)(int)(lbl_803E3D24 * (lbl_803E3D10 - *(float *)(param_9 + 0x98)));
  return 0;
}
