...
union Dll94ConstF32 { f32 f; };
const union Dll94ConstF32 lbl_803E1268 = {1.0f};
const union Dll94ConstF32 lbl_803E126C = {0.0f};
const union Dll94ConstF32 lbl_803E1270 = {155.0f};
const union Dll94ConstF32 lbl_803E1274 = {55.0f};
const union Dll94ConstF32 lbl_803E1278 = {0.15f};
const union Dll94ConstF32 lbl_803E127C = {0.1f};
const union Dll94ConstF32 lbl_803E1280 = {-0.5f};
const union Dll94ConstF32 lbl_803E1284 = {4.0f};
const union Dll94ConstF32 lbl_803E1288 = {25.0f};
const union Dll94ConstF32 lbl_803E128C = {8.0f};
const union Dll94ConstF32 lbl_803E1290 = {2.0f};
...
void dll_94_func03(int sourceObj, int variant, int posSource, u32 flags, int arg5, f32* extraArgs)
{
    ...
    e[0].tex = base + 0x60;
    e[0].mode = 4;
    e[0].x = lbl_803E126C.f;
    e[0].y = lbl_803E126C.f;
    e[0].z = lbl_803E126C.f;
    e[1].layer = 0;
    e[1].flags = 1;
    ...
    if (variant == 1)
    {
        e[1].x = lbl_803E1270.f;
    }
    else
    {
        e[1].x = lbl_803E1274.f;
    }
    e[1].y = lbl_803E126C.f;
    e[1].z = lbl_803E126C.f;
    e[2].layer = 0;
    e[2].flags = 6;
    e[2].tex = base + 0x54;
    e[2].mode = 2;
    if (variant == 1)
    {
        e[2].z = e[2].y = e[2].x = lbl_803E1278.f * s;
    }
    else
    {
        e[2].z = e[2].y = e[2].x = lbl_803E127C.f * s;
    }
    e[3].layer = 1;
    e[3].flags = 6;
    e[3].tex = base + 0x54;
    e[3].mode = 0x4000;
    e[3].x = lbl_803E1280.f;
    e[3].y = lbl_803E1268.f;
    e[3].z = lbl_803E126C.f;
    e[4].layer = 1;
    e[4].flags = 6;
    e[4].tex = base + 0x54;
    e[4].mode = 2;
    e[4].x = lbl_803E1284.f;
    e[4].y = lbl_803E1284.f;
    e[4].z = lbl_803E1288.f;
    e[5].layer = 2;
    e[5].flags = 6;
    e[5].tex = base + 0x54;
    e[5].mode = 0x4000;
    e[5].x = lbl_803E1280.f;
    e[5].y = lbl_803E1268.f;
    e[5].z = lbl_803E126C.f;
    e[6].layer = 2;
    e[6].flags = 6;
    e[6].tex = base + 0x54;
    e[6].mode = 2;
    e[6].x = lbl_803E128C.f;
    e[6].y = lbl_803E128C.f;
    e[6].z = lbl_803E1268.f;
    e[7].layer = 3;
    e[7].flags = 6;
    e[7].tex = base + 0x54;
    e[7].mode = 0x4000;
    e[7].x = lbl_803E1280.f;
    e[7].y = lbl_803E1268.f;
    e[7].z = lbl_803E126C.f;
    e[8].layer = 3;
    e[8].flags = 1;
    e[8].tex = lbl_803DB938;
    e[8].mode = 4;
    e[8].x = lbl_803E126C.f;
    e[8].y = lbl_803E126C.f;
    e[8].z = lbl_803E126C.f;
    buf.v58 = 0;
    buf.ctx = sourceObj;
    buf.v44 = variant;
    buf.pos[0] = lbl_803E126C.f;
    buf.pos[1] = lbl_803E126C.f;
    buf.pos[2] = lbl_803E126C.f;
    buf.col[0] = lbl_803E126C.f;
    buf.col[1] = lbl_803E126C.f;
    buf.col[2] = lbl_803E126C.f;
    buf.scale = lbl_803E1290.f;
    buf.v40 = 1;
    buf.v3c = 0;
    buf.v59 = 6;
    buf.v5a = 0;
    ...
    if ((buf.flags & 1) != 0)
    {
        ...
        {
            buf.pos[0] =
                lbl_803E126C.f + (((GameObject*)(sourceObj))->anim.worldPosX + ((PartFxSpawnParams*)posSource)->posX);
            buf.pos[1] =
                lbl_803E126C.f + (((GameObject*)(sourceObj))->anim.worldPosY + ((PartFxSpawnParams*)posSource)->posY);
            buf.pos[2] =
                lbl_803E126C.f + (((GameObject*)(sourceObj))->anim.worldPosZ + ((PartFxSpawnParams*)posSource)->posZ);
        }
