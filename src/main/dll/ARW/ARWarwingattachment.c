...
void FUN_801f1104(void)
{
  ...
  uVar3 = FUN_8028683c();
  iVar4 = FUN_80017a98();
  iVar10 = *(int *)&((GameObject *)uVar3)->anim.placementData;
  pcVar9 = *(char **)&((GameObject *)uVar3)->extra;
  ...
  *pcVar9 = *pcVar9 + -1;
  ...
  if ((*(int *)(uVar3 + 0x58) == 0) || (*(char *)(*(int *)(uVar3 + 0x58) + 0x10f) < '\x01')) {
    if ((((GameObject *)uVar3)->anim.mapEventSlot == '\v') &&
       (((cVar6 = (*gMapEventInterface)->getMode((int)((GameObject *)uVar3)->anim.mapEventSlot), cVar6 == '\x03' &&
    ...
    *(short *)(pcVar9 + 2) = *(short *)(iVar10 + 0x1e) * 0x3c;
    ...
    for (iVar8 = 0; iVar8 < *(char *)(*(int *)(uVar3 + 0x58) + 0x10f); iVar8 = iVar8 + 1) {
      ...
      if (dVar14 < (double)(*(float *)(iVar7 + 0x10) - ((GameObject *)uVar3)->anim.localPosY)) {
        *pcVar9 = '\x05';
      }
  ...
  if (((((GameObject *)uVar3)->anim.mapEventSlot == '\v') &&
      (cVar6 = (*gMapEventInterface)->getMode((int)((GameObject *)uVar3)->anim.mapEventSlot), cVar6 == '\x01')) && (dVar13 <= dVar12)) {
    if (*pcVar9 == '\0') {
      ...
      fVar1 = *(float *)(iVar10 + 0xc) - ((GameObject *)uVar3)->anim.localPosY;
  ...
  if (*pcVar9 == '\0') {
    if (*(short *)(pcVar9 + 2) == 0) {
      ((GameObject *)uVar3)->anim.localPosY = lbl_803E6A0C * lbl_803DC074 + ((GameObject *)uVar3)->anim.localPosY;
      bVar11 = ((GameObject *)uVar3)->anim.localPosY <= *(float *)(iVar10 + 0xc);
      if (!bVar11) {
        ((GameObject *)uVar3)->anim.localPosY = *(float *)(iVar10 + 0xc);
      }
    ...
    fVar1 = ((GameObject *)uVar3)->anim.localPosY;
    if (fVar2 <= fVar1) {
      ((GameObject *)uVar3)->anim.localPosY = -(lbl_803E6A0C * lbl_803DC074 - fVar1);
      if (fVar2 <= ((GameObject *)uVar3)->anim.localPosY) {
        bVar11 = true;
      }
      else {
        ((GameObject *)uVar3)->anim.localPosY = fVar2;
      ...
      ((GameObject *)uVar3)->anim.localPosY = lbl_803E6A08 * lbl_803DC074 + fVar1;
      if (fVar2 < ((GameObject *)uVar3)->anim.localPosY) {
        ((GameObject *)uVar3)->anim.localPosY = fVar2;
      }
      FUN_80017698((int)*(short *)(iVar10 + 0x1c),1);
    ...
    *(undefined *)((int)puVar12 + 5) = uVar8;
    ...
    if (((GameObject *)param_9)->unkF8 == 0) {
      ...
      *(byte *)&((GameObject *)param_9)->anim.resetHitboxMode = *(byte *)&((GameObject *)param_9)->anim.resetHitboxMode & 0xf7;
      ...
      iVar5 = FUN_800632f4((double)((GameObject *)param_9)->anim.localPosX,(double)((GameObject *)param_9)->anim.localPosY,
                 ...
                 undefined4 param_13,undefined4 param_14,undefined4 param_15,undefined4 param_16)
{
  ...
  if ((*(byte *)&((GameObject *)param_9)->anim.resetHitboxMode & 8) != 0) {
    *(byte *)&((GameObject *)param_9)->anim.resetHitboxMode = *(byte *)&((GameObject *)param_9)->anim.resetHitboxMode ^ 8;
  }
  ...
  if (uVar1 == 0) {
    ...
    if (((GameObject *)param_9)->anim.currentMove != 2) {
  ...
  if (((*(byte *)&((GameObject *)param_9)->anim.resetHitboxMode & 1) == 0) || (uVar1 = FUN_80017690(0x2fb), uVar1 != 0)) {
...
void FUN_801f284c(int param_1,int param_2,int param_3,int param_4,int param_5,s8 visible)
{
  ...
  iVar1 = FUN_80286840();
  if (visible != 0) {
    cVar3 = (*gMapEventInterface)->getMode((int)((GameObject *)iVar1)->anim.mapEventSlot);
    if (cVar3 == '\x04') {
