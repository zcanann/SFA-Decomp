...
const f32 lbl_803E7460[1] = {-0.1f};
const f32 lbl_803E7464[1] = {-0.5f};
const f32 lbl_803E7468[1] = {-0.2f};
const f32 lbl_803E746C[1] = {476.0f};
const f32 lbl_803E7470[1] = {112.5f};
const f32 lbl_803E7474[1] = {150.0f};
const f32 lbl_803E7478[1] = {180.0f};
const f32 lbl_803E747C[1] = {-1.0f};
const f32 lbl_803E7480[1] = {1.0f};
const f32 lbl_803E7484[1] = {0.5f};
const f32 lbl_803E7488[1] = {0.0f};
const f32 lbl_803E748C[1] = {256.0f};
...
int gf_levelcon_SeqFn(GameObject* obj, int eventId, ObjAnimUpdateState* animUpdate)
{
    ...
    for (i = 0; i < animUpdate->eventCount; i++)
    {
        ...
        case GFLEVELCON_SEQEV_SKY_PRESET_A:
            ...
            skyFn_800894a8(7, lbl_803E7460[0], lbl_803E7464[0], lbl_803E7468[0]);
            getEnvfxActVoid((int)obj, (int)obj, GFLEVELCON_ENVFX_A, 0);
            break;
        case GFLEVELCON_SEQEV_START_PROMPT:
            state->promptTimer = lbl_803E746C[0];
            break;
        case GFLEVELCON_SEQEV_SKY_PRESET_B:
            skyFn_80089710(7, 1, 0);
            skyFn_800895e0(7, lbl_803E7470[0], lbl_803E7474[0], lbl_803E7478[0], 0, 0);
            skyFn_800894a8(7, lbl_803E7464[0], lbl_803E747C[0], lbl_803E7464[0]);
        ...
        case GFLEVELCON_SEQEV_SKY_PRESET_C:
            skyFn_80089710(7, 1, 0);
            skyFn_800895e0(7, 0x96, 0xc8, 0xf0, 0, 0);
            skyFn_800894a8(7, lbl_803E7480[0], lbl_803E747C[0], lbl_803E7464[0]);
        ...
        case GFLEVELCON_SEQEV_SKY_PRESET_D:
            skyFn_80089710(7, 1, 0);
            skyFn_800895e0(7, 0x96, 0xc8, 0xf0, 0, 0);
            skyFn_800894a8(7, lbl_803E7484[0], lbl_803E747C[0], lbl_803E7464[0]);
            getEnvfxActVoid((int)obj, (int)obj, GFLEVELCON_ENVFX_A, 0);
            break;
    ...
    if (state->promptTimer > lbl_803E7488[0])
    {
        gameTextShow(0x476);
        state->promptTimer -= timeDelta;
        if (state->promptTimer < lbl_803E7488[0])
        {
            state->promptTimer = lbl_803E7488[0];
        }
    }

    {
        ...
        if (scroll != NULL)
        {
            *scroll += (s16)(lbl_803E748C[0] * timeDelta);
        }
    }
    {
...
void gf_levelcon_render(GameObject* obj, int p2, int p3, int p4, int p5, s8 visible)
{
    if (visible != 0)
    {
        objRenderModelAndHitVolumes((int)obj, p2, p3, p4, p5, lbl_803E7480[0]);
    }
}
