...
void fn_80152514(int *obj, u8 *state)
{
    ...
    if (((BaddieState *)state)->unk2DC & 0x2000) {
        int step;

        if (Curve_AdvanceAlongPath(path, ((BaddieState *)state)->unk2FC) != 0 || ((RomCurveWalker *)path)->unk10 != 0) {
            if ((*(u8 (**)(u8 *))(*(int *)gRomCurveInterface + 0x90))(path) != 0) {
                if ((*(u8 (**)(u8 *, int *, f32, u8 *, int))(*(int *)gRomCurveInterface + 0x8c))(
                    ...
                    ((BaddieState *)state)->unk2DC &= ~0x2000;
                }
            }
        }
        ((GameObject *)obj)->anim.velocityX =
            (((RomCurveWalker *)path)->unk68 - ((GameObject *)obj)->anim.localPosX) / timeDelta;
        ((GameObject *)obj)->anim.velocityZ =
            (((RomCurveWalker *)path)->unk70 - ((GameObject *)obj)->anim.localPosZ) / timeDelta;
        step = (s8)*((u8 *)def + 0x2a);
        if (step == 0) {
            fn_8014CF7C(obj, state, ((RomCurveWalker *)path)->unk68, ((RomCurveWalker *)path)->unk70, 0xf, 0);
        } else if (((BaddieState *)state)->unk2DC & 0x2000) {
            spd = step << 8;
            if ((int)(lbl_803E2828 * ((RomCurveWalker *)path)->unk78) >= 0) {
                step = spd;
            } else {
                step = -spd;
            }
            ...
            *(s16 *)obj += step;
            ...
            step = ((int)(lbl_803E2828 * ((RomCurveWalker *)path)->unk78) >= 0) ? step : -step;
            *(s16 *)obj += step;
        }
        if (((GameObject *)obj)->anim.localPosY - ((RomCurveWalker *)path)->unk6C < lbl_803E282C) {
            if (Sfx_IsPlayingFromObject(obj, SFXar_laser216) == 0) {
                Sfx_PlayFromObject(obj, SFXar_laser216);
            }
            ((BaddieState *)state)->unk33A = 1;
        } else {
    ...
    if (lbl_803E2814 == *(f32 *)(state + 0x32c)) {
        ...
        if (child2 != 0) {
            ...
            flag = 0;
            if (*(s8 *)((char *)def + 0x2a) != 0 && !(((BaddieState *)state)->unk2DC & 0x2000)) {
                flag = 1;
            }
...
void fn_801522E0(int* obj, u8* state) {
    ...
    *(f32 *)&((BaddieState *)state)->eventFlags = fz;
    ...
    if ((s8)*((s8*)sub + 46) != -1) {
        *(int *)&((BaddieState *)state)->unk2DC |= 1;
    }
...
void fn_80152040(int *obj, u8 *state)
{
    ...
    if (((BaddieState *)state)->unk33A == 2 && GameBit_Get(*(s16 *)((char *)def + 0x1c)) == 0) {
    ...
    flags = ((BaddieState *)state)->unk2DC;
    if (flags & 0x80000000) {
        if (lbl_8031F290[((BaddieState *)state)->unk33A].unk4 != 0) {
            u32 triggered = 0x40000000;
            ((BaddieState *)state)->unk2DC = flags | triggered;
        }
    }
    flags = ((BaddieState *)state)->unk2DC;
    if (flags & 0x40000000) {
        ...
        if (((BaddieState *)state)->unk33A == 0) {
            if (flags & 0x20000000) {
                if (GameBit_Get(*(s16 *)((char *)def + 0x1c)) != 0) {
                    ((BaddieState *)state)->unk33A = lbl_8031F290[((BaddieState *)state)->unk33A].alt;
                } else {
                    ((BaddieState *)state)->unk33A = lbl_8031F290[((BaddieState *)state)->unk33A].next;
                }
            }
        } else if (((BaddieState *)state)->unk33A == 2) {
            if (GameBit_Get(*(s16 *)((char *)def + 0x1c)) != 0 ||
                !(((BaddieState *)state)->unk2DC & 0x20000000)) {
                ((BaddieState *)state)->unk33A = lbl_8031F290[((BaddieState *)state)->unk33A].next;
            }
        } else if (((BaddieState *)state)->unk33A == 3) {
            if (GameBit_Get(*(s16 *)((char *)def + 0x1c)) != 0) {
                ((BaddieState *)state)->unk33A = lbl_8031F290[((BaddieState *)state)->unk33A].alt;
            } else {
                ((BaddieState *)state)->unk33A = lbl_8031F290[((BaddieState *)state)->unk33A].next;
        ...
        if (anim != animTbl[((BaddieState *)state)->unk33A * 12]) {
            if (animTbl[((BaddieState *)state)->unk33A * 12] != 0 && animTbl[((BaddieState *)state)->unk33A * 12] != 4) {
                Sfx_PlayFromObject(obj, 0x4a8);
            }
            fn_8014D08C(obj, state, animTbl[((BaddieState *)state)->unk33A * 12],
                        *(f32 *)((u8 *)lbl_8031F290 + ((BaddieState *)state)->unk33A * 12), 0, 0xf);
        }
    }
    if (lbl_8031F290[((BaddieState *)state)->unk33A].flagB != 0) {
