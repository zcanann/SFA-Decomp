 ...
 * - debug-side path: dll/dll_152.c
 *
 * Why this stub exists:
 * - dll_152.c is a concrete anonymous bridge target in a stable debug-side
 *   neighborhood immediately after the groundAnimator/crackanim packet.
