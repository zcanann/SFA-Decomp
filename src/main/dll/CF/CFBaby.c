  ...
  if (bVar1 == 1) {
    ...
    *(undefined4 *)(param_9 + 0x14) = *(undefined4 *)(iVar4 + 0x10);
    ...
    if (iVar4 != 0) {
      ...
      uVar6 = FUN_80035fe8(param_9,5,4,0);
      uVar2 = FUN_80017ae8();
      if ((uVar2 & 0xff) != 0) {
                 ...
                 int param_9)
{
  ...
  if (iVar1 != 0) {
    ...
    FUN_8003817c(param_9,*(int *)(iVar2 + 0x10));
  }
  return;
}
                 ...
                 int param_9)
{
  ...
  if ((pfVar7[4] == 0.0) && (uVar3 = FUN_80017ae8(), (uVar3 & 0xff) != 0)) {
    ...
    param_1 = extraout_f1;
    if (pfVar7[4] != 0.0) {
      FUN_800381f8(param_9,(int)pfVar7[4],0);
  ...
  if (bVar1 == 1) {
    ...
    if (iVar2 != 0) {
      ...
      iVar2 = FUN_80037008(0xf,param_9,(float *)0x0);
