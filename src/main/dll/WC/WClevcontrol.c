                 ...
                 undefined4 param_5,undefined4 param_6,undefined4 param_7,undefined4 param_8)
{
  ...
  *(short *)(param_2 + 0x2c) =
  ...
  param_1[1] = (short)(int)(lbl_803E6940 *
                            (f32)(s32)(uVar5) * lbl_803DC074 +
  ...
  dVar6 = (double)lbl_803E6940;
  *(short *)(param_2 + 0x2e) =
       (short)(int)(dVar6 * (double)((f32)(s32)(uVar5) * lbl_803DC074) +
  ...
  *param_1 = *(short *)(param_2 + 0x2c) + 0x4000;
  ...
  if (param_1[0x50] != 0xf) {
    FUN_800305f8((double)lbl_803E6908,dVar1,dVar6,in_f4,in_f5,in_f6,in_f7,in_f8,param_1,0xf,0,
                 iVar2,param_5,param_6,param_7,param_8);
  }
  iVar2 = FUN_8002fc3c((double)lbl_803E6944,(double)lbl_803DC074);
  if (iVar2 != 0) {
                 ...
                 undefined4 param_5,undefined4 param_6,undefined4 param_7,undefined4 param_8)
{
  ...
  if ((*(char *)(iVar7 + 0x6e) == '\0') && (*(char *)(param_1 + 0x56) != '\v')) {
    ...
    *(float *)(iVar7 + 0x58) =
         *(float *)(iVar7 + 0x58) +
         ((float)((double)CONCAT44(0x43300000,uStack_24) - dVar2) * lbl_803DC074) / fVar3;
    fVar3 = lbl_803E6958;
    *(float *)(iVar7 + 0x5c) =
         -(lbl_803DC074 * *(float *)(iVar7 + 0x5c) * lbl_803E6958 - *(float *)(iVar7 + 0x5c));
    *(float *)(iVar7 + 0x58) =
         -(lbl_803DC074 * *(float *)(iVar7 + 0x58) * fVar3 - *(float *)(iVar7 + 0x58));
    fVar3 = lbl_803E6950;
    iVar6 = (int)(lbl_803E6950 * *(float *)(iVar7 + 0x58));
...
void SB_CloudRunner_update(int obj)
{
    ...
    *(f32 *)(state + 0x58) = *(f32 *)(state + 0x58) - timeDelta * (*(f32 *)(state + 0x58) * lbl_803E5CC0);
    ...
    ((GameObject *)obj)->anim.localPosY = lbl_803E5CB8 * *(f32 *)(state + 0x58) + *(f32 *)(state + 0x50);
    ((GameObject *)obj)->anim.localPosZ = lbl_803E5CB8 * *(f32 *)(state + 0x5c) + *(f32 *)(state + 0x54);
