...
extern const f32 lbl_803E17C0;
extern const f32 lbl_803E17C4;
extern const f32 lbl_803E17C8;
extern const f32 lbl_803E17CC;
extern const f32 lbl_803E17D0;
extern const f32 lbl_803E17E0;
extern const f32 lbl_803E17E4;
extern const f32 lbl_803E17E8;
extern const f32 lbl_803E17EC;
extern const f32 lbl_803E17F0;
extern const f32 lbl_803E17F4;
extern const f32 lbl_803E17F8;
extern const f32 lbl_803E17FC;
extern const f32 lbl_803E1800;
extern const f32 lbl_803E1804;
extern const f32 lbl_803E1808;
extern const f32 lbl_803E180C;
extern const f32 lbl_803E1810;
extern const f32 lbl_803E1814;
extern const f32 lbl_803E1818;
extern const f32 lbl_803E181C;
extern const f32 lbl_803E1820;
extern const f32 lbl_803E1824;
extern const f32 lbl_803E1828;
extern const f32 lbl_803E182C;
extern const f32 lbl_803E1830;
extern const f32 lbl_803E1834;
...
void CameraModeViewfinder_update(s16* obj)
{
    ...
    {
    case 0:
        lbl_803DD548->mode = firstPersonEnter((u8*)obj, (s16*)*(int*)(obj + 0x52));
        break;
    case 1:
    ...
    case 3:
        ...
        *obj = lbl_803DD548->viewCurve.sample[0];
        ...
        if (angleDiff != 0)
        {
            ...
            lbl_803DD548->viewCurve.coeffFn = Curve_BuildHermiteCoeffs;
            curvesMove(&lbl_803DD548->viewCurve);
            *(s16*)(*(int*)(obj + 0x52) + 6) = *(s16*)(*(int*)(obj + 0x52) + 6) & ~0x4000;
        ...
        *(u8*)(obj + 0x9f) = 1;
        break;
    case 4:
        *(f32*)(obj + 0xc) = lbl_803DD548->posXCurve.end;
        *(f32*)(obj + 0xe) = lbl_803DD548->posYCurve.end;
        *(f32*)(obj + 0x10) = lbl_803DD548->posZCurve.end;
        {
            f32 fade = (lbl_803E17E8 - *(f32*)(obj + 0x7a)) - lbl_803E1824;
        ...
        {
            hitY = *(f32*)(obj + 0xe) - (*(f32*)(camObj + 0x1c) + lbl_803E17C0);
            ...
            obj[1] = obj[1] + (int)((f32)angleDiff * timeDelta) / 8;
        }
        if (brightness != 0)
        {
    ...
    if (ObjHits_GetPriorityHit(*(int*)(obj + 0x52), 0, 0, 0) != 0)
    {
        firstPersonExit((CameraObject*)obj);
        *(f32*)(obj + 0xc) = lbl_803DD548->posXCurve.end;
        *(f32*)(obj + 0xe) = lbl_803DD548->posYCurve.end;
    ...
    fn_80137948(&sCam5BYDebugFormat, *(f32*)(obj + 0xe));
    Obj_TransformWorldPointToLocal(*(f32*)(obj + 0xc), *(f32*)(obj + 0xe), *(f32*)(obj + 0x10),
