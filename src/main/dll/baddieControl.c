...
extern f32 lbl_803DC608;
extern f32 lbl_803DC60C;
extern f32 lbl_803DC610;
extern f32 lbl_803DC614;
extern f32 lbl_803DC618;
extern f32 lbl_803DC620;
extern f32 lbl_803DC628;
extern f32 lbl_803DC630;
extern f32 lbl_803DC638;
extern f32 lbl_803DDA58;
extern f32 lbl_803DDA5C;
extern f32 lbl_803DE1F8;
extern f32 lbl_803DE220;
extern f32 lbl_803DE224;
extern f32 lbl_803DE228;
...
extern f32 lbl_803E26A8;
extern f32 lbl_803E26AC;
...
extern f32 lbl_803E2758;
extern f32 lbl_803E275C;
extern f32 lbl_803E2760;
extern f32 lbl_803E2764;
extern f32 lbl_803E2770;
...
extern f32 lbl_803E2818;
extern f32 lbl_803E281C;
...
extern f32 lbl_803E2864;
extern f32 lbl_803E2868;
extern f32 lbl_803E286C;
extern f32 lbl_803E2870;
extern f32 lbl_803E2874;
...
void FUN_8010df40(void)
{
    ...
    if (*(char *)((int)DAT_803de200 + 9) == *(char *)(DAT_803de200 + 2)) {
      ...
      if (-1 < *(char *)((int)DAT_803de200 + 0x15)) {
        ...
        *psVar5 = *psVar5 + sVar4 / *(short *)((int)DAT_803de200 + 10);
        ...
        dVar17 = (double)(float)((double)lbl_803E26D8 * dVar17);
        fVar2 = lbl_803E26DC +
                *(float *)(iVar14 + 0x1c) + (float)((double)lbl_803E26D8 * dVar16);
    ...
    if (*(char *)((int)DAT_803de200 + 9) == '\0') {
      ...
      if (-1 < *(char *)((int)DAT_803de200 + 0x15)) {
        *(short *)((int)DAT_803de200 + 10) = *(short *)((int)DAT_803de200 + 10) + -1;
        ...
        if ((uVar8 & 8) != 0) {
          dVar18 = (double)(lbl_803E26AC * *DAT_803de200);
        }
        if ((uVar8 & 4) != 0) {
          dVar18 = (double)(lbl_803E26B0 * *DAT_803de200);
        }
        dVar19 = dVar18;
        if (dVar18 < (double)lbl_803E26A8) {
          dVar19 = -dVar18;
        }
        dVar17 = (double)DAT_803de200[1];
        dVar15 = dVar17;
        if (dVar17 < (double)lbl_803E26A8) {
          dVar15 = -dVar17;
        }
        fVar1 = lbl_803E26B8;
        if (dVar19 < dVar15) {
        ...
        *DAT_803de200 = *DAT_803de200 + DAT_803de200[1];
        if (*DAT_803de200 < lbl_803E26BC) {
          *DAT_803de200 = lbl_803E26BC;
        }
        if (lbl_803E26C0 < *DAT_803de200) {
          *DAT_803de200 = lbl_803E26C0;
        }
        ...
        if (*(char *)(DAT_803de200 + 5) != '\0') {
          ...
          *DAT_803de200 =
               *DAT_803de200 +
               (float)((double)CONCAT44(0x43300000,
                                        (int)(short)(int)(lbl_803E26C4 - *DAT_803de200) /
        ...
        *psVar5 = *psVar5 + cVar11 * 3;
        ...
        fVar3 = lbl_803E26D0 + *(float *)(iVar14 + 0x1c);
  ...
  *(float *)(psVar10 + 4) = lbl_803E26E4 + lbl_803E26E8 / *DAT_803de200;
  *psVar7 = *psVar10;
  psVar7[1] = psVar10[1];
  *(undefined4 *)(psVar7 + 4) = *(undefined4 *)(psVar10 + 4);
  if (((short)(*psVar7 + -0x2198) < -0x1fff) || (0x1fff < (short)(*psVar7 + -0x2198))) {
    *(undefined *)(psVar7 + 0x1b) = 0;
    ...
    dVar19 = (double)FUN_80294964();
    fVar1 = lbl_803E26A8;
    if (lbl_803E26A8 <= lbl_803E26EC * (float)(dVar19 * dVar18)) {
      dVar18 = (double)FUN_80294964();
      dVar19 = (double)FUN_80294964();
      fVar1 = lbl_803E26EC * (float)(dVar19 * dVar18);
    }
...
void FUN_8010ebd0(short *param_1)
{
  ...
  local_68 = lbl_803E2708;
  local_64 = lbl_803E270C;
  local_60 = lbl_803E2708;
  local_5c = lbl_803E2708;
  dVar4 = FUN_80006a30((double)*(float *)(DAT_803de208 + 4),&local_68,(float *)0x0);
  psVar3 = *(short **)(param_1 + 0x52);
  local_58 = (longlong)(int)((double)lbl_803E2710 * dVar4);
  sVar2 = (-0x8000 - *psVar3) + (short)(int)((double)lbl_803E2710 * dVar4);
  uStack_4c = (int)sVar2 ^ 0x80000000;
  local_50 = 0x43300000;
  dVar5 = (double)FUN_80294964();
  dVar6 = (double)FUN_80293f90();
  dVar8 = (double)lbl_803E271C;
  dVar7 = (double)lbl_803E2720;
  *(float *)(param_1 + 6) =
  ...
  *(float *)(param_1 + 10) =
  ...
  fVar1 = lbl_803E2724;
  *(float *)(param_1 + 8) =
       -(float)((double)lbl_803E2728 * dVar4 - (double)(lbl_803E2724 + *(float *)(psVar3 + 0xe))
               );
  param_1[1] = 0x11c6 - (short)(int)(fVar1 * (float)((double)lbl_803E272C * dVar4));
  *param_1 = sVar2 + 0x1ffe;
  param_1[2] = 0;
  *(undefined *)((int)param_1 + 0x13b) = 0;
  *(float *)(param_1 + 0x5a) = lbl_803E2730;
  *(float *)(DAT_803de208 + 4) = lbl_803E2734 * lbl_803DC074 + *(float *)(DAT_803de208 + 4);
  if (lbl_803E270C < *(float *)(DAT_803de208 + 4)) {
    *(float *)(DAT_803de208 + 4) = lbl_803E270C;
  }
  return;
}
...
void FUN_8010ed80(void)
{
  ...
  *(float *)(DAT_803de208 + 4) = lbl_803E2708;
  return;
}
  ...
  if (psVar4 != (short *)0x0) {
    if (*(char *)(DAT_803de210 + 8) < '\0') {
      ...
      (**(code **)(*DAT_803dd6d0 + 0x38))
                ((double)lbl_803E275C,param_1,local_3c,auStack_40,&local_44,&local_48,0);
      uVar1 = FUN_80017730();
      ...
      *param_1 = *param_1 + (short)iVar3;
      ...
      dVar5 = (double)FUN_80293f90();
      *(float *)(param_1 + 0xc) =
           (float)((double)lbl_803E2750 * dVar5 + (double)*(float *)(psVar4 + 0xc));
      uStack_2c = (int)*psVar4 ^ 0x80000000;
      local_30 = 0x43300000;
      dVar5 = (double)FUN_80294964();
      *(float *)(param_1 + 0x10) =
           (float)((double)lbl_803E2750 * dVar5 + (double)*(float *)(psVar4 + 0x10));
      *(float *)(param_1 + 0xe) = lbl_803E2754 + *(float *)(psVar4 + 0xe);
      ...
      local_28 = 0x43300000;
      dVar5 = FUN_800176f4((double)(f32)(s32)uStack_24
                           ,(double)lbl_803E2758,(double)lbl_803DC074);
      uStack_1c = (int)(short)*param_1 ^ 0x80000000;
      local_20 = 0x43300000;
      iVar2 = (int)((double)(f32)(s32)uStack_1c +
                   dVar5);
    ...
    *param_1 = (short)(int)((float)((double)CONCAT44(0x43300000,(int)*param_1 ^ 0x80000000) -
                           ...
                           (float)((double)CONCAT44(0x43300000,
                                                    (int)(short)(((-0x8000 - *(short *)*DAT_803de218
                                                                ...
                                                                *param_1) ^ 0x80000000) -
                                  DOUBLE_803e2778) / lbl_803E2760);
    dVar2 = (double)FUN_80293f90();
    *(float *)(param_1 + 6) =
         -(float)((double)lbl_803E2764 * dVar2 - (double)*(float *)(*DAT_803de218 + 0xc));
    *(float *)(param_1 + 8) = lbl_803E2770 + *(float *)(*DAT_803de218 + 0x10);
    dVar2 = (double)FUN_80294964();
    *(float *)(param_1 + 10) =
         -(float)((double)lbl_803E2764 * dVar2 - (double)*(float *)(*DAT_803de218 + 0x14));
  }
  return;
}
...
void FUN_8010f3d4(short *param_1)
{
  ...
  local_d0 = (float)(dVar3 * (double)lbl_803DC628 + dVar10);
  local_cc = lbl_803E2788 + *(float *)(psVar2 + 0xe);
  dVar3 = (double)*(float *)(psVar2 + 0x10);
  local_c8 = (float)(dVar4 * (double)lbl_803DC628 + dVar3);
  ...
  lbl_803DE228 = (float)dVar3;
  lbl_803DE220 = (float)dVar3;
  FUN_80294d2c((int)psVar2,local_d4,&local_d6);
  local_d6 = local_d6 >> 1;
  dVar10 = (double)*(float *)(psVar2 + 0xc);
  dVar4 = (double)(*(float *)(psVar2 + 0xe) + lbl_803DE224);
  dVar3 = (double)*(float *)(psVar2 + 0x10);
  ...
  local_b8 = 0x43300000;
  dVar5 = FUN_800176f4((double)(f32)(s32)uStack_b4,
                       (double)lbl_803E2798,(double)lbl_803DC074);
  uStack_ac = (int)*param_1 ^ 0x80000000;
  local_b0 = 0x43300000;
  iVar1 = (int)((double)(f32)(s32)uStack_ac + dVar5);
  ...
  *param_1 = (short)iVar1;
  ...
  local_a0 = 0x43300000;
  dVar5 = FUN_800176f4((double)(f32)(s32)uStack_9c,
                       (double)lbl_803E2798,(double)lbl_803DC074);
  uStack_94 = (int)param_1[1] ^ 0x80000000;
  local_98 = 0x43300000;
  iVar1 = (int)((double)(f32)(s32)uStack_94 + dVar5);
...
void FUN_8010f760(int param_1,undefined4 param_2,undefined4 *param_3)
{
  ...
  local_44 = (float)(dVar2 * (double)lbl_803DC628 + dVar4);
  local_40 = lbl_803E2788 + *(float *)(psVar1 + 0xe);
  dVar2 = (double)*(float *)(psVar1 + 0x10);
  local_3c = (float)(dVar3 * (double)lbl_803DC628 + dVar2);
  ...
  lbl_803DE228 = (float)dVar2;
  if (param_3 == (undefined4 *)0x0) {
    lbl_803DC628 = lbl_803E279C;
    lbl_803DE224 = lbl_803E2788;
  }
  else {
    lbl_803DC628 = (float)*param_3;
    lbl_803DE224 = (float)param_3[1];
  }
  return;
}
...
void FUN_8010f8e8(short *param_1)
{
  ...
  if (puVar2 == (ushort *)0x0) {
    ...
    local_c0 = *(float *)(psVar3 + 0xe) + lbl_803DC630;
    ...
    local_b6 = puVar2[1];
    local_b4 = puVar2[2];
    local_b0 = lbl_803E27A0;
    FUN_80017754(afStack_a0,&local_b8);
    FUN_80017778((double)lbl_803E27A4,(double)lbl_803E27A8,(double)lbl_803E27AC,afStack_a0,
...
void FUN_8010fcb4(short *param_1)
{
  ...
  if (*(char *)((int)DAT_803de238 + 0xd) == '\0') {
    ...
    fVar1 = -(float)((double)lbl_803E27C0 * dVar8 - (double)*(float *)(*DAT_803de238 + 0x18)) -
            *(float *)(DAT_803de238[2] + 0x18);
    fVar2 = -(float)((double)lbl_803E27C0 * dVar6 - (double)*(float *)(*DAT_803de238 + 0x20)) -
            *(float *)(DAT_803de238[2] + 0x20);
    dVar7 = FUN_80293900((double)(fVar1 * fVar1 + fVar2 * fVar2));
    fVar1 = (float)((double)(float)((double)lbl_803E27C4 - dVar7) / (double)lbl_803E27C4);
    *(float *)(param_1 + 0x5a) = lbl_803E27CC * fVar1 + lbl_803E27C8;
    dVar7 = (double)(lbl_803E27D4 * fVar1 + lbl_803E27D0);
    *(float *)(param_1 + 0xc) = -(float)(dVar8 * dVar7 - (double)*(float *)(*DAT_803de238 + 0x18));
    *(float *)(param_1 + 0xe) =
         lbl_803E27DC * fVar1 + lbl_803E27D8 + *(float *)(*DAT_803de238 + 0x1c);
    ...
    *param_1 = -(short)iVar4;
    ...
    if (*(char *)(DAT_803de238 + 3) == '\0') {
      fVar1 = (float)DAT_803de238[4] / lbl_803E27DC;
      *(float *)(param_1 + 0xc) =
      ...
      *param_1 = (short)iVar4;
      ...
      local_a0 = 0x43300000;
      iVar4 = (int)((f32)(s32)uStack_a4 * fVar1 +
                   (f32)(s32)uStack_9c);
      local_98 = (longlong)iVar4;
      param_1[1] = (short)iVar4;
      DAT_803de238[4] = (int)((float)DAT_803de238[4] - lbl_803DC074);
      fVar1 = lbl_803E27E8;
      if ((float)DAT_803de238[4] < lbl_803E27E8) {
...
void FUN_80110320(ushort *param_1)
{
  ...
  *(float *)(param_1 + 0x10) = *(float *)(iVar6 + 0x20) + DAT_803a5058;
  if (*(char *)(iVar6 + 0xac) != '&') {
    fVar3 = DAT_803a5060 / DAT_803a505c - lbl_803E2820;
    if (lbl_803E2824 <= fVar3) {
      *(float *)(param_1 + 0x10) =
           (f32)(s32)(-(uint)DAT_803a507b) * fVar3 + *(float *)(param_1 + 0x10);
    }
    else {
      *(float *)(param_1 + 0x10) =
           (f32)(s32)(-(uint)DAT_803a507a) * fVar3 + *(float *)(param_1 + 0x10);
    }
  }
  iVar1 = (int)((f32)(s32)((int)DAT_803a5074) * DAT_803a5064);
  local_70 = (double)(longlong)iVar1;
  iVar2 = (int)((f32)(s32)((int)DAT_803a5076) * DAT_803a5068);
  local_60 = (double)(longlong)iVar2;
  uVar4 = FUN_8020a6f4(iVar6);
  if (uVar4 == 0) {
    iVar6 = FUN_8020a6e4(iVar6);
    if (iVar6 == 0) {
      iVar6 = (int)((f32)(s32)((int)DAT_803a5078) * DAT_803a506c);
      ...
      local_30 = 0x43300000;
      iVar6 = (int)((f32)(s32)uStack_2c *
                    lbl_803DC074 * lbl_803E282C + (f32)(s32)((int)(short)param_1[2]));
      ...
      local_50 = 0x43300000;
      iVar6 = (int)((f32)(s32)(uVar4) * lbl_803DC074 * lbl_803E282C +
                   (f32)(s32)uStack_4c);
      ...
      *param_1 = (ushort)iVar6;
      ...
      iVar6 = (int)((f32)(s32)(uVar4) * lbl_803DC074 * lbl_803E282C +
                   (f32)(s32)((int)(short)param_1[1]));
      local_70 = (double)(longlong)iVar6;
      param_1[1] = (ushort)iVar6;
    }
    else {
      DAT_803a5070 = DAT_803a5070 * lbl_803E2830;
      iVar6 = (int)(DAT_803a5070 * lbl_803DC074 + (f32)(s32)((int)(short)param_1[2]));
      local_28 = (double)(longlong)iVar6;
      param_1[2] = (ushort)iVar6;
    }
  }
  else {
    DAT_803a5070 = lbl_803E2828;
    (**(code **)(*DAT_803dd6d0 + 0x38))
              ((double)lbl_803E2824,param_1,local_7c,local_80,local_84,local_88,0);
    iVar6 = (int)(DAT_803a5070 * lbl_803DC074 + (f32)(s32)((int)(short)param_1[2]));
    ...
    uVar4 = (uint)((f32)(s32)(uVar4) * lbl_803DC074);
    local_78 = (double)(longlong)(int)uVar4;
    uStack_4c = (int)(short)*param_1 ^ 0x80000000;
    local_50 = 0x43300000;
    iVar6 = (int)((f32)(s32)(uVar4) * lbl_803E282C +
                 (f32)(s32)uStack_4c);
    ...
    *param_1 = (ushort)iVar6;
    ...
    uStack_2c = (uint)((f32)(s32)(uVar4) * lbl_803DC074);
    local_38 = (double)(longlong)(int)uStack_2c;
    uStack_2c = uStack_2c ^ 0x80000000;
    local_30 = 0x43300000;
    iVar6 = (int)((f32)(s32)uStack_2c * lbl_803E282C
                 + (f32)(s32)((int)(short)param_1[1]));
...
void FUN_80110a44(int param_1,int param_2)
{
  ...
  DAT_803a506c = lbl_803E2850;
  DAT_803a5044 = lbl_803E2854;
  DAT_803a5048 = lbl_803E2858;
  DAT_803a504c = lbl_803E2824;
  DAT_803a5060 = lbl_803E285C;
  DAT_803a505c = lbl_803E285C;
  DAT_803a507b = 0x5a;
  DAT_803a507a = 100;
  DAT_803a5028 = lbl_803E2824;
  DAT_803a5024 = lbl_803E2824;
...
void FUN_80110c90(ushort *param_1)
{
  ...
  if (DAT_803de24a != DAT_803de249) {
    ...
    if (lbl_803E2870 <= lbl_803DC638) {
      fVar1 = -(lbl_803E2874 * (lbl_803DC638 - lbl_803E2870) - lbl_803E2860);
      fVar1 = lbl_803E2870 * (lbl_803E2860 - fVar1 * fVar1) + lbl_803E2870;
    }
    else {
      fVar1 = lbl_803E2870 * lbl_803E2874 * lbl_803DC638 * lbl_803E2874 * lbl_803DC638;
    }
    fVar1 = fVar1 * lbl_803E287C * fVar1 * fVar1 +
            lbl_803E2870 * fVar1 + lbl_803E2878 * fVar1 * fVar1;
    *(float *)(param_1 + 6) =
    ...
    *(float *)(param_1 + 10) =
    ...
    if (ABS((float)(local_18 - DOUBLE_803e2890)) <= lbl_803E2880) {
      local_18 = (double)CONCAT44(0x43300000,uVar2);
...
void FUN_80111aec(void)
{
  ...
  dVar15 = (double)lbl_803E28AC;
  if (dVar15 < dVar16) {
    *(float *)(iVar12 + 1000) =
         (float)((double)lbl_803DC074 * (double)*(float *)(iVar12 + 0x3ec) + dVar16);
    uVar1 = *(ushort *)(iVar12 + 0x400);
    if ((uVar1 & 0x20) == 0) {
      if ((uVar1 & 0x40) == 0) {
        dVar13 = (double)*(float *)(iVar12 + 1000);
        if (dVar15 <= dVar13) {
          dVar14 = (double)lbl_803E28C4;
          if (dVar14 < dVar13) {
  ...
  if (*(char *)(iVar7 + 0x354) != '\0') {
    ...
    *(undefined *)(iVar12 + 0x40a) = (undefined)local_34;
    if (iVar6 != 0) {
      if (in_r10 != 0) {
        *(float *)(in_r10 + 0xc) = local_40 + lbl_803DDA58;
        *(undefined4 *)(in_r10 + 0x10) = local_44;
        *(float *)(in_r10 + 0x14) = local_48 + lbl_803DDA5C;
      }
      if (in_r8 == 0) {
        local_38 = 0;
      }
      ...
      *(char *)(iVar7 + 0x354) = *(char *)(iVar7 + 0x354) - (char)local_38;
      if (*(char *)(iVar7 + 0x354) < '\x01') {
        ...
        *(float *)(iVar12 + 1000) = lbl_803E28C8;
        *(float *)(iVar12 + 0x3ec) = lbl_803E28CC;
        ...
        *(float *)(iVar12 + 1000) = lbl_803E28C8;
        *(float *)(iVar12 + 0x3ec) = lbl_803E28D0;
            ...
            *(float *)(iVar4 + 0x20) = (float)dVar8;
            if (DAT_803de25c != 0) {
              ...
              *(undefined4 *)(DAT_803de25c + 0xc) = uVar1;
              fVar2 = *(float *)(iVar4 + 0x10) + lbl_803E28DC;
...
void FUN_801126b8(undefined4 param_1,undefined4 param_2,int param_3)
{
  ...
  if ((((*(char *)(iVar4 + 0x346) != '\0') && (*(int *)(iVar4 + 0x2d0) == iVar2)) &&
    ...
    local_8c = lbl_803E28E8 + *(float *)(iVar2 + 0x10);
...
void CameraModeCrawl_copyToCurrent(void *param1, int param2) {
    ...
    if (param2 == 0) {
        c = mathSinf(lbl_803E1AC0 * (f32)(s32)*(s16 *)state / lbl_803E1AC4);
        s = mathCosf(lbl_803E1AC0 * (f32)(s32)*(s16 *)state / lbl_803E1AC4);
    } else {
        c = -mathSinf(lbl_803E1AC0 * (f32)(s32)*(s16 *)state / lbl_803E1AC4);
        s = -mathCosf(lbl_803E1AC0 * (f32)(s32)*(s16 *)state / lbl_803E1AC4);
    }
...
void dll_54_update(u8 *obj) {
    ...
    if (*(u8 *)(lbl_803DD5C0 + 13) != 0) {
        ...
        if (*(void **)(lbl_803DD5C0 + 4) == NULL) {
            ...
            for (; i < count; i++) {
                int o = arr[i];
                if (((GameObject *)o)->anim.seqId == 0x2ab) {
                    *(int *)(lbl_803DD5C0 + 4) = o;
                } else if (((GameObject *)o)->anim.seqId == 0x4dc) {
                    *(int *)lbl_803DD5C0 = o;
                }
            }
        }
        ...
        }
        {
            ...
            int b;
            dx = ((GameObject *)a)->anim.worldPosX - *(f32 *)((b = *(int *)lbl_803DD5C0) + 0x18);
            dy = ((GameObject *)a)->anim.worldPosY - ((GameObject *)b)->anim.worldPosY;
            dz = ((GameObject *)a)->anim.worldPosZ - ((GameObject *)b)->anim.worldPosZ;
        }
        zz = dz * dz;
        xx = dx * dx;
        ...
        *(f32 *)&((GameObject *)obj)->unkB4 = lbl_803E1B4C * t + lbl_803E1B48;
        h = lbl_803E1B54 * t + lbl_803E1B50;
        ((GameObject *)obj)->anim.worldPosX = -(nx * h - *(f32 *)(*(int *)lbl_803DD5C0 + 0x18));
        ((GameObject *)obj)->anim.worldPosY =
            lbl_803E1B5C * t + (lbl_803E1B58 + *(f32 *)(*(int *)lbl_803DD5C0 + 0x1c));
        ((GameObject *)obj)->anim.worldPosZ = -(nz * h - *(f32 *)(*(int *)lbl_803DD5C0 + 0x20));
        *(s16 *)obj = -getAngle(dx, dz);
        ...
        if (*(u8 *)(lbl_803DD5C0 + 12) == 0) {
            ...
            ((GameObject *)obj)->anim.worldPosX =
                t2 * (*(f32 *)(lbl_803DD5C0 + 20) - ((GameObject *)obj)->anim.worldPosX) + ((GameObject *)obj)->anim.worldPosX;
            ((GameObject *)obj)->anim.worldPosY =
                t2 * (*(f32 *)(lbl_803DD5C0 + 24) - ((GameObject *)obj)->anim.worldPosY) + ((GameObject *)obj)->anim.worldPosY;
            ((GameObject *)obj)->anim.worldPosZ =
                t2 * (*(f32 *)(lbl_803DD5C0 + 28) - ((GameObject *)obj)->anim.worldPosZ) + ((GameObject *)obj)->anim.worldPosZ;
            ...
            *(s16 *)obj = (f32)d * t2 + (f32)cur;
            ...
            cur = ((GameObject *)obj)->anim.rotY;
            d = (s16)(*(s16 *)(lbl_803DD5C0 + 34) - (u16)cur);
            d = (d > 0x8000) ? (s16)(d - 0xffff) : d;
            d = (d < -0x8000) ? (s16)(d + 0xffff) : d;
            ((GameObject *)obj)->anim.rotY = (f32)d * t2 + (f32)cur;
...
void CameraModeWorldMap_update(u8 *obj) {
    GameObject *state;
    CameraModeWorldMapState *worldMapState;
    int objA, objB;
    int buttons;
    ...
    state = (GameObject *)((GameObject *)obj)->anim.targetObj;
    worldMapState = lbl_803DD588;
    ...
    switch (worldMapState->mode) {
    case 0:
        if (worldMapState->previousMode != worldMapState->mode) {
            worldMapState->focusBlendTimer = 1;
            (*gScreenTransitionInterface)->start(0xc, 1);
            worldMapState->settleFrames = 2;
            worldMapState->flags.transitionActive = 1;
        } else {
            s16 dYaw, dPitch;
            if (worldMapState->flags.transitionActive != 0 &&
                (*gScreenTransitionInterface)->isFinished() != 0) {
                fn_8012DDB8(0);
                (*gScreenTransitionInterface)->step(0xc, 1);
                worldMapState->flags.transitionActive = 0;
                *(u8 *)(*(int *)(ObjList_FindObjectById(0x43077) + 0xb8) + 0x27d) = 0;
            }
            if (worldMapState->flags.transitionActive == 0) {
                worldMapState->settleFrames -= 1;
                if (worldMapState->settleFrames < 1) {
                    worldMapState->settleFrames = 1;
                }
                if (buttons & 8) {
                    spd = lbl_803E1A2C * worldMapState->distance;
                }
                if (buttons & 4) {
                    spd = lbl_803E1A30 * worldMapState->distance;
                }
                {
                    f32 a, b, rate, vel;
                    if (spd < lbl_803E1A28) {
                    ...
                    vel = worldMapState->distanceVelocity;
                    if (vel < lbl_803E1A28) {
                        b = -vel;
                    } else {
                        b = vel;
                    ...
                    worldMapState->distanceVelocity =
                        rate * (spd - vel) + worldMapState->distanceVelocity;
                }
                worldMapState->distance = worldMapState->distance + worldMapState->distanceVelocity;
                if (worldMapState->distance < lbl_803E1A3C) {
                    worldMapState->distance = lbl_803E1A3C;
                }
                if (worldMapState->distance > lbl_803E1A40) {
                    worldMapState->distance = lbl_803E1A40;
                }
                dYaw = (s16)((s8)padGetCX(0) * 3);
                dPitch = (s16)((s8)padGetCY(0) * 3);
                if (worldMapState->focusBlendTimer != 0) {
                    int f = ObjList_FindObjectById(worldMapState->focusObjectId);
                    f32 dx = ((GameObject *)f)->anim.worldPosX - ((GameObject *)objA)->anim.worldPosX;
                    f32 dz = ((GameObject *)f)->anim.worldPosZ - ((GameObject *)objA)->anim.worldPosZ;
                    s16 d;
                    f32 cur;
                    worldMapState->targetAngle = (s16)(0x8000 - getAngle(dx, dz));
                    d = (s16)(worldMapState->targetAngle - (u16)*(s16 *)obj);
                    if (d > 0x8000) {
                        d = (s16)(d - 0xffff);
                    }
                    if (d < -0x8000) {
                    ...
                    *(s16 *)obj = *(s16 *)obj + d / worldMapState->focusBlendTimer;
                    worldMapState->targetAngle =
                        (s16)(0x47d0 - getAngle(sqrtf(dx * dx + dz * dz),
                                                ((GameObject *)f)->anim.worldPosY - ((GameObject *)objA)->anim.worldPosY));
                    d = (s16)(worldMapState->targetAngle - (u16)((GameObject *)obj)->anim.rotY);
                    if (d > 0x8000) {
                        d = (s16)(d - 0xffff);
                    }
                    if (d < -0x8000) {
                    ...
                    ((GameObject *)obj)->anim.rotY = ((GameObject *)obj)->anim.rotY + d / worldMapState->focusBlendTimer;
                    cur = worldMapState->distance;
                    worldMapState->distance =
                        cur + (f32)((s16)(s32)(lbl_803E1A44 - cur) /
                                    (s32)worldMapState->focusBlendTimer);
                    worldMapState->focusBlendTimer -= 1;
                }
                *(s16 *)obj += dYaw;
                ((GameObject *)obj)->anim.rotY += dPitch;
                if (((GameObject *)obj)->anim.rotY > 12000) {
                    ((GameObject *)obj)->anim.rotY = 12000;
                }
                if (((GameObject *)obj)->anim.rotY < -12000) {
                    ((GameObject *)obj)->anim.rotY = -12000;
                }
                {
                    ...
                    f32 r, vy, h, px, pz;
                    f32 dxx, dyy, dzz;
                    snYaw = -mathCosf(lbl_803E1A48 * (f32)*(s16 *)obj / lbl_803E1A4C);
                    csYaw = mathSinf(lbl_803E1A48 * (f32)*(s16 *)obj / lbl_803E1A4C);
                    snPit = mathCosf(lbl_803E1A48 * (f32)(((GameObject *)obj)->anim.rotY + 0x320) / lbl_803E1A4C);
                    csPit = mathSinf(lbl_803E1A48 * (f32)(((GameObject *)obj)->anim.rotY + 0x320) /
                                        lbl_803E1A4C);
                    r = worldMapState->distance;
                    vy = r * csPit;
                    h = r * snPit;
                    px = h * csYaw;
                    pz = h * snYaw;
                    dxx = ((GameObject *)obj)->anim.worldPosX - (((GameObject *)state)->anim.worldPosX + px);
                    dyy = ((GameObject *)obj)->anim.worldPosY - ((lbl_803E1A50 + ((GameObject *)state)->anim.worldPosY) + vy);
                    dzz = ((GameObject *)obj)->anim.worldPosZ - (((GameObject *)state)->anim.worldPosZ + pz);
                    ((GameObject *)obj)->anim.worldPosX =
                        ((GameObject *)obj)->anim.worldPosX - dxx / (f32)worldMapState->settleFrames;
                    ((GameObject *)obj)->anim.worldPosY =
                        ((GameObject *)obj)->anim.worldPosY - dyy / (f32)worldMapState->settleFrames;
                    ((GameObject *)obj)->anim.worldPosZ =
                        ((GameObject *)obj)->anim.worldPosZ - dzz / (f32)worldMapState->settleFrames;
                }
            }
        }
        break;
    case 1: {
        ...
        if (worldMapState->previousMode != worldMapState->mode) {
            ...
            if (worldMapState->flags.transitionActive == 0) {
                ...
                ang = (u16)-getAngle(((GameObject *)objA)->anim.worldPosX - ((GameObject *)state)->anim.worldPosX,
                                     ((GameObject *)objA)->anim.worldPosZ - ((GameObject *)state)->anim.worldPosZ);
                ...
                *(s16 *)obj = *(s16 *)obj + d / worldMapState->settleFrames;
                d = (s16)(0x7d0 - (u16)((GameObject *)obj)->anim.rotY);
                if (d > 0x8000) {
                    d = (s16)(d - 0xffff);
                }
                if (d < -0x8000) {
                ...
                ((GameObject *)obj)->anim.rotY = ((GameObject *)obj)->anim.rotY + d / worldMapState->settleFrames;
                {
                    ...
                    pz = t5 * sn;
                    dxx = ((GameObject *)obj)->anim.worldPosX - (((GameObject *)state)->anim.worldPosX + px);
                    dyy = ((GameObject *)obj)->anim.worldPosY -
                          (lbl_803E1A5C + (((GameObject *)state)->anim.worldPosY + t6));
                    dzz = ((GameObject *)obj)->anim.worldPosZ - (((GameObject *)state)->anim.worldPosZ + pz);
                    ((GameObject *)obj)->anim.worldPosX =
                        ((GameObject *)obj)->anim.worldPosX - dxx / (f32)worldMapState->settleFrames;
                    ((GameObject *)obj)->anim.worldPosY =
                ...
                }
                {
                    ...
                    f32 sb = mathCosf(b);
                    f32 cb = -mathSinf(b);
                    ((GameObject *)g)->anim.localPosX = lbl_803E1A60 * cb + ((GameObject *)obj)->anim.worldPosX;
                    ((GameObject *)g)->anim.localPosY =
                        ((GameObject *)obj)->anim.worldPosY + lbl_80319DF8[(s8)*(u8 *)&((GameObject *)g)->anim.bankIndex];
                    ((GameObject *)g)->anim.localPosZ = lbl_803E1A60 * sb + ((GameObject *)obj)->anim.worldPosZ;
                    *(s16 *)g = (s16)(-0xbb8 - my);
                }
            }
        }
    ...
    worldMapState->previousMode = worldMapState->mode;
    m = ObjList_FindObjectById(0x431dc);
    mdx = ((GameObject *)m)->anim.worldPosX - ((GameObject *)obj)->anim.worldPosX;
    mdz = ((GameObject *)m)->anim.worldPosZ - ((GameObject *)obj)->anim.worldPosZ;
    *(s16 *)m = (s16)(getAngle(mdx, mdz) + 0x8000);
    ((GameObject *)m)->anim.rotY = (s16)(0x8000 - getAngle(sqrtf(mdx * mdx + mdz * mdz),
                                              ((GameObject *)m)->anim.worldPosY - ((GameObject *)obj)->anim.worldPosY));
    ((GameObject *)m)->anim.rootMotionScale = lbl_803E1A64 + lbl_803E1A68 / worldMapState->distance;
    *(s16 *)objB = *(s16 *)m;
    ((GameObject *)objB)->anim.rotY = ((GameObject *)m)->anim.rotY;
    ((GameObject *)objB)->anim.rootMotionScale = ((GameObject *)m)->anim.rootMotionScale;

    e = (s16)(*(s16 *)objB - 0x2198);
