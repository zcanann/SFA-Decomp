 ...
 *                (2.5f, capped at
 *                80.0f) and records a contact hit on any
...
#define SHKILLERMUSHROOM_PARTFX_STUN 0x51d /* stun effect (20.0f-timed) */
