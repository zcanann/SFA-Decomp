...
int trickyFn_8013b368(u8 *obj, f32 vel, u8 *state)
{
    ...
    if ((wg != 0) && (((TrickyState *)state)->flagsD0 != wg)) {
        ((TrickyState *)state)->flagsD0 = wg;
        ((TrickyState *)state)->flags54 &= ~0x400LL;
        *(u16 *)(state + 0x98) = 0;
        *(u16 *)(state + 0x9a) = 0;
        *(u16 *)(state + 0x9c) = 0;
        *(u16 *)(state + 0x9e) = 0;
    ...
    trickyDebugPrint(strs + 0x1e8, ((TrickyState *)state)->flagsD0, wg, targetWg, ((TrickyState *)state)->unk532);
    if (((TrickyState *)state)->flagsD0 == 0) {
        trickyReportError(strs + 0x214, ((GameObject *)obj)->anim.worldPosX, ((GameObject *)obj)->anim.worldPosY,
                          ((GameObject *)obj)->anim.worldPosZ);
    }
    velBefore = ((TrickyState *)state)->speed14;
    trickyUpdateApproachSpeed(obj, vel, state, (f32 *)target, 0);
    trickyDebugPrint(strs + 0x268, velBefore, ((TrickyState *)state)->speed14);
    if (targetWg == ((TrickyState *)state)->flagsD0) {
        ((TrickyState *)state)->flags54 = ((TrickyState *)state)->flags54 | 0x400;
        i = 0;
        mask = 1;
        for (; i < 4; i++) {
            if (wgi.mask & mask) {
    ...
    if ((targetWg != 0) && (targetWg == ((TrickyState *)state)->flagsD0)) {
        *(s16 *)&((TrickyState *)state)->boolD2 = 0;
    } else {
        prod = targetWg * ((TrickyState *)state)->flagsD0 & 0xffff;
        if (prod != 0) {
            for (i = 0; i < 4; i++) {
                if ((prod == wgi.patch[i]) && ((wgi.mask & (1 << i)) != 0)) {
                    *(s16 *)&((TrickyState *)state)->boolD2 = prod;
    ...
    link = getPatchGroup((f32 *)target, ((TrickyState *)state)->flagsD0);
    trickyDebugPrint(strs + 0x2e4, link);
    if ((((TrickyState *)state)->flags54 & 0x400) != 0) {
        for (i = 0; i < 4; i++) {
    ...
    if (*(s16 *)&((TrickyState *)state)->boolD2 != 0) {
        trickyDebugPrint(strs + 0x328, *(f32 *)(state + 0xd4), *(f32 *)(state + 0xd8),
                         *(f32 *)(state + 0xdc));
    }
    tp = getPatchGroup((f32 *)target, ((TrickyState *)state)->flagsD0) & 0xffff;
    trickyPatch = getPatchGroup((f32 *)(obj + 0x18), ((TrickyState *)state)->flagsD0) & 0xffff;
    if ((targetWg == 0) || (wg != targetWg)) {
        ulink = walkGroupFn_800db3e4((f32 *)(obj + 0x18), (f32 *)target, ((TrickyState *)state)->flagsD0);
        if (ulink != 0) {
            ((TrickyState *)state)->unk09 = 1;
            if (ulink != ((TrickyState *)state)->flagsD0) {
                *(s16 *)&((TrickyState *)state)->flagsD0 = ulink;
                ((TrickyState *)state)->flags54 &= ~0x400LL;
                *(u16 *)(state + 0x98) = 0;
                *(u16 *)(state + 0x9a) = 0;
                *(u16 *)(state + 0x9c) = 0;
            ...
            if (tp != 0) {
                if (targetWg == 0) {
                    ...
                    if (wg != 0) {
                        ...
                        if (wg == 0) {
                            tp = (u16)getPatchGroup((f32 *)(obj + 0x18), ((TrickyState *)state)->flagsD0);
                            if (tp != 0) {
                                if (*(s16 *)&((TrickyState *)state)->boolD2 == (int)tp) {
                        ...
                        pp = (u16)tp;
                        i = isPointWithinPatchGroup((f32 *)(obj + 0x18), ((TrickyState *)state)->flagsD0,
                                                    pp);
                        trickyReportError(strs + 0x374, pp, targetWg, wg, ((TrickyState *)state)->flagsD0,
                                          i);
                        ((TrickyState *)state)->unk09 = 0;
                    }
                }
                ...
                if (targetWg == 0) {
                    ...
                    if (wg != 0) {
                        ...
                        if (isPointWithinPatchGroup((f32 *)(obj + 0x18), ((TrickyState *)state)->flagsD0,
                                                    targetWg) != 0) {
                            if (*(s16 *)&((TrickyState *)state)->boolD2 == (int)targetWg) {
                                ((TrickyState *)state)->unk09 = 3;
                            } else {
                                ((TrickyState *)state)->unk09 = 5;
                            }
                            ...
                            if ((i == 4) || (targetWg != *(s16 *)&((TrickyState *)state)->boolD2)) {
                                ((TrickyState *)state)->unk09 = 5;
                            }
                        }
                    } else {
                        u32 p = (u16)getPatchGroup((f32 *)(obj + 0x18), ((TrickyState *)state)->flagsD0);
                        if (p != 0) {
                            if (targetWg == ((TrickyState *)state)->flagsD0) {
                                for (i = 0; i < 4; i++) {
                            ...
                            } else if (*(s16 *)&((TrickyState *)state)->boolD2 == (int)p) {
                                ((TrickyState *)state)->unk09 = 3;
                            } else {
                                fn_800DB240(target, state + 0xec, p);
                                ((TrickyState *)state)->unk09 = 4;
...
state_selected:
    if (((TrickyState *)state)->unk09 < 5) {
        ((TrickyState *)state)->flags54 &= ~0x2000LL;
    }
    ...
    case 0:
        ...
        ((TrickyState *)state)->speed14 = (v < lbl_803E23DC) ? lbl_803E23DC : v;
        if (lbl_803E23DC == ((TrickyState *)state)->speed14) {
            moved = 0;
        } else {
    ...
    case 2:
        ...
        ((TrickyState *)state)->speed14 = velBefore;
    ...
    case 6:
        ...
        if (lbl_803E23E0 > dist) {
            *(u32 *)&((TrickyState *)state)->unk4A0 = *(u8 *)(state + 0x41c);
            ...
            if (node == 0) {
                ...
                if (trickySelectRouteEntry(state, node, *(u8 *)(state + 0x41c)) == 0) {
                    ...
                    trickyAdvanceRouteTargetAhead(obj, state + 0x420, ((TrickyState *)state)->speed14);
                    moved = trickyMove(obj, state + 0x488);
                    switch (*(s8 *)(prevNode + 0x1a)) {
                    case 1:
                        ((TrickyState *)state)->speed2C =
                            *(f32 *)(*(int *)(state + 0x4c0) + 8) - ((GameObject *)obj)->anim.worldPosX;
                        ((TrickyState *)state)->speed30 =
                            *(f32 *)(*(int *)(state + 0x4c0) + 0x10) - ((GameObject *)obj)->anim.worldPosZ;
                        len = sqrtf(((TrickyState *)state)->speed2C * ((TrickyState *)state)->speed2C +
                                    ((TrickyState *)state)->speed30 * ((TrickyState *)state)->speed30);
                        if (lbl_803E23DC != len) {
                            ((TrickyState *)state)->speed2C = ((TrickyState *)state)->speed2C / len;
                            ((TrickyState *)state)->speed30 = ((TrickyState *)state)->speed30 / len;
                        }
                        ((TrickyState *)state)->speed14 = lbl_803E248C;
                    ...
                    case 2:
                    case 7:
                        ((TrickyState *)state)->flags54 = ((TrickyState *)state)->flags54 | 0x2000;
                    default:
    ...
    case 7:
        ...
        if ((*(s8 *)(*(int *)(state + 0x4bc) + 0x1a) != 9) && (*(s8 *)(node + 0x1a) != 9)) {
            ...
            if ((lbl_803E23DC < delta[2]) && (lbl_803E23DC != ((TrickyState *)state)->speed14)) {
                step = 0;
                while ((step < 4) &&
                ...
                if (step == 4) {
                    fn_8004B31C(state + 0x538, *(u32 *)(state + 0x4c4), ((TrickyState *)state)->unk28,
                                ((TrickyState *)state)->unk532, *(u32 *)&((TrickyState *)state)->unk4A0);
                    fn_8004B31C(state + 0x568, *(u32 *)(state + 0x4bc), ((TrickyState *)state)->unk28,
                                ((TrickyState *)state)->unk532, *(u32 *)&((TrickyState *)state)->unk4A0 ^ 1);
                    found = 0;
                    step = 0;
        ...
        if (((dir == 0) && (*(int *)(state + 0x430) != 0)) ||
            ...
            if (node != 0) {
                ...
                case 2:
                case 7:
                    prod = ((TrickyState *)state)->flags54;
                    if ((prod & 0x2000) != 0) {
                        ((TrickyState *)state)->flags54 = prod & ~0x2000LL;
                    } else {
                        ((TrickyState *)state)->flags54 = prod | 0x2000;
                    }
                    break;
                }
    ...
    case 8:
        ...
        ((TrickyState *)state)->speed14 = (v > lbl_803E248C) ? lbl_803E248C : v;
        if ((((TrickyState *)state)->unk534 != 0) && (wg == ((TrickyState *)state)->unk534)) {
            v = lbl_803E241C * timeDelta + velBefore;
            ((TrickyState *)state)->speed14 = (v < lbl_803E23DC) ? lbl_803E23DC : v;
        }
    ...
    case 9:
        ...
        if ((u8)(((TrickyState *)state)->flags54 & 0x10000000)) {
        ...
        if (((GameObject *)obj)->anim.currentMoveProgress < lbl_803E24A8) {
            ((ObjAnimSampleRootCurveObjectFirstFn)ObjAnim_SampleRootCurvePhase)(
                (int)obj, ((TrickyState *)state)->speed14, (float *)(state + 0x34));
            ((GameObject *)obj)->anim.localPosX =
                timeDelta * ((TrickyState *)state)->speed2C * ((TrickyState *)state)->speed14 + ((GameObject *)obj)->anim.localPosX;
            ((GameObject *)obj)->anim.localPosZ =
                timeDelta * ((TrickyState *)state)->speed30 * ((TrickyState *)state)->speed14 + ((GameObject *)obj)->anim.localPosZ;
        } else {
            ((ObjAnimSampleRootCurveObjectFirstFn)ObjAnim_SampleRootCurvePhase)(
                (int)obj, ((TrickyState *)state)->speed14 * lbl_803E24AC, (float *)(state + 0x34));
            k = lbl_803E24AC;
            ((GameObject *)obj)->anim.localPosX =
                timeDelta * ((TrickyState *)state)->speed2C * ((TrickyState *)state)->speed14 * k +
                ((GameObject *)obj)->anim.localPosX;
            ((GameObject *)obj)->anim.localPosZ =
                timeDelta * ((TrickyState *)state)->speed30 * ((TrickyState *)state)->speed14 * k +
                ((GameObject *)obj)->anim.localPosZ;
        }
        if ((((TrickyState *)state)->flags54 & 0x8000000) != 0) {
            ...
            *(f32 *)(state + 0x6c) =
            ...
            ((TrickyState *)state)->speed14 = lbl_803E24A4;
    ...
    case 0xe:
        ...
        if ((((TrickyState *)state)->flags54 & 0x8000000) != 0) {
            ((TrickyState *)state)->speed14 = lbl_803E24C0;
            trickyMove(obj, state + 0x488);
            ((TrickyState *)state)->unk09 = 7;
        }
        break;
    ...
    if (((((step == 0) || (step == 2)) || (step == 4)) || (step == 3)) &&
        (lbl_803E23DC == ((TrickyState *)state)->speed14)) {
        return 2;
    }
    if (moved != 0) {
        return 1;
...
void trickyUpdateApproachSpeed(u8 *obj, f32 baseRadius, u8 *state, f32 *targetPos, u8 flag)
{
    ...
    if (dist < distSq) {
        candidate = lbl_803E241C * timeDelta + ((TrickyState *)state)->speed14;
        ((TrickyState *)state)->speed14 =
    ...
    if ((((TrickyState *)state)->flags54 & 0x10000000) != 0) {
        ((TrickyState *)state)->speed14 =
            lbl_803E23F4 * timeDelta + ((TrickyState *)state)->speed14;
        if (((TrickyState *)state)->speed14 < lbl_803E23DC) {
            ((TrickyState *)state)->speed14 = lbl_803E23DC;
        }
        return;
    }
    {
        ...
        if (dist < deltaSpeedSq) {
            if (candidate > lbl_803E23DC) {
                if (candidate < ((TrickyState *)state)->speed14) {
                    f32 step = lbl_803E241C * timeDelta + ((TrickyState *)state)->speed14;
                    ((TrickyState *)state)->speed14 = (step < candidate) ? candidate : step;
                    return;
                } else {
                    f32 step;
                    if (candidate > lbl_803E248C) {
                        step = lbl_803E2420 * timeDelta + ((TrickyState *)state)->speed14;
                        ((TrickyState *)state)->speed14 =
    ...
    if ((((TrickyState *)state)->flags54 & 0x00100000) != 0) {
        ((TrickyState *)state)->speed14 =
            lbl_803E243C * timeDelta + ((TrickyState *)state)->speed14;
        if (((TrickyState *)state)->speed14 > lbl_803E248C) {
            ((TrickyState *)state)->speed14 = lbl_803E248C;
        }
        return;
    }
    {
        f32 step = lbl_803E2420 * timeDelta + ((TrickyState *)state)->speed14;
        ((TrickyState *)state)->speed14 = (step > lbl_803E248C) ? lbl_803E248C : step;
    }
}
