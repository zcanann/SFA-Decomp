...
void dll_9B_func03(int target, int variant, int parent, u32 flags)
{
    ...
    entry[0].mode = 4;
    entry[0].x = lbl_803E13A0;
    entry[0].y = lbl_803E13A0;
    entry[0].z = lbl_803E13A0;
    entry[1].layer = 0;
    entry[1].flags = 0x15;
    entry[1].tex = base + 0x1b0;
    entry[1].mode = 2;
    entry[1].x = lbl_803E13A4;
    entry[1].y = lbl_803E13A8;
    entry[1].z = lbl_803E13A4;
    entry[2].layer = 0;
    entry[2].flags = 0;
    entry[2].tex = 0;
    entry[2].mode = 0x400000;
    entry[2].x = lbl_803E13A0;
    entry[2].y = lbl_803E13AC;
    entry[2].z = lbl_803E13A0;
    entry[3].layer = 0;
    entry[3].flags = 0x124;
    entry[3].tex = 0;
    entry[3].mode = 0x20000;
    entry[3].x = lbl_803E13A0;
    entry[3].y = lbl_803E13A0;
    entry[3].z = lbl_803E13A0;
    entry[4].layer = 1;
    entry[4].flags = 0x15;
    entry[4].tex = base + 0x1b0;
    entry[4].mode = 2;
    entry[4].x = lbl_803E13B0;
    entry[4].y = lbl_803E13B4;
    entry[4].z = lbl_803E13B0;
    entry[5].layer = 1;
    entry[5].flags = 0xe;
    entry[5].tex = base + 0x1dc;
    entry[5].mode = 4;
    entry[5].x = lbl_803E13B8;
    entry[5].y = lbl_803E13A0;
    entry[5].z = lbl_803E13A0;
    entry[6].layer = 1;
    entry[6].flags = 0x15;
    entry[6].tex = base + 0x1b0;
    entry[6].mode = 0x4000;
    entry[6].x = lbl_803E13A8;
    entry[6].y = lbl_803E13BC;
    entry[6].z = lbl_803E13A0;
    entry[7].layer = 1;
    entry[7].flags = 0;
    entry[7].tex = 0;
    entry[7].mode = 0x400000;
    entry[7].x = lbl_803E13A0;
    entry[7].y = lbl_803E13C0;
    entry[7].z = lbl_803E13A0;
    entry[8].layer = 2;
    entry[8].flags = 0x15;
    entry[8].tex = base + 0x1b0;
    entry[8].mode = 0x4000;
    entry[8].x = lbl_803E13A8;
    entry[8].y = lbl_803E13BC;
    entry[8].z = lbl_803E13A0;
    entry[9].layer = 3;
    entry[9].flags = 0x124;
    entry[9].tex = 0;
    entry[9].mode = 0x20000;
    entry[9].x = lbl_803E13A0;
    entry[9].y = lbl_803E13A0;
    entry[9].z = lbl_803E13A0;
    entry[10].layer = 3;
    entry[10].flags = 0xe;
    entry[10].tex = base + 0x1dc;
    entry[10].mode = 4;
    entry[10].x = lbl_803E13A0;
    entry[10].y = lbl_803E13A0;
    entry[10].z = lbl_803E13A0;
    entry[11].layer = 3;
    entry[11].flags = 0x15;
    entry[11].tex = base + 0x1b0;
    entry[11].mode = 0x4000;
    entry[11].x = lbl_803E13A8;
    entry[11].y = lbl_803E13BC;
    entry[11].z = lbl_803E13A0;
    entry[12].layer = 3;
    entry[12].flags = 0x15;
    entry[12].tex = base + 0x1b0;
    entry[12].mode = 2;
    entry[12].x = lbl_803E13A4;
    entry[12].y = lbl_803E13C4;
    entry[12].z = lbl_803E13A4;
    entry[13].layer = 3;
    entry[13].flags = 0;
    entry[13].tex = 0;
    entry[13].mode = 0x400000;
    entry[13].x = lbl_803E13A0;
