...
void levelname_update(int* obj)
{
    ...
    case 0:
        ...
        if (Vec_distance(&((GameObject*)obj)->anim.worldPosX, &((GameObject*)player)->anim.worldPosX) < (f32)(u32)sub[
            0xc]
        )
        {
    ...
    case 2:
        {
            ...
            ((LevelnameState*)sub)->unk12 = (s16)(
                (s32)(lbl_803E36E0 * mathSinf(
                    (lbl_803E36E4 * (f32)((s32)((LevelnameState*)sub)->unk10 * 0x500)) / lbl_803E36E8)) + 0xdc);
            break;
        }
    case 3:
        ((LevelnameState*)sub)->unk12 = (s16)(((LevelnameState*)sub)->unk12 - framesThisStep * 4);
