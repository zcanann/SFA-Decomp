...
void curves_distFn15(undefined8 param_1,double param_2,double param_3)
{
  ...
  if (lVar15 < 0) {
    ...
    while (iVar11 <= iVar7) {
      ...
      iVar9 = (int)gRomCurveTable[iVar8];
  ...
  do {
    ...
    if (uVar12 != ROMCURVE_LINK_ID_NONE) {
      if ((int)uVar12 < 0) {
        ...
        while (iVar7 <= iVar8) {
          iVar6 = iVar8 + iVar7 >> 1;
          iVar11 = (int)gRomCurveTable[iVar6];
        ...
        if (iVar12 != 0) {
          ...
          do {
            if (iVar12 < 1) {
              ...
              iVar25 = (int)gRomCurveTable[local_618[iVar12]];
        ...
        if (iVar13 != 0) {
          ...
          do {
            if (iVar13 < 1) {
              ...
              iVar25 = (int)gRomCurveTable[local_610[iVar13]];
    ...
    do {
      ...
      if (-1 < (int)uVar9) {
        if ((int)uVar9 < 0) {
          ...
          while (iVar3 <= iVar6) {
            iVar4 = iVar6 + iVar3 >> 1;
            iVar8 = (int)gRomCurveTable[iVar4];
      ...
      do {
        if (((int)*(char *)(iVar9 + 0x1b) & 1 << iVar7) == 0) {
          ...
          if ((int)uVar5 < 0) {
            ...
            while (iVar3 <= iVar4) {
              iVar2 = iVar4 + iVar3 >> 1;
              iVar6 = (int)gRomCurveTable[iVar2];
  ...
  if (bVar1) {
    while (iVar8 = iVar3, iVar8 != 0) {
      ...
      if ((int)uVar5 < 0) {
        ...
        while (iVar4 <= iVar7) {
          iVar6 = iVar7 + iVar4 >> 1;
          iVar3 = (int)gRomCurveTable[iVar6];
...
int FUN_800e3ad4(int param_1)
{
  ...
  do {
    ...
    if ((int)uVar4 < 0) {
      ...
      while (iVar2 <= iVar3) {
        iVar5 = iVar3 + iVar2 >> 1;
        param_1 = (int)gRomCurveTable[iVar5];
...
void FUN_800e3cec(undefined4 param_1,undefined4 param_2,float *param_3,float *param_4)
{
  ...
  do {
    ...
    if ((int)uVar12 < 0) {
      ...
      while (iVar5 <= iVar7) {
        iVar6 = iVar7 + iVar5 >> 1;
        iVar8 = (int)gRomCurveTable[iVar6];
