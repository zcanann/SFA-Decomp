  ...
  if ((int)((ulonglong)param_1 >> 0x20) == 0) {
    ...
    if (lbl_803DD6C5 == 0) {
      if ((int)param_1 == 0) {
        ...
        *(u16 *)((char *)lbl_8031A7BC[idx].entries + 0x16) =
             (u16)(*(u16 *)((char *)lbl_8031A7BC[idx].entries + 0x16) | 0x4000);
        *(s8 *)((char *)lbl_8031A7BC[idx].entries + 0x56) = -1;
        *(u16 *)((char *)lbl_8031A7BC[idx].entries + 0x3c) = 984;
        lbl_803DD6C5 = 1;
        lbl_803DD6B8 =
             ((void *(**)(int, int, int, int, int))gTitleMenuItemInterface->vtable)[3]
                 (983,41,0,1,0);
        ((void (**)(void *, int))gTitleMenuItemInterface->vtable)[8](lbl_803DD6B8,1);
        ((void (**)(void *))gTitleMenuLinkInterface->vtable)[11](lbl_8031A7BC[idx].entries);
      }
    }
    else {
      if ((u8)((u8 (**)(void *))gTitleMenuItemInterface->vtable)[9](lbl_803DD6B8) == 1) {
        gplaySaveGame((s8)saveFileSelect_currentSlotIndex);
      }
