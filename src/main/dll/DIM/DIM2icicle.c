    ...
    *piVar2 = (int)piVar1;
    if (*piVar2 != 0) {
      ...
      if (param_2 == '\0') {
        ...
        FUN_8001754c((double)FLOAT_803e58c4,dVar3,dVar4,in_f4,in_f5,in_f6,in_f7,in_f8,*piVar2,0,0xff
                     ,0,0,0xc0,in_r9,in_r10);
      }
      else {
        FUN_8001759c(*piVar2,0,0xff,0,0xff);
        FUN_80017588(*piVar2,0,0xff,0,0xff);
        FUN_8001754c((double)FLOAT_803e58c0,dVar3,dVar4,in_f4,in_f5,in_f6,in_f7,in_f8,*piVar2,0,0,
                     0xff,0,0xc0,in_r9,in_r10);
      }
      FUN_800175d0((double)FLOAT_803e58c4,(double)FLOAT_803e58c8,*piVar2);
      FUN_800175bc(*piVar2,1);
      FUN_800175cc((double)FLOAT_803e5870,*piVar2,'\x01');
      FUN_80017594(*piVar2,0x40,0,0,0x40);
      FUN_80017580(*piVar2,0x40,0,0,0x40);
      FUN_8001753c(*piVar2,2,0x28);
      FUN_800175d8(*piVar2,1);
      FUN_80017544((double)FLOAT_803e5854,*piVar2);
    }
  }
  return;
}
...
void FUN_801bb848(void)
{
  ...
  if (piVar4 != (int *)0x0) {
    if (*(short *)((int)uVar12 + 0x402) == 1) {
      FUN_800175ec((double)(float)piVar7[0x16],(double)(float)piVar7[0x17],
                   (double)(float)piVar7[0x18],piVar4);
    }
    else {
      FUN_800175ec((double)(float)piVar7[0x10],(double)(float)piVar7[0x11],
                   (double)(float)piVar7[0x12],piVar4);
    }
    FUN_80017584(*piVar7,&local_b5,&local_b6,&local_b7,&uStack_b8);
    FUN_80017548(*piVar7,local_b5,local_b6,local_b7,0xc0);
    iVar6 = *piVar7;
  ...
  if ((*(int *)(iVar5 + 0xb0) == 0) ||
    ...
    if ((*(uint *)(iVar4 + 0x314) & 4) != 0) {
      *(uint *)(iVar4 + 0x314) = *(uint *)(iVar4 + 0x314) & 0xfffffffb;
      ...
      FUN_80006b94((double)FLOAT_803e5890);
    }
    ...
    if ((DAT_803de800 & 1) != 0) {
      FUN_800069bc();
      FUN_80006b94((double)FLOAT_803e5890);
      FUN_8000691c((double)FLOAT_803e585c,(double)FLOAT_803e5860,(double)FLOAT_803e5864);
    }
    if ((DAT_803de800 & 0x40000) != 0) {
      FUN_800069bc();
      FUN_80006b94((double)FLOAT_803e5904);
    ...
    if ((DAT_803de800 & 2) != 0) {
      ...
      FUN_80006920((double)FLOAT_803e5870);
    }
    if ((DAT_803de800 & 4) == 0) {
      FUN_80017698(0x25e,0);
    }
    else {
      FUN_80017698(0x25e,1);
    }
                 ...
                 undefined8 param_5,undefined8 param_6,undefined8 param_7,undefined8 param_8)
{
  ...
  iVar4 = FUN_800369d0(uVar3,&local_40,&local_38,&uStack_3c);
  if (iVar4 != 0) {
      ...
      *(char *)(iVar6 + 0x354) = *(char *)(iVar6 + 0x354) + -1;
      ...
      if (*(char *)(iVar6 + 0x354) < '\x01') {
        ...
        *(byte *)(uVar3 + 0xaf) = *(byte *)(uVar3 + 0xaf) & 0x7f;
        uVar8 = FUN_80017698(0x20e,1);
        if (*(short *)(iVar7 + 0x402) == 1) {
          uVar8 = FUN_80017698(0x20b,1);
        }
        else if (*(short *)(iVar7 + 0x402) == 2) {
          uVar8 = FUN_80017698(0x266,1);
        }
      }
      ...
      FUN_80037bd4(uVar8,param_2,param_3,param_4,param_5,param_6,param_7,param_8,local_40,0xe0001,
