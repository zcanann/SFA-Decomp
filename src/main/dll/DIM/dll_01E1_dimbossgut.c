...
int DIM_BossGut_getExtraSize(void) { return 0x0; }
int DIM_BossGut_getObjectTypeId(void) { return 0x0; }

void DIM_BossGut_free(void)
{
}

void DIM_BossGut_render(int obj, u32 p2, u32 p3, u32 p4,
...
u32 gDIM_BossGut2ObjDescriptor[16] = { 0x00000000, 0x00000000, 0x00000000, 0x000b0000, (u32)DIM_BossGut2_initialise, (u32)DIM_BossGut2_release, 0x00000000, (u32)DIM_BossGut2_init, (u32)DIM_BossGut2_update, (u32)DIM_BossGut2_hitDetect, (u32)DIM_BossGut2_render, (u32)DIM_BossGut2_free, (u32)DIM_BossGut2_getObjectTypeId, (u32)DIM_BossGut2_getExtraSize, (u32)DIM_BossGut2_setScale, (u32)DIM_BossGut2_func0B };
...
u32 gDFropenodeObjDescriptor[24] = { 0x00000000, 0x00000000, 0x00000000, 0x00130000, (u32)dfropenode_initialise, (u32)dfropenode_release, 0x00000000, (u32)dfropenode_init, (u32)dfropenode_update, (u32)dfropenode_hitDetect, (u32)dfropenode_render, (u32)dfropenode_free, (u32)dfropenode_getObjectTypeId, (u32)dfropenode_getExtraSize, (u32)dfropenode_getPlaneEquation, (u32)dfropenode_getWorldPosAtPhase, (u32)dfropenode_advancePhaseByDistance, (u32)dfropenode_applyForceAtPhase, (u32)dfropenode_findNearestRopePoint, (u32)dfropenode_getAngle, (u32)dfropenode_setVisible, (u32)dfropenode_isVisible, (u32)dfropenode_setMinY, (u32)dfropenode_clearLinkedObj };
