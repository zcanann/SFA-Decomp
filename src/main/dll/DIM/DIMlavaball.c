                 ...
                 int param_9)
{
  ...
  if ((*(int *)(param_9 + 0xf8) == 0) || (uVar3 = GameBit_Get(0xf33), uVar3 != 0)) {
    if ((*(int *)(param_9 + 0xf8) == 0) && (uVar3 = GameBit_Get(0xf33), uVar3 != 0)) {
      uVar5 = FUN_80080f28(7,'\x01');
      uVar5 = FUN_80006728(uVar5,param_2,param_3,param_4,param_5,param_6,param_7,param_8,param_9,
                           uVar2,0x13a,0,in_r7,in_r8,in_r9,in_r10);
  ...
  if ((*pbVar4 & 0x80) == 0) {
    ...
    if (pbVar4[2] != 0) {
      ...
      if (lbl_803E5198 *
        ...
        *(float *)(param_9 + 0x28) = -(lbl_803E51A0 * lbl_803DC074 - fVar1);
      }
      else {
        *(float *)(param_9 + 0x28) = lbl_803E519C * lbl_803DC074 + fVar1;
      }
      ...
      *(float *)(param_9 + 0x10) = (float)((double)*(float *)(param_9 + 0x10) + dVar5);
      ...
      dVar5 = (double)FUN_80293f90();
      *(short *)(param_9 + 4) =
           *(short *)(param_9 + 4) + (short)(int)((double)lbl_803E51BC * dVar5);
      param_2 = (double)lbl_803E51B4;
      dVar5 = (double)FUN_80293f90();
      *(short *)(param_9 + 2) =
           *(short *)(param_9 + 2) + (short)(int)((double)lbl_803E51BC * dVar5);
  ...
  if (iVar3 != -1) {
    ...
    *(ushort *)(iVar4 + 0x24) = *(ushort *)(iVar4 + 0x24) & ~0x80;
    iVar3 = FUN_801a8168((double)*(float *)(param_1 + 0xc),(double)*(float *)(param_1 + 0x10),
                         ...
                         (double)(float)((double)lbl_803E5200 + (double)*(float *)(param_1 + 0x10)
                                        ),param_1,&local_18,auStack_14);
    if (iVar3 != 0) {
      if (iVar3 == 2) {
        *(ushort *)(iVar4 + 0x24) = *(ushort *)(iVar4 + 0x24) | 0x100;
        fVar1 = lbl_803E51EC;
        *(float *)(param_1 + 0x24) = lbl_803E51EC;
...
void FUN_801a86b0(int param_1)
{
  ...
  *(float *)(param_1 + 0x24) = lbl_803E51EC;
  *(float *)(param_1 + 0x28) = lbl_803E5208 * *(float *)(iVar2 + 0x298) + lbl_803E5204;
  *(float *)(param_1 + 0x2c) = lbl_803E5210 * *(float *)(iVar2 + 0x298) + lbl_803E520C;
  local_18 = local_1c;
  local_14 = local_1c;
...
void mmp_moonrock_update(int obj) {
    ...
    if ((*(u16 *)(state + 0x24) & 4) != 0) {
        return;
    }
    if ((*(u16 *)(state + 0x24) & 0x200) != 0) {
        ...
        if (v > k) {
            *(f32 *)(state + 0x14) = v - timeDelta;
            if (*(f32 *)(state + 0x14) <= k) {
                ...
                *(u8 *)(obj + 0x36) = (u8)(int)(lbl_803E4584 * (lbl_803E457C - *(f32 *)(state + 0x14) / lbl_803E4558));
                objParticleFn_80099d84(obj, lbl_803E4588, 2, lbl_803E457C - *(f32 *)(state + 0x14) / lbl_803E4558, 0);
                objParticleFn_80099d84(obj, lbl_803E4588, 2, lbl_803E457C - *(f32 *)(state + 0x14) / lbl_803E4558, 0);
            }
        }
        return;
    ...
    *(u16 *)(state + 0x24) |= 2;
    ...
    if ((*(u16 *)(state + 0x24) & 0x400) != 0) {
        *(u8 *)(state + 0x2F) = GameBit_Get(0x894);
    } else {
        *(u8 *)(state + 0x2F) = 0;
    }
    Sfx_PlayFromObject(obj, 0x108);
    Sfx_SetObjectChannelVolume(obj, 0x40, *(u8 *)(state + 0x2F) * 0x20 + 0x20, lbl_803E4588);
    {
        f32 speed = *(f32 *)(obj + 0x28);
        if (speed < lbl_803E458C * ((lbl_803E4568 * (f32)*(u8 *)(state + 0x2F) + *(f32 *)(state + 0xC)) - *(f32 *)(obj + 0x10))) {
            *(f32 *)(obj + 0x28) = speed + lbl_803E4590;
        } else {
            *(f32 *)(obj + 0x28) = speed - lbl_803E4594;
        }
    }
    *(u16 *)(state + 0x26) += 0x1000;
    *(u16 *)(state + 0x28) += 0xDAC;
    *(u16 *)(state + 0x2A) += 0x800;
    ((void (*)(int, f32, f32, f32))objMove)(obj, lbl_803E4554, *(f32 *)(obj + 0x28) * timeDelta, lbl_803E4554);
    *(f32 *)(obj + 0x10) = *(f32 *)(obj + 0x10) + fn_80293E80((lbl_803E4598 * (f32)*(u16 *)(state + 0x26)) / lbl_803E459C);
    if (*(f32 *)(obj + 0x10) < *(f32 *)(state + 0xC)) {
        *(f32 *)(obj + 0x10) = *(f32 *)(state + 0xC);
    }
    *(s16 *)(obj + 4) = (s16)(*(s16 *)(obj + 4) + (int)(lbl_803E45A0 * fn_80293E80((lbl_803E4598 * (f32)*(u16 *)(state + 0x28)) / lbl_803E459C)));
    *(s16 *)(obj + 2) = (s16)(*(s16 *)(obj + 2) + (int)(lbl_803E45A0 * fn_80293E80((lbl_803E4598 * (f32)*(u16 *)(state + 0x2A)) / lbl_803E459C)));
