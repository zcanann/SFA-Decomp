                 ...
                 undefined4 param_14,undefined4 param_15,undefined4 param_16)
{
  ...
  piVar8 = ((GameObject *)param_9)->extra;
  ...
  if (*piVar8 == 0) {
    ...
    if (((GameObject *)param_9)->anim.seqId == 0x170) {
      param_12 = 0x16f;
    }
    else {
      param_12 = 0x16c;
  ...
  if ((((GameObject *)param_9)->anim.seqId == 0x373) || (uVar3 = GameBit_Get(0x3a2), uVar3 != 0)) {
    iVar7 = *piVar8;
    if (((GameObject *)param_9)->anim.currentMove != 0x100) {
...
void FUN_801aeab4(int param_1)
{
  ...
  if (iVar3 != 0) {
    ...
    if (*pbVar5 < 5) {
      ...
      (**(code **)(**(int **)(*(int *)&((GameObject *)param_1)->anim.parent + 0x68) + 0x28))(dVar6);
    }
...
{
  if ((visible != 0) &&
     ((*(char *)(*(int *)&((GameObject *)param_1)->extra + 8) != '\0' || (((GameObject *)param_1)->anim.alpha != 0)))) {
    FUN_8003b818(param_1);
  }
  return;
}
...
void FUN_801af444(void)
{
  ...
  iVar4 = FUN_80017a98();
  iVar5 = FUN_80017a90();
  pbVar6 = (*gMapEventInterface)->getProgressPtr();
      ...
      if (*pbVar6 != 0) {
        ...
        *(byte *)(puVar9 + 1) = (cVar2 + -1) * '@' | *(byte *)(puVar9 + 1) & 0x3f;
        if ((cVar2 == -1) && ((*(ushort *)(iVar5 + 0xb0) & 0x1000) == 0)) {
          GameBit_Set(0x386,1);
          (*gObjectTriggerInterface)->runSequence(*(byte *)(puVar9 + 1) >> 3 & 7,
                                                  (void *)iVar3, -1);
          *(byte *)(puVar9 + 1) =
                 ...
                 int param_9)
{
  ...
  puVar4 = ((GameObject *)param_9)->extra;
  ((GameObject *)param_9)->objectFlags = ((GameObject *)param_9)->objectFlags | 0x6000;
                 ...
                 int param_9,int param_10)
{
  ...
  if ((param_10 == 0) && (iVar1 = *(int *)(*(int *)&((GameObject *)param_9)->extra + 8), iVar1 != 0)) {
