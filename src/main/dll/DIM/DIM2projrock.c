...
void FUN_801b8c88(uint param_1)
{
  ...
  if (iVar2 == 0xe) {
    iVar2 = FUN_80017a98();
    FUN_8001771c((float *)&((GameObject *)param_1)->anim.worldPosX,(float *)(iVar2 + 0x18));
    fVar1 = lbl_803E5774;
    ((GameObject *)param_1)->anim.velocityX = *(float *)(local_18[0] + 0x24) * lbl_803E5774;
    ((GameObject *)param_1)->anim.velocityZ = *(float *)(local_18[0] + 0x2c) * fVar1;
    FUN_80006824(param_1,SFXchar_puts_out_fire);
  }
  return;
}
...
void FUN_801b8d0c(int *param_1)
{
  ...
  if (*(char *)(pfVar6 + 1) == '\0') {
    param_1[9] = (int)((float)param_1[9] * lbl_803E577C);
    param_1[0xb] = (int)((float)param_1[0xb] * fVar2);
  }
  else {
    param_1[9] = (int)((float)param_1[9] * lbl_803E5778);
    param_1[0xb] = (int)((float)param_1[0xb] * fVar1);
  }
  fVar1 = lbl_803E5788;
  if (((((float)param_1[9] < lbl_803E5780) && (lbl_803E5784 < (float)param_1[9])) &&
      ((float)param_1[0xb] < lbl_803E5780)) && (lbl_803E5784 < (float)param_1[0xb])) {
    param_1[9] = (int)lbl_803E5788;
    param_1[0xb] = (int)fVar1;
  }
  FUN_80017a88((double)((float)param_1[9] * lbl_803DC074),(double)lbl_803E5788,
               (double)((float)param_1[0xb] * lbl_803DC074),(int)param_1);
  ...
  if (iVar3 != 0) {
    ...
    if ((double)lbl_803E5788 != dVar8) {
      dVar7 = (double)(float)((double)lbl_803E5770 / dVar8);
      dVar11 = (double)(float)(dVar11 * dVar7);
      dVar10 = (double)(float)(dVar10 * dVar7);
      dVar9 = (double)(float)(dVar9 * dVar7);
    }
    dVar7 = (double)(lbl_803E5790 *
    ...
    dVar9 = (double)lbl_803E5794;
    param_1[9] = (int)((float)param_1[9] * (float)(dVar9 * dVar8));
    param_1[10] = (int)((float)param_1[10] * (float)((double)lbl_803E5774 * dVar8));
    param_1[0xb] = (int)((float)param_1[0xb] * (float)(dVar9 * dVar8));
  }
  param_1[4] = (int)-(lbl_803E5798 * lbl_803DC074 - (float)param_1[4]);
  ...
  *(undefined *)(pfVar6 + 1) = 0;
  ...
  if (0 < iVar3) {
    do {
      if ((float)param_1[4] < lbl_803E579C + *(float *)*puVar4) {
...
void FUN_801b9354(uint param_1)
{
  ...
  pfVar8 = ((GameObject *)param_1)->extra;
  iVar4 = FUN_80017a98();
  iVar7 = *(int *)&((GameObject *)param_1)->anim.placementData;
  bVar2 = false;
  iVar6 = 0;
  ...
  bVar1 = *(byte *)(pfVar8 + 1);
  if (bVar1 == 3) {
    *pfVar8 = *pfVar8 + lbl_803E57A8 * lbl_803DC074 +
                        lbl_803E57AC *
                        (float)((double)CONCAT44(0x43300000,
                                                 ((uint)(byte)((*pfVar8 < lbl_803E57A4) << 3) <<
                                                 0x1c) >> 0x1f ^ 0x80000000) - DOUBLE_803e57c0);
    if (lbl_803E57B0 < *pfVar8) {
      *pfVar8 = lbl_803E57B0;
    }
    ((GameObject *)param_1)->anim.localPosY = *pfVar8 * lbl_803DC074 + ((GameObject *)param_1)->anim.localPosY;
    if (*(float *)(iVar7 + 0xc) < ((GameObject *)param_1)->anim.localPosY) {
      FUN_80006824(param_1,SFXchar_on_firelp);
      *(undefined4 *)&((GameObject *)param_1)->anim.localPosY = *(undefined4 *)(iVar7 + 0xc);
    ...
    if (bVar1 == 1) {
      ...
      if (bVar2) {
        if ((*(char *)((int)pfVar8 + 6) != '\0') && (*(char *)((int)pfVar8 + 5) != '\0')) {
          FUN_80006824(param_1,SFXsp_lfoot_taunt3);
      ...
      uVar5 = GameBit_Get((int)*(short *)(iVar7 + 0x20));
      if (uVar5 != 0) {
        FUN_80006824(param_1,SFXsp_lfoot_taunt3);
        *(undefined *)(pfVar8 + 1) = 4;
        *pfVar8 = lbl_803E57A4;
      ...
      if (*(char *)((int)pfVar8 + 5) == '\0') {
        ...
        if (uVar5 == 0) {
          ...
          *(undefined *)((int)pfVar8 + 5) = 0;
          GameBit_Set((int)*(short *)(iVar7 + 0x1e),0);
        }
      }
      else if (!bVar2) {
        FUN_80006824(param_1,SFXsp_lfoot_taunt3);
    ...
    *pfVar8 = lbl_803E57B4 * lbl_803DC074 + *pfVar8;
    if (*pfVar8 < lbl_803E57B8) {
      *pfVar8 = lbl_803E57B8;
    }
    ((GameObject *)param_1)->anim.localPosY = *pfVar8 * lbl_803DC074 + ((GameObject *)param_1)->anim.localPosY;
    if (((GameObject *)param_1)->anim.localPosY < *(float *)(iVar7 + 0xc) - lbl_803E57BC) {
      FUN_80006824(param_1,SFXchar_on_firelp);
      ((GameObject *)param_1)->anim.localPosY = *(float *)(iVar7 + 0xc) - lbl_803E57BC;
      *(undefined *)(pfVar8 + 1) = 2;
      GameBit_Set((int)*(short *)(iVar7 + 0x1e),1);
    }
    if ((*(char *)((int)pfVar8 + 5) == '\0') &&
       (uVar5 = GameBit_Get((int)*(short *)(iVar7 + 0x20)), uVar5 == 0)) {
      *(undefined *)(pfVar8 + 1) = 3;
      GameBit_Set((int)*(short *)(iVar7 + 0x1e),0);
    }
  }
...
void FUN_801b972c(undefined2 *param_1,int param_2)
{
  ...
  *(float *)(iVar3 + 0xa4) =
       (float)((double)CONCAT44(0x43300000,(int)*(short *)(param_2 + 0x1c) ^ 0x80000000) -
              DOUBLE_803e57f8) / lbl_803E57E0;
  uVar2 = randomGetRange(0xffffffe2,0x1e);
  *(float *)(iVar3 + 0xa8) =
       (f32)(s32)(uVar2);
  ...
  *(undefined *)(param_1 + 0x1b) = 0;
  sVar1 = param_1[0x23];
  if (sVar1 == 0x10d) {
    uVar2 = randomGetRange(0,0x32);
    *(float *)(iVar3 + 0xac) =
         lbl_803E57EC + (f32)(s32)(uVar2)
    ;
    *(float *)(iVar3 + 0xb0) = lbl_803E57E8;
  }
  else if ((sVar1 < 0x10d) && (sVar1 == 0x109)) {
    uVar2 = randomGetRange(0,0x28);
    *(float *)(iVar3 + 0xac) =
         lbl_803E57E4 + (f32)(s32)(uVar2)
    ;
    *(float *)(iVar3 + 0xb0) = lbl_803E57E8;
  }
  else {
...
void FUN_801b9914(uint param_1)
{
  ...
  if (bVar1 != 2) {
    if (bVar1 < 2) {
      ...
      if (*(char *)((int)pfVar7 + 7) == '\0') {
        iVar4 = FUN_800632f4((double)((GameObject *)param_1)->anim.localPosX,(double)((GameObject *)param_1)->anim.localPosY,
                             (double)((GameObject *)param_1)->anim.localPosZ,param_1,local_28,0,0);
        *pfVar7 = lbl_803E5808;
      ...
      if ((0 < *(short *)(pfVar7 + 2)) &&
         ...
         *(short *)(pfVar7 + 2) < 1)) {
        FUN_80006824(param_1,SFXmv_blockscrape_lp);
      }
      ((GameObject *)param_1)->anim.velocityY = -(lbl_803E580C * lbl_803DC074 - ((GameObject *)param_1)->anim.velocityY);
      if (((GameObject *)param_1)->anim.velocityY < lbl_803E5810) {
        ((GameObject *)param_1)->anim.velocityY = lbl_803E5810;
      }
      ((GameObject *)param_1)->anim.localPosY =
           ((GameObject *)param_1)->anim.velocityY * lbl_803DC074 + ((GameObject *)param_1)->anim.localPosY;
      if (*pfVar7 <= ((GameObject *)param_1)->anim.localPosY) {
        return;
      }
      GameBit_Set((int)*(short *)(iVar6 + 0x1e),1);
      *(undefined *)((int)pfVar7 + 6) = 2;
      (**(code **)(*DAT_803dd718 + 0x10))
                ((double)((GameObject *)param_1)->anim.localPosX,(double)*pfVar7,
                 (double)((GameObject *)param_1)->anim.localPosZ,(double)lbl_803E5814,param_1);
      (**(code **)(*DAT_803dd718 + 0x14))
                ((double)((GameObject *)param_1)->anim.localPosX,(double)*pfVar7,
                 (double)((GameObject *)param_1)->anim.localPosZ,(double)lbl_803E5818,0,2);
      FUN_80006824(param_1,SFXmv_missingcog_lp);
      *(undefined2 *)(pfVar7 + 2) = 0x96;
      return;
    }
    if (bVar1 < 4) {
      *(undefined2 *)&((GameObject *)param_1)->anim.rotY = *(undefined2 *)(pfVar7 + 1);
      *(short *)(pfVar7 + 1) =
           (short)(int)((float)((double)CONCAT44(0x43300000,(int)*(short *)(pfVar7 + 1) ^ 0x80000000
                                                ) - DOUBLE_803e5820) * lbl_803E5804);
      if (9 < ((GameObject *)param_1)->anim.rotY) {
        return;
      }
      *(undefined2 *)&((GameObject *)param_1)->anim.rotY = 0;
  ...
  if (iVar2 < 0) {
    iVar2 = 0;
    *(undefined4 *)&((GameObject *)param_1)->anim.localPosY = *(undefined4 *)(iVar6 + 0xc);
    ((GameObject *)param_1)->anim.velocityY = lbl_803E5818;
  }
...
void FUN_801b9c2c(undefined2 *param_1,int param_2)
{
  ...
  *param_1 = (short)((int)*(char *)(param_2 + 0x18) << 8);
  *(float *)(param_1 + 0x14) = lbl_803E5818;
  param_1[0x58] = param_1[0x58] | 0x2000;
  return;
}
                 ...
                 int param_9)
{
  ...
  if ((uint)bVar1 != (uint)(byte)(&DAT_803dcb90)[*pcVar4]) {
    ...
    FUN_80047fdc((double)lbl_803E5828,pcVar4[3]);
  }
  iVar2 = FUN_80017a98();
  ...
  SH_LevelControl_runBloopEvent(pcVar4 + 8,1,-1,-1,0xd99,(int *)0xde);
  SH_LevelControl_runBloopEvent(pcVar4 + 8,2,-1,-1,0xda5,*(int **)(pcVar4 + 0xc));
  SH_LevelControl_runBloopEvent(pcVar4 + 8,8,-1,-1,0xf04,(int *)0x96);
  ...
  *(undefined4 *)(puVar3 + 0xc) = 0xd7;
  ...
  if ((puVar3[2] & 1) == 0) {
    *puVar3 = 3;
    ...
    uVar5 = FUN_80047fdc((double)lbl_803E5828,uRam803dcb93);
  }
  else {
    *puVar3 = 0;
    puVar3[3] = DAT_803dcb90;
    uVar5 = FUN_80047fdc((double)lbl_803E5828,DAT_803dcb90);
  }
...
void FUN_801ba45c(int param_1)
{
  ...
  if (iVar3 != 0) {
    if (((GameObject *)param_1)->anim.seqId == 0xd1) {
      uVar2 = (undefined)(int)lbl_803E5834;
  ...
  iVar3 = FUN_80017a98();
  dVar5 = FUN_80017714((float *)(iVar3 + 0x18),(float *)&((GameObject *)param_1)->anim.worldPosX);
  if (dVar5 < (double)lbl_803E5838) {
