...
void fn_8015625C(u32 obj, int state)
{
    ...
    else
    {
        ...
        moveSpeed = sidekickToy_accelerateTowardTargetXZ(
            obj, tracked->anim.worldPosX, lbl_803E2AB8 + tracked->anim.worldPosY, tracked->anim.worldPosZ, lbl_803E2ABC,
...
void fn_8015652C(u32 obj, int state)
{
    ...
    if ((((BaddieState*)state)->controlFlags & BADDIE_CONTROL_PATH_FOLLOW) != 0)
    {
        ...
        {
            moveSpeed = sidekickToy_accelerateTowardTargetXZ(obj, route->posX, route->posY, route->posZ, lbl_803E2ABC,
                                                             lbl_803E2AC0, lbl_803E2AC4, ((BaddieState*)state)->unk304);
        }
    }
    ...
    {
        moveSpeed =
            sidekickToy_accelerateTowardTargetXZ(obj, placement->posX, placement->posY, placement->posZ, lbl_803E2ABC,
                                                 lbl_803E2AC0, lbl_803E2AC4, ((BaddieState*)state)->unk304);
    }
    if (((moveSpeed > lbl_803E2A98) && (((GameObject*)obj)->anim.velocityY < lbl_803E2AC8)) ||
        ((((BaddieState*)state)->controlFlags & 0x8000000) != 0))
