 ...
 * --INFO--
 *
 * Function: FUN_801a2dc4
 * EN v1.0 Address: 0x801A2DC4
 * EN v1.0 Size: 56b
 ...
 * --INFO--
 *
 * Function: FUN_801a2dfc
 * EN v1.0 Address: 0x801A2DFC
 * EN v1.0 Size: 840b
...
void FUN_801a2dfc(void)
{
  ...
  if (*(int *)(iVar8 + 0xc) == 0) {
    uVar3 = FUN_80017690((int)*(short *)(iVar9 + 0x1e));
    if (uVar3 == 0) {
      iVar11 = 0;
      for (iVar10 = 0; iVar5 = *(int *)(iVar2 + 0x54), iVar10 < *(char *)(iVar5 + 0x71);
        ...
        if (*(char *)(iVar5 + iVar10 + 0x75) == '\x05') {
          if (iVar7 == 0) {
            FUN_80017698((int)*(short *)(iVar9 + 0x1e),1);
            break;
          }
          uVar3 = 0;
          ...
          if (!bVar1) {
            *(int *)(iVar8 + (uint)*(byte *)(iVar8 + 0x11) * 4) = iVar6;
            FUN_80017698(*(byte *)(iVar8 + 0x11) + 0x2de,0);
            FUN_80017698(*(byte *)(iVar8 + 0x11) + 0x2df,1);
            if ((int)*(short *)(iVar9 + 0x20) != 0xffffffff) {
              FUN_80017698((int)*(short *)(iVar9 + 0x20),*(byte *)(iVar8 + 0x11) + 1);
            }
            DAT_803de798 = 300;
            iVar5 = *(byte *)(iVar8 + 0x11) + 1;
            if (iVar7 < iVar5) {
              for (iVar5 = 0; iVar5 < iVar7 + 1; iVar5 = iVar5 + 1) {
                FUN_80017698(iVar5 + 0x2de,0);
              }
              FUN_80017698((int)*(short *)(iVar9 + 0x1e),1);
              FUN_801a2cb8(iVar2,(int)*(short *)(iVar9 + 0x1c));
              FUN_80017a78(iVar2,2);
              *(undefined4 *)(iVar8 + 0xc) = 1;
            }
            else {
              *(char *)(iVar8 + 0x11) = (char)iVar5;
              FUN_80017a78(iVar2,(uint)*(byte *)(iVar8 + 0x11));
            }
          }
        }
        iVar11 = iVar11 + 4;
      ...
      uVar4 = FUN_801a2cb8(iVar2,(int)*(short *)(iVar9 + 0x1c));
 ...
 * --INFO--
 *
 * Function: FUN_801a3144
 * EN v1.0 Address: 0x801A3144
 * EN v1.0 Size: 400b
  ...
  *(char *)(iVar3 + 0x10) = (char)*(undefined2 *)(param_2 + 0x1a);
  if ((int)*(short *)(param_2 + 0x20) != 0xffffffff) {
    ...
    *(char *)(iVar3 + 0x11) = (char)uVar1;
    if ((uVar1 & 0xff) != 0) {
      FUN_80017a78((int)param_1,(uint)*(byte *)(iVar3 + 0x11));
    }
  }
  FUN_80017698(0x2de,1);
  *param_1 = (short)((int)*(char *)(param_2 + 0x18) << 8);
  uVar1 = FUN_80017690((int)*(short *)(param_2 + 0x1e));
  if (uVar1 != 0) {
    uVar2 = FUN_801a2cb8((int)param_1,(int)*(short *)(param_2 + 0x1c));
 ...
 * --INFO--
 *
 * Function: FUN_801a35f4
 * EN v1.0 Address: 0x801A35F4
 * EN v1.0 Size: 4b
 ...
 * --INFO--
 *
 * Function: FUN_801a35f8
 * EN v1.0 Address: 0x801A35F8
 * EN v1.0 Size: 1268b
  ...
  *(undefined2 *)(param_2 + 100) = *(undefined2 *)(param_3 + 0x1e);
  ...
  if (dVar4 != dVar5) {
    ...
    *(float *)(param_2 + 0x24) =
    ...
    if (lbl_803E5000 < *(float *)(param_2 + 0x20)) {
      *(byte *)(param_2 + 0x6c) = *(byte *)(param_2 + 0x6c) | 8;
    }
    if (lbl_803E5000 < *(float *)(param_2 + 0x24)) {
...
int fn_801A2BDC(int p1, int p2, int p3, int p4)
{
    ...
    *(s16 *)(s + 0x1c) = c->unk66;
    *(s16 *)(s + 0x1e) = c->unk64;
    *(u16 *)(s + 0x2c) = c->spinX * (f32)(u32)c->spinScale;
    *(u16 *)(s + 0x2e) = c->spinY * (f32)(u32)c->spinScale;
    *(u16 *)(s + 0x30) = c->spinZ * (f32)(u32)c->spinScale;
    f1 = lbl_803E4354;
...
void fn_801A30C0(int obj, int slot, int def)
{
    ...
    if (mag != lbl_803E4368) {
        ...
        c->unk28 = (f32)(int)randomGetRange(0, max2) / lbl_803E4374;
        c->unk2C = (f32)(int)randomGetRange(0, max2) / lbl_803E4374;
        c->unk30 = (f32)(int)randomGetRange(0, max2) / lbl_803E4374;
        c->unk34 = dx * scale;
