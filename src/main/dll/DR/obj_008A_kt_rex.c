...
typedef struct KTRexRuntime {
    ...
    u8 pad272[8];
    u8 unk27A;
    u8 unk27B;          /* player-control handoff latch */
    u8 pad27C[4];
    f32 unk280;
    f32 unk284;
    u8 pad288[0xc];
...
int ktrex_animEventCallback(int obj, int unused, ObjAnimUpdateState *animUpdate) {
    ...
    } else if (((GameObject *)obj)->moveF8 == 3) {
        ((GameObject *)obj)->moveF8 = 4;
    }
    return 0;
}
...
int ktrex_updateArenaPathProgress(int obj) {
    ...
    ((KTRexArenaState *)gKTRexState)->speed8 = speed * timeDelta + ((KTRexArenaState *)gKTRexState)->speed8;
    if ((((KTRexArenaState *)gKTRexState)->speed8 > lbl_8032A540[((KTRexArenaState *)gKTRexState)->unkFC] && speed > lbl_803E67B8) ||
        (((KTRexArenaState *)gKTRexState)->speed8 < lbl_8032A534[((KTRexArenaState *)gKTRexState)->unkFC] && speed < lbl_803E67B8)) {
        if (dir != 0) {
            phase--;
            if (phase < 0) {
                phase = 3;
        ...
        if (((KTRexArenaState *)gKTRexState)->speed8 > lbl_8032A540[((KTRexArenaState *)gKTRexState)->unkFC]) {
            ((KTRexArenaState *)gKTRexState)->speed8 = lbl_8032A540[((KTRexArenaState *)gKTRexState)->unkFC];
        } else if (((KTRexArenaState *)gKTRexState)->speed8 < lbl_8032A534[((KTRexArenaState *)gKTRexState)->unkFC]) {
            ((KTRexArenaState *)gKTRexState)->speed8 = lbl_8032A534[((KTRexArenaState *)gKTRexState)->unkFC];
        }
        changed = 1;
    }
    ((KTRexArenaState *)gKTRexState)->posXE8 = ((KTRexArenaState *)gKTRexState)->speed8 * (((f32 *)*(int *)&((KTRexArenaState *)gKTRexState)->rowBX)[phase] - ((f32 *)*(int *)&((KTRexArenaState *)gKTRexState)->rowAX)[phase]) + ((f32 *)*(int *)&((KTRexArenaState *)gKTRexState)->rowAX)[phase];
    ((KTRexArenaState *)gKTRexState)->posYE8 = ((KTRexArenaState *)gKTRexState)->speed8 * (((f32 *)*(int *)&((KTRexArenaState *)gKTRexState)->rowBY)[phase] - ((f32 *)*(int *)&((KTRexArenaState *)gKTRexState)->rowAY)[phase]) + ((f32 *)*(int *)&((KTRexArenaState *)gKTRexState)->rowAY)[phase];
    ((KTRexArenaState *)gKTRexState)->posZE8 = ((KTRexArenaState *)gKTRexState)->speed8 * (((f32 *)*(int *)&((KTRexArenaState *)gKTRexState)->rowBZ)[phase] - ((f32 *)*(int *)&((KTRexArenaState *)gKTRexState)->rowAZ)[phase]) + ((f32 *)*(int *)&((KTRexArenaState *)gKTRexState)->rowAZ)[phase];
    return changed;
}
...
void ktrex_update(int obj) {
    ...
    ((KTRexRuntime *)runtime)->playerObj2D0 = Obj_GetPlayerObject();
    if (((KTRexRuntime *)runtime)->playerObj2D0 != NULL) {
        player = ((KTRexRuntime *)runtime)->playerObj2D0;
    ...
    dz = ((f32 *)*(int *)&((KTRexArenaState *)gKTRexState)->rowBX)[phase] - ((f32 *)*(int *)&((KTRexArenaState *)gKTRexState)->rowAX)[phase];
    ...
    ((GameObject *)obj)->anim.localPosY = ((KTRexArenaState *)gKTRexState)->posYE8;
}
...
int ktrex_stateHandlerB08(int obj, int runtime) {
    if ((s8)((KTRexRuntime *)runtime)->unk27A != 0) {
        ...
        ((KTRexRuntime *)runtime)->unk2A0 =
            lbl_803E67F4 + lbl_803E67F8 * (f32)(int)(((KTRexArenaState *)gKTRexState)->counter101 >> 1);
...
int ktrex_stateHandlerB03(int obj, int runtime) {
    ...
    if (dir != 0) {
        *(s16 *)obj = lbl_803E6814 * ((GameObject *)obj)->anim.currentMoveProgress + (f32)(int)((KTRexArenaState *)gKTRexState)->homeYaw;
    } else {
        *(s16 *)obj = (f32)(int)((KTRexArenaState *)gKTRexState)->homeYaw - lbl_803E6814 * ((GameObject *)obj)->anim.currentMoveProgress;
    }
    return 0;
}
...
int ktrex_stateHandlerB04(int obj, int runtime) {
    ...
    u16 mask;
    if ((s8)((KTRexRuntime *)runtime)->unk27A != 0) {
        ObjAnim_SetCurrentMove(obj, (&lbl_803DC260)[((KTRexArenaState *)gKTRexState)->boolFD], lbl_803E67B8, 0);
        ((KTRexRuntime *)runtime)->unk2A0 = lbl_8032A51C[((KTRexArenaState *)gKTRexState)->boolFD];
        z = lbl_803E67B8;
        ((KTRexRuntime *)runtime)->unk280 = z;
        ((KTRexRuntime *)runtime)->unk284 = z;
    }
    mask = (&lbl_803DC288)[((KTRexArenaState *)gKTRexState)->boolFD];
    if ((((KTRexRuntime *)gKTRexRuntime)->handlerState & 1) != 0) {
        ((KTRexRuntime *)gKTRexRuntime)->handlerState &= ~1;
...
int ktrex_stateHandlerB01(int obj, int runtime) {
    ...
    mask = (&lbl_803DC268)[((KTRexArenaState *)gKTRexState)->unkFC];
    if ((((KTRexRuntime *)gKTRexRuntime)->handlerState & 4) != 0) {
        ((KTRexRuntime *)gKTRexRuntime)->handlerState &= ~4;
        *(int *)&((KTRexArenaState *)gKTRexState)->phaseFlags |= mask;
    }
    mask = (&lbl_803DC270)[((KTRexArenaState *)gKTRexState)->unkFC];
    ...
    if (((KTRexArenaState *)gKTRexState)->unk108 != 0) {
        mask = (&lbl_803DC278)[((KTRexArenaState *)gKTRexState)->unkFC];
    } else {
    ...
    dx = oneOverTimeDelta * (((KTRexArenaState *)gKTRexState)->posXE8 - ((GameObject *)obj)->anim.localPosX);
    dz = oneOverTimeDelta * (((KTRexArenaState *)gKTRexState)->posZE8 - ((GameObject *)obj)->anim.localPosZ);
    ObjAnim_SampleRootCurvePhase(sqrtf(dx * dx + dz * dz), (ObjAnimComponent *)obj, &((KTRexRuntime *)runtime)->unk2A0);
    ((GameObject *)obj)->anim.localPosX = ((KTRexArenaState *)gKTRexState)->posXE8;
    ((GameObject *)obj)->anim.localPosZ = ((KTRexArenaState *)gKTRexState)->posZE8;
    return 0;
}
...
int ktrex_stateHandlerB02(int obj, int runtime) {
    ...
    ((KTRexRuntime *)runtime)->flags34C |= 1;
    ...
    if (dir != 0) {
        ...
        *(s16 *)obj = (f32)(int)((KTRexArenaState *)gKTRexState)->homeYaw - lbl_803E681C * ((GameObject *)obj)->anim.currentMoveProgress;
    }
    return 0;
}
...
void ktrex_init(int obj, char *arg) {
    ...
    *(int *)&((KTRexRuntime *)gKTRexRuntime)->playerObj2D0 = 0;
    ((KTRexRuntime *)gKTRexRuntime)->bool25F = 0;
    ((KTRexRuntime *)gKTRexRuntime)->bool349 = 0;
    ...
    *(s16 *)obj = (s16)((s8)arg[0x2a] << 8);
    ...
    ((KTRexArenaState *)gKTRexState)->timer102 = 4;
    ((KTRexRuntime *)gKTRexRuntime)->timer354 = 3;
...
void ktrex_updateContactEffects(int obj, void *runtime) {
    ...
    if ((s8)((KTRexRuntime *)runtime)->timer354 != 0 && (hitType == 3 || hitType == 2) &&
        (((KTRexArenaState *)gKTRexState)->timerFA & 0x10) != 0 && hit == 5) {
        pt = contactPoints + hitType * 4;
        ((KTRexWork *)lbl_803AD158)->posXC = playerMapOffsetX + pt[1];
        ((KTRexWork *)lbl_803AD158)->posYC = pt[2];
        ((KTRexWork *)lbl_803AD158)->posZC = playerMapOffsetZ + pt[3];
        Sfx_PlayFromObject(obj, SFXmv_deaththud16);
        ...
        (*gPartfxInterface)->spawnObject((void *)obj, 0x4b3, lbl_803AD158, 0x200001, -1,
                                         NULL);
        if (hit == 0xe) {
            ((KTRexRuntime *)runtime)->timer354 -= 1;
        } else {
            ((KTRexRuntime *)runtime)->timer354 = 0;
        }
        if ((s8)((KTRexRuntime *)runtime)->timer354 <= 0) {
            ((KTRexRuntime *)runtime)->timer354 = 0;
        ...
        (*gPartfxInterface)->spawnObject((void *)obj, 0x328, lbl_803AD158, 0x200001, -1,
                                         NULL);
        ((KTRexWork *)lbl_803AD158)->posXC -= ((GameObject *)obj)->anim.worldPosX;
        ((KTRexWork *)lbl_803AD158)->posYC -= ((GameObject *)obj)->anim.worldPosY;
        ((KTRexWork *)lbl_803AD158)->posZC -= ((GameObject *)obj)->anim.worldPosZ;
    ...
    if ((s8)((KTRexRuntime *)runtime)->timer354 < 1) {
        ((KTRexRuntime *)runtime)->timer354 = 0;
    }
...
int ktrex_stateHandlerA02(int obj, int runtime) {
    ...
    flags = ((KTRexArenaState *)gKTRexState)->timerFA;
    phase = ((KTRexArenaState *)gKTRexState)->counter101;
    if (((KTRexArenaState *)gKTRexState)->unkFC == 0 && phase >= 2 && (flags & 0x20) == 0 &&
        (((flags & 1) == 0 && ((KTRexArenaState *)gKTRexState)->speed8 >= lbl_803E67E8) ||
         ((flags & 1) != 0 && ((KTRexArenaState *)gKTRexState)->speed8 <= lbl_803E67C0))) {
        idx = phase >> 1;
        if (randomGetRange(0, 0x64) <= *(u8 *)((char *)p + idx + 0x56)) {
            int push = 5;
            ((KTRexArenaState *)gKTRexState)->timer103 = 2;
            if (Stack_IsFull(((KTRexArenaState *)gKTRexState)->stack) == 0) {
                Stack_Push(((KTRexArenaState *)gKTRexState)->stack, &push);
            }
            ((KTRexArenaState *)gKTRexState)->boolFD = 1;
            return 5;
        }
        if (randomGetRange(0, 0x64) <= *(u8 *)((char *)p + idx + 0x52)) {
            ...
            if (cond && (((KTRexArenaState *)gKTRexState)->timerFA & 0x40) == 0) {
                int push = 0xb;
                ((KTRexArenaState *)gKTRexState)->boolFD = 0;
                if (Stack_IsFull(((KTRexArenaState *)gKTRexState)->stack) == 0) {
                    Stack_Push(((KTRexArenaState *)gKTRexState)->stack, &push);
                }
                return 5;
    ...
    if ((((KTRexArenaState *)gKTRexState)->unkFE & ((KTRexArenaState *)gKTRexState)->unkFF) != 0) {
        ...
        if ((((KTRexArenaState *)gKTRexState)->unkFE & ((KTRexArenaState *)gKTRexState)->unkFF) != 0) {
            ...
            if ((((KTRexArenaState *)gKTRexState)->timerFA & 1) != 0) {
                if (((KTRexArenaState *)gKTRexState)->speed8 - ((KTRexArenaState *)gKTRexState)->unkF4 > lbl_803E67B4) {
                    result = 1;
                } else {
                    result = 0;
                }
            } else {
                if (((KTRexArenaState *)gKTRexState)->unkF4 - ((KTRexArenaState *)gKTRexState)->speed8 > lbl_803E67B4) {
                    result = 1;
                } else {
                    result = 0;
                }
            ...
            if (result != 0) {
                int push = 5;
                ((KTRexArenaState *)gKTRexState)->timer103 = 1;
                if (Stack_IsFull(((KTRexArenaState *)gKTRexState)->stack) == 0) {
                    Stack_Push(((KTRexArenaState *)gKTRexState)->stack, &push);
                }
                ((KTRexArenaState *)gKTRexState)->boolFD = 1;
...
int ktrex_stateHandlerA03(int obj, int runtime) {
    ...
    if ((s8)((KTRexRuntime *)runtime)->unk346 != 0) {
        ...
        if (__fabs(f5) > __fabs(f4)) {
            ((KTRexArenaState *)gKTRexState)->speed8 =
...
int ktrex_stateHandlerA07(int obj, int runtime) {
    if ((s8)((KTRexRuntime *)runtime)->unk27B != 0) {
        ...
        *(u8 *)&((GameObject *)obj)->anim.resetHitboxMode &= ~8;
        ((KTRexArenaState *)gKTRexState)->counter101 += 1;
        ktrexlevel_clearPathGameBits();
        GameBit_Set(1394, ((KTRexArenaState *)gKTRexState)->counter101);
        ((KTRexArenaState *)gKTRexState)->timerFA |= 0x10;
...
int ktrex_stateHandlerA04(int obj, int runtime) {
    ...
    if ((s8)((KTRexRuntime *)runtime)->unk27B != 0) {
        ...
        ((KTRexArenaState *)gKTRexState)->timer4 =
            (f32)(u32)*(u16 *)((char *)p + ((KTRexArenaState *)gKTRexState)->boolFD * 2 + 0x44);
        return 0;
    }
    t = ((KTRexArenaState *)gKTRexState)->timer4 - timeDelta;
    ((KTRexArenaState *)gKTRexState)->timer4 = t;
    if (t < lbl_803E67B8) {
        ((KTRexArenaState *)gKTRexState)->timer4 = lbl_803E67B8;
    }
    if ((s8)((KTRexRuntime *)runtime)->unk346 != 0) {
        if (((KTRexArenaState *)gKTRexState)->timer4 <= lbl_803E67B8) {
            popped = 0;
            if (Stack_IsEmpty(((KTRexArenaState *)gKTRexState)->stack) == 0) {
                Stack_Pop(((KTRexArenaState *)gKTRexState)->stack, &popped);
            }
...
int ktrex_stateHandlerA05(int obj, int runtime) {
    ...
    if (ktrex_updateArenaPathProgress(runtime) != 0) {
        ((KTRexArenaState *)gKTRexState)->timer103 -= 1;
        if ((s8)((KTRexArenaState *)gKTRexState)->timer103 <= 0) {
            pushLo = 2;
            if (Stack_IsFull(((KTRexArenaState *)gKTRexState)->stack) == 0) {
...
int ktrex_stateHandlerA08(int obj, int runtime) {
    ...
    if ((s8)((KTRexRuntime *)runtime)->unk27B != 0) {
        ...
        ((KTRexArenaState *)gKTRexState)->timer4 =
            (f32)(u32)*(u16 *)((char *)p + (((KTRexArenaState *)gKTRexState)->counter101 & ~1) + 0x4a);
        *(u8 *)&((GameObject *)obj)->anim.resetHitboxMode &= ~8;
        return 0;
    }
    ...
    if ((((KTRexArenaState *)gKTRexState)->timerFA & 8) != 0) {
        ((KTRexArenaState *)gKTRexState)->timer102 -= 1;
        ((KTRexRuntime *)runtime)->timer354 = 3;
    }
    ((KTRexArenaState *)gKTRexState)->timerFA &= ~0x10;
    if (((KTRexArenaState *)gKTRexState)->timer102 == 0) {
        return 2;
    }
    *(u8 *)&((GameObject *)obj)->anim.resetHitboxMode |= 8;
    return 10;
...
int ktrex_stateHandlerA09(int obj, int runtime) {
    ...
    if ((s8)((KTRexRuntime *)runtime)->unk346 != 0) {
        ...
        ((KTRexArenaState *)gKTRexState)->timer4 = lbl_803E67D8;
        Music_Trigger(147, 0);
        Music_Trigger(148, 1);
        return 11;
    }
...
int ktrex_stateHandlerA10(int obj, int runtime) {
    ...
    ((KTRexArenaState *)gKTRexState)->timer4 -= timeDelta;
    if (((KTRexArenaState *)gKTRexState)->timer4 <= lbl_803E67B8) {
        ((KTRexArenaState *)gKTRexState)->timer4 = lbl_803E67B8;
    }
    if (((KTRexArenaState *)gKTRexState)->timer4 <= lbl_803E67B8 &&
        ((KTRexArenaState *)gKTRexState)->unk0C == phase &&
        ((laneBit == 0 && ((KTRexArenaState *)gKTRexState)->speed8 >= lbl_803E67D0) ||
         (laneBit != 0 && ((KTRexArenaState *)gKTRexState)->speed8 <= lbl_803E67D4))) {
        if ((((KTRexArenaState *)gKTRexState)->timerFA & 8) != 0) {
            int cond;
            u8 fe;
            ((KTRexArenaState *)gKTRexState)->counter101 += 1;
            GameBit_Set(0x572, ((KTRexArenaState *)gKTRexState)->counter101);
            ((KTRexArenaState *)gKTRexState)->boolFD = 0;
            ((KTRexArenaState *)gKTRexState)->timerFA &= ~0x8;
