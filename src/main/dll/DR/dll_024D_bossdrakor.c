...
void bossdrakor_update(int obj)
{
    ...
    if (((DrakorFlags *)((char *)state + 0x198))->b10) {
        ...
        ((GameObject *)obj)->anim.localPosX = ((BossDrakorState *)state)->posX90;
        ((GameObject *)obj)->anim.localPosZ = ((BossDrakorState *)state)->posZ90;
        ((GameObject *)obj)->anim.localPosY = ((BossDrakorState *)state)->posY90;
        ...
        (*gGameUIInterface)->initAirMeter(((BossDrakorState *)state2)->timer170, 0x63e);
        (*gGameUIInterface)->runAirMeter(((BossDrakorState *)state2)->timer170);
    ...
    moveResult = Obj_UpdateRomCurveFollowVelocityIndexed(*(f32 *)state, lbl_803E6568, lbl_803E6520, obj, (void *)((char *)state + 0x28), 1, (void *)&((BossDrakorState *)state)->bool194);
    ...
    if (timerCountDown(&((BossDrakorState *)state)->unk10) != 0) {
        bossdrakor_spawnAttackObjects(obj, state, ((BossDrakorState *)state)->unk174);
        if (((BossDrakorState *)state)->unk14 != lbl_803E6510) {
            s16toFloat((void *)&((BossDrakorState *)state)->unk10, (int)((BossDrakorState *)state)->unk14);
        }
    }
    if ((((GameObject *)obj)->objectFlags & 0x800) == 0) {
        ((BossDrakorState *)state)->posX1C = ((GameObject *)obj)->anim.localPosX;
        ((BossDrakorState *)state)->posY1C = ((GameObject *)obj)->anim.localPosY - lbl_803E655C;
        ((BossDrakorState *)state)->posZ1C = ((GameObject *)obj)->anim.localPosZ;
    }
    ...
    if (((DrakorFlags *)((char *)state + 0x198))->b20) {
        (*gGameUIInterface)->runAirMeter(((BossDrakorState *)state)->timer170);
    }
    t = lbl_803E6510;
    if (t != ((BossDrakorState *)state)->unk178) {
        ((BossDrakorState *)state)->speed17C = -(lbl_803E6578 * timeDelta - ((BossDrakorState *)state)->speed17C);
        ((BossDrakorState *)state)->unk178 = ((BossDrakorState *)state)->unk178 + ((BossDrakorState *)state)->speed17C;
...
void bossdrakor_updateHeadTracking(int obj, int state)
{
    ...
    if (neck != NULL) {
        ...
        neck[0] += (s16)step;
        PSVECSubtract(&((BossDrakorState *)state)->posX1C, &((GameObject *)obj)->anim.localPosX, prm.vec);
        ...
        case 1:
            ...
            if (((DrakorFlags *)((char *)state + 0x198))->b40) {
                if (Obj_IsLoadingLocked() != 0) {
                    ...
                    ((ObjPlacement *)setup)->posX = ((BossDrakorState *)state)->posX1C;
                    ((ObjPlacement *)setup)->posY = ((BossDrakorState *)state)->posY1C;
                    ((ObjPlacement *)setup)->posZ = ((BossDrakorState *)state)->posZ1C;
                    setup[4] = 1;
                    setup[5] = 1;
                    setup[6] = 0xff;
                    setup[7] = 0xff;
                    if ((void *)player != NULL) {
                        ...
                        if ((void *)missile != NULL) {
                            ...
                            PSVECSubtract(&((GameObject *)player)->anim.localPosX, &((BossDrakorState *)state)->posX1C, vecA);
                            PSVECSubtract(target, &((BossDrakorState *)state)->posX1C, vecB);
                            ...
                            PSVECScale(vecC, (f32 *)((char *)missile + 0x24), ((BossDrakorState *)state)->unk184 * lbl_803DC18C);
                            *mstate = spd;
...
void bossdrakor_free(int obj)
{
    ...
    if (((GameObject *)obj)->seqIdC8 != NULL) {
        ObjLink_DetachChild(obj, *(int *)&((GameObject *)obj)->seqIdC8);
    }
...
void bossdrakor_handleActionEvent(int obj, int state, int action)
{
    ...
    case 1:
        ...
        break;
    case 2:
        storeZeroToFloatParam(&((BossDrakorState *)state)->unk10);
        s16toFloat((void *)&((BossDrakorState *)state)->unk10, 0x1e);
        ((BossDrakorState *)state)->unk174 = 2;
        ((BossDrakorState *)state)->unk14 = lbl_803E6510;
        break;
    case 3:
        storeZeroToFloatParam(&((BossDrakorState *)state)->unk10);
        s16toFloat((void *)&((BossDrakorState *)state)->unk10, 0x5a);
        ((BossDrakorState *)state)->unk14 = lbl_803E6540;
        ((BossDrakorState *)state)->unk174 = 1;
        ((BossDrakorState *)state)->unk184 = *(f32 *)((char *)tbl + 0x84);
        ((BossDrakorState *)state)->unk188 = *(f32 *)((char *)tbl + 0x90);
        break;
    case 4:
        storeZeroToFloatParam(&((BossDrakorState *)state)->unk10);
        s16toFloat((void *)&((BossDrakorState *)state)->unk10, 0x3c);
        ((BossDrakorState *)state)->unk14 = lbl_803E6544;
        ((BossDrakorState *)state)->unk174 = 1;
    ...
    case 5:
        storeZeroToFloatParam(&((BossDrakorState *)state)->unk10);
        s16toFloat((void *)&((BossDrakorState *)state)->unk10, 0x1e);
        ((BossDrakorState *)state)->unk14 = lbl_803E6548;
        ((BossDrakorState *)state)->unk174 = 1;
    ...
    case 6:
        t = lbl_803E6510;
        ((BossDrakorState *)state)->unk14 = t;
        ((BossDrakorState *)state)->unk10 = t;
        storeZeroToFloatParam(&((BossDrakorState *)state)->unk10);
        break;
    case 7:
    ...
    case 11:
    case 12:
        if (((BossDrakorState *)state)->timer170 < *(int *)((char *)tbl + action * 4 + 0x74)) {
            ((BossDrakorState *)state)->bool194 = 1;
        }
        break;
    case 14:
    case 15:
...
void bossdrakor_hitDetect(int obj)
{
    ...
    if (hit == 0xf || hit == 0xe) {
        if (((DrakorFlags *)((char *)inner + 0x198))->b40) {
            ((BossDrakorState *)inner)->timer170 -= 1;
            ((DrakorFlags *)((char *)inner + 0x198))->b08 = 1;
            if (((BossDrakorState *)inner)->timer170 < 0) {
            ...
            if (((BossDrakorState *)inner)->timer19C <= lbl_803E6510) {
                ((BossDrakorState *)inner)->timer19C = lbl_803E6558;
                Sfx_PlayFromObject(obj, 0x478);
            }
            if (((BossDrakorState *)inner)->timer1A0 <= lbl_803E6510) {
                ((BossDrakorState *)inner)->timer1A0 = lbl_803E6520;
                Sfx_PlayFromObject(obj, 0x4af);
            }
            t518 = lbl_803E6518;
            ((BossDrakorState *)inner)->speed17C = t518;
    ...
    ((BossDrakorState *)inner)->timer19C -= timeDelta;
    ((BossDrakorState *)inner)->timer1A0 -= timeDelta;
}
...
int bossdrakor_animEventCallback(int obj, int unused, ObjAnimUpdateState *animUpdate)
{
    ...
    if (((BossDrakorState *)inner)->timer18C > lbl_803E6510) {
        gameTextShow(0x569);
        ((BossDrakorState *)inner)->timer18C -= timeDelta;
        if (((BossDrakorState *)inner)->timer18C < lbl_803E6510) {
            ((BossDrakorState *)inner)->timer18C = lbl_803E6510;
        }
    }
    for (i = 0; i < animUpdate->eventCount; i++) {
        ...
        case 6:
            ...
            if ((void *)target != NULL && ((GameObject *)obj)->seqIdEB != 0) {
        ...
        case 7:
            ...
            if ((void *)target != NULL) {
                ...
                ((BossDrakorState *)inner)->timer18C = lbl_803E6514;
            }
            break;
        case 9:
...
void bossdrakor_init(int obj, u8 *init)
{
    ...
    ((BossDrakorState *)inner)->timer170 = *(s16 *)((char *)init + 0x1a);
    fz = lbl_803E6510;
    ((BossDrakorState *)inner)->unk14 = fz;
    ((BossDrakorState *)inner)->moveState = 0;
    ((BossDrakorState *)inner)->unk16C = -1;
    ((BossDrakorState *)inner)->unk174 = 0;
    ((BossDrakorState *)inner)->unk164 = lbl_803E657C;
    ((DrakorFlags *)((char *)inner + 0x198))->b40 = 1;
    ((BossDrakorState *)inner)->unk178 = fz;
    ((BossDrakorState *)inner)->speed17C = fz;
    ((BossDrakorState *)inner)->bool194 = 0;
    ((BossDrakorState *)inner)->timer18C = fz;
    ((DrakorFlags *)((char *)inner + 0x198))->b10 = 1;
    storeZeroToFloatParam(&((BossDrakorState *)inner)->unk10);
