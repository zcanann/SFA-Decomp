 ...
 */
undefined4
FUN_801be44c(undefined8 param_1,double param_2,double param_3,undefined8 param_4,undefined8 param_5,
                 ...
                 uint param_9,int param_10)
{
  ...
  if (iVar1 != 0) {
    ...
    FUN_80006b94((double)FLOAT_803e5940);
    ...
    FUN_80006920((double)FLOAT_803e5944);
