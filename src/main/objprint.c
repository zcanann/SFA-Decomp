...
void FUN_8003a328(double param_1,short *param_2,char *param_3)
{
  ...
  if (psVar2 != (short *)0x0) {
    ...
    if ((double)FLOAT_803df664 < param_1) {
      FUN_80039c4c(param_1,(undefined4)(u32)param_2,param_3,(int)psVar2);
    }
    else {
