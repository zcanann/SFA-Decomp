...
undefined4 FUN_8003988c(double param_1,double param_2,int param_3,short *param_4)
{
  ...
  if ((int)*(short *)(param_3 + 0x14) == (int)*(short *)(param_3 + 0x16)) {
    ...
    local_30 = 0x43300000;
    local_20 = 0x43300000;
    dVar3 = (double)(((f32)(s32)uStack_34 -
                     (f32)(s32)uStack_2c) /
  ...
  do {
    ...
    do {
      if ((uVar4 & 1 ^ uVar4 >> 0x1f) == uVar4 >> 0x1f) {
        iVar10 = (int)(lbl_803DF66C * (f32)(s32)((int)*param_5));
    ...
    if (param_4 == 0) {
      ...
      iVar8 = uVar4 * ((int)(short)(int)(lbl_803DF66C * (f32)(s32)(-(int)*param_5)) /
                      DAT_803dc0c0);
      if (iVar8 <= iVar10) {
        iVar11 = uVar4 * ((int)(short)(int)(lbl_803DF66C * (f32)(s32)((int)*param_5)) /
                         DAT_803dc0c0);
        iVar8 = iVar10;
        if (iVar11 < iVar10) {
          iVar8 = iVar11;
      ...
      iVar10 = (int)(lbl_803DF66C * (f32)(s32)((int)*psVar14));
...
int modelRenderCb_8003c268(int obj, int *p2, int p3)
{
    ...
    GXSetTexCoordGen2(1, 1, 4, 0x3c, 0, 0x46);
