...
void objSeqDoBgCmds0D(u8 *seq, u8 *obj, int skipSpawns)
{
    ...
    if (lbl_803DD090 != 0 && ((GameObject *)obj)->classIdB4 != (s8)((ObjSeqState *)seq)->slot) {
...
void ObjSeq_ApplyFrameCurves(u8 *obj, u8 *seqObj, u8 *seq, int frame)
{
    ...
    if (((ObjSeqState *)seq)->animEntries != NULL) {
        ...
        lbl_803DD114 = 1;
        ((GameObject *)obj)->anim.localPosX = *(f32 *)(model + 0x8) + lbl_803DD0CC;
        ((GameObject *)obj)->anim.localPosY = *(f32 *)(model + 0xc) + lbl_803DD0C8;
        ((GameObject *)obj)->anim.localPosZ = *(f32 *)(model + 0x10) + lbl_803DD0C4;
...
int ObjSeq_update(u8 *obj, f32 t)
{
    ...
    do {
        ...
        *(u16 *)&((GameObject *)obj)->anim.rotZ = ((GameObject *)obj)->anim.rotZ + ((ObjSeqState *)seq)->rotStepZ;
        *(u16 *)&((GameObject *)obj)->anim.rotY = ((GameObject *)obj)->anim.rotY + ((ObjSeqState *)seq)->rotStepY;
        *(u16 *)&((GameObject *)obj)->anim.rotX = ((GameObject *)obj)->anim.rotX + ((ObjSeqState *)seq)->rotStepX;
    ...
    *seqObj = activeObj;
    ...
    if ((s8)((ObjSeqState *)seq)->unk7A == 1 &&
        hitDetectFn_800658a4(obj, ((GameObject *)obj)->anim.localPosX, ((GameObject *)obj)->anim.localPosY,
                             ((GameObject *)obj)->anim.localPosZ, groundY, 0) == 0) {
        ((GameObject *)obj)->anim.localPosY =
            ((GameObject *)obj)->anim.localPosY + ((((GameObject *)obj)->anim.localPosY - groundY[0]) - *(f32 *)(sourceObj + 0xc));
    }
...
void ObjSeq_ApplyLinkedObjectTransform(u8 *obj, u8 *seqObj, u8 *seq)
{
    ...
    if (*(void **)(seqObj + 0x30) == ((GameObject *)obj)->anim.parent || (s8)lbl_803DD114 == 0) {
...
checked:
    ...
    i = 0;
    st->cmdFlags[((GameObject *)obj)->classIdB4] = 0;
    base[((GameObject *)obj)->classIdB4 + 0x3334] = 0;
    lbl_8030ECF8[((GameObject *)obj)->classIdB4] = 0;
    st->handles[((GameObject *)obj)->classIdB4] = ((GameObject *)obj)->anim.seqId;
        ...
        if (flags & (1 << idx)) {
            ...
            *(s8 *)(setup + 0x1f) = (s8)slot;
            ...
            if (*(u16 *)(walk2 + 4) & 0x2000) {
                ...
                if (lbl_803DD064 == 0 || lbl_803DD064 == ((GameObject *)obj)->classIdB4) {
                    lbl_803DD064 = ((GameObject *)obj)->classIdB4;
                    curSeqNo = slot;
                }
            ...
            if (idx == 0) {
                st->cmdFlags[((GameObject *)obj)->classIdB4] = *(u16 *)(walk2 + 4);
                st->handles[((GameObject *)obj)->classIdB4] =
    ...
    st->headings[((GameObject *)obj)->classIdB4] = heading;
    j = 0;
    base[((GameObject *)obj)->classIdB4 + 0x3590] = 0;
    base[((GameObject *)obj)->classIdB4 + 0x338c] = 0;
    n = (s8)lbl_803DD124;
    for (; j < n; j++) {
        if (*(u8 **)mon == obj) {
...
gotFlags:
    if (seqFlags != 0) {
        st->cmdFlags[((GameObject *)obj)->classIdB4] |= 0x10;
    } else {
        lbl_803DD070 = 0;
    ...
    st->dists[((GameObject *)obj)->classIdB4] = (f32)seqFlags;
    st->frames[((GameObject *)obj)->classIdB4] = (f32)seqFlags;
