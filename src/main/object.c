...
void Obj_ClearModelColorFadeRecursive(u8 *obj) {
    ...
    ((GameObject *)obj)->flagsE5 &= ~0x6;
    i = 0;
    childScan = obj;
    while (i < ((GameObject *)obj)->seqIdEB) {
        Obj_ClearModelColorFadeRecursive(((GameObject *)childScan)->seqIdC8);
        childScan += 4;
        i++;
    }
}
...
void Obj_TickModelColorFadeRecursive(u8 *obj) {
    ...
    childScan = obj;
    while (i < ((GameObject *)obj)->seqIdEB) {
        Obj_TickModelColorFadeRecursive(((GameObject *)childScan)->seqIdC8);
        childScan += 4;
        i++;
    }
}
...
void Obj_SetModelColorFadeRecursive(u8 *obj, int frames, u8 red, u8 green, u8 blue, u8 startAtHalf) {
    ...
    ((GameObject *)obj)->flagsE5 &= ~4;
    ((GameObject *)obj)->flagsE5 |= 2;
    obj[0xec] = red;
    obj[0xed] = green;
    obj[0xee] = blue;
    if (frames == 10000) {
        ((GameObject *)obj)->flagsE5 |= 8;
    } else {
        ((GameObject *)obj)->flagsE5 &= ~8;
    }
    if (startAtHalf != 0) {
    ...
    childScan = obj;
    while (i < ((GameObject *)obj)->seqIdEB) {
        Obj_SetModelColorFadeRecursive(((GameObject *)childScan)->seqIdC8, frames, red, green, blue, startAtHalf);
        childScan += 4;
        i++;
    }
}
...
void Obj_SetModelColorOverrideRecursive(u8 *obj, u8 red, u8 green, u8 blue, u8 alpha, u8 enabled) {
    ...
    childScan = obj;
    while (i < ((GameObject *)obj)->seqIdEB) {
        Obj_SetModelColorOverrideRecursive(((GameObject *)childScan)->seqIdC8, red, green, blue, alpha, enabled);
        childScan += 4;
        i++;
    }
}
...
void Obj_ResetModelColorState(u8 *obj) {
    ((GameObject *)obj)->unkE6 = 0;
    ((GameObject *)obj)->flagsE5 &= ~1;
    ((GameObject *)obj)->counterF0 = 0;
...
void Obj_StartModelFadeIn(u8 *obj, int frames) {
    ...
    if ((*(u8 *)((u8 *)((GameObject *)obj)->anim.modelInstance + 0x76) & 1) != 0) {
        if (((GameObject *)obj)->counterF0 < fadeLimit) {
            ((GameObject *)obj)->counterF0++;
            Obj_SetModelColorFadeRecursive(obj, 0x1e, 0xa0, 0xff, 0xff, 0);
        }
        if (((GameObject *)obj)->counterF0 == fadeLimit) {
            if ((((GameObject *)obj)->flagsE5 & 2) != 0) {
                Obj_ClearModelColorFadeRecursive(obj);
            }
            ((GameObject *)obj)->unkE6 = (s16)frames;
            ((GameObject *)obj)->flagsE5 = (u8)(((GameObject *)obj)->flagsE5 | 1);
...
int objIsFrozen(u8 *obj) {
    return ((GameObject *)obj)->flagsE5 & 1;
}

int objGetFlagsE5_2(u8 *obj) {
    return ((GameObject *)obj)->flagsE5 & 2;
}
...
void objFreeObjDef(void *objp, int flag) {
    ...
    if (((GameObject *)obj)->flagsE5 & 1) {
        *(u16 *)&((GameObject *)obj)->unkE6 = 0;
        ((GameObject *)obj)->flagsE5 = ((GameObject *)obj)->flagsE5 & ~1;
        ((GameObject *)obj)->counterF0 = 0;
    ...
    if (((GameObject *)obj)->classIdB4 >= 0) {
        if (flag == 0) {
            (*gObjectTriggerInterface)->endSequence(((GameObject *)obj)->classIdB4);
        }
        ((GameObject *)obj)->classIdB4 = 0xffff;
    }
...
void Obj_UpdateObject(u8 *obj)
{
    ...
    if (((GameObject *)obj)->flagsE5 != 0 && *(int *)&((GameObject *)obj)->unkC4 == 0 && (((GameObject *)obj)->flagsE5 & 2)) {
        Obj_TickModelColorFadeRecursive(obj);
    }
    if (*(int *)&((GameObject *)obj)->unkC0 != 0) {
        if (*(int *)&((GameObject *)obj)->seqIdC8 != 0) {
            t = *(u8 **)((u8 *)((GameObject *)obj)->seqIdC8 + 0x54);
            if (t != 0) {
...
void Obj_UpdateAllObjects(u8 flags)
{
    ...
    if (obj2 != 0 && ((GameObject *)obj2)->seqIdC8 != 0) {
        *(int *)((u8 *)((GameObject *)obj2)->seqIdC8 + 0x30) = *(int *)&((GameObject *)obj2)->anim.parent;
        Obj_UpdateObject(((GameObject *)obj2)->seqIdC8);
    }
    if (timeStop == 0) {
        ...
        if (obj2 != 0 && ((GameObject *)obj2)->seqIdC8 != 0) {
            *(int *)((u8 *)((GameObject *)obj2)->seqIdC8 + 0x30) = *(int *)&((GameObject *)obj2)->anim.parent;
            child = *(int *)&((GameObject *)obj2)->seqIdC8;
...
void Obj_UpdateModelBlendStates(void)
{
    ...
    for (; i < lbl_803DCB84; i++) {
        ...
        if (obj != 0 && objAnim->modelInstance != NULL) {
            ...
            j = 0;
            walker = obj;
            for (; j < ((GameObject *)obj)->seqIdEB; j++) {
