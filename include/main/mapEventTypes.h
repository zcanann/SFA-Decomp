...
typedef struct MapEventInterface {
    ...
    void (*updateTransientMapBits)(void);
    u8 (*getPlayerNo)(void);
    void (*unk78)(int);
    u8 pad7C[0x88 - 0x7C];
    u8 *(*getGameBitSaveData)(void);
...
STATIC_ASSERT(offsetof(MapEventInterface, updateTransientMapBits) == 0x70);
STATIC_ASSERT(offsetof(MapEventInterface, getPlayerNo) == 0x74);
STATIC_ASSERT(offsetof(MapEventInterface, unk78) == 0x78);
STATIC_ASSERT(offsetof(MapEventInterface, getGameBitSaveData) == 0x88);
