...
typedef struct SnowBikeState {
    u8 pad000[0xc];
    f32 posX00C;             /* 0x00c: position snapshot X */
    f32 posY00C;             /* 0x010: position snapshot Y */
    f32 posZ00C;             /* 0x014: position snapshot Z */
    f32 unk018;             /* 0x018 */
    f32 unk01C;             /* 0x01c */
    f32 unk020;             /* 0x020 */
    f32 unk024;             /* 0x024 */
    ...
    s16 angle02E;             /* 0x02e: rider pitch on free */
    u8 pad030[0x4];
    f32 unk034;             /* 0x034 */
    int unk038;             /* 0x038 */
    int unk03C;             /* 0x03c */
    ...
    int unk044;             /* 0x044 */
    u8 pad048[0x4];
    f32 posX04C;             /* 0x04c: rider pos X on free */
    f32 posY04C;             /* 0x050: rider pos Y on free */
    f32 posZ04C;             /* 0x054: rider pos Z on free */
    u8 unk058;              /* 0x058 */
    u8 pad059[0x3];
    u8 unk05C;              /* 0x05c */
    u8 unk05D;              /* 0x05d */
...
STATIC_ASSERT(offsetof(SnowBikeState, posX16C) == 0x16C);
