 ...
 * "bit" column of gCMenuTrickyAbilities above. BADDIE is the prompt-only
 * sidekick/distract slot: it can light Tricky's "bad guy" prompt but has no
 * normal C-menu row.
 */
enum TrickyAbilityBit
{
    ...
    TRICKY_ABILITY_BADDIE      = 0x04, /* prompt-only baddie/distract target */
