...
extern int wclevelcont_seqFn(int obj, int unused, ObjAnimUpdateState *animUpdate);
...
extern int mclightning_SeqFn(int obj, int unused, ObjAnimUpdateState *animUpdate);
...
void arwbombcoll_setLifetime(int obj, int v);
