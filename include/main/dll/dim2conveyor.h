...
STATIC_ASSERT(offsetof(NwMammothObject, localPosX) == 0x0C);
STATIC_ASSERT(offsetof(NwMammothObject, worldPosX) == 0x18);
STATIC_ASSERT(offsetof(NwMammothObject, mapData) == 0x4C);
STATIC_ASSERT(offsetof(NwMammothObject, modelState) == 0x64);
STATIC_ASSERT(offsetof(NwMammothObject, currentMove) == 0xA0);
STATIC_ASSERT(offsetof(NwMammothObject, hitboxFlags) == 0xAF);
