...
int dfropenode_findNearestRopePoint(struct GameObject* obj, f32 x, f32 y, f32 z, float* distanceOut, float* phaseOut,
                                    u8* sideOut);
void dfropenode_applyForceAtPhase(f32 phase, f32 force, int obj);
void dfropenode_advancePhaseByDistance(struct GameObject* distance, int obj, float* phase);
