...
extern void objThrowFn_80182504(struct GameObject *a);
...
extern void arwprojectile_placeForward(struct GameObject *obj, f32 dist);
extern void arwprojectile_setLifetime(struct GameObject *obj, int frames);
...
extern void staffactivated_calcInteractionTargetXZ(struct GameObject *a, void *b, void *c);
...
extern void fn_802B0EA4(struct GameObject *obj, int state, int sub);
...
extern int playerStateAttack(int obj, int state, f32 fv);
...
extern int cfPrisonGuard_getPullRateMode(struct GameObject *a);
...
extern f32 lbl_803E7FA8;
extern void cfPrisonGuard_setGameBitMirror(struct GameObject *a, int b);
...
int fn_8029605C(struct GameObject *obj, f32 *outX, f32 *outY);
...
int playerState0D(struct GameObject *obj, int p2);
...
void staffShootFireball(int obj, int p2, f32 unused);
