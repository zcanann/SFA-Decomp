...
extern void dll_2E_func06(GameObject* obj, void* p, int v);
...
extern void dll_2E_func05(GameObject* obj, void* p, int a, int b, int c);
...
extern int Obj_PredictInterceptPoint(GameObject* player, f32 v, f32* objPos, f32* out);
...
extern int Obj_UpdateRomCurveFollowVelocity(GameObject* obj, f32* p, f32 a, f32 b, f32 c, int d);
