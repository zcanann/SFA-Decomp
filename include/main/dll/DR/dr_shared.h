...
extern int GM_MazeWell_SeqFn(int obj, int unused, ObjAnimUpdateState *animUpdate);
...
extern int DR_Creator_SeqFn(int obj, int unused, ObjAnimUpdateState *animUpdate);
...
extern int drshackle_SeqFn(int obj, int unused, ObjAnimUpdateState *animUpdate);
