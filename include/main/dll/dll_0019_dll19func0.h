...
void dll_19_startHitReaction(GameObject* obj, BaddieState* state, void* hitbox, s16 gameBit, u8* flagOut, s16 substate, s16 moveMode, int animMove, s8 field25f);
...
int dll_19_updateSequenceMovement(GameObject* obj, ObjSeqState* seq, GroundBaddieState* st, void* moveHandlers, void* stateHandlers, s16 controlMode);
int dll_19_func10(GameObject* obj, GroundBaddieState* state, int moveArg0, int moveArg1, s16 controlMode, f32* destX, f32* destZ, int* reachedOut);
...
int dll_19_updateHitReaction(GameObject* obj, BaddieState* baddieState, void* hitbox, s16 gameBit, int* tableA, u8* tableB, s16 substate, void* hitPosOut);
int dll_19_processMessages(GameObject* obj, BaddieState* state, void* hitbox, s16 gameBit, u8* flagOut, s16 substateIdle, s16 substateActive, s16 moveMode);
void dll_19_initGroundBaddie(GameObject* obj, GroundBaddiePlacement* config, GroundBaddieState* state, int moveArg0, int moveArg1, int pathFlags, u8 initFlags, f32 pathRadius);
