...
STATIC_ASSERT(offsetof(DfpTargetBlockObject, anim) == 0x00);
STATIC_ASSERT(offsetof(DfpTargetBlockObject, x) == offsetof(ObjAnimComponent, localPosX));
STATIC_ASSERT(offsetof(DfpTargetBlockObject, velX) == offsetof(ObjAnimComponent, velocityX));
STATIC_ASSERT(offsetof(DfpTargetBlockObject, objectType) == offsetof(ObjAnimComponent, seqId));
