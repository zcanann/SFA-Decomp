...
extern f32 gPlayerFallAnimSpeed;
extern int gPlayerHitReactionMoves[2];
extern f32 gPlayerHitReactionMoveSpeeds[2];
...
extern f32 gPlayerCloudRunnerAimZResponse;
extern f32 gPlayerCloudRunnerAimXResponse;
extern f32 gPlayerCloudRunnerTurnScale;
