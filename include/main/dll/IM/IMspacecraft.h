...
void FUN_801a57e8(int param_1,int param_2,int param_3,int param_4,int param_5,s8 visible);
...
void FUN_801a5da4(int param_1,int param_2,int param_3,int param_4,int param_5,s8 visible);
...
void FUN_801a66c0(int param_1,int param_2,int param_3,int param_4,int param_5,s8 visible);
