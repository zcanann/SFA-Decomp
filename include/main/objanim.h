...
int Object_ObjAnimSetMove(f32 moveProgress,int objAnim,int moveId,int moveControlFlags);
...
int ObjAnim_SetCurrentMove(int objAnim,int moveId,f32 moveProgress,int moveControlFlags);
