...
void fn_8008908C(u8 *ambientRed, u8 *ambientGreen, u8 *ambientBlue, u8 *lightRed, u8 *lightGreen, u8 *lightBlue);
...
void curveFn_80083e00(RomCurveInterpState *out, RomCurveNode *curve, RomCurveNode *next, f32 t, int flag);
void romCurveFn_80084190(RomCurveInterpState *state, f32 t);
void curveFindFn_800843c4(RomCurveInterpState *out, int id);
int romCurveFn_800844b8(RomCurveInterpState *state, f32 *offset, f32 *outPos, s16 *outAngle, int ignoreY);
