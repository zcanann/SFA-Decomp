...
typedef struct StaffState {
    ...
    u8 unkAA;
    u8 padAB[5];
    s16 geometrySegmentCount;
    s16 orientationSegmentIndex;
    u8 padB4[5];
...
STATIC_ASSERT(offsetof(StaffState, geometryPointAX) == 0x54);
STATIC_ASSERT(offsetof(StaffState, geometryPointAY) == 0x5C);
STATIC_ASSERT(offsetof(StaffState, geometryPointAZ) == 0x64);
STATIC_ASSERT(offsetof(StaffState, geometryPointBX) == 0x6C);
STATIC_ASSERT(offsetof(StaffState, geometryPointBY) == 0x74);
STATIC_ASSERT(offsetof(StaffState, geometryPointBZ) == 0x7C);
...
STATIC_ASSERT(offsetof(StaffState, geometrySegmentCount) == 0xB0);
STATIC_ASSERT(offsetof(StaffState, orientationSegmentIndex) == 0xB2);
