...
typedef struct SHthorntailState {
    ...
    u8* impactSfxTable;
    f32 idleTimer;
    f32 closeAttackWaitTimer;
    f32 tailSwingEffectTimer;
    s16 storedFacingAngle;
    s8 closeAttackRepeatCount;
...
STATIC_ASSERT(offsetof(SHthorntailState, closeAttackWaitTimer) == 0x634);
STATIC_ASSERT(offsetof(SHthorntailState, tailSwingEffectTimer) == 0x638);
STATIC_ASSERT(offsetof(SHthorntailState, storedFacingAngle) == 0x63C);
STATIC_ASSERT(offsetof(SHthorntailState, closeAttackRepeatCount) == 0x63E);
